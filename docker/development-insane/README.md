...
- http://localhost:8086 (with Alpine 3.14 (Apache and PHP 7.4))
- http://localhost:8087 (with Alpine 3.14 (Apache and PHP 8.0))
- http://localhost:8088 (with Alpine Edge (Apache and now PHP 8.0))
- http://localhost:8089 (with Alpine 3.7 (Apache and PHP 7.1) with redis)
- http://localhost:8090 (with Alpine 3.9 (Apache and PHP 7.2) with redis)
- http://localhost:8091 (with Alpine 3.11 (Apache and PHP 7.3) with redis)
- http://localhost:8092 (with Alpine 3.12 (Apache and PHP 7.3) with redis)
- http://localhost:8093 (with Alpine 3.13 (Apache and PHP 7.4) with redis)
- http://localhost:8094 (with Alpine 3.13 (Apache and PHP 8.0) with redis)
- http://localhost:8095 (with Alpine 3.14 (Apache and PHP 7.4) with redis)
- http://localhost:8096 (with Alpine 3.14 (Apache and PHP 8.0) with redis)
- http://localhost:8097 (with Alpine Edge (Apache and now PHP 8.0) with redis)
...
- https://localhost:9086 with SSL and Alpine 3.14 (with Apache and PHP 7.4)
- https://localhost:9087 with SSL and Alpine 3.14 (with Apache and PHP 8.0)
- https://localhost:9088 with SSL and Alpine Edge (with Apache and now PHP 8.0)
- https://localhost:9089 with SSL and Alpine 3.7 (with Apache and PHP 7.1 with redis)
- https://localhost:9090 with SSL and Alpine 3.9 (with Apache and PHP 7.2 with redis)
- https://localhost:9091 with SSL and Alpine 3.11 (with Apache and PHP 7.3 with redis)
- https://localhost:9092 with SSL and Alpine 3.12 (with Apache and PHP 7.3 with redis)
- https://localhost:9093 with SSL and Alpine 3.13 (with Apache and PHP 7.4 with redis)
- https://localhost:9094 with SSL and Alpine 3.13 (with Apache and PHP 8.0 with redis)
- https://localhost:9095 with SSL and Alpine 3.14 (with Apache and PHP 7.4 with redis)
- https://localhost:9096 with SSL and Alpine 3.14 (with Apache and PHP 8.0 with redis)
- https://localhost:9097 with SSL and Alpine Edge (with Apache and now PHP 8.0 with redis)
...
docker pull openemr/openemr:flex-3.14
docker pull openemr/openemr:flex-3.14-8
