#!/bin/bash
# Upgrade number 15 for OpenEMR docker
#  From prior version 8.4.0 (needed for the sql upgrade script).
priorOpenemrVersion="8.4.0"
echo "Start: Upgrade to docker-version 15"
...
echo "Completed: Upgrade to docker-version 15"
