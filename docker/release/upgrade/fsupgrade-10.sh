#!/bin/bash
# Upgrade number 10 for OpenEMR docker
#  From prior version 8.0.0 (needed for the sql upgrade script).
priorOpenemrVersion="8.0.0"
echo "Start: Upgrade to docker-version 10"
...
echo "Completed: Upgrade to docker-version 10"
