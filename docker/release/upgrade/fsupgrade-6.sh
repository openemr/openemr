#!/bin/bash
# Upgrade number 6 for OpenEMR docker
#  From prior version 7.0.1 (needed for the sql upgrade script).
priorOpenemrVersion="7.0.1"
...
echo "Completed: Upgrade to docker-version 6"
