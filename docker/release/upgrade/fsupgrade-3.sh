#!/bin/bash
# Upgrade number 3 for OpenEMR docker
#  From prior version 6.0.0 (needed for the sql upgrade script).
priorOpenemrVersion="6.0.0"
...
echo "Completed: Upgrade to docker-version 3"
