#!/bin/bash
# Upgrade number 14 for OpenEMR docker
#  From prior version 8.3.0 (needed for the sql upgrade script).
priorOpenemrVersion="8.3.0"
echo "Start: Upgrade to docker-version 14"
...
echo "Completed: Upgrade to docker-version 14"
