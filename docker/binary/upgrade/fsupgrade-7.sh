#!/bin/bash
# Upgrade number 7 for OpenEMR docker
#  From prior version 7.0.2 (needed for the sql upgrade script).
priorOpenemrVersion="7.0.2"
...
echo "Completed: Upgrade to docker-version 7"
