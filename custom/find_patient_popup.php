...
include_once("$srcdir/translation.inc.php");
...
<form method='post' name='theform' id="theform" action='find_patient_popup.php?<?php if(isset($_GET['pflag'])) echo "pflag=0"; ?>' class="form-inline">
    <div class="form-group">
        <label for="searchby"><?php echo htmlspecialchars( xl('Search by:'), ENT_NOQUOTES); ?></label>
    ...
    <div class="form-group">
        <label><?php echo htmlspecialchars( xl('for:'), ENT_NOQUOTES); ?></label>
        <input type='text' class="form-control" id='searchparm' name='searchparm' size='12' value='<?php echo htmlspecialchars( $_REQUEST['searchparm'], ENT_QUOTES); ?>' title='<?php echo htmlspecialchars( xl('If name, any part of lastname or lastname,firstname'), ENT_QUOTES); ?>'>
    </div>
    <input type='submit' class="btn btn-primary ml-1" id="submitbtn" value='<?php echo htmlspecialchars( xl('Search'), ENT_QUOTES); ?>'>
