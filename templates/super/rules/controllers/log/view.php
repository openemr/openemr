...
<form method='post' name='theform' id='theform' action='cdr_log.php' onsubmit='return top.restoreSession()'>
    ...
    <div id="report_parameters">
        ...
        <table>
            ...
            <tr>
                <td colspan="2">
                    <p class="text-start"><i class='ms-2 fa fa-comment' title=" <?php echo xla("Select feedback icon to show feedback") ?>"></i> <?php echo xlt("Rule has user provided feedback, select icon to show feedback"); ?></p>
                </td>
            </tr>
        </table>
