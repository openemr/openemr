...
(29, 'EMAIL', 'STOP', '', '<span class="btn btn-danger" title="OptOut of EMAIL Messaging. Demographics updated." aria-label=‚Äö√Ñ√∫Optout EMAIL‚Äö√Ñ√π><i class="fa fa-envelope-o" aria-hidden="true"> STOP</i></span>', ''),
