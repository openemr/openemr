...
-- =========================
#IfRow2D layout_group_properties grp_form_id DEM grp_title Guardian
UPDATE layout_group_properties SET grp_title = 'Related' WHERE grp_title = 'Guardian' AND grp_form_id = 'DEM';
#EndIf
...
-- TODO: @adunsulag need to handle migration of patient_related_persons table to person and contact_address/telecom tables
