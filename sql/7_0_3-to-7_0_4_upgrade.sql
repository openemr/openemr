...
ALTER TABLE `onetime_auth`
    ADD `scope` tinytext COMMENT 'context scope for this token';
#EndIf

#IfMissingColumn onetime_auth profile
ALTER TABLE `onetime_auth`
    ADD `profile` tinytext COMMENT 'profile of scope for this token';
#EndIf

#IfMissingColumn onetime_auth onetime_actions
ALTER TABLE `onetime_auth`
    ADD `onetime_actions` text COMMENT 'JSON array of actions that can be performed with this token';
#EndIf

UPDATE `list_options`
SET `notes` = '{"form_title":{"presence": {"message": "Title Required"}}}'
WHERE `list_id` = 'page_validation'
  AND `option_id` = 'add_edit_event#theform_prov'
  AND `title` = '/interface/main/calendar/add_edit_event.php?prov=true'
  AND `notes` = '{}';
...
ALTER TABLE `product_registration`
    ADD `auth_by_id` INT(11) NULL;
#EndIf

#IfMissingColumn product_registration telemetry_disabled
ALTER TABLE `product_registration`
    ADD `telemetry_disabled` TINYINT(1) NULL COMMENT '1 disabled. NULL ask. 0 use option scopes';
#EndIf

#IfMissingColumn product_registration last_ask_date
ALTER TABLE `product_registration`
    ADD `last_ask_date` DATETIME NULL;
#EndIf

#IfMissingColumn product_registration last_ask_version
ALTER TABLE `product_registration`
    ADD `last_ask_version` TINYTEXT;
#EndIf

#IfMissingColumn product_registration options
ALTER TABLE `product_registration`
    ADD `options` TEXT COMMENT 'JSON array of scope options';
#EndIf

#IfIndex track_events unique_event_label
ALTER TABLE `track_events`
    DROP INDEX `unique_event_label`;
#EndIf

#IfIndex track_events unique_event_label_url
ALTER TABLE `track_events`
    DROP INDEX `unique_event_label_url`;
#EndIf

#IfNotIndex track_events unique_event_label_target
ALTER TABLE `track_events`
    ADD UNIQUE `unique_event_label_target` (`event_label`, `event_url`(255), `event_target`(255));
#EndIf
...
VALUES ('care_team_roles', 'primary_care_provider', 'Primary Care Provider', 10, 'SNOMED-CT:62247001', ''),
...
VALUES ('lists', 'ecqm_2023_reporting', 'eCQM 2023 Performance Period', 0, 1, 0, '');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS1028v1', 'Severe Obstetric Complications', 10, 0, 'Patients with severe obstetric complications which occur during the inpatient delivery hospitalization.');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS104v11', 'Discharged on Antithrombotic Therapy', 20, 0, 'Ischemic stroke patients prescribed or continuing to take antithrombotic therapy at hospital discharge');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS105v11', 'Discharged on Statin Medication', 30, 0, 'Ischemic stroke patients who are prescribed or continuing to take statin medication at hospital discharge');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS108v11', 'Venous Thromboembolism Prophylaxis', 40, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS111v11', 'Median Admit Decision Time to ED Departure Time for Admitted Patients', 50, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS117v11', 'Childhood Immunization Status', 60, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS122v11', 'Diabetes: Hemoglobin A1c (HbA1c) Poor Control (> 9%)', 70, 1, 'Percentage of patients 18-75 years of age with diabetes who had hemoglobin A1c &gt; 9.0% during the measurement period');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS124v11', 'Cervical Cancer Screening', 80, 1,
        'Percentage of women 21-64 years of age who were screened for cervical cancer using either of the following criteria:<br>*  Women age 21-64 who had cervical cytology performed within the last 3 years<br>*  Women age 30-64 who had cervical human papillomavirus (HPV) testing performed within the last 5 years');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS125v11', 'Breast Cancer Screening', 90, 1, 'Percentage of women 50-74 years of age who had a mammogram to screen for breast cancer in the 27 months prior to the end of the Measurement Period');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS127v11', 'Pneumococcal Vaccination Status for Older Adults', 100, 1, 'Percentage of patients 66 years of age and older who have received a pneumococcal vaccine');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS128v11', 'Anti-depressant Medication Management', 110, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS129v12', 'Prostate Cancer: Avoidance of Overuse of Bone Scan for Staging Low Risk Prostate Cancer Patients', 120, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS130v11', 'Colorectal Cancer Screening', 130, 1, 'Percentage of adults 45-75 years of age who had appropriate screening for colorectal cancer');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS131v11', 'Diabetes: Eye Exam', 140, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS133v11', 'Cataracts: 20/40 or Better Visual Acuity within 90 Days Following Cataract Surgery', 150, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS134v11', 'Diabetes: Medical Attention for Nephropathy', 160, 0, 'The percentage of patients 18-75 years of age with diabetes who had a nephropathy screening test or evidence of nephropathy during the measurement period');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS135v11', 'Heart Failure (HF): Angiotensin-Converting Enzyme (ACE) Inhibitor or Angiotensin Receptor Blocker (ARB) or Angiotensin Receptor-Neprilysin Inhibitor (ARNI) Therapy for Left Ventricular Systolic Dysfunction (LVSD)', 170, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS136v12', 'Follow-Up Care for Children Prescribed ADHD Medication (ADD)', 180, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS137v11', 'Initiation and Engagement of Substance Use Disorder Treatment', 190, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS138v11', 'Preventive Care and Screening: Tobacco Use: Screening and Cessation Intervention', 200, 1,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS139v11', 'Falls: Screening for Future Fall Risk', 210, 0, 'Percentage of patients 65 years of age and older who were screened for future fall risk during the measurement period');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS142v11', 'Diabetic Retinopathy: Communication with the Physician Managing Ongoing Diabetes Care', 220, 0,
        'Percentage of patients aged 18 years and older with a diagnosis of diabetic retinopathy who had a dilated macular or fundus exam performed with documented communication to the physician who manages the ongoing care of the patient with diabetes mellitus regarding the findings of the macular or fundus exam at least once within 12 months');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS143v11', 'Primary Open-Angle Glaucoma (POAG): Optic Nerve Evaluation', 230, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS144v11', 'Heart Failure (HF): Beta-Blocker Therapy for Left Ventricular Systolic Dysfunction (LVSD)', 240, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS145v11', 'Coronary Artery Disease (CAD): Beta-Blocker Therapy-Prior Myocardial Infarction (MI) or Left Ventricular Systolic Dysfunction (LVEF <=40%)', 250, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS146v11', 'Appropriate Testing for Pharyngitis', 260, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS147v12', 'Preventive Care and Screening: Influenza Immunization', 270, 1,
        'Percentage of patients aged 6 months and older seen for a visit between October 1 and March 31 who received an influenza immunization OR who reported previous receipt of an influenza immunization');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS149v11', 'Dementia: Cognitive Assessment', 280, 0, 'Percentage of patients, regardless of age, with a diagnosis of dementia for whom an assessment of cognition is performed and the results reviewed at least once within a 12-month period');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS153v11', 'Chlamydia Screening in Women', 290, 0, 'Percentage of women 16-24 years of age who were identified as sexually active and who had at least one test for chlamydia during the measurement period');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS154v11', 'Appropriate Treatment for Upper Respiratory Infection (URI)', 300, 0, 'Percentage of episodes for patients 3 months of age and older with a diagnosis of upper respiratory infection (URI) that did not result in an antibiotic order');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS155v11', 'Weight Assessment and Counseling for Nutrition and Physical Activity for Children/Adolescents', 310, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS156v11', 'Use of High-Risk Medications in Older Adults', 320, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS157v11', 'Oncology: Medical and Radiation - Pain Intensity Quantified', 330, 0,
        'Percentage of patient visits, regardless of patient age, with a diagnosis of cancer currently receiving chemotherapy or radiation therapy in which pain intensity is quantified');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS159v11', 'Depression Remission at Twelve Months', 340, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS161v11', 'Adult Major Depressive Disorder (MDD): Suicide Risk Assessment', 350, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS165v11', 'Controlling High Blood Pressure', 360, 1,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS177v11', 'Child and Adolescent Major Depressive Disorder (MDD): Suicide Risk Assessment', 370, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS190v11', 'Intensive Care Unit Venous Thromboembolism Prophylaxis', 380, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS22v11', 'Preventive Care and Screening: Screening for High Blood Pressure and Follow-Up Documented', 390, 1,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS249v5', 'Appropriate Use of DXA Scans in Women Under 65 Years Who Do Not Meet the Risk Factor Profile for Osteoporotic Fracture', 400, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS2v12', 'Preventive Care and Screening: Screening for Depression and Follow-Up Plan', 410, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS334v4', 'Cesarean Birth', 420, 0, 'Nulliparous women with a term, singleton baby in a vertex position delivered by cesarean birth');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS347v6', 'Statin Therapy for the Prevention and Treatment of Cardiovascular Disease', 430, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS349v5', 'HIV Screening', 440, 0, 'Percentage of patients aged 15-65 at the start of the measurement period who were between 15-65 years old when tested for Human immunodeficiency virus (HIV)');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS506v5', 'Safe Use of Opioids - Concurrent Prescribing', 450, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS50v11', 'Closing the Referral Loop: Receipt of Specialist Report', 460, 0, 'Percentage of patients with referrals, regardless of age, for which the referring clinician receives a report from the clinician to whom the patient was referred');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS529v3', 'Core Clinical Data Elements for the Hybrid Hospital-Wide Readmission (HWR) Measure with Claims and Electronic Health Record Data', 470, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS56v11', 'Functional Status Assessment for Total Hip Replacement', 480, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS645v6', 'Bone density evaluation for patients with prostate cancer and receiving androgen deprivation therapy', 490, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS646v3', 'Intravesical Bacillus-Calmette-Guerin for non-muscle invasive bladder cancer', 500, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS66v11', 'Functional Status Assessment for Total Knee Replacement', 510, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS68v12', 'Documentation of Current Medications in the Medical Record', 520, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS69v11', 'Preventive Care and Screening: Body Mass Index (BMI) Screening and Follow-Up Plan', 530, 1,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS71v12', 'Anticoagulation Therapy for Atrial Fibrillation/Flutter', 540, 0, 'Ischemic stroke patients with atrial fibrillation/flutter who are prescribed or continuing to take anticoagulation therapy at hospital discharge');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS72v11', 'Antithrombotic Therapy By End of Hospital Day 2', 550, 0, 'Ischemic stroke patients administered antithrombotic therapy by the end of hospital day 2');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS74v12', 'Primary Caries Prevention Intervention as Offered by Dentists', 560, 0, 'Percentage of children, 6 months - 20 years of age, who received a fluoride varnish application during the measurement period as determined by a dentist');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS75v11', 'Children Who Have Dental Decay or Cavities', 570, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS771v4', 'Urinary Symptom Score Change 6-12 Months After Diagnosis of Benign Prostatic Hyperplasia', 580, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS816v2', 'Hospital Harm - Severe Hypoglycemia', 590, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS819v1', 'Hospital Harm - Opioid-Related Adverse Events', 600, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS844v3', 'Core Clinical Data Elements for the Hybrid Hospital-Wide (All-Condition, All-Procedure) Risk-Standardized Mortality Measure (HWM)', 610, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS871v2', 'Hospital Harm - Severe Hyperglycemia', 620, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS90v12', 'Functional Status Assessments for Heart Failure', 630, 0, 'Percentage of patients 18 years of age and older with heart failure who completed initial and follow-up patient-reported functional status assessments');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS951v1', 'Kidney Health Evaluation', 640, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS986v1', 'Global Malnutrition Composite Score', 650, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS996v3', 'Appropriate Treatment for ST-Segment Elevation Myocardial Infarction (STEMI) Patients in the Emergency Department (ED)', 660, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2023_reporting', 'CMS9v11', 'Exclusive Breast Milk Feeding', 670, 0,
        'PC-05 Exclusive breast milk feeding during the newborn&#39;s entire hospitalization.<br><br>The measure is reported as an overall rate which includes all newborns that were exclusively fed breast milk during the entire hospitalization.');
#EndIf
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `is_default`, `option_value`, `notes`)
VALUES ('lists', 'ecqm_2024_reporting', 'eCQM 2024 Performance Period', 0, 1, 0, '');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS1028v2', 'Severe Obstetric Complications', 10, 0, 'Patients with severe obstetric complications which occur during the inpatient delivery hospitalization');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS104v12', 'Discharged on Antithrombotic Therapy', 20, 0, 'Ischemic stroke patients prescribed or continuing to take antithrombotic therapy at hospital discharge');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS1056v1', 'Excessive Radiation Dose or Inadequate Image Quality for Diagnostic Computed Tomography (CT) in Adults (Clinician Level)', 30, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS1074v1', 'Excessive Radiation Dose or Inadequate Image Quality for Diagnostic Computed Tomography (CT) in Adults (Facility IQR)', 40, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS108v12', 'Venous Thromboembolism Prophylaxis', 50, 0,
        'This measure assesses the number of patients who received Venous Thromboembolism (VTE) prophylaxis or have documentation why no VTE prophylaxis was given between the day of arrival to the day after hospital admission or surgery end date for surgeries that start the day of or the day after hospital admission');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS117v12', 'Childhood Immunization Status', 60, 0,
        'Percentage of children 2 years of age who had four diphtheria, tetanus and acellular pertussis (DTaP); three polio (IPV), one measles, mumps and rubella (MMR); three or four H influenza type B (Hib); three hepatitis B (Hep B); one chicken pox (VZV); four pneumococcal conjugate (PCV); one hepatitis A (Hep A); two or three rotavirus (RV); and two influenza (flu) vaccines by their second birthday');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS1188v1', 'Sexually Transmitted Infection (STI) Testing for People with HIV', 70, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS1206v1', 'Excessive Radiation Dose or Inadequate Image Quality for Diagnostic Computed Tomography (CT) in Adults (Facility OQR)', 80, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS122v12', 'Diabetes: Hemoglobin A1c (HbA1c) Poor Control (> 9%)', 90, 1, 'Percentage of patients 18-75 years of age with diabetes who had hemoglobin A1c &gt; 9.0% during the measurement period');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS124v12', 'Cervical Cancer Screening', 100, 1,
        'Percentage of women 21-64 years of age who were screened for cervical cancer using either of the following criteria:<br>- Women age 21-64 who had cervical cytology performed within the last 3 years<br>- Women age 30-64 who had cervical human papillomavirus (HPV) testing performed within the last 5 years');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS125v12', 'Breast Cancer Screening', 110, 1, 'Percentage of women 50-74 years of age who had a mammogram to screen for breast cancer in the 27 months prior to the end of the Measurement Period');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS127v12', 'Pneumococcal Vaccination Status for Older Adults', 120, 1, 'Percentage of patients 65 years of age and older who have received a pneumococcal vaccine');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS128v12', 'Anti-depressant Medication Management', 130, 0,
        'Percentage of patients 18 years of age and older who were treated with antidepressant medication, had a diagnosis of major depression, and who remained on an antidepressant medication treatment. Two rates are reported. <br>a. Percentage of patients who remained on an antidepressant medication for at least 84 days (12 weeks). <br>b. Percentage of patients who remained on an antidepressant medication for at least 180 days (6 months).');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS129v13', 'Prostate Cancer: Avoidance of Overuse of Bone Scan for Staging Low Risk Prostate Cancer Patients', 140, 0,
        'Percentage of patients, regardless of age, with a diagnosis of prostate cancer at low (or very low) risk of recurrence receiving interstitial prostate brachytherapy, OR external beam radiotherapy to the prostate, OR radical prostatectomy who did not have a bone scan performed at any time since diagnosis of prostate cancer');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS130v12', 'Colorectal Cancer Screening', 150, 1, 'Percentage of adults 45-75 years of age who had appropriate screening for colorectal cancer');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS131v12', 'Diabetes: Eye Exam', 160, 0,
        'Percentage of patients 18-75 years of age with diabetes and an active diagnosis of retinopathy in any part of the measurement period who had a retinal or dilated eye exam by an eye care professional during the measurement period or diabetics with no diagnosis of retinopathy in any part of the measurement period who had a retinal or dilated eye exam by an eye care professional during the measurement period or in the 12 months prior to the measurement period');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS133v12', 'Cataracts: 20/40 or Better Visual Acuity within 90 Days Following Cataract Surgery', 170, 0,
        'Percentage of cataract surgeries for patients aged 18 and older with a diagnosis of uncomplicated cataract and no significant ocular conditions impacting the visual outcome of surgery and had best-corrected visual acuity of 20/40 or better (distance or near) achieved in the operative eye within 90 days following the cataract surgery');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS135v12', 'Heart Failure (HF): Angiotensin-Converting Enzyme (ACE) Inhibitor or Angiotensin Receptor Blocker (ARB) or Angiotensin Receptor-Neprilysin Inhibitor (ARNI) Therapy for Left Ventricular Systolic Dysfunction (LVSD)', 180, 0,
        'Percentage of patients aged 18 years and older with a diagnosis of heart failure (HF) with a current or prior left ventricular ejection fraction (LVEF) &lt;=40% who were prescribed or already taking ACE inhibitor or ARB or ARNI therapy during the measurement period');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS136v13', 'Follow-Up Care for Children Prescribed ADHD Medication (ADD)', 190, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS137v12', 'Initiation and Engagement of Substance Use Disorder Treatment', 200, 0,
        'Percentage of patients 13 years of age and older with a new substance use disorder (SUD) episode who received the following (Two rates are reported):<br><br>a. Percentage of patients who initiated treatment, including either an intervention or medication for the treatment of SUD, within 14 days of the new SUD episode. <br>b. Percentage of patients who engaged in ongoing treatment, including two additional interventions or short-term medications, or one long-term medication for the treatment of SUD, within 34 days of the initiation.');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS138v12', 'Preventive Care and Screening: Tobacco Use: Screening and Cessation Intervention', 210, 1,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS139v12', 'Falls: Screening for Future Fall Risk', 220, 0, 'Percentage of patients 65 years of age and older who were screened for future fall risk during the measurement period');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS142v12', 'Diabetic Retinopathy: Communication with the Physician Managing Ongoing Diabetes Care', 230, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS143v12', 'Primary Open-Angle Glaucoma (POAG): Optic Nerve Evaluation', 240, 0,
        'Percentage of patients aged 18 years and older with a diagnosis of primary open-angle glaucoma (POAG) who have an optic nerve head evaluation during one or more visits within 12 months');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS144v12', 'Heart Failure (HF): Beta-Blocker Therapy for Left Ventricular Systolic Dysfunction (LVSD)', 250, 0,
        'Percentage of patients aged 18 years and older with a diagnosis of heart failure (HF) with a current or prior left ventricular ejection fraction (LVEF) &lt;= 40% who were prescribed or already taking beta-blocker therapy during the measurement period');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS145v12', 'Coronary Artery Disease (CAD): Beta-Blocker Therapy-Prior Myocardial Infarction (MI) or Left Ventricular Systolic Dysfunction (LVEF <=40%)', 260, 0,
        'Percentage of patients aged 18 years and older with a diagnosis of coronary artery disease seen within a 12-month period who also have a prior MI or a current or prior LVEF &lt;=40% who were prescribed beta-blocker therapy');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS146v12', 'Appropriate Testing for Pharyngitis', 270, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS147v13', 'Preventive Care and Screening: Influenza Immunization', 280, 1,
        'Percentage of patients aged 6 months and older seen for a visit between October 1 and March 31 who received an influenza immunization OR who reported previous receipt of an influenza immunization');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS149v12', 'Dementia: Cognitive Assessment', 290, 0, 'Percentage of patients, regardless of age, with a diagnosis of dementia for whom an assessment of cognition is performed and the results reviewed at least once within a 12-month period');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS153v12', 'Chlamydia Screening in Women', 300, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS154v12', 'Appropriate Treatment for Upper Respiratory Infection (URI)', 310, 0, 'Percentage of episodes for patients 3 months of age and older with a diagnosis of upper respiratory infection (URI) that did not result in an antibiotic order');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS155v12', 'Weight Assessment and Counseling for Nutrition and Physical Activity for Children/Adolescents', 320, 0,
        'Percentage of patients 3-17 years of age who had an outpatient visit with a primary care physician (PCP) or obstetrician/gynecologist (OB/GYN) and who had evidence of the following during the measurement period.<br><br> - Percentage of patients with height, weight, and body mass index (BMI) percentile documentation<br> - Percentage of patients with counseling for nutrition<br> - Percentage of patients with counseling for physical activity');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS156v12', 'Use of High-Risk Medications in Older Adults', 330, 0,
        'Percentage of patients 65 years of age and older who were ordered at least two high-risk medications from the same drug class. Three rates are reported. <br>1. Percentage of patients 65 years of age and older who were ordered at least two high-risk medications from the same drug class.<br>2. Percentage of patients 65 years of age and older who were ordered at least two high-risk medications from the same drug class, except for appropriate diagnoses.<br>3. Total rate (the sum of the two numerators divided by the denominator, deduplicating for patients in both numerators).');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS157v12', 'Oncology: Medical and Radiation - Pain Intensity Quantified', 340, 0,
        'Percentage of patient visits, regardless of patient age, with a diagnosis of cancer currently receiving chemotherapy or radiation therapy in which pain intensity is quantified');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS159v12', 'Depression Remission at Twelve Months', 350, 0,
        'The percentage of adolescent patients 12 to 17 years of age and adult patients 18 years of age or older with major depression or dysthymia who reached remission 12 months (+/- 60 days) after an index event');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS161v12', 'Adult Major Depressive Disorder (MDD): Suicide Risk Assessment', 360, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS165v12', 'Controlling High Blood Pressure', 370, 1,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS177v12', 'Child and Adolescent Major Depressive Disorder (MDD): Suicide Risk Assessment', 380, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS190v12', 'Intensive Care Unit Venous Thromboembolism Prophylaxis', 390, 0,
        'This measure assesses the number of patients who received Venous Thromboembolism (VTE) prophylaxis or have documentation why no VTE prophylaxis was given the day of or the day after the initial admission (or transfer) to the Intensive Care Unit (ICU) or surgery end date for surgeries that start the day of or the day after ICU admission (or transfer)');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS22v12', 'Preventive Care and Screening: Screening for High Blood Pressure and Follow-Up Documented', 400, 1,
        'Percentage of patient visits for patients aged 18 years and older seen during the measurement period who were screened for high blood pressure AND a recommended follow-up plan is documented, as indicated, if blood pressure is elevated or hypertensive');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS249v6', 'Appropriate Use of DXA Scans in Women Under 65 Years Who Do Not Meet the Risk Factor Profile for Osteoporotic Fracture', 410, 0,
        'Percentage of female patients 50 to 64 years of age without select risk factors for osteoporotic fracture who received an order for a dual-energy x-ray absorptiometry (DXA) scan during the measurement period');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS2v13', 'Preventive Care and Screening: Screening for Depression and Follow-Up Plan', 420, 0,
        'Percentage of patients aged 12 years and older screened for depression on the date of the encounter or up to 14 days prior to the date of the encounter using an age-appropriate standardized depression screening tool AND if positive, a follow-up plan is documented on the date of or up to two days after the date of the qualifying encounter');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS314v1', 'HIV Viral Suppression', 430, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS334v5', 'Cesarean Birth', 440, 0, 'Nulliparous women with a term, singleton baby in a vertex position delivered by cesarean birth');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS347v7', 'Statin Therapy for the Prevention and Treatment of Cardiovascular Disease', 450, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS349v6', 'HIV Screening', 460, 0, 'Percentage of patients aged 15-65 at the start of the measurement period who were between 15-65 years old when tested for Human immunodeficiency virus (HIV)');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS506v6', 'Safe Use of Opioids - Concurrent Prescribing', 470, 0,
        'Proportion of inpatient hospitalizations for patients 18 years of age and older prescribed, or continued on, two or more opioids or an opioid and benzodiazepine concurrently at discharge');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS50v12', 'Closing the Referral Loop: Receipt of Specialist Report', 480, 0, 'Percentage of patients with referrals, regardless of age, for which the referring clinician receives a report from the clinician to whom the patient was referred');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS529v4', 'Core Clinical Data Elements for the Hybrid Hospital-Wide Readmission (HWR) Measure with Claims and Electronic Health Record Data', 490, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS56v12', 'Functional Status Assessment for Total Hip Replacement', 500, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS645v7', 'Bone density evaluation for patients with prostate cancer and receiving androgen deprivation therapy', 510, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS646v4', 'Intravesical Bacillus-Calmette-Guerin for non-muscle invasive bladder cancer', 520, 0,
        'Percentage of patients initially diagnosed with non-muscle invasive bladder cancer and who received intravesical Bacillus-Calmette-Guerin (BCG) within 6 months of bladder cancer staging');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS68v13', 'Documentation of Current Medications in the Medical Record', 530, 0,
        'Percentage of visits for patients aged 18 years and older for which the eligible clinician attests to documenting a list of current medications using all immediate resources available on the date of the encounter');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS69v12', 'Preventive Care and Screening: Body Mass Index (BMI) Screening and Follow-Up Plan', 540, 1,
        'Percentage of patients aged 18 years and older with a BMI documented during the current encounter or during the measurement period AND who had a follow-up plan documented if BMI was outside of normal parameters');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS71v13', 'Anticoagulation Therapy for Atrial Fibrillation/Flutter', 550, 0, 'Ischemic stroke patients with atrial fibrillation/flutter who are prescribed or continuing to take anticoagulation therapy at hospital discharge');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS72v12', 'Antithrombotic Therapy By End of Hospital Day 2', 560, 0, 'Ischemic stroke patients administered antithrombotic therapy by the end of hospital day 2');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS74v13', 'Primary Caries Prevention Intervention as Offered by Dentists', 570, 0, 'Percentage of children, 1 - 20 years of age, who received two fluoride varnish applications during the measurement period as determined by a dentist');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS75v12', 'Children Who Have Dental Decay or Cavities', 580, 0, 'Percentage of children, 1 - 20 years of age at the start of the measurement period, who have had tooth decay or cavities during the measurement period as determined by a dentist');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS771v5', 'Urinary Symptom Score Change 6-12 Months After Diagnosis of Benign Prostatic Hyperplasia', 590, 0,
        'Percentage of patients with an office visit within the measurement period and with a new diagnosis of clinically significant Benign Prostatic Hyperplasia who have International Prostate Symptoms Score (IPSS) or American Urological Association (AUA) Symptom Index (SI) documented at time of diagnosis and again 6-12 months later with an improvement of 3 points');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS816v3', 'Hospital Harm - Severe Hypoglycemia', 600, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS819v2', 'Hospital Harm - Opioid-Related Adverse Events', 610, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS826v1', 'Hospital Harm - Pressure Injury', 620, 0, 'The proportion of inpatient hospitalizations for patients aged 18 and older who suffer the harm of developing a new stage 2, stage 3, stage 4, deep tissue, or unstageable pressure injury');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS832v1', 'Hospital Harm -  Acute Kidney Injury', 630, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS844v4', 'Core Clinical Data Elements for the Hybrid Hospital-Wide (All-Condition, All-Procedure) Risk-Standardized Mortality Measure (HWM)', 640, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS871v3', 'Hospital Harm - Severe Hyperglycemia', 650, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS90v13', 'Functional Status Assessments for Heart Failure', 660, 0, 'Percentage of patients 18 years of age and older with heart failure who completed initial and follow-up patient-reported functional status assessments');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS951v2', 'Kidney Health Evaluation', 670, 0,
        'Percentage of patients aged 18-75 years with a diagnosis of diabetes who received a kidney health evaluation defined by an Estimated Glomerular Filtration Rate (eGFR) AND Urine Albumin-Creatinine Ratio (uACR) within the measurement period');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2024_reporting', 'CMS996v4', 'Appropriate Treatment for ST-Segment Elevation Myocardial Infarction (STEMI) Patients in the Emergency Department (ED)', 680, 0,
        'Percentage of emergency department (ED) encounters for patients 18 years and older with a diagnosis of ST-segment elevation myocardial infarction (STEMI) that received appropriate treatment, defined as fibrinolytic therapy within 30 minutes of ED arrival, percutaneous coronary intervention (PCI) within 90 minutes of ED arrival, or transfer within 45 minutes of ED arrival');
#EndIf
-- ---------------------------------------------------------------------------------------------------------------------------------
--
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `is_default`, `option_value`, `notes`)
VALUES ('lists', 'ecqm_2025_reporting', 'eCQM 2025 Performance Period', 0, 1, 0, '');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS1017v1', 'Hospital Harm – Falls with Injury', 10, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS1028v3', 'Severe Obstetric Complications', 20, 0, 'Patients with severe obstetric complications that occur during the inpatient delivery hospitalization');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS104v13', 'Discharged on Antithrombotic Therapy', 30, 0, 'Ischemic stroke patients prescribed or continuing to take antithrombotic therapy at hospital discharge');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS1056v2', 'Excessive Radiation Dose or Inadequate Image Quality for Diagnostic Computed Tomography (CT) in Adults (Clinician Level)', 40, 1,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS1074v2', 'Excessive Radiation Dose or Inadequate Image Quality for Diagnostic Computed Tomography (CT) in Adults (Facility IQR)', 50, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS108v13', 'Venous Thromboembolism Prophylaxis', 60, 0,
        'This measure assesses the number of patients who received Venous Thromboembolism (VTE) prophylaxis or have documentation why no VTE prophylaxis was given between the day of arrival to the day after hospital admission or surgery end date for surgeries that start the day of or the day after hospital admission');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS1157v1', 'HIV Annual Retention in Care', 70, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS117v13', 'Childhood Immunization Status', 80, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS1188v2', 'Sexually Transmitted Infection (STI) Testing for People with HIV', 90, 0,
        'Percentage of patients 13 years of age and older with a diagnosis of HIV who had tests for syphilis, gonorrhea, and chlamydia performed within the measurement period');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS1206v2', 'Excessive Radiation Dose or Inadequate Image Quality for Diagnostic Computed Tomography (CT) in Adults (Facility OQR)', 100, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS1218v1', 'Hospital Harm - Postoperative Respiratory Failure', 110, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS122v13', 'Diabetes: Glycemic Status Assessment Greater Than 9%', 120, 1,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS124v13', 'Cervical Cancer Screening', 130, 1,
        'Percentage of women 21-64 years of age who were screened for cervical cancer using either of the following criteria:<br>- Women age 21-64 who had cervical cytology performed within the last 3 years<br>- Women age 30-64 who had cervical human papillomavirus (HPV) testing performed within the last 5 years');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS125v13', 'Breast Cancer Screening', 140, 1, 'Percentage of women 50-74 years of age who had a mammogram to screen for breast cancer in the 27 months prior to the end of the Measurement Period');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS128v13', 'Antidepressant Medication Management', 150, 0,
        'Percentage of patients 18 years of age and older who were treated with antidepressant medication, had a diagnosis of major depression, and who remained on an antidepressant medication treatment. Two rates are reported. <br>a. Percentage of patients who remained on an antidepressant medication for at least 84 days (12 weeks). <br>b. Percentage of patients who remained on an antidepressant medication for at least 180 days (6 months).');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS129v14', 'Prostate Cancer: Avoidance of Overuse of Bone Scan for Staging Low Risk Prostate Cancer Patients', 160, 0,
        'Percentage of patients, regardless of age, with a diagnosis of prostate cancer at low (or very low) risk of recurrence receiving interstitial prostate brachytherapy, OR external beam radiotherapy to the prostate, OR radical prostatectomy who did not have a bone scan performed at any time since diagnosis of prostate cancer');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS130v13', 'Colorectal Cancer Screening', 170, 1, 'Percentage of adults 45-75 years of age who had appropriate screening for colorectal cancer');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS131v13', 'Diabetes: Eye Exam', 180, 0,
        'Percentage of patients 18-75 years of age with diabetes and an active diagnosis of retinopathy in any part of the measurement period who had a retinal or dilated eye exam by an eye care professional during the measurement period or diabetics with no diagnosis of retinopathy in any part of the measurement period who had a retinal or dilated eye exam by an eye care professional during the measurement period or in the 12 months prior to the measurement period');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS133v13', 'Cataracts: 20/40 or Better Visual Acuity within 90 Days Following Cataract Surgery', 190, 0,
        'Percentage of cataract surgeries for patients aged 18 and older with a diagnosis of uncomplicated cataract and no significant ocular conditions impacting the visual outcome of surgery and had best-corrected visual acuity of 20/40 or better (distance or near) achieved in the operative eye within 90 days following the cataract surgery');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS135v13', 'Heart Failure (HF): Angiotensin-Converting Enzyme (ACE) Inhibitor or Angiotensin Receptor Blocker (ARB) or Angiotensin Receptor-Neprilysin Inhibitor (ARNI) Therapy for Left Ventricular Systolic Dysfunction (LVSD)', 200, 0,
        'Percentage of patients aged 18 years and older with a diagnosis of heart failure (HF) with a current or prior left ventricular ejection fraction (LVEF) &lt;=40% who were prescribed or already taking ACE inhibitor or ARB or ARNI therapy during the measurement period');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS136v14', 'Follow-Up Care for Children Prescribed ADHD Medication (ADD)', 210, 0,
        'Percentage of children 6-12 years of age and newly prescribed a medication for attention-deficit/hyperactivity disorder (ADHD) who had appropriate follow-up care. Two rates are reported.  <br>a. Percentage of children who had one follow-up visit with a practitioner with prescribing authority during the 30-Day Initiation Phase.<br>b. Percentage of children who remained on ADHD medication for at least 210 treatment days and who, in addition to the visit in the Initiation Phase, had at least two additional follow-up visits with a practitioner within 270 days (9 months) after the Initiation Phase ended.');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS137v13', 'Initiation and Engagement of Substance Use Disorder Treatment', 220, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS138v13', 'Preventive Care and Screening: Tobacco Use: Screening and Cessation Intervention', 230, 1,
        'Percentage of patients aged 12 years and older who were screened for tobacco use one or more times during the measurement period AND who received tobacco cessation intervention during the measurement period or in the six months prior to the measurement period if identified as a tobacco user.<br><br>Three rates are reported: <br>a. Percentage of patients aged 12 years and older who were screened for tobacco use one or more times during the measurement period<br>b. Percentage of patients aged 12 years and older who were identified as a tobacco user during the measurement period who received tobacco cessation intervention during the measurement period or in the six months prior to the measurement period <br>c. Percentage of patients aged 12 years and older who were screened for tobacco use one or more times during the measurement period AND who received tobacco cessation intervention during the measurement period or in the six months prior to the measurement period if identified as a tobacco user');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS139v13', 'Falls: Screening for Future Fall Risk', 240, 0, 'Percentage of patients 65 years of age and older who were screened for future fall risk during the measurement period');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS142v13', 'Diabetic Retinopathy: Communication with the Physician Managing Ongoing Diabetes Care', 250, 0,
        'Percentage of patients aged 18 years and older with a diagnosis of diabetic retinopathy who had a dilated macular or fundus exam performed with documented communication to the physician who manages the ongoing care of the patient with diabetes mellitus regarding the findings of the macular or fundus exam at least once during the measurement period');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS143v13', 'Primary Open-Angle Glaucoma (POAG): Optic Nerve Evaluation', 260, 0,
        'Percentage of patients aged 18 years and older with a diagnosis of primary open-angle glaucoma (POAG) who have an optic nerve head evaluation during one or more visits within 12 months');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS144v13', 'Heart Failure (HF): Beta-Blocker Therapy for Left Ventricular Systolic Dysfunction (LVSD)', 270, 0,
        'Percentage of patients aged 18 years and older with a diagnosis of heart failure (HF) with a current or prior left ventricular ejection fraction (LVEF) &lt;= 40% who were prescribed or already taking beta-blocker therapy during the measurement period');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS145v13', 'Coronary Artery Disease (CAD): Beta-Blocker Therapy-Prior Myocardial Infarction (MI) or Left Ventricular Systolic Dysfunction (LVEF less than or equal to 40%)', 280, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS146v13', 'Appropriate Testing for Pharyngitis', 290, 0,
        'The percentage of episodes for patients 3 years and older with a diagnosis of pharyngitis that resulted in an antibiotic order on or three days after the episode date and a group A streptococcus (strep) test in the seven-day period from three days prior to the episode date through three days after the episode date');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS149v13', 'Dementia: Cognitive Assessment', 300, 0, 'Percentage of patients, regardless of age, with a diagnosis of dementia for whom an assessment of cognition is performed and the results reviewed at least once within a 12-month period');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS153v13', 'Chlamydia Screening in Women', 310, 0,
        'Percentage of women 16-24 years of age who were identified as sexually active at any time during the measurement period and who had at least one test for chlamydia during the measurement period');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS154v13', 'Appropriate Treatment for Upper Respiratory Infection (URI)', 320, 0, 'Percentage of episodes for patients 3 months of age and older with a diagnosis of upper respiratory infection (URI) that did not result in an antibiotic order');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS155v13', 'Weight Assessment and Counseling for Nutrition and Physical Activity for Children/Adolescents', 330, 0,
        'Percentage of patients 3-17 years of age who had an outpatient visit with a primary care physician (PCP) or obstetrician/gynecologist (OB/GYN) and who had evidence of the following during the measurement period.<br><br> - Percentage of patients with height, weight, and body mass index (BMI) percentile documentation<br> - Percentage of patients with counseling for nutrition<br> - Percentage of patients with counseling for physical activity');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS156v13', 'Use of High-Risk Medications in Older Adults', 340, 0,
        'Percentage of patients 65 years of age and older who were ordered at least two high-risk medications from the same drug class. Three rates are reported. <br>1. Percentage of patients 65 years of age and older who were ordered at least two high-risk medications from the same drug class.<br>2. Percentage of patients 65 years of age and older who were ordered at least two high-risk medications from the same drug class, except for appropriate diagnoses.<br>3. Total rate (the sum of the two numerators divided by the denominator, deduplicating for patients in both numerators).');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS157v13', 'Oncology: Medical and Radiation - Pain Intensity Quantified', 350, 0,
        'Percentage of patient visits, regardless of patient age, with a diagnosis of cancer currently receiving chemotherapy or radiation therapy in which pain intensity is quantified');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS159v13', 'Depression Remission at Twelve Months', 360, 0,
        'The percentage of adolescent patients 12 to 17 years of age and adult patients 18 years of age or older with major depression or dysthymia who reached remission 12 months (+/- 60 days) after an index event');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS165v13', 'Controlling High Blood Pressure', 370, 1,
        'Percentage of patients 18-85 years of age who had a diagnosis of essential hypertension starting before and continuing into, or starting during the first six months of the measurement period, and whose most recent blood pressure was adequately controlled (&lt;140/90 mmHg) during the measurement period');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS177v13', 'Child and Adolescent Major Depressive Disorder (MDD): Suicide Risk Assessment', 380, 0,
        'Percentage of patient visits for those patients aged 6 through 16 at the start of the measurement period with a diagnosis of major depressive disorder (MDD) with an assessment for suicide risk');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS190v13', 'Intensive Care Unit Venous Thromboembolism Prophylaxis', 390, 0,
        'This measure assesses the number of patients who received Venous Thromboembolism (VTE) prophylaxis or have documentation why no VTE prophylaxis was given the day of or the day after the initial admission (or transfer) to the Intensive Care Unit (ICU) or surgery end date for surgeries that start the day of or the day after ICU admission (or transfer)');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS22v13', 'Preventive Care and Screening: Screening for High Blood Pressure and Follow-Up Documented', 400, 1,
        'Percentage of patient visits for patients aged 18 years and older seen during the measurement period who were screened for high blood pressure AND a recommended follow-up plan is documented, as indicated, if blood pressure is elevated or hypertensive');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS249v7', 'Appropriate Use of DXA Scans in Women Under 65 Years Who Do Not Meet the Risk Factor Profile for Osteoporotic Fracture', 410, 0,
        'Percentage of female patients 50 to 64 years of age without select risk factors for osteoporotic fracture who received an order for a dual-energy x-ray absorptiometry (DXA) scan during the measurement period');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS2v14', 'Preventive Care and Screening: Screening for Depression and Follow-Up Plan', 420, 0,
        'Percentage of patients aged 12 years and older screened for depression on the date of the encounter or up to 14 days prior to the date of the encounter using an age-appropriate standardized depression screening tool AND if positive a follow-up plan is documented on the date of or up to two days after the date of the qualifying encounter');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS314v2', 'HIV Viral Suppression', 430, 0,
        'Percentage of patients, regardless of age, diagnosed with HIV prior to or during the first 90 days of the measurement period, with an eligible encounter in the first 240 days of the measurement period, whose last HIV viral load test result was less than 200 copies/mL during the measurement period');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS334v6', 'Cesarean Birth', 440, 0, 'Nulliparous women with a term, singleton baby in a vertex position delivered by cesarean birth');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS347v8', 'Statin Therapy for the Prevention and Treatment of Cardiovascular Disease', 450, 0,
        'Percentage of the following patients - all considered at high risk of cardiovascular events - who were prescribed or were on statin therapy during the measurement period: <br>- All patients who were previously diagnosed with or currently have a diagnosis of clinical atherosclerotic cardiovascular disease (ASCVD), including an ASCVD procedure; OR <br>- Patients aged 20 to 75 years who have ever had a low-density lipoprotein cholesterol (LDL-C) level &gt;= 190 mg/dL or were previously diagnosed with or currently have an active diagnosis of familial hypercholesterolemia; OR <br>- Patients aged 40-75 years with a diagnosis of diabetes; OR<br>- Patients aged 40 to 75 with a 10-year ASCVD risk score of &gt;= 20 percent.');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS349v7', 'HIV Screening', 460, 0, 'Percentage of patients aged 15-65 at the start of the measurement period who were between 15-65 years old when tested for human immunodeficiency virus (HIV).');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS506v7', 'Safe Use of Opioids - Concurrent Prescribing', 470, 0,
        'Proportion of inpatient hospitalizations for patients 18 years of age and older prescribed, or continued on, two or more opioids or an opioid and benzodiazepine concurrently at discharge');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS50v13', 'Closing the Referral Loop: Receipt of Specialist Report', 480, 0, 'Percentage of patients with referrals, regardless of age, for which the referring clinician receives a report from the clinician to whom the patient was referred');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS529v5', 'Core Clinical Data Elements for the Hybrid Hospital-Wide Readmission Measure with Claims and Electronic Health Record Data - HWR', 490, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS56v13', 'Functional Status Assessment for Total Hip Replacement', 500, 0,
        'Percentage of patients 19 years of age and older who received an elective primary total hip arthroplasty (THA) and completed a functional status assessment within 90 days prior to the surgery and in the 300 - 425 days after the surgery');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS645v8', 'Bone Density Evaluation for Patients with Prostate Cancer and Receiving Androgen Deprivation Therapy', 510, 0,
        'Percentage of patients determined as having prostate cancer who are currently starting or undergoing androgen deprivation therapy (ADT), for an anticipated period of 12 months or greater and who receive an initial bone density evaluation. The bone density evaluation must be prior to the start of ADT or within 3 months of the start of ADT.');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS646v5', 'Intravesical Bacillus-Calmette-Guerin for Non-Muscle Invasive Bladder Cancer', 520, 0,
        'Percentage of patients initially diagnosed with non-muscle invasive bladder cancer and who received intravesical Bacillus-Calmette-Guerin (BCG) within 6 months of bladder cancer staging');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS68v14', 'Documentation of Current Medications in the Medical Record', 530, 1,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS69v13', 'Preventive Care and Screening: Body Mass Index (BMI) Screening and Follow-Up Plan', 540, 1,
        'Percentage of patients aged 18 years and older with a BMI documented during the current encounter or during the measurement period AND who had a follow-up plan documented if BMI was outside of normal parameters');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS71v14', 'Anticoagulation Therapy for Atrial Fibrillation/Flutter', 550, 0, 'Ischemic stroke patients with atrial fibrillation/flutter who are prescribed or continuing to take anticoagulation therapy at hospital discharge');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS72v13', 'Antithrombotic Therapy by End of Hospital Day 2', 560, 0, 'Ischemic stroke patients administered antithrombotic therapy by the end of hospital day 2');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS74v14', 'Primary Caries Prevention Intervention as Offered by Dentists', 570, 0, 'Percentage of children, 1-20 years of age, who received two fluoride varnish applications during the measurement period as determined by a dentist');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS75v13', 'Children Who Have Dental Decay or Cavities', 580, 0, 'Percentage of children, 1-20 years of age at the start of the measurement period, who have had dental decay or cavities during the measurement period as determined by a dentist');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS771v6', 'Urinary Symptom Score Change 6-12 Months After Diagnosis of Benign Prostatic Hyperplasia', 590, 0,
        'Percentage of patients with an office visit within the measurement period and with a new diagnosis of clinically significant Benign Prostatic Hyperplasia who have International Prostate Symptoms Score (IPSS) or American Urological Association (AUA) Symptom Index (SI) documented at time of diagnosis and again 6-12 months later with an improvement of 3 points');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS816v4', 'Hospital Harm - Severe Hypoglycemia', 600, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS819v3', 'Hospital Harm - Opioid-Related Adverse Events', 610, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS826v2', 'Hospital Harm - Pressure Injury', 620, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS832v2', 'Hospital Harm -  Acute Kidney Injury', 630, 0,
        'The measure assesses the number of inpatient hospitalizations for patients age 18 and older who have an acute kidney injury (stage 2 or greater) that occurred during the encounter. Acute kidney injury (AKI) stage 2 or greater is defined as a substantial increase in serum creatinine value, or by the initiation of kidney dialysis (continuous renal replacement therapy (CRRT), hemodialysis or peritoneal dialysis).');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS844v5', 'Core Clinical Data Elements for the Hybrid Hospital-Wide All-Condition All-Procedure Risk-Standardized Mortality Measure - HWM', 640, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS871v4', 'Hospital Harm - Severe Hyperglycemia', 650, 0,
        'This measure assesses the number of inpatient hospital days for patients age 18 and older with a hyperglycemic event (harm) per the total qualifying inpatient hospital days for that encounter');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS90v14', 'Functional Status Assessments for Heart Failure', 660, 0, 'Percentage of patients 18 years of age and older with heart failure who completed initial and follow-up patient-reported functional status assessments');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS951v3', 'Kidney Health Evaluation', 670, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS986v4', 'Global Malnutrition Composite Score', 680, 0,
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `notes`)
VALUES ('ecqm_2025_reporting', 'CMS996v5', 'Appropriate Treatment for ST-Segment Elevation Myocardial Infarction (STEMI) Patients in the Emergency Department (ED)', 690, 0,
        'Percentage of emergency department (ED) encounters for patients 18 years and older with a diagnosis of ST-segment elevation myocardial infarction (STEMI) that received appropriate treatment, defined as fibrinolytic therapy within 30 minutes of ED arrival, percutaneous coronary intervention (PCI) within 90 minutes of ED arrival, or transfer within 45 minutes of ED arrival');
#EndIf
-- ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--
...
VALUES ('lists', 'ecqm_reporting_period', 'eCQM Reporting Periods', 0, 1, 0);
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `is_default`)
VALUES ('ecqm_reporting_period', '2022', '2022 Reporting Period', 10, 0, 0);
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `is_default`)
VALUES ('ecqm_reporting_period', '2023', '2023 Reporting Period', 20, 1, 1);
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `is_default`)
VALUES ('ecqm_reporting_period', '2024', '2024 Reporting Period', 30, 1, 0);
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `is_default`)
VALUES ('ecqm_reporting_period', '2025', '2025 Reporting Period', 40, 1, 0);
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `activity`, `is_default`)
VALUES ('ecqm_reporting_period', '2026', '2026 Reporting Period', 50, 0, 0);
#EndIf
-- ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- Social History SDOH
...
(
    ...
    `food_insecurity_notes`           text                         DEFAULT NULL,
    `housing_instability`             varchar(50)                  DEFAULT NULL,
    `housing_instability_notes`       text                         DEFAULT NULL,
    `transportation_insecurity`       varchar(50)                  DEFAULT NULL,
    `transportation_insecurity_notes` text                         DEFAULT NULL,
    `utilities_insecurity`            varchar(50)                  DEFAULT NULL,
    `utilities_insecurity_notes`      text                         DEFAULT NULL,
    `interpersonal_safety`            varchar(50)                  DEFAULT NULL,
    `interpersonal_safety_notes`      text                         DEFAULT NULL,
    `financial_strain`                varchar(50)                  DEFAULT NULL,
    `financial_strain_notes`          text                         DEFAULT NULL,
    `social_isolation`                varchar(50)                  DEFAULT NULL,
    `social_isolation_notes`          text                         DEFAULT NULL,
    `childcare_needs`                 varchar(50)                  DEFAULT NULL,
    `childcare_needs_notes`           text                         DEFAULT NULL,
    `digital_access`                  varchar(50)                  DEFAULT NULL,
    `digital_access_notes`            text                         DEFAULT NULL,
...
(
    ...
    `relatedsex_1`          VARCHAR(31)  DEFAULT NULL,
    `relatedaddress_1`      VARCHAR(63)  DEFAULT NULL,
    `relatedcity_1`         VARCHAR(63)  DEFAULT NULL,
    `relatedstate_1`        VARCHAR(31)  DEFAULT NULL,
    `relatedpostalcode_1`   VARCHAR(15)  DEFAULT NULL,
    `relatedcountry_1`      VARCHAR(31)  DEFAULT NULL,
    `relatedphone_1`        VARCHAR(25)  DEFAULT NULL,
    `relatedworkphone_1`    VARCHAR(25)  DEFAULT NULL,
    `relatedemail_1`        VARCHAR(254) DEFAULT NULL,

    `relatedfirstname_2`    VARCHAR(63)  DEFAULT NULL,
    `relatedlastname_2`     VARCHAR(63)  DEFAULT NULL,
    `relatedrelationship_2` VARCHAR(63)  DEFAULT NULL,
    `relatedsex_2`          VARCHAR(31)  DEFAULT NULL,
    `relatedaddress_2`      VARCHAR(63)  DEFAULT NULL,
    `relatedcity_2`         VARCHAR(63)  DEFAULT NULL,
    `relatedstate_2`        VARCHAR(31)  DEFAULT NULL,
    `relatedpostalcode_2`   VARCHAR(15)  DEFAULT NULL,
    `relatedcountry_2`      VARCHAR(31)  DEFAULT NULL,
    `relatedphone_2`        VARCHAR(25)  DEFAULT NULL,
    `relatedworkphone_2`    VARCHAR(25)  DEFAULT NULL,
    `relatedemail_2`        VARCHAR(254) DEFAULT NULL,

    `relatedfirstname_3`    VARCHAR(63)  DEFAULT NULL,
    `relatedlastname_3`     VARCHAR(63)  DEFAULT NULL,
    `relatedrelationship_3` VARCHAR(63)  DEFAULT NULL,
    `relatedsex_3`          VARCHAR(31)  DEFAULT NULL,
    `relatedaddress_3`      VARCHAR(63)  DEFAULT NULL,
    `relatedcity_3`         VARCHAR(63)  DEFAULT NULL,
    `relatedstate_3`        VARCHAR(31)  DEFAULT NULL,
    `relatedpostalcode_3`   VARCHAR(15)  DEFAULT NULL,
    `relatedcountry_3`      VARCHAR(31)  DEFAULT NULL,
    `relatedphone_3`        VARCHAR(25)  DEFAULT NULL,
...
(`grp_form_id`, `grp_group_id`, `grp_title`, `grp_subtitle`, `grp_mapping`,
 `grp_seq`, `grp_activity`, `grp_repeats`, `grp_columns`, `grp_size`,
 `grp_issue_type`, `grp_aco_spec`, `grp_save_close`, `grp_init_open`,
 `grp_referrals`, `grp_services`, `grp_products`, `grp_diags`,
 `grp_last_update`, `grp_unchecked`)
VALUES
    ('DEM', @newgrp, 'Related', '', '', 0, 1, 0, 0, 0, '', '', 0, 0, 0, '', '', '', NULL, 0);
...
VALUES
    ...
    ('DEM','relatedstate_1',      @newgrp,'State',     70,26,1,0, 0,'state',1,1,'','','State',       0,'','F','','',''),
    ('DEM','relatedpostalcode_1', @newgrp,'Postal Code',80,2,1,6, 63,'',1,1,'','','Postal Code',     0,'','F','','',''),
    ('DEM','relatedcountry_1',    @newgrp,'Country',   90,26,1,0, 0,'country',1,1,'','','Country',   0,'','F','','',''),
    ('DEM','relatedphone_1',      @newgrp,'Phone',    100, 2,1,20,63,'',1,1,'','','Phone',           0,'','F','','',''),
    ('DEM','relatedworkphone_1',  @newgrp,'Work Phone',110,2,1,20,63,'',1,1,'','','Work Phone',      0,'','F','','',''),
    ('DEM','relatedemail_1',      @newgrp,'Email',    120, 2,1,20,63,'',1,1,'','','Related Email Address',0,'','F','','',''),

    ('DEM','static1',             @newgrp,'Related Person',125,31,1,0,0,'',1,3,'','','Patient Second Related Person',0,'','F','','',''),
    ...
    ('DEM','relatedstate_2',      @newgrp,'State',     190,26,1,0, 0,'state',1,1,'','','State',       0,'','F','','',''),
    ('DEM','relatedpostalcode_2', @newgrp,'Postal Code',200,2,1,6, 63,'',1,1,'','','Postal Code',     0,'','F','','',''),
    ('DEM','relatedcountry_2',    @newgrp,'Country',   210,26,1,0, 0,'country',1,1,'','','Country',   0,'','F','','',''),
    ('DEM','relatedphone_2',      @newgrp,'Phone',     220, 2,1,20,63,'',1,1,'','','Phone',           0,'','F','','',''),
    ('DEM','relatedworkphone_2',  @newgrp,'Work Phone',230, 2,1,20,63,'',1,1,'','','Work Phone',      0,'','F','','',''),
    ('DEM','relatedemail_2',      @newgrp,'Email',     240, 2,1,20,63,'',1,1,'','','Related Email Address',0,'','F','','',''),

    ('DEM','static2',             @newgrp,'Related Person',245,31,1,0,0,'',1,3,'','','Patient Third Related Person',0,'','F','','',''),
    ...
    ('DEM','relatedstate_3',      @newgrp,'State',     310,26,1,0, 0,'state',1,1,'','','State',       0,'','F','','',''),
    ('DEM','relatedpostalcode_3', @newgrp,'Postal Code',320,2,1,6, 63,'',1,1,'','','Postal Code',     0,'','F','','',''),
    ('DEM','relatedcountry_3',    @newgrp,'Country',   330,26,1,0, 0,'country',1,1,'','','Country',   0,'','F','','',''),
    ('DEM','relatedphone_3',      @newgrp,'Phone',     340, 2,1,20,63,'',1,1,'','','Phone',           0,'','F','','',''),
    ('DEM','relatedworkphone_3',  @newgrp,'Work Phone',350, 2,1,20,63,'',1,1,'','','Work Phone',      0,'','F','','',''),
    ('DEM','relatedemail_3',      @newgrp,'Email',     360, 2,1,20,63,'',1,1,'','','Related Email Address',0,'','F','','','');
#EndIf
-- ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
