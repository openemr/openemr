...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `is_default`, `option_value`, `mapping`, `notes`, `codes`, `toggle_setting_1`, `toggle_setting_2`, `activity`, `subtype`) VALUES
('page_validation', 'add_edit_issue#theform', '/interface/patient_file/patient_file/summary/add_edit_issue.php', 10, 0, 0, '', '{form_title:{presence: true}}', '', 0, 0, 1, '');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `is_default`, `option_value`, `mapping`, `notes`, `codes`, `toggle_setting_1`, `toggle_setting_2`, `activity`, `subtype`) VALUES
('page_validation', 'add_edit_issue#theform1', '/interface/patient_file/summary/add_edit_issue.php', 20, 0, 0, '', '{form_title:{presence: true}}', '', 0, 0, 1, '');
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `is_default`, `option_value`, `mapping`, `notes`, `codes`, `toggle_setting_1`, `toggle_setting_2`, `activity`, `subtype`) VALUES
('page_validation', 'add_edit_issue#theform2', '/interface/patient_file/summary/add_edit_issue.php', 30, 0, 0, '', '{form_title:{presence: true}}', '', 0, 0, 0, '');
