...
('LBF_Validations','int1','Integers1-100',1,0,0,'','{\"numericality\": {\"onlyInteger\": true,\"greaterThanOrEqualTo\": 1,\"lessThanOrEqualTo\":100}}','',0,0,1,''),
('LBF_Validations','name','Names',2,0,0,'','{\"format\":{\"pattern\":\"[a-zA-z]+([ \'-\\s][a-zA-Z]+)*\"}}','',0,0,1,''),
('LBF_Validations','birthdate','Birth Date',3,0,0,'','{\"date\":{\"dateOnly\":true},\"onlyPast\":{\"message\":\"must be past date\"}}','',0,0,1,'');
#EndIf
