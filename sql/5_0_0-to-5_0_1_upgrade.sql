...
INSERT INTO `medex_icons` (`i_UID`, `msg_type`, `i_description`, `i_html`, `i_blob`) VALUES
...
(5, 'SMS', 'READ', '<span class="btn" title="SMS Sent and Read - waiting for response" aria-label="SMS Delivered" style="padding:5px;background-color:#146abd;"><i class="fa fa-commenting-o fa-flip-horizontal fa-fw" aria-hidden="true"></i></span>', ''),
(6, 'SMS', 'FAILURE', '<span class="btn" title="SMS Failed to be delivered" style="padding:5px;background-color:red;"><i class="fa fa-commenting-o fa-inverse fa-fw"></i></span>', ''),
...
(9, 'SMS', 'EXTRA', '<span class="fa-stack fa-lg"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-terminal fa-stack-1x fa-fw fa-inverse"></i></span>', ''),
...
(15, 'AVM', 'FAILURE', '<span class="btn" title="AVM: Failed.  Check patient''s phone numbers." style="padding:5px;background-color:red;"><i class="fa fa-phone fa-inverse fa-fw"></i></span>', ''),
...
(19, 'AVM', 'STOP', '<span class="btn btn-danger" title="OptOut of Voice Messaging. Demographics updated." aria-label=“Optout AVM”><i class="fa fa-phone" aria-hidden="true"> STOP</i></span>', ''),
...
(25, 'EMAIL', 'FAILURE', '<span class="btn" title="EMAIL: Failed.  Check patient\'s email address." style="padding:5px;background-color:red;"><i class="fa fa-envelope-o fa-inverse fa-fw"></i></span>', ''),
...
(29, 'EMAIL', 'STOP', '<span class="btn btn-danger" title="OptOut of EMAIL Messaging. Demographics updated." aria-label=“Optout EMAIL”><i class="fa fa-envelope-o" aria-hidden="true"> STOP</i></span>', ''),
...
(36, 'AVM', 'READ', '<span class="btn" title="AVM completed - waiting for manual response" aria-label="AVM Delivered" style="padding:5px;background-color:#146abd;"><i class="fa fa-phone fa-fw" aria-hidden="true"></i></span>', ''),
