...
(10, 'SMS', 'STOP', '', '<span class="btn btn-danger fa fa fa-comment-dots fa-commenting-o" title="OptOut of SMS Messaging. Demographics updated." aria-label=\'Optout SMS\'> STOP</span>', ''),
...
(29, 'EMAIL', 'STOP', '', '<span class="btn btn-danger fa-envelope" title="OptOut of EMAIL Messaging. Demographics updated." aria-label="Optout EMAIL"><i class="fa fa-envelope-o" aria-hidden="true"> STOP</i></span>', ''),
