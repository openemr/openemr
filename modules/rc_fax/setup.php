                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="form_username"><?php echo xlt("Username or Phone") ?> *</label>
                            <input id="form_username" type="text" name="username" class="form-control"
                                required="required" value='<?php echo $c['username'] ?>'>
                        </div>
                        <div class="form-group">
                            <label for="form_extension"><?php echo xlt("Phone Extension") ?></label>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input id="form_redirect_url" type="text" name="redirect_url" class="form-control"
                                required="required" value='<?php echo $c['redirect_url'] ?>'>
                        </div>
                        <div class="form-group">
