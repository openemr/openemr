...
use OpenEMR\Setting\Fixture\GlobalSettingsFixture;
use OpenEMR\Setting\Fixture\Purger\GlobalSettingsPurger;
...
use OpenEMR\Tests\Api\Standard\SettingTrait\ByDataType\Global\ColorCodeSettingsAwareTrait;
...
use OpenEMR\Tests\Api\Standard\SettingTrait\ByDataType\Global\HourSettingsAwareTrait;
...
use OpenEMR\Tests\Api\Standard\SettingTrait\BySection\Global\LocaleSectionAwareTrait;
...
class AdminGlobalSettingApiTest extends TestCase
{
    ...
    use ColorCodeSettingsAwareTrait;
    use DefaultVisitCategorySettingsAwareTrait;
    use EnumSettingsAwareTrait;
    use HourSettingsAwareTrait;
    use LocaleSectionAwareTrait;
    ...
    {
        yield from self::getLocaleDataProviderChunks();
    }
