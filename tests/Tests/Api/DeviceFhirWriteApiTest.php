...
/**
 * FHIR Device API (HTTP write) tests.
 *
 * Drives real HTTP POST/PUT through OAuth against /apis/default/fhir/Device
...
class DeviceFhirWriteApiTest extends TestCase
{
    private const RESOURCE_URL = '/apis/default/fhir/Device';
    private const RESOURCE_TYPE = 'Device';
    ...
    protected function setUp(): void
    {
        ...
        $fixtureData = json_decode(
            (string) file_get_contents(__DIR__ . '/../Fixtures/FHIR/device.json'),
            true
        );
    ...
    public function testPostCreatesDevice(): void
    {
    ...
    public function testPutUpdatesDevice(): void
    {
