...
class ApiTestClient
{
    ...
    const PUBLIC_CLIENT_SCOPES = "openid offline_access api:oemr api:fhir api:port patient/encounter.read patient/patient.read patient/AllergyIntolerance.read patient/Encounter.read patient/Immunization.read patient/Patient.read";
