...
class PrescriptionApiTest extends TestCase
{
    ...
    {
        // Try to delete a prescription that doesn't exist
        // The current implementation returns 200 even for non-existent records
        // because the DELETE statement succeeds (just affects 0 rows)
