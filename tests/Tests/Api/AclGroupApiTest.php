...
use OpenEMR\Tests\Fixtures\AclGroupFixture;
...
/**
 * @see AclGroupRestController
 */
#[Group('group')]
#[Group('api')]
#[CoversClass(AclGroupRestController::class)]
#[CoversMethod(AclGroupRestController::class, 'post')]
#[CoversMethod(AclGroupRestController::class, 'getOne')]
#[CoversMethod(AclGroupRestController::class, 'getAll')]
class AclGroupApiTest extends TestCase
{
    private readonly AclGroupFixture $fixture;
    ...
    protected function tearDown(): void
    {
        ...
        foreach (['inspectors', 'inspectorswithparentid'] as $groupValue) {
            $this->groupService->deleteByValue($groupValue);
        }
    ...
    /**
     * @see AclGroupRestController::post()
    ...
    public function postFailedValidationTest(
        ...
        $response = $this->testClient->request('POST', '/apis/default/api/admin/group', [], $data);
    ...
    /**
     * @see AclGroupRestController::getOne()
    ...
    public function getOneFailedTest(
        ...
        $response = $this->testClient->request('GET', sprintf('/apis/default/api/admin/group/%s', $id));
    ...
    public function getOneSucceededTest(): void
    {
        ...
        $response = $this->testClient->request('GET', sprintf('/apis/default/api/admin/group/%s', $record['id']));
     ...
     *
     * @see AclGroupRestController::getAll()
     * @see AclGroupService::getAll()
     */
    #[Test]
    public function getAllTest(): void
    {
        $response = $this->testClient->request('GET', '/apis/default/api/admin/group');
        $this->assertEquals(200, $response->getStatusCode());
        ...
        foreach ($json['data'] as $resultIndex => $searchResult) {
    ...
    /**
     * @see AclGroupRestController::delete()
    ...
    public function deleteFailedTest(
        ...
        $response = $this->testClient->request('DELETE', sprintf('/apis/default/api/admin/group/%s', $id));
        $this->assertEquals($expectedStatusCode, $response->getStatusCode());
    ...
    public function deleteSucceededTest(): void
    {
        ...
        $response = $this->testClient->request('DELETE', sprintf('/apis/default/api/admin/group/%s', $record['id']));
        $this->assertEquals(200, $response->getStatusCode());
    }
}
