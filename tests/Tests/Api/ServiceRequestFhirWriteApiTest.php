...
/**
 * FHIR ServiceRequest API (HTTP write) tests.
 *
 * Drives real HTTP POST/PUT through OAuth against /apis/default/fhir/ServiceRequest
...
class ServiceRequestFhirWriteApiTest extends TestCase
{
    private const RESOURCE_URL = '/apis/default/fhir/ServiceRequest';
    private const RESOURCE_TYPE = 'ServiceRequest';
    ...
    protected function setUp(): void
    {
        ...
        $fixtureData = json_decode(
            (string) file_get_contents(__DIR__ . '/../Fixtures/FHIR/service-request.json'),
            true
        );
    ...
    public function testPostCreatesServiceRequest(): void
    {
    ...
    public function testPutUpdatesServiceRequest(): void
    {
