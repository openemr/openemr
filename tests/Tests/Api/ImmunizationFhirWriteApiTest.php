...
/**
 * FHIR Immunization API (HTTP write) tests.
 *
 * Drives real HTTP POST/PUT through OAuth against /apis/default/fhir/Immunization
...
class ImmunizationFhirWriteApiTest extends TestCase
{
    private const RESOURCE_URL = '/apis/default/fhir/Immunization';
    private const RESOURCE_TYPE = 'Immunization';
    ...
    protected function setUp(): void
    {
        ...
        $fixtureData = json_decode(
            (string) file_get_contents(__DIR__ . '/../Fixtures/FHIR/immunization.json'),
            true
        );
    ...
    public function testPostCreatesImmunization(): void
    {
    ...
    public function testPutUpdatesImmunization(): void
    {
