...
/**
 * FHIR AllergyIntolerance API (HTTP write) tests.
 *
 * Drives real HTTP POST/PUT through OAuth against /apis/default/fhir/AllergyIntolerance
...
class AllergyIntoleranceFhirWriteApiTest extends TestCase
{
    private const RESOURCE_URL = '/apis/default/fhir/AllergyIntolerance';
    private const RESOURCE_TYPE = 'AllergyIntolerance';
    ...
    protected function setUp(): void
    {
        ...
        $fixtureData = json_decode(
            (string) file_get_contents(__DIR__ . '/../Fixtures/FHIR/allergy-intolerance.json'),
            true
        );
    ...
    protected function tearDown(): void
    {
        QueryUtils::sqlStatementThrowException(
            "DELETE FROM lists WHERE type = 'allergy' AND title LIKE 'test-fixture%'"
        );
        QueryUtils::sqlStatementThrowException(
            "DELETE FROM lists WHERE type = 'allergy' AND comments LIKE 'test-fixture%'"
        );
    ...
    public function testPostCreatesAllergyIntolerance(): void
    {
    ...
    public function testPutUpdatesAllergyIntolerance(): void
    {
