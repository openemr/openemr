...
class ProceduresProvidersTabTest extends PantherTestCase
{
    private $e2eBaseUrl;
    ...
    /** @test */
    public function testAddNewOnProceduresProvidersTabOpensModal()
    {
        $session = $this->start();
        (new TabTestElement)->open($session, 'Procedures', 'Providers');
