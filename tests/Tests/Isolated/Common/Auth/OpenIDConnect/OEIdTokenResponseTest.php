...
/**
 * Unit tests for OEIdTokenResponse class handling SMART on FHIR OAuth2 token responses.
 *
 * AI-GENERATED CODE: This test class was generated using Claude AI assistant on August 15, 2025
 * to provide comprehensive unit test coverage for the OEIdTokenResponse class, including mocking
...
class OEIdTokenResponseTest extends TestCase
{
    ...
    public function testGenerateHttpResponseWithOfflineAccess(): void
    {
        ...
        $scopes = [$this->createMockScope(OEIdTokenResponse::SCOPE_OFFLINE_ACCESS)];
    ...
    public function testGetBuilderWithoutNonce(): void
    {
        ...
        $this->logger->expects($this->once())
            ->method('debug')
            ->with('OEIdTokenResponse->getBuilder() no nonce found in session');
    ...
    private function createMockAccessToken(): AccessTokenEntityInterface&MockObject
    {
    ...
    private function createMockUserEntity(): UserEntityInterface&MockObject
    {
    ...
    private function createMockScope(string $identifier): ScopeEntityInterface&MockObject
    {
