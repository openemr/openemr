...
final class DocumentViewDeleteLinkTest extends TestCase
{
    ...
    public function testDeleteLinkCarriesNoPatientWhenThePageHasNone(): void
    {
        $html = (new C_Document())->view_action(null, $this->documentId);
        $this->assertIsString($html);

        // document_pid 0 never matches a document filed under a patient, so deleter.php refuses the delete.
