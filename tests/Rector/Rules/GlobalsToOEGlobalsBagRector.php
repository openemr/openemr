...
CODE_SAMPLE
                    ,
                    <<<'CODE_SAMPLE'
$value = \OpenEMR\Core\OEGlobalsBag::getInstance()->get('srcdir');
\OpenEMR\Core\OEGlobalsBag::getInstance()->set('key', 'value');
if (\OpenEMR\Core\OEGlobalsBag::getInstance()->has('flag')) {}
$path = \OpenEMR\Core\OEGlobalsBag::getInstance()->get('webroot') . "/index.php";
CODE_SAMPLE
                ),
            ]
        );
    ...
    private function buildGetInstanceCall(): StaticCall
    {
        return new StaticCall(
            new FullyQualified(\OpenEMR\Core\OEGlobalsBag::class),
