# BATS: flex devtoolsLibrary.source — functional tests (source and call prepareVariables)
...
@test "flex devtoolsLibrary: prepareVariables sets CUSTOM_* variables" {
...
@test "flex devtoolsLibrary: prepareVariables defaults (openemr, 3306)" {
