...
abstract class DbRow_Signable implements SignableIF
{
    ...
    public function getSignatures()
    {
        ...
        $statement = "SELECT E.id, E.tid, E.table, E.uid, U.fname, U.lname, U.valedictory, E.datetime, E.is_lock, E.amendment, E.hash, E.signature_hash FROM esign_signatures E ";
