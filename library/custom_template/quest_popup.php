        ...
        <table>
            <tr class="text">
                <td>
                    ...
                    ?>
                    <a href="#" onclick="replace_quest('<?php echo htmlspecialchars($row['option_id'],ENT_QUOTES);?>')" class="btn btn-default"><?php echo htmlspecialchars($row['title'],ENT_QUOTES);?></a>
                    <?php
                    }
                    ?>
                </td>
