                    ...
                    <table>
                        ...
                        while ($row = sqlFetchArray($res)) {
                            ...
                            <tr class="text <?php echo $class;?>">
                                ...
                                <td class="right bottom"><a href="#" onclick='editme("<?php echo htmlspecialchars((string) $row['cl_list_slno'], ENT_QUOTES);?>","<?php echo htmlspecialchars((string) $row['cl_list_item_long'], ENT_QUOTES);?>")'><img src='<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('images_static_relative'); ?>/b_edit.png' border=0></a></td>
                                <td class="right bottom"><a href="#" onclick="deleteme(<?php echo htmlspecialchars((string) $row['cl_list_slno'], ENT_QUOTES);?>)"><img src='<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('images_static_relative'); ?>/deleteBtn.png' border=0></a></td>
                            </tr>
                            <?php
                        }
                        ?>
