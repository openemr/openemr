      ...
      <tr>
       ...
       <td align="center" class="title_bar_top ">&nbsp;</td>
        ...
        while($row = sqlFetchArray($res)){
            ...
            $class='class1';
        ?>
         <tr class='<?php echo htmlspecialchars($class,ENT_QUOTES);
?>' ><input type='hidden' name='<?php echo htmlspecialchars("hidid".$i,ENT_QUOTES);
...
?>" value="<?php echo htmlspecialchars($sl,ENT_QUOTES);?>"  readonly="" style="width:25px; background-color:#C9C9C9"/></td>
        <td align='center'><input type='text' name="<?php echo htmlspecialchars("inshort".$i,ENT_QUOTES);
?>" size="10" value="<?php echo htmlspecialchars($row['cl_list_item_short'],ENT_QUOTES);?>" /></td>
        <td align='center'><input type='text' name="<?php echo htmlspecialchars("designation".$i,ENT_QUOTES);
?>" value="<?php echo htmlspecialchars($row['cl_list_item_long'],ENT_QUOTES);?>" /></td>
        <td align='center'><input type='text' name='<?php echo htmlspecialchars("level".$i,ENT_QUOTES);
?>' value="<?php echo htmlspecialchars($row['cl_order'],ENT_QUOTES);?>" size=1></td>
        <td align='center'><input type='checkbox' name='<?php echo htmlspecialchars("chk".$i,ENT_QUOTES);
?>'  value='<?php echo htmlspecialchars($row['cl_list_slno'],ENT_QUOTES);?>'></td>
         </tr>
        <?php
        $i++;
        $sl++;
...
?>" value="<?php echo htmlspecialchars($sl+1,ENT_QUOTES);?>"  readonly="" style="width:25px; background-color:#C9C9C9"/></td>
...
?>" value="<?php echo htmlspecialchars($sl+2,ENT_QUOTES);?>"  readonly="" style="width:25px; background-color:#C9C9C9"/></td>
      ...
      <tr class="text">
       <td colspan="5" align="center">
        ...
        <input type='submit' name='form_delete' id='form_delete' value="<?php echo htmlspecialchars(xl('Delete'),ENT_QUOTES);
