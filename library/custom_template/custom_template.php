    ...
    <table width=100% align=left cellpadding=0 cellspacing=0 margin-left=0px>
        ...
        <tr>
            ...
            <tr clss="text">
                ...
                <a href="#" id="enter" onclick="top.restoreSession();ascii_write('13','textarea1');" title="<?php echo htmlspecialchars(xl('Enter Key'), ENT_QUOTES);?>"><img border=0 src="../../public/images/enter.gif"></a>&nbsp;
                                <a href="#" id="quest" onclick="top.restoreSession();CKEDITOR.instances.textarea1.insertText('? ');" title="<?php echo htmlspecialchars(xl('Question Mark'), ENT_QUOTES);?>"><img border=0 src="../../public/images/question.png"></a>&nbsp;
                                <a href="#" id="para" onclick="top.restoreSession();ascii_write('para','textarea1');"  title="<?php echo htmlspecialchars(xl('New Paragraph'), ENT_QUOTES);?>"><img border=0 src="../../public/images/paragraph.png"></a>&nbsp;
