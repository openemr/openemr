...
class OemrUI
{
    ...
    */
    public function __construct($arrHeading = array())
    {
        $this->heading = $arrHeading[0];
        $this->arrExpandable = $arrHeading[1];
        $this->arrAction = $arrHeading[2];
        $this->display_help_icon = $arrHeading[3][0];
        $this->help_file = $arrHeading[3][1];
    }
    ...
    */
    ...
    {
        $arrExpandable = $this->arrExpandable;
        if ($arrExpandable) {
        ...
        if ($expandable) {
            //$expandable_icon = "<i id='exp_cont_icon' class='fa " .  attr($expand_icon_class) . " oe-superscript-small expand_contract'" . " title='" . attr($expand_title) . "'
