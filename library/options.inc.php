...
function generate_form_field($frow, $currvalue)
{
  ...
  // These data types support backup lists.
    if ($data_type == 1 || $data_type == 33) {
        ...
        echo "</table>";
    } elseif ($data_type == 24) { // the list of active allergies for the current patient; this is read-only!
    ...
    } elseif ($data_type == 34) { //$data_type == 33
    ...
    } elseif ($data_type == 36) { //multiple select
    ...
    if (false && ($data_type == 1 || $data_type == 26 || $data_type == 33)) {
      ...
      echo "<input type='text'" .
        ...
        *****************************************************************/
        ...
        echo "</table>";
    } elseif ($data_type == 36) { //Multi-select
        // Supports backup lists.
        if (empty($fld_length)) {
            if ($list_id == 'titles') {
                $fld_length = 3;
