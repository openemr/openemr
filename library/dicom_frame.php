...
if ($web_path) {
    ...
    $state_url = \OpenEMR\Core\OEGlobalsBag::getInstance()->get('web_root') . "/library/ajax/upload.php";
...
echo $twig->render("dicom/dicom-viewer.html.twig", [
    'assets_static_relative' => \OpenEMR\Core\OEGlobalsBag::getInstance()->get('assets_static_relative')
    ,'web_root' => $web_root
    ,'web_path' => $web_path
