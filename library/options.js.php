...
<script>
    ...
    imageURLPrefix: '<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('assets_static_relative') ?>/literallycanvas/img'
});
    if (canHeight > 261) {
    ...
    dlgopen('<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('webroot'); ?>/interface/main/calendar/find_patient_popup.php', '_blank', 500, 400);
}
    ...
    let url = '<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('webroot'); ?>/library/specialty_forms.php?';
