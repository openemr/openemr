...
class InsuranceNumbers extends ORDataObject{
	...
	var $group_number;
	var $x12_id_type;
	var $x12_id_type_array = array ("" => "Unspecified", "0B" => "State License Number", "1A" => "Blue Cross Provider Number","1B" => "Blue Shield Provider Number","1C" => "Medicare Provider Number",
	...
	function get_x12_id_type() {
		return $this->x12_id_type;
	}
	
	function set_x12_id_type($string) {
		$this->x12_id_type = $string;
	}
