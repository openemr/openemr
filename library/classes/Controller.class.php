...
class Controller extends Smarty
{
    ...
    public function __construct()
    {
         ...
         $this->_state = true;
         $this->setCompileDir(\OpenEMR\Core\OEGlobalsBag::getInstance()->get('OE_SITE_DIR') . '/documents/smarty/main');
         $this->setCompileCheck(true);
         $this->setPluginsDir([__DIR__ . "/../smarty/plugins", \OpenEMR\Core\OEGlobalsBag::getInstance()->get('vendor_dir') . "/smarty/smarty/libs/plugins"]);
    ...
    {
         $this->display(\OpenEMR\Core\OEGlobalsBag::getInstance()->get('template_dir') . "error/" . $this->template_mod . "_function_argument.html");
         exit;
    }
    ...
    public function act($qarray)
    {
        ...
        if (!$this->i_once(\OpenEMR\Core\OEGlobalsBag::getInstance()->get('fileroot') . "/controllers/C_" . $c_name . ".class.php")) {
