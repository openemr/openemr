...
class Installer {
    ...
    public $iuname;
    public $igroup;
    public $server; // mysql server (usually localhost)
    public $loginhost; // php/apache server (usually localhost)
    public $port;
    public $root;
    public $rootpass;
    public $login;
    ...
    public function __construct($cgi_variables) {
        ...
        foreach ($cgi_variables as $key => $cgi_variable) {
            $this->{$key} = $cgi_variable;
        }
