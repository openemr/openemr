...
class Immunizations
{
    ...
    {
        $dobPlus42Days = date('Y-m-d 00:00:00', strtotime('+42 day', strtotime((string) $patient->dob)));
        $dobPlus2Years = date('Y-m-d 00:00:00', strtotime('+2 year', strtotime((string) $patient->dob)));
        $fourCount = [ Medication::OPTION_COUNT => 4, Medication::OPTION_UNIQUE_DATES => true ];
        if (
    ...
    public static function checkIpv(CqmPatient $patient, $beginDate, $endDate)
    {
        $dobPlus42Days = date('Y-m-d 00:00:00', strtotime('+42 day', strtotime((string) $patient->dob)));
        $dobPlus2Years = date('Y-m-d 00:00:00', strtotime('+2 year', strtotime((string) $patient->dob)));
        $threeCount = [ Medication::OPTION_COUNT => 3 ];
        if (
    ...
    {
        $dobPlus1Year = date('Y-m-d 00:00:00', strtotime('+1 year', strtotime((string) $patient->dob)));
        $dobPlus2Years = date('Y-m-d 00:00:00', strtotime('+2 year', strtotime((string) $patient->dob)));
        $dateMinus2Years = date('Y-m-d 00:00:00', strtotime('-2 year', strtotime((string) $endDate)));
        if (
    ...
    {
        $options = [ Medication::OPTION_COUNT => 2 ];
        $dobPlus42Days = date('Y-m-d 00:00:00', strtotime('+42 day', strtotime((string) $patient->dob)));
        $dobPlus2Years = date('Y-m-d 00:00:00', strtotime('+2 year', strtotime((string) $patient->dob)));
        if (
    ...
    {
        $options = [ Medication::OPTION_COUNT => 3 ];
        $dobPlus2Years = date('Y-m-d 00:00:00', strtotime('+2 year', strtotime((string) $patient->dob)));
        if (
    ...
    {
        $options = [ Medication::OPTION_COUNT => 1 ];
        $dobPlus2Years = date('Y-m-d 00:00:00', strtotime('+2 year', strtotime((string) $patient->dob)));
        if (
    ...
    {
        $options = [ Medication::OPTION_COUNT => 4 ];
        $dobPlus42Days = date('Y-m-d 00:00:00', strtotime('+42 day', strtotime((string) $patient->dob)));
        $dobPlus2Years = date('Y-m-d 00:00:00', strtotime('+2 year', strtotime((string) $patient->dob)));
        if (
    ...
    {
        $options = [ Medication::OPTION_COUNT => 2 ];
        $dobPlus180Days = date('Y-m-d 00:00:00', strtotime('+180 day', strtotime((string) $patient->dob)));
        $dobPlus2Years = date('Y-m-d 00:00:00', strtotime('+2 year', strtotime((string) $patient->dob)));
        if (
