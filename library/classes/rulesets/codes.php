...
class Code_Lookup {
    ...
    public function check_for_obgyn( $patient_id, $end_measurement ) {
        return $this->check_codes( $this->obgyn_codes, $patient_id, $end_measurement );
    }

    public function check_for_dtap_allergy( $patient_id, $end_measurement ) {
        return $this->check_codes( $this->dtap_allergy_codes, $patient_id, $end_measurement );
    }

    public function check_for_ipv_allergy( $patient_id, $end_measurement ) {
        return $this->check_codes( $this->ipv_allergy_codes, $patient_id, $end_measurement );
    }

    public function check_for_neomycin_allergy( $patient_id, $end_measurement ) {
        return $this->check_codes( $this->neomycin_allergy_codes, $patient_id, $end_measurement );
    }

    public function check_for_streptomycin_allergy( $patient_id, $end_measurement ) {
        return $this->check_codes( $this->streptomycin_allergy_codes, $patient_id, $end_measurement );
    }

    public function check_for_polymyxin_allergy( $patient_id, $end_measurement ) {
        return $this->check_codes( $this->polymyxin_allergy_codes, $patient_id, $end_measurement );
    }

    public function check_for_progressive_neurological_disorder( $patient_id, $end_measurement ) {
    ...
    private $ipv_allergy_codes = array(
    'type' => 'RXNORM',
    'category' => 'allergy',
    'codes' => array(
    '763103', '866820'
    ...
    private $neomycin_allergy_codes = array(
    'type' => 'RXNORM',
    'category' => 'allergy',
    'codes' => array(
    ...
    private $polymyxin_allergy_codes = array(
    'type' => 'RXNORM',
    'category' => 'allergy',
    'codes' => array(
    ...
    private $streptomycin_allergy_codes = array(
    'type' => 'RXNORM',
    'category' => 'allergy',
    'codes' => array(
    'C1134151'
    ...
    // *** SNOMED codes
    private $progressive_neurological_disorder_codes = array(
    'type' => 'SNOMED',
    'category' => 'medical_problem',
    'codes' => array(
