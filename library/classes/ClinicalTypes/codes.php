...
class Codes
{
    ...
    protected static $_codes = [
        ...
        Allergy::DTAP_VAC => [
            'RXNORM' => [ '204525','205257','205259','260122','359454','562372','795926','795930','795938','795939','795942','798309','798347','802049','805375','805379','806587','806593','807277','807415','824542','829894','829971','829987','830518','830549','830555','830893','835879' ]
        ],
        Allergy::HIB => [
            'RXNORM' => [ '260123','798282','798348','798440','798447','860904' ]
        ],
        Allergy::IPV => [
            'RXNORM' => [ '763103', '866820' ]
        ],
        Allergy::NEOMYCIN => [
            'RXNORM' => [ 'C0988018','C1123055','C1123343','C1123363','C1124224','C1127589','C1134215','C1140030','C1140542','C1186980','C1704126','C272305' ]
        ],
        Allergy::POLYMYXIN => [
            'RxNORM' => [ 'C0988924','C1123393','C1125567','C1133048','C2729553' ]
        ],
        Allergy::STREPTOMYCIN => [
            'RXNORM' => [ 'C1134151' ]
        ],
        Communication::COUNS_NUTRITION => [
            'ICD9' => [ 'V65.3' ]
        ],
        Communication::COUNS_PHYS_ACTIVITY => [
            'ICD9' => [ 'V65.41' ]
        ],
        Communication::PREV_RECEIPT_VACCINE => [
            'SNOMED' => ['185900003','185901004','185902006', '416928007']
        ],
        Diagnosis::ASYMPTOMATIC_HIV => [
            'ICD9' => [ '042','V08' ]
        ],
        Diagnosis::CANCER_LYMPH_HIST => [
            'ICD9' => [ '201','202','203' ]
        ],
        Diagnosis::DIABETES => [
