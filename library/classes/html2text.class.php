 ...
 *
 *  Modified 2015-10-04 by Rod Roark <rod@sunsetsystems.com>
 *  Added an argument to the _convert function to allow omission of the
 *  links at the end.
 *
...
class html2text
{
    ...
    {
        if (substr($link, 0, 7) == 'https://' || substr($link, 0, 8) == 'https://' ||
