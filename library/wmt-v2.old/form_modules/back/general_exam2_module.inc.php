...
?>
    ...
    <tr>
      <td colspan="3"><textarea name="ge_dictate" id="ge_dictate" class="FullInput" rows="4"><?php echo htmlspecialchars($dt{'ge_dictate'}, ENT_QUOTES, '', FALSE); ?></textarea></td>
    </tr>
		<?php if($client_id == 'hcardio' || $client_id == 'ccc') { ?>
		<tr>
			<td class="wmtLabel">Diagnostic Tests:</td>
			<td>&nbsp;</td>
			<td><div style="float: right; padding-right: 10px;"><a class="css_button" tabindex="-1" onClick="ClearThisField('diagnostics_nt');" href="javascript:;"><span>Clear Tests</span></a></div></td>
		</tr>
    <tr>
      <td colspan="3"><textarea name="diagnostics_nt" id="diagnostics_nt" class="FullInput" rows="4"><?php echo htmlspecialchars($dt{'diagnostics_nt'}, ENT_QUOTES, '', FALSE); ?></textarea></td>
    </tr>
		<?php } ?>
		<tr>
