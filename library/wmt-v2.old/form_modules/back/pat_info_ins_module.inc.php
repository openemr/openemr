...
<table width="100%"	border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse; padding: 0px;">
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
			<tr>
				<td style="width: 35%" class="bkkL"><span class="bkkLabel2">Birth Date</span><br><input name="<?php echo $field_prefix; ?>DOB" id="<?php echo $field_prefix; ?>DOB" type="text" class="bkkDateInput" value="<?php echo htmlspecialchars($dt[$field_prefix.'DOB'], ENT_QUOTES, '', FALSE); ?>" onchange="CalcPatAge('<?php echo $field_prefix; ?>DOB', 'tmp_age');" onkeyup="datekeyup(this, mypcc)" onblur="dateblur(this, mypcc);" title="YYYY-MM-DD" />
       		<img src="<?php echo $GLOBALS['rootdir']; ?>/pic/show_calendar.gif" width="20" height="20" id="img_<?php echo $field_prefix; ?>DOB" border="0" alt="[?]" style="vertical-align: bottom; cursor:pointer;" title="Click here to choose a date"></td>
				...
				<td style="width: 15%"><span class="bkkLabel2">Age</span><input name="tmp_age" id="tmp_age" type="text" tabindex="-1" style="background-color: #EAEAEA;" readonly class="bkkFullInput" value="<?php echo $patient->age; ?>" /></td>
				<td style="width: 25%"><span class="bkkLabel2">Race</span><select name="<?php echo $field_prefix; ?>race" id="<?php echo $field_prefix; ?>race" class="bkkFullInput">
				<?php ListSel($dt{$field_prefix.'race'}, 'race'); ?>
				</select></td>
				<td style="width: 25%"><span class="bkkLabel2">Marital Status</span><select name="<?php echo $field_prefix; ?>status" id="<?php echo $field_prefix; ?>status" class="bkkFullInput">
			...
			<tr>
				<td colspan="2"><span class="bkkLabel2">Occupation</span><input name="<?php echo $field_prefix; ?>occupation" id="<?php echo $field_prefix; ?>occupation" type="text" class="bkkFullInput" value="<?php echo htmlspecialchars($dt{$field_prefix.'occupation'}, ENT_QUOTES, '', FALSE); ?>" /></td>
				<td colspan="2"><span class="bkkLabel2">Education (Last Completed)</span><input name="<?php echo $field_prefix; ?>wmt_education" id="<?php echo $field_prefix; ?>wmt_education" type="text" class="bkkFullInput" value="<?php echo htmlspecialchars($dt{$field_prefix.'wmt_education'}, ENT_QUOTES, '', FALSE); ?>" /></td>
			</tr>
			...
			<tr>
				<td colspan="4"><span class="bkkLabel2">Address</span><input name="<?php echo $field_prefix; ?>street" id="<?php echo $field_prefix; ?>street" type="text" class="bkkFullInput" value="<?php echo htmlspecialchars($dt{$field_prefix.'street'}, ENT_QUOTES, '', FALSE); ?>" /></td>
			</tr>
			...
			<tr>
				<td colspan="2"><span class="bkkLabel2">City</span><input name="<?php echo $field_prefix; ?>city" id="<?php echo $field_prefix; ?>city" type="text" class="bkkFullInput" value="<?php echo htmlspecialchars($dt{$field_prefix.'city'}, ENT_QUOTES, '', FALSE); ?>" /></td>
				<td><span class="bkkLabel2">State</span><input name="<?php echo $field_prefix; ?>state" id="<?php echo $field_prefix; ?>state" type="text" class="bkkFullInput" value="<?php echo htmlspecialchars($dt{$field_prefix.'state'}, ENT_QUOTES, '', FALSE); ?>" /></td>
				<td><span class="bkkLabel2">ZIP</span><input name="<?php echo $field_prefix; ?>postal_code" id="<?php echo $field_prefix; ?>postal_code" type="text" class="bkkFullInput" value="<?php echo htmlspecialchars($dt{$field_prefix.'postal_code'}, ENT_QUOTES, '', FALSE); ?>" /></td>
			</tr>
			...
			<tr>
				<td colspan="2"><span class="bkkLabel2">Home Phone</span><input name="<?php echo $field_prefix; ?>phone_home" id="<?php echo $field_prefix; ?>phone_home" type="text" class="bkkFullInput" value="<?php echo htmlspecialchars($dt{$field_prefix.'phone_home'}, ENT_QUOTES, '', FALSE); ?>" /></td>
				<td colspan="2"><span class="bkkLabel2">Work Phone</span><input name="<?php echo $field_prefix; ?>phone_biz" id="<?php echo $field_prefix; ?>phone_biz" type="text" class="bkkFullInput" value="<?php echo htmlspecialchars($dt{$field_prefix.'phone_biz'}, ENT_QUOTES, '', FALSE); ?>" /></td>
			</tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
			<tr>
				<td colspan="3"><span class="bkkLabel2">E-mail</span><input name="<?php echo $field_prefix; ?>email" id="<?php echo $field_prefix; ?>email" type="text" class="bkkFullInput" value="<?php echo htmlspecialchars($dt[$field_prefix.'email'], ENT_QUOTES, '', FALSE); ?>" /></td>
				<td colspan="2"><span class="bkkLabel2">Cell Phone</span><input name="<?php echo $field_prefix; ?>phone_cell" id="<?php echo $field_prefix; ?>phone_cell" type="text" class="bkkFullInput" value="<?php echo htmlspecialchars($dt[$field_prefix.'phone_cell'], ENT_QUOTES, '', FALSE); ?>" /></td>
			</tr>
			...
			<!-- tr>
				<td colspan="3"><span class="bkkLabel2">Ethnicity</span><select name="<?php echo $field_prefix; ?>ethnicity" id="<?php echo $field_prefix; ?>ethnicity" class="bkkFullInput">
				<?php // ListSel($patient->ethnicity, 'ethnicity'); ?>
				</select></td>
				<td colspan="2"><span class="bkkLabel2">Language</span><select name="<?php echo $field_prefix; ?>language" id="<?php echo $field_prefix; ?>language" class="bkkFullInput">
