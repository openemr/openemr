<?php
if(!isset($dt['img_dt'])) $dt['img_dt'] = '';
if(!isset($dt['img_type'])) $dt['img_type'] = '';
if(!isset($dt['img_nt'])) $dt['img_nt'] = '';
...
<table width="100%" border="0" cellspacing="0" cellpadding="3" style="border-collapse: collapse;">
	<tr class="<?php echo $portal_mode ? 'bkkBorder1B' : 'wmtBorder1B'; ?>">
		<td class="<?php echo $portal_mode ? 'bkkLabel bkkC' : 'wmtLabel wmtC'; ?>" style="width: 90px">Date</td>
		<td class="<?php echo $portal_mode ? 'bkkLabel bkkC' : 'wmtLabel wmtC'; ?>">Type</td>
		<td class="<?php echo $portal_mode ? 'bkkLabel bkkC' : 'wmtLabel wmtC wmtBorder1L'; ?>">Notes</td>
<?php if($delete_allow && $unlink_allow) { ?>
		<td class="<?php echo $portal_mode ? '' : 'wmtLabel wmtBorder1L'; ?>" style="width: 175px">&nbsp;</td>
<?php } else if($unlink_allow) { ?>
		<td class="<?php echo $portal_mode ? '' : 'wmtLabel wmtBorder1L'; ?>" style="width: 115px">&nbsp;</td>
...
?>
	<tr class="<?php echo $portal_mode ? $bg.' ' : ''; ?><?php echo (!$portal_mode && ($prev['classification'] == 9)) ? 'wmtHighlight' : ''; ?><?php echo !$portal_mode ? ' wmtBorder1B' : ''; ?>">
		<td class="<?php echo $portal_mode ? 'bkkDateCell' : 'wmtDateCell'; ?>"><input name="img_id_<?php echo $cnt; ?>" id="img_id_<?php echo $cnt; ?>" type="hidden" readonly="readonly" value="<?php echo $prev['id']; ?>" /><input name="img_num_links_<?php echo $cnt; ?>" id="img_num_links_<?php echo $cnt; ?>" type="hidden" tabindex="-1" value="<?php echo $prev['img_num_links']; ?>" />
		<?php if($portal_mode && ($prev['classification'] != 9)) { ?>
			<span class="bkkBody"><?php echo htmlspecialchars($prev['img_dt'], ENT_QUOTES, '', FALSE); ?>&nbsp;</span>
		<?php } else { ?>
			<input name="img_dt_<?php echo $cnt; ?>" id="img_dt_<?php echo $cnt; ?>" class="<?php echo $portal_mode ? 'bkkFullInput' : 'FullInput'; ?>" type="text" value="<?php echo htmlspecialchars($prev['img_dt'], ENT_QUOTES, '', FALSE); ?>" title="YYYY-MM-DD" />
		<?php } ?>
		</td>
		<td class="<?php echo $portal_mode ? '' : 'wmtBorder1B wmtBorder1L'; ?>">
		<?php if($portal_mode && ($prev['classification'] != 9)) { ?>
			<span class="bkkBody"><?php echo ListLook($prev['img_type'],'Image_Types'); ?>&nbsp;</span>
		<?php } else { ?>
			<select name="img_type_<?php echo $cnt; ?>" id="img_type_<?php echo $cnt; ?>" class="<?php echo $portal_mode ? 'bkkFullInput' : 'wmtFullInput'; ?>" tabindex="-1">
		...
		<td class="<?php echo $portal_mode ? '' : 'wmtBorder1B wmtBorder1L'; ?>">
		<?php if ($portal_mode && ($prev['classification'] != 9)) { ?>
			<span class="bkkBody"><?php echo $prev['img_nt']; ?>&nbsp;</span>
		<?php } else { ?>
			<input name="img_nt_<?php echo $cnt; ?>" id="img_nt_<?php echo $cnt; ?>" class="<?php echo $portal_mode ? 'bkkFullInput' : 'wmtFullInput'; ?>" type="text" tabindex="-1" value="<?php echo htmlspecialchars($prev['img_nt'], ENT_QUOTES, '', FALSE); ?>" />
		<?php } ?>
		</td>
		<td class="<?php echo $portal_mode ? '' : 'wmtBorder1B wmtBorder1L'; ?>">
...
?>
	...
	<tr class="<?php echo $portal_mode ? $bg . ' bkkBorder1B' : 'wmtBorder1B'; ?>">
		<td class="<?php echo $portal_mode ? 'bkkDateCell' : ''; ?>"><input name="img_dt" id="img_dt" class="<?php echo $portal_mode ? 'bkkFullInput' : 'wmtFullInput'; ?>" type="text" value="<?php echo htmlspecialchars($dt['img_dt'], ENT_QUOTES, '', FALSE); ?>" /></td>
		<td class="<?php echo (($portal_mode)?'bkkBorder1B':'BodyBorderLB'); ?>"><select name="img_type" id="img_type" class="<?php echo $portal_mode ? 'bkkFullInput' : 'wmtFullInput'; ?>">
			<?php ListSelAlpha($dt['img_type'],'Image_Types'); ?>
		</select></td>
		<td class="<?php echo $portal_mode ? 'bkkBorder1B' : 'wmtBorder1L'; ?>"><input name="img_nt" id="img_nt" class="<?php echo $portal_mode ? 'bkkFullInput' : 'wmtFullInput'; ?>" type="text" value="<?php echo htmlspecialchars($dt['img_nt'], ENT_QUOTES, '', FALSE); ?>" /></td>
		<td class="<?php echo $portal_mode ? 'bkkBorder1B' : 'wmtBorder1L'; ?>">&nbsp;</td>
	</tr>
	<tr class="wmtColorBar <?php echo $portal_mode ? 'bkkBorder1B': 'wmtBorder1B'; ?>">
