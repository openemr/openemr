...
?>
		...
		<tr>
			<td  colspan="3" class="<?php echo (($portal_mode)?'bkkCollapseBar ':'wmtCollapseBar '); ?> <?php echo ((checkSettingMode('wmt::fyi_pmh_nt') && (isset($dt['fyi_pmh_nt'])) && !$portal_mode)?'wmtBorder1B' : ''); ?><?php echo (($portal_mode)?'bkkBorder1B':''); ?>" >
