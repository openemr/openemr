...
if($smk_exists) {
  ...
  PrintSingleLineLeftRight('Are you aware of the risks of smoking to your health and well being?',htmlspecialchars($lifestyle->lf_sc_risks, ENT_QUOTES, '', FALSE),3, '', 'wmtPrnBody');
  PrintSingleLineLeftRight('Have you tried to quit smoking?',htmlspecialchars($lifestyle->lf_sc_tried, ENT_QUOTES, '', FALSE),3, '', 'wmtPrnBody');
  PrintSingleLineLeftRight('What is the longest period of time you have gone without smoking?',htmlspecialchars($lifestyle->lf_sc_wo, ENT_QUOTES, '', FALSE),3, '', 'wmtPrnBody');
  PrintSingleLineLeftRight('Why did you start smoking?',htmlspecialchars($lifestyle->lf_sc_why_start, ENT_QUOTES, '', FALSE),3, '', 'wmtPrnBody');
  PrintSingleLineLeftRight('Have you tried a structured treatment plan?',htmlspecialchars($lifestyle->lf_sc_treat, ENT_QUOTES, '', FALSE),3, '', 'wmtPrnBody');
  PrintSingleLineLeftRight('Have you tried patches and/or gum?',htmlspecialchars($lifestyle->lf_sc_patch, ENT_QUOTES, '', FALSE),3, '', 'wmtPrnBody');
  PrintSingleLineLeftRight('What is the primary reason you feel you have not been able to quit smoking?',htmlspecialchars($lifestyle->lf_sc_reason, ENT_QUOTES, '', FALSE),3, '', 'wmtPrnBody');
  PrintSingleLineLeftRight('Patient referred to:',htmlspecialchars($lifestyle->lf_sc_referred, ENT_QUOTES, '', FALSE),3, '', 'wmtPrnBody');
}
