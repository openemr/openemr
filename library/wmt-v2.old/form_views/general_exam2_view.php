...
if($dt{'ge_pul_norm_exam'} == '1') {
	...
	while($cnt < 5) {
		...
		EE1_GenPrintChoice('Wheezes: ', $dt{'ge_pul_ron'}, '');
		EE1_GenPrintChoice('Decreased Breathing Sounds: ',$dt{'ge_pul_ron'},'');
...
if($dt{'ge_gi_norm_exam'} == '1') {
	...
	while($cnt < 5) {
		...
		if($dtl && $dt{'ge_gi_tend_nt'}) $dtl .= ' - ';
		EE1_GenPrintChoice('Tender: ', $dt{'ge_gi_tend'}.$dtl, 
					$dt{'ge_gi_tend_nt'});
