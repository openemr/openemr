class Coveragelib {
	...
	async fetchEligibilityVerification(cnt, pid, case_id, ins_id, provider_id) {
		const result = await $.ajax({
			type: "POST",
			url: top.webroot_url + '/library/OemrAD/interface/forms/cases/ajax/coverage_verification.php',
			datatype: "json",
			data: {
				case_id: case_id,
				cnt: cnt,
	...
	handleHistory(pid, case_id, cnt) {
		var url = top.webroot_url + '/library/OemrAD/interface/forms/cases/ajax/coverage_history.php?pid='+pid+'&case_id='+case_id+'&cnt='+cnt;
	...
	async fetchEligibilityContent(cnt, pid, case_id, ins_id, provider_id) {
		const result = await $.ajax({
			type: "POST",
			url: top.webroot_url + '/library/OemrAD/interface/forms/cases/ajax/coverage_view.php',
			datatype: "json",
			data: {
				case_id: case_id,
				cnt: cnt,
