		...
		async function handlePrepareData(event_id = '', config_id = '') {
			...
			if(event_id != '') {
				...
				const result = await $.ajax({
			 	...
			 	// const result = await $.ajax({
			  //       url: "<?php //echo $GLOBALS['webroot'].'/library/OemrAD/interface/batchcom/action_event_log.php'; ?>",
			  //       type: 'POST',
			  //       data: ajaxParam
			  //   });
			}
		...
		async function handleSendData(event_id = '', config_id = '') {
			...
			if(event_id != '') {
				...
				const result = await $.ajax({
			 	...
			 	// const result = await $.ajax({
			  //       url: "<?php //echo $GLOBALS['webroot'].'/library/OemrAD/crons/reminder/cron_notification.php'; ?>",
			  //       type: 'POST',
			  //       data: ajaxParam
			  //   });
			}
