	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
		    table = $('#document_results').DataTable({
				...
				'serverMethod': 'post',
				'ajax': {
				  'url':'<?php echo $GLOBALS['webroot']."/library/OemrAD/interface/main/messages/ajax/msg_select_messages.php?pid=".$_REQUEST['pid']."&assigned_to=".$_REQUEST['assigned_to']."&type=ajax"; ?>'
		      	},
