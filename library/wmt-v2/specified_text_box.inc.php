...
?>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
        <td colspan="3"><textarea name="<?php echo $field_prefix.$field_name; ?>" id="<?php echo $field_prefix.$field_name; ?>" class="wmtFullInput" rows="3"><?php echo htmlspecialchars($dt{$field_prefix.$field_name}, ENT_QUOTES); ?></textarea></td>
      </tr>
    </table>
<?php ?>
