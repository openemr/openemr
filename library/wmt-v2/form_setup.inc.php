...
$unlink_allow = AclMain::aclCheckCore('patients', 'med');
$delete_allow = AclMain::aclCheckCore('admin','super');
$unlink_all_rx_history = AclMain::aclCheckCore('patients', 'med');
$unlink_all_allergies = AclMain::aclCheckCore('patients', 'med');
$unlink_all_meds = AclMain::aclCheckCore('patients', 'med');
$use_snippets = checkSettingMode('wmt::use_snippets','',$frmdir);
$approval = canApproveForms();
$is_billed = BillingUtilities::isEncounterBilled($pid, $encounter);
