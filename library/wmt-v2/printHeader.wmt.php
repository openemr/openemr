...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td class="wmtPrnBody"><?php echo htmlspecialchars($facility->addr, ENT_QUOTES); ?></td>
  </tr>
  <tr>
    <td class="wmtPrnBody"><?php echo htmlspecialchars($facility->csz, ENT_QUOTES); ?></td>
  </tr>
	<?php if($GLOBALS['wmt::print_phone_and_fax'] && $facility->phone_fax) { ?>
  <tr>
    <td class="wmtPrnBody"><?php echo htmlspecialchars($facility->phone_fax, ENT_QUOTES); ?></td>
  </tr>
	<?php } ?>
	<?php if($GLOBALS['wmt::print_website'] && $facility->website) { ?>
  <tr>
    <td class="wmtPrnBody wmtPrnC">Website Address: <?php echo htmlspecialchars($facility->website, ENT_QUOTES); ?></td>
  </tr>
	<?php } ?>
	<?php if($GLOBALS['wmt::print_email'] && $facility->email) { ?>
  <tr>
