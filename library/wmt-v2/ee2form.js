function toggleROStoNo()
{
  ...
  for (i=0; i<l; i++) {
    ...
    if(document.forms[0].elements[i].type.indexOf('check') != -1) {
      if(document.forms[0].elements[i].name.indexOf('hpi') != -1) {
...
function ClearExam()
{
  ...
  for (i=0; i<l; i++) {
    ...
    if(document.forms[0].elements[i].name.indexOf('ms_nt') != -1) {
			document.forms[0].elements[i].value='';
		}
  }
}
...
function setGEGeneralNormal(practice, chk)
{
	if(chk.checked == true) {
		if(practice == 'ashford') {
  		document.forms[0].elements['ge_gen_nt'].value=
  		...
  		document.forms[0].elements['ge_gen_norm'].checked=true;
  		document.forms[0].elements['ge_gen_dev'].checked=true;
  		document.forms[0].elements['ge_gen_groom'].checked=true;
  		document.forms[0].elements['ge_gen_dis'].checked=true;
			if(practice != 'sfa') {
  			document.forms[0].elements['ge_gen_jaun'].selectedIndex='2';
  			document.forms[0].elements['ge_gen_waste'].selectedIndex='2';
  			document.forms[0].elements['ge_gen_sleep'].selectedIndex='1';
			}
			if(practice == 'cffm') {
  			document.forms[0].elements['ge_gen_sleep'].selectedIndex='0';
			}
		}
	} else {
...
function setGEHeadNormal(practice, chk)
{
	if(chk.checked == true) {
		if(practice == 'ashford') {
  		document.forms[0].elements['ge_hd_nt'].value=
				'No edema or erythema. No cutaneous lesions. Facial movement full '+
				'and symmetric';
		} else {
			clearGESection(practice, 'ge_hd_', 'norm_exam');
  		document.forms[0].elements['ge_hd_atra'].checked=true;
  		document.forms[0].elements['ge_hd_norm'].checked=true;
  		document.forms[0].elements['ge_hd_feat'].selectedIndex=1;
  		document.forms[0].elements['tmp_ge_hd_head_mid-line'].checked=true;
		}
	} else {
...
{
	if(chk.checked == true) {
		if(practice == 'curylo') return true;
		if(practice == 'ashford') {
  		document.forms[0].elements['ge_eye_nt'].value=
			...
			if(practice != 'sfa') {
  			document.forms[0].elements['ge_eye_hem'].selectedIndex='2';
  			document.forms[0].elements['ge_eye_exu'].selectedIndex='2';
  			document.forms[0].elements['ge_eye_av'].selectedIndex='2';
  			document.forms[0].elements['ge_eye_pap'].selectedIndex='2';
			}
  		document.forms[0].elements['ge_eyer_norm'].selectedIndex='1';
  		document.forms[0].elements['ge_eyer_scleral'].checked=true;
  		document.forms[0].elements['ge_eyer_eomi'].selectedIndex='1';
  		document.forms[0].elements['ge_eyer_perrl'].selectedIndex='1';
  		document.forms[0].elements['ge_eyel_norm'].selectedIndex='1';
  		document.forms[0].elements['ge_eyel_scleral'].checked=true;
  		document.forms[0].elements['ge_eyel_eomi'].selectedIndex='1';
  		document.forms[0].elements['ge_eyel_perrl'].selectedIndex='1';
			if(practice == 'cffm') {
  			document.forms[0].elements['ge_eyer_exo'].selectedIndex='2';
  			document.forms[0].elements['ge_eyel_exo'].selectedIndex='2';
			}
		}
	} else {
...
function setGEEarsNormal(practice, chk)
{
	if(chk.checked == true) {
		if(practice == 'curylo') return true;
		if(practice == 'ashford') {
  		document.forms[0].elements['ge_ear_nt'].value=
  		...
  		document.forms[0].elements['ge_earr_clear'].selectedIndex='1';
  		document.forms[0].elements['ge_earr_perf'].selectedIndex='2';
  		document.forms[0].elements['ge_earr_ret'].selectedIndex='2';
  		document.forms[0].elements['ge_earr_bulge'].selectedIndex='2';
  		document.forms[0].elements['ge_earr_pus'].selectedIndex='0';
  		document.forms[0].elements['ge_earr_ceru'].selectedIndex='2';
  		document.forms[0].elements['ge_earl_clear'].selectedIndex='1';
  		document.forms[0].elements['ge_earl_perf'].selectedIndex='2';
  		document.forms[0].elements['ge_earl_ret'].selectedIndex='2';
  		document.forms[0].elements['ge_earl_bulge'].selectedIndex='2';
  		document.forms[0].elements['ge_earl_pus'].selectedIndex='0';
  		document.forms[0].elements['ge_earl_ceru'].selectedIndex='2';
		}
	} else {
...
function setGENoseNormal(practice, chk)
{
	if(chk.checked == true) {
		if(practice == 'curylo') return true;
		if(practice == 'ashford') {
  		document.forms[0].elements['ge_nose_nt'].value=
  		...
  		document.forms[0].elements['ge_nose_ery'].selectedIndex='2';
  		document.forms[0].elements['ge_nose_swell'].selectedIndex='2';
  		document.forms[0].elements['ge_nose_pall'].selectedIndex='2';
  		document.forms[0].elements['ge_nose_polps'].selectedIndex='2';
			if(practice == 'cffm') {
  			document.forms[0].elements['ge_nose_sept'].selectedIndex='2';
			}
		}
	} else {
...
function setGEMouthNormal(practice, chk)
{
	if(chk.checked == true) {
		if(practice == 'curylo') return true;
		if(practice == 'ashford') {
  		document.forms[0].elements['ge_mouth_nt'].value=
  		...
  		document.forms[0].elements['ge_mouth_moist'].checked=true;
			if(practice == 'cffm') {
  			document.forms[0].elements['ge_mouth_les'].checked=true;
			}
		}
	} else {
...
function setGEThroatNormal(practice, chk)
{
	if(chk.checked == true) {
		if(practice == 'curylo') return true;
		if(practice == 'ashford') {
  		document.forms[0].elements['ge_thrt_nt'].value=
  		...
  		document.forms[0].elements['ge_thrt_ery'].checked=true;
  		document.forms[0].elements['ge_thrt_exu'].checked=true;
		}
	} else {
...
function setGENeckNormal(practice, chk)
{
	if(chk.checked == true) {
		if(practice == 'curylo') return true;
		if(practice == 'ashford') {
  		document.forms[0].elements['ge_nk_nt'].value=
  		...
  		document.forms[0].elements['ge_nk_sup'].checked=true;
  		document.forms[0].elements['ge_nk_trach'].checked=true;
			if(practice == 'cffm' || practice == 'uimda' || practice == 'sfa') {
  			document.forms[0].elements['ge_nk_brit'].selectedIndex='2';
  			document.forms[0].elements['ge_nk_jvp'].selectedIndex='2';
  			document.forms[0].elements['ge_nk_lymph'].selectedIndex='2';
			}
			if(practice == 'ccc') {
  			document.forms[0].elements['ge_nk_brit'].selectedIndex='1';
  			document.forms[0].elements['ge_nk_jvp'].selectedIndex='1';
  			document.forms[0].elements['ge_nk_lymph'].selectedIndex='1';
			}
		}
	} else {
...
function setGEThyroidNormal(practice, chk)
{
	if(chk.checked == true) {
		if(practice == 'curylo') return true;
		if(practice == 'ashford') {
  		document.forms[0].elements['ge_thy_nt'].value=
				'Indirect mirror exam inadequate.';
		} else {
			clearGESection(practice, 'ge_thy_', 'norm_exam');
  		document.forms[0].elements['ge_thy_norm'].checked=true;
  		document.forms[0].elements['ge_thy_nod'].selectedIndex='2';
			if(practice != 'cffm' && practice != 'sfa') {
  			document.forms[0].elements['ge_thy_brit'].selectedIndex='2';
			}
  		document.forms[0].elements['ge_thy_tnd'].selectedIndex='2';
			if(practice == 'cffm') {
  			document.forms[0].elements['ge_thy_tnd'].selectedIndex='2';
			}
		}
...
function setGELymphNormal(practice, chk)
{
	if(chk.checked == true) {
		if(practice == 'curylo') return true;
		if(practice == 'ashford') {
  		document.forms[0].elements['ge_lym_nt'].value=
...
function setGEBreastNormal(practice, chk)
{
	if(chk.checked == true) {
		...
		if(practice == 'cffm') {
  		document.forms[0].elements['ge_br_sym'].selectedIndex='1';
  		document.forms[0].elements['ge_brr_axil'].selectedIndex='2';
  		document.forms[0].elements['ge_brr_mass'].selectedIndex='2';
  		document.forms[0].elements['ge_nipr_dis'].selectedIndex='2';
  		document.forms[0].elements['ge_nipr_ret'].selectedIndex='2';
  		document.forms[0].elements['ge_brl_axil'].selectedIndex='2';
  		document.forms[0].elements['ge_brl_mass'].selectedIndex='2';
  		document.forms[0].elements['ge_nipl_dis'].selectedIndex='2';
  		document.forms[0].elements['ge_nipl_ret'].selectedIndex='2';
		}
		if(practice == 'uimda') {
  		document.forms[0].elements['ge_brr_axil'].selectedIndex='2';
  		document.forms[0].elements['ge_brr_mass'].selectedIndex='2';
...
function setGECardioNormal(practice, chk)
{
	if(chk.checked == true) {
  	...
  	document.forms[0].elements['ge_cr_norm'].selectedIndex='1';
  	document.forms[0].elements['ge_cr_mur'].selectedIndex='2';
  	document.forms[0].elements['ge_cr_gall'].selectedIndex='2';
  	document.forms[0].elements['ge_cr_click'].selectedIndex='2';
  	document.forms[0].elements['ge_cr_rubs'].selectedIndex='2';
  	document.forms[0].elements['ge_cr_extra'].selectedIndex='2';
  	document.forms[0].elements['ge_cr_pmi'].selectedIndex='1';
	} else {
...
function setGEPulmoNormal(practice, chk)
{
	if(chk.checked == true) {
  	...
  	document.forms[0].elements['ge_pul_clear'].selectedIndex='1';
  	document.forms[0].elements['ge_pul_rales'].selectedIndex='2';
  	document.forms[0].elements['ge_pul_whz'].selectedIndex='2';
  	document.forms[0].elements['ge_pul_ron'].selectedIndex='2';
  	document.forms[0].elements['ge_pul_dec'].selectedIndex='2';
  	document.forms[0].elements['ge_pul_crack'].selectedIndex='2';
	} else {
...
function setGEGastroNormal(practice, chk)
{
	if(chk.checked == true) {
  	...
  	document.forms[0].elements['ge_gi_soft'].selectedIndex='1';
  	document.forms[0].elements['ge_gi_tend'].selectedIndex='2';
  	document.forms[0].elements['ge_gi_dis'].selectedIndex='2';
  	document.forms[0].elements['ge_gi_asc'].selectedIndex='2';
  	document.forms[0].elements['ge_gi_pnt'].selectedIndex='2';
  	document.forms[0].elements['ge_gi_grd'].selectedIndex='2';
  	document.forms[0].elements['ge_gi_reb'].selectedIndex='2';
  	document.forms[0].elements['ge_gi_mass'].selectedIndex='2';
  	document.forms[0].elements['ge_gi_scar'].selectedIndex='2';
  	document.forms[0].elements['ge_gi_hern'].selectedIndex='2';
  	document.forms[0].elements['ge_gi_bowel'].selectedIndex='0';
  	document.forms[0].elements['ge_gi_hepa'].selectedIndex='2';
  	document.forms[0].elements['ge_gi_spleno'].selectedIndex='2';
	} else {
...
function setGENeuroNormal(practice, chk)
{
	if(chk.checked == true) {
		if(practice == 'ashford') {
  		document.forms[0].elements['ge_neu_cn_nt'].value=
  		...
  		document.forms[0].elements['ge_neu_ao'].selectedIndex='3';
  		document.forms[0].elements['ge_neu_cn'].selectedIndex='1';
  		document.forms[0].elements['ge_neu_bicr'].selectedIndex='0';
  		document.forms[0].elements['ge_neu_bicl'].selectedIndex='0';
  		document.forms[0].elements['ge_neu_trir'].selectedIndex='0';
  		document.forms[0].elements['ge_neu_tril'].selectedIndex='0';
  		document.forms[0].elements['ge_neu_brar'].selectedIndex='0';
  		document.forms[0].elements['ge_neu_bral'].selectedIndex='0';
  		document.forms[0].elements['ge_neu_patr'].selectedIndex='0';
  		document.forms[0].elements['ge_neu_patl'].selectedIndex='0';
  		document.forms[0].elements['ge_neu_achr'].selectedIndex='0';
  		document.forms[0].elements['ge_neu_achl'].selectedIndex='0';
			if(practice == 'cffm') {
  			document.forms[0].elements['ge_neu_bicr'].selectedIndex='2';
  			document.forms[0].elements['ge_neu_bicl'].selectedIndex='2';
  			document.forms[0].elements['ge_neu_patr'].selectedIndex='2';
  			document.forms[0].elements['ge_neu_patl'].selectedIndex='2';
  			document.forms[0].elements['ge_neu_achr'].selectedIndex='2';
  			document.forms[0].elements['ge_neu_achl'].selectedIndex='2';
  			document.forms[0].elements['ge_neu_pup'].selectedIndex='6';
  			document.forms[0].elements['ge_neu_plow'].selectedIndex='6';
  			document.forms[0].elements['ge_neu_dup'].selectedIndex='6';
  			document.forms[0].elements['ge_neu_dlow'].selectedIndex='6';
			}
		}
	} else {
...
function setGEMuscNormal(practice, chk)
{
	if(chk.checked == true) {
		if(practice == 'curylo') return true;
		if(practice == 'ashford') {
  		document.forms[0].elements['ge_ms_nt'].value=
			...
			if(practice == 'cffm') {
  			document.forms[0].elements['ge_ms_intact'].checked=true;
			}
  		document.forms[0].elements['ge_ms_mass'].selectedIndex=2;
  		document.forms[0].elements['ge_ms_tnd'].selectedIndex=2;
  		document.forms[0].elements['ge_ms_scl'].selectedIndex=2;
  		document.forms[0].elements['ge_ms_cval'].selectedIndex=2;
  		document.forms[0].elements['ge_ms_cvar'].selectedIndex=2;
  		document.forms[0].elements['ge_ms_lim'].selectedIndex=2;
  		document.forms[0].elements['ge_ms_def'].selectedIndex=2;
  		document.forms[0].elements['ge_ms_full'].selectedIndex=1;
  		document.forms[0].elements['ge_ms_gait'].selectedIndex=1;
  		document.forms[0].elements['ge_ms_norm'].checked=true;
		}
	} else {
...
function setGEExtNormal(practice, chk)
{
	if(chk.checked == true) {
  	...
  	document.forms[0].elements['ge_ext_edema'].selectedIndex='2';
  	document.forms[0].elements['ge_ext_refill'].selectedIndex='1';
  	document.forms[0].elements['ge_ext_club'].selectedIndex='2';
  	document.forms[0].elements['ge_ext_cyan'].selectedIndex='2';
		if(practice == 'cffm') {
  		document.forms[0].elements['ge_ext_pls_rad'].selectedIndex='3';
  		document.forms[0].elements['ge_ext_pls_post'].selectedIndex='3';
		}
	} else {
...
function setGEFootNormal(practice,chk)
{
	if(chk.checked == true) {
  	...
  	document.forms[0].elements['ge_db_prop'].selectedIndex='1';
  	document.forms[0].elements['ge_db_vib'].selectedIndex='1';
  	document.forms[0].elements['ge_db_sens'].selectedIndex='1';
	} else {
...
function setGERectalNormal(sex,practice,chk)
{
	if(chk.checked == true) {
		...
		if(practice == 'sfa') {
  		document.forms[0].elements['ge_rc_tone'].selectedIndex='1';
  		document.forms[0].elements['ge_rc_tone_nt'].value='and remainder of exam';
		}
		if(practice == 'cffm') {
  		document.forms[0].elements['ge_rc_tone'].selectedIndex='1';
  		document.forms[0].elements['ge_rc_ext'].selectedIndex='2';
			if(sex != 'f') {
  			document.forms[0].elements['ge_rc_pro'].selectedIndex='1';
			}
  		document.forms[0].elements['ge_rc_bog'].selectedIndex='2';
  		document.forms[0].elements['ge_rc_hard'].selectedIndex='2';
  		document.forms[0].elements['ge_rc_mass'].selectedIndex='2';
  		document.forms[0].elements['ge_rc_tend'].selectedIndex='2';
		}
	} else {
...
function setGESkinNormal(practice, chk)
{
	if(chk.checked == true) {
		...
		if(practice == 'cffm') {
  		document.forms[0].elements['ge_skin_app'].checked=true;
  		document.forms[0].elements['ge_skin_les'].checked=true;
		} else {
  		document.forms[0].elements['ge_skin_jau'].selectedIndex='2';
  		document.forms[0].elements['ge_skin_con'].selectedIndex='2';
  		document.forms[0].elements['ge_skin_ecc'].selectedIndex='2';
  		document.forms[0].elements['ge_skin_rash'].selectedIndex='2';
  		document.forms[0].elements['ge_skin_abs'].selectedIndex='2';
  		document.forms[0].elements['ge_skin_lac'].selectedIndex='2';
		}
	} else {
...
function setGEPsychNormal(practice, chk)
{
	if(chk.checked == true) {
  	...
  	document.forms[0].elements['ge_psych_judge'].checked=true;
  	document.forms[0].elements['ge_psych_judge_nt'].value='Appropriate';
  	document.forms[0].elements['ge_psych_orient'].checked=true;
  	document.forms[0].elements['ge_psych_orient_nt'].value='Appropriate';
  	document.forms[0].elements['ge_psych_memory'].checked=true;
  	document.forms[0].elements['ge_psych_memory_nt'].value='Appropriate';
  	document.forms[0].elements['ge_psych_mood'].checked=true;
  	document.forms[0].elements['ge_psych_mood_nt'].value='Appropriate';
	} else {
...
function SetExamNormal(practiceId)
{
	...
	chk = document.getElementById('ge_gen_norm_exam');
	chk.checked = true;
	setGEGeneralNormal(practiceId, chk);
	
	chk = document.getElementById('ge_hd_norm_exam');
	chk.checked = true;
	setGEHeadNormal(practiceId, chk);

	chk = document.getElementById('ge_eye_norm_exam');
	chk.checked = true;
	setGEEyesNormal(practiceId, chk);

	chk = document.getElementById('ge_ear_norm_exam');
	chk.checked = true;
	setGEEarsNormal(practiceId, chk);

	chk = document.getElementById('ge_nose_norm_exam');
	chk.checked = true;
	setGENoseNormal(practiceId, chk);

	chk = document.getElementById('ge_mouth_norm_exam');
	chk.checked = true;
	setGEMouthNormal(practiceId, chk);

	chk = document.getElementById('ge_thrt_norm_exam');
	chk.checked = true;
	setGEThroatNormal(practiceId, chk);

	chk = document.getElementById('ge_nk_norm_exam');
	chk.checked = true;
	setGENeckNormal(practiceId, chk);

	chk = document.getElementById('ge_thy_norm_exam');
	chk.checked = true;
	setGEThyroidNormal(practiceId, chk);

	chk = document.getElementById('ge_lym_norm_exam');
	chk.checked = true;
	setGELymphNormal(practiceId, chk);

	chk = document.getElementById('ge_br_norm_exam');
	chk.checked = true;
	setGEBreastNormal(practiceId, chk);

	chk = document.getElementById('ge_cr_norm_exam');
	chk.checked = true;
	setGECardioNormal(practiceId, chk);

	chk = document.getElementById('ge_pul_norm_exam');
	chk.checked = true;
	setGEPulmoNormal(practiceId, chk);

	chk = document.getElementById('ge_gi_norm_exam');
	chk.checked = true;
	setGEGastroNormal(practiceId, chk);

	chk = document.getElementById('ge_neu_norm_exam');
	chk.checked = true;
	setGENeuroNormal(practiceId, chk);

	chk = document.getElementById('ge_ms_norm_exam');
	chk.checked = true;
	setGEMuscNormal(practiceId, chk);

	chk = document.getElementById('ge_ext_norm_exam');
	chk.checked = true;
	setGEExtNormal(practiceId, chk);

	chk = document.getElementById('ge_db_norm_exam');
	chk.checked = true;
	setGEFootNormal(practiceId, chk);

	chk = document.getElementById('ge_te_norm_exam');
	chk.checked = true;
	setGETestesNormal(practiceId, chk);

	chk = document.getElementById('ge_rc_norm_exam');
	chk.checked = true;
	setGERectalNormal(sex, practiceId, chk);

	chk = document.getElementById('ge_skin_norm_exam');
	chk.checked = true;
	setGESkinNormal(practiceId, chk);

	chk = document.getElementById('ge_psych_norm_exam');
	chk.checked = true;
...
function toggleCCNorm(chk) {
	if(chk.checked == true) {
		document.forms[0].elements['ge_neu_cc_fh'].selectedIndex=0;
		document.forms[0].elements['ge_neu_cc_hs'].selectedIndex=0;
		document.forms[0].elements['ge_neu_cc_ra'].selectedIndex=0;
		document.forms[0].elements['ge_neu_cc_rm'].selectedIndex=0;
		document.forms[0].elements['ge_neu_cc_pd'].selectedIndex=0;
		document.forms[0].elements['ge_neu_sns_chc'].selectedIndex=0;
	} else {
		document.forms[0].elements['ge_neu_norm_exam'].checked = false;
	}
} 
