...
if(!isset($ros_style_prefix)) $ros_style_prefix = 'wmt';
?>
...
$rs[$o['option_id'].'_nt'], 'constitutional', true, true, $ros_style_prefix);
}
?>
<tr><!-- For spacing only -->
<td>&nbsp;</td>
...
$rs[$o['option_id']], $rs[$o['option_id'].'_nt'], 'ent', true, true, $ros_style_prefix);
}
?>
<tr><!-- For spacing only -->
<td>&nbsp;</td>
...
GenerateROSLine($o['option_id'],$o['title'],$rs[$o['option_id']],
 $rs[$o['option_id'].'_nt'],'respiratory', true, true, $ros_style_prefix);
}
?>
<tr><!-- For spacing only -->
<td>&nbsp;</td>
...
GenerateROSLine($o['option_id'],$o['title'],
$rs[$o['option_id']], $rs[$o['option_id'].'_nt'], 'genito', true, true, $ros_style_prefix);
}
}
?>
<tr><!-- For spacing only -->
...
GenerateROSLine($o['option_id'], $o['title'],
$rs[$o['option_id']], $rs[$o['option_id'].'_nt'], 'neurologic', true, true, $ros_style_prefix);
}
?>
<tr><!-- For spacing only -->
<td>&nbsp;</td>
</tr>
<?php if($GLOBALS['wmt::client_id'] != 'curylo') { ?>
<tr>
...
GenerateROSLine($o['option_id'], $o['title'],
$rs[$o['option_id']], $rs[$o['option_id'].'_nt'], 'endocrine', true, true, $ros_style_prefix);
}
?>
<?php } ?>
<?php if($pat_sex == 'm' && $GLOBALS['wmt::client_id'] != 'curylo') { ?>
<tr><td>&nbsp;</td></tr>
<tr><td>&nbsp;</td></tr>
<tr><td>&nbsp;</td></tr>
<tr><td>&nbsp;</td></tr>
...
GenerateROSLine($o['option_id'], $o['title'],
$rs[$o['option_id']], $rs[$o['option_id'].'_nt'],'eyes', true, true, $ros_style_prefix);
}
?>
<tr><!-- For spacing only -->
<td>&nbsp;</td>
...
GenerateROSLine($o['option_id'], $o['title'],
$rs[$o['option_id']], $rs[$o['option_id'].'_nt'], 'cardio', true, true, $ros_style_prefix);
}
?>
<tr>
<td>&nbsp;</td>	
...
GenerateROSLine($o['option_id'], $o['title'],
$rs[$o['option_id']], $rs[$o['option_id'].'_nt'], 'gastro', true, true, $ros_style_prefix);
						}
						?>
						<tr>
							<td>&nbsp;</td>	
...
<?php if($GLOBALS['wmt::client_id'] != 'curylo') { ?>
            ...
            <tr>
						...
						foreach($ros_options as $o) {
							...
							GenerateROSLine($o['option_id'], $o['title'],
								$rs[$o['option_id']], $rs[$o['option_id'].'_nt'], 'muscle', true, true, $ros_style_prefix);
						}
						?>
<?php } ?>
            <tr><!-- For spacing only -->
            ...
            <tr>
						...
						foreach($ros_options as $o) {
							...
							GenerateROSLine($o['option_id'], $o['title'],
								$rs[$o['option_id']], $rs[$o['option_id'].'_nt'], 'skin', true, true, $ros_style_prefix);
						}
						?>
            <tr><!-- For spacing only -->
              <td>&nbsp;</td>
...
GenerateROSLine($o['option_id'], $o['title'],
$rs[$o['option_id']],$rs[$o['option_id'].'_nt'],'psychiatric', true, true, $ros_style_prefix);
}
?>
<tr><!-- For spacing only -->
<td>&nbsp;</td>
...
GenerateROSLine($o['option_id'], $o['title'],
$rs[$o['option_id']], $rs[$o['option_id'].'_nt'],'lymphatic', true, true, $ros_style_prefix);
}
?>
<?php if($pat_sex == 'f' && $GLOBALS['wmt::client_id'] != 'curylo') { ?>
<tr><td>&nbsp;</td></tr>
<tr><td>&nbsp;</td></tr>
<tr><td>&nbsp;</td></tr>
<tr><td>&nbsp;</td></tr>
...
<tr>
<td colspan="3"><textarea name="ros_nt" id="ros_nt" class="wmtFullInput" rows="4"><?php echo htmlspecialchars($wmt_ros{'ros_nt'}, ENT_QUOTES, '', FALSE); ?></textarea></td>
</tr>
</table>
