...
if(!isset($dt['ge_id'])) $dt['ge_id'] = $id;
if(!isset($form_mode)) $form_mode = '';

$flds = sqlListFields('form_ext_exam2');
foreach($flds as $fld) {
	if(substr($fld,0,3) != 'ge_') continue;
...
if($form_mode == 'new') {
  ...
  // THIS HANDLES LOADING THE PRIOR ENTRIES FOR WHICHEVER EXAM TYPE WE NEED 
	...
	if($_GET['type']) {
  	$old = sqlQuery("SELECT form_id, formdir, encounter, form_type FROM " .
		...
		// CONSIDER A 'noload' OVERRIDE HERE
	} else {
	...
	// NOW LOAD PRIOR VALUES RESPECTING THE USER/PRACTICE SETTING
	if(!isset($old{'form_id'})) $old{'form_id'} = '';
	if($old{'form_id'} && !$noload) {
	...
	// ALL SAVE PROCESSING IS IN THE PRE AND POST PROCESS DIRECTORIES
	loadFormComments($dt, 'general_exam2', $id, $frmn, $pid);
}
...
$field_name = 'ge_dictate';
$notes_save = $module['notes'];
$module['notes'] = 'Notes (for dictation';
...
?>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td><div style="float: right; padding-right: 10px;"><a class="css_button_small" tabindex="-1" onClick="ClearThisField('diagnostics_nt');" href="javascript:;"><span>Clear Tests</span></a></div></td>
		</tr>
    <tr>
      <td colspan="4"><textarea name="diagnostics_nt" id="diagnostics_nt" class="wmtFullInput" rows="4"><?php echo htmlspecialchars($dt{'diagnostics_nt'}, ENT_QUOTES, '', FALSE); ?></textarea></td>
    </tr>
		<?php } ?>
		<tr>
			<td class="wmtBody"><b><i>Use the category checkboxes to reveal/hide these sections</i></b></td>
			<td><div style="float: left; padding-right: 10px;"><a class="css_button_small" tabindex="-1" onClick="showAllExamSections('<?php echo $pat_sex; ?>');" href="javascript:;"><span>Show ALL Sections</span></a></div>&nbsp;&nbsp;&nbsp;&nbsp;
			<div style="float: right; padding-right: 10px;"><a class="css_button_small" tabindex="-1" onClick="hideAllExamSections('<?php echo $pat_sex; ?>');" href="javascript:;"><span>Hide ALL Sections</span></a></div>
			<td><div style="float: right; padding-right: 10px;"><a class="css_button_small" tabindex="-1" onClick="SetExamNormal('<?php echo $client_id; ?>','<?php echo $pat_sex; ?>');" href="javascript:;"><span>Set Exam ALL Normal</span></a></div></td>
			<td><div style="float: right; padding-right; 10px"><a class="css_button_small" tabindex="-1" onClick="ClearExam('<?php echo $client_id; ?>');" href="javascript:;"><span>Clear Exam</span></a></div></td>
		</tr>
		</table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td class="wmtBody" style="width: 30%;"><input name="ge_gen_norm_exam" id="ge_gen_norm_exam" type="checkbox" value="1" <?php echo (($dt['ge_gen_norm_exam'] == 1)?' checked':''); ?> onChange="setGEGeneralNormal('<?php echo $client_id; ?>',this);" /><label for="ge_gen_norm_exam">Set General Exam Normal</label></td>
			<td><div name="tmp_ge_gen_button_disp" id="tmp_ge_gen_button_disp" style="float: left; display: <?php echo $dt['tmp_ge_gen_disp']; ?>;"><a href="javascript:;" tabindex="-1" class="css_button_small" onClick="clearGESection('<?php echo $client_id; ?>', 'ge_gen_');"><span>Clear</span></a></div></td>
    </tr>
		</table>
    ...
    <tr>
      <td colspan="3"><textarea name="ge_gen_nt" id="ge_gen_nt" class="wmtFullInput" rows="3" onchange="document.getElementById('ge_gen_norm_exam').checked = false;"><?php echo htmlspecialchars($dt{'ge_gen_nt'}, ENT_QUOTES, '', FALSE); ?></textarea></td>
    </tr>
		</table>
		</fieldset>
		</div>
    ...
    <tr>
      ...
      <td class="wmtBody" style="width: 30%;"><input name="ge_hd_norm_exam" id="ge_hd_norm_exam" type="checkbox" value="1" <?php echo (($dt['ge_hd_norm_exam'] == 1)?' checked':''); ?> onChange="setGEHeadNormal('<?php echo $client_id; ?>',this);" /><label for="ge_hd_norm_exam">Set Head Exam Normal</label></td>
			<td><div name="tmp_ge_head_button_disp" id="tmp_ge_head_button_disp" style="float: left; display: <?php echo $dt['tmp_ge_head_disp']; ?>;"><a href="javascript:;" tabindex="-1" class="css_button_small" onClick="clearGESection('<?php echo $client_id; ?>', 'ge_hd_');"><span>Clear</span></a></div></td>
    </tr>
		</table>
    ...
    <tr>
      <td colspan="3"><textarea name="ge_hd_nt" id="ge_hd_nt" class="wmtFullInput" rows="3" onchange="document.getElementById('ge_hd_norm_exam').checked = false;"><?php echo htmlspecialchars($dt{'ge_hd_nt'}, ENT_QUOTES, '', FALSE); ?></textarea></td>
    </tr>
		</table>
		</fieldset>
		</div>
    ...
    <tr>
      ...
      <td class="wmtBody" style="width: 30%;"><input name="ge_eye_norm_exam" id="ge_eye_norm_exam" type="checkbox" value="1" <?php echo (($dt['ge_eye_norm_exam'] == 1)?' checked':''); ?> onChange="setGEEyesNormal('<?php echo $client_id; ?>',this);" /><label for="ge_eye_norm_exam">Set Eye Exam Normal</label></td>
			<td><div name="tmp_ge_eyes_button_disp" id="tmp_ge_eyes_button_disp" style="float: left; display: <?php echo $dt['tmp_ge_eyes_disp']; ?>;"><a href="javascript:;" tabindex="-1" class="css_button_small" onClick="clearGESection('<?php echo $client_id; ?>', 'ge_eye');"><span>Clear</span></a></div></td>
    </tr>
		</table>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
    	...
    	<tr>
      	<td class="wmtLabel" colspan="3">Fundoscopic</td>
			...
			<?php
			EE1_GESelLine('ge_eye','hem','Hemorrhage',$dt{'ge_eye_hem'},$dt{'ge_eye_hem_nt'}, 'Yes_No');
			EE1_GESelLine('ge_eye','exu','Exudate',$dt{'ge_eye_exu'},$dt{'ge_eye_exu_nt'}, 'Yes_No');
			EE1_GESelLine('ge_eye','av','AV Nicking',$dt{'ge_eye_av'},$dt{'ge_eye_av_nt'}, 'Yes_No');
			EE1_GESelLine('ge_eye','pap','Papilledema',$dt{'ge_eye_pap'},$dt{'ge_eye_pap_nt'}, 'Yes_No');
			?>
    	<tr>
    	...
    	<tr>
      	<td colspan="3"><textarea name="ge_eye_nt" id="ge_eye_nt" class="wmtFullInput" rows="3" onchange="document.getElementById('ge_eye_norm_exam').checked = false;"><?php echo htmlspecialchars($dt{'ge_eye_nt'}, ENT_QUOTES, '', FALSE); ?></textarea></td>
    	</tr>
		</table>
		</fieldset>
		</div>
    ...
    <tr>
      ...
      <td class="wmtBody" style="width: 30%;"><input name="ge_ear_norm_exam" id="ge_ear_norm_exam" type="checkbox" value="1" <?php echo (($dt['ge_ear_norm_exam'] == 1)?' checked':''); ?> onChange="setGEEarsNormal('<?php echo $client_id; ?>',this);" /><label for="ge_ear_norm_exam">Set Ear Exam Normal</label></td>
			<td><div name="tmp_ge_ears_button_disp" id="tmp_ge_ears_button_disp" style="float: left; display: <?php echo $dt['tmp_ge_ears_disp']; ?>;"><a href="javascript:;" tabindex="-1" class="css_button_small" onClick="clearGESection('<?php echo $client_id; ?>', 'ge_ear');"><span>Clear</span></a></div></td>
		</tr>
		</table>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
    	...
    	<tr>
      	...
      	<td class="wmtBody">Tympanic Membrane</td>
				<td style="width: 70%;"><input name="ge_earr_tym_nt" id="ge_earr_tym_nt" class="wmtFullInput" type="text" value="<?php echo htmlspecialchars($dt{'ge_earr_tym_nt'}, ENT_QUOTES, '', FALSE); ?>" onchange="document.getElementById('ge_ear_norm_exam').checked = false;"/></td>
    	</tr>
			<?php
    	...
    	<tr>
				<td>&nbsp;</td>
      	<td class="wmtBody">Tympanic Membrane</td>
				<td><input name="ge_earl_tym_nt" id="ge_earl_tym_nt" class="wmtFullInput" type="text" value="<?php echo htmlspecialchars($dt{'ge_earl_tym_nt'}, ENT_QUOTES, '', FALSE); ?>" onchange="document.getElementById('ge_ear_norm_exam').checked = false;" /></td>
    	</tr>
			<?php
    	...
    	<tr>
      	<td colspan="3"><textarea name="ge_ear_nt" id="ge_ear_nt" class="wmtFullInput" rows="3" onchange="document.getElementById('ge_ear_norm_exam').checked = false;"><?php echo htmlspecialchars($dt{'ge_ear_nt'}, ENT_QUOTES, '', FALSE); ?></textarea></td>
    	</tr>
		</table>
		</fieldset>
		</div>
    ...
    <tr>
      ...
      <td class="wmtBody" style="width: 30%;"><input name="ge_nose_norm_exam" id="ge_nose_norm_exam" type="checkbox" value="1" <?php echo (($dt['ge_nose_norm_exam'] == 1)?' checked':''); ?> onChange="setGENoseNormal('<?php echo $client_id; ?>',this);" /><label for="ge_nose_norm_exam">Set Nose Exam Normal</label></td>
			<td><div name="tmp_ge_nose_button_disp" id="tmp_ge_nose_button_disp" style="float: left; display: <?php echo $dt['tmp_ge_nose_disp']; ?>;"><a href="javascript:;" tabindex="-1" class="css_button_small" onClick="clearGESection('<?php echo $client_id; ?>', 'ge_nose_');"><span>Clear</span></a></div></td>
		</tr>
		</table>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
    	...
    	<tr>
      	<td colspan="3"><textarea name="ge_nose_nt" id="ge_nose_nt" class="wmtFullInput" rows="3" onchange="document.getElementById('ge_nose_norm_exam').checked = false;"><?php echo htmlspecialchars($dt{'ge_nose_nt'}, ENT_QUOTES, '', FALSE); ?></textarea></td>
    	</tr>
		</table>
		</fieldset>
		</div>
    ...
    <tr>
      ...
      <td class="wmtBody" style="width: 30%;"><input name="ge_mouth_norm_exam" id="ge_mouth_norm_exam" type="checkbox" value="1" <?php echo (($dt['ge_mouth_norm_exam'] == 1)?' checked':''); ?> onChange="setGEMouthNormal('<?php echo $client_id; ?>',this);" /><label for="ge_mouth_norm_exam">Set Mouth Exam Normal</label></td>
			<td><div name="tmp_ge_mouth_button_disp" id="tmp_ge_mouth_button_disp" style="float: left; display: <?php echo $dt['tmp_ge_mouth_disp']; ?>;"><a href="javascript:;" tabindex="-1" class="css_button_small" onClick="clearGESection('<?php echo $client_id; ?>', 'ge_mouth_');"><span>Clear</span></a></div></td>
		</tr>
		</table>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
    	...
    	<tr>
      	<td colspan="3"><textarea name="ge_mouth_nt" id="ge_mouth_nt" class="wmtFullInput" rows="3" onchange="document.getElementById('ge_mouth_norm_exam').checked = false;"><?php echo htmlspecialchars($dt{'ge_mouth_nt'}, ENT_QUOTES, '', FALSE); ?></textarea></td>
    	</tr>
		</table>
		</fieldset>
		</div>
    ...
    <tr>
      ...
      <td class="wmtBody" style="width: 30%;"><input name="ge_thrt_norm_exam" id="ge_thrt_norm_exam" type="checkbox" value="1" <?php echo (($dt['ge_thrt_norm_exam'] == 1)?' checked':''); ?> onChange="setGEThroatNormal('<?php echo $client_id; ?>',this);" /><label for="ge_thrt_norm_exam">Set Throat Exam Normal</label></td>
			<td><div name="tmp_ge_throat_button_disp" id="tmp_ge_throat_button_disp" style="float: left; display: <?php echo $dt['tmp_ge_throat_disp']; ?>;"><a href="javascript:;" tabindex="-1" class="css_button_small" onClick="clearGESection('<?php echo $client_id; ?>', 'ge_thrt_');"><span>Clear</span></a></div></td>
		</tr>
		</table>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
    	...
    	<tr>
      	<td colspan="3"><textarea name="ge_thrt_nt" id="ge_thrt_nt" class="wmtFullInput" rows="3" onchange="document.getElementById('ge_thrt_norm_exam').checked = false;"><?php echo htmlspecialchars($dt{'ge_thrt_nt'}, ENT_QUOTES, '', FALSE); ?></textarea></td>
    	</tr>
		</table>
		</fieldset>
		</div>
    ...
    <tr>
      ...
      <td class="wmtBody" style="width: 30%;"><input name="ge_nk_norm_exam" id="ge_nk_norm_exam" type="checkbox" value="1" <?php echo (($dt['ge_nk_norm_exam'] == 1)?' checked':''); ?> onChange="setGENeckNormal('<?php echo $client_id; ?>',this);" /><label for="ge_nk_norm_exam">Set Neck Exam Normal</label></td>
			<td><div name="tmp_ge_neck_button_disp" id="tmp_ge_neck_button_disp" style="float: left; display: <?php echo $dt['tmp_ge_neck_disp']; ?>;"><a href="javascript:;" tabindex="-1" class="css_button_small" onClick="clearGESection('<?php echo $client_id; ?>','ge_nk_');"><span>Clear</span></a></div></td>
		</tr>
		</table>
    ...
    <tr>
      ...
      <td class="wmtBody" style="width: 30%;"><input name="ge_thy_norm_exam" id="ge_thy_norm_exam" type="checkbox" value="1" <?php echo (($dt['ge_thy_norm_exam'] == 1)?' checked':''); ?> onChange="setGEThyroidNormal('<?php echo $client_id; ?>',this);" /><label for="ge_thy_norm_exam">Set Thyroid Exam Normal</label></td>
			<td><div name="tmp_ge_thyroid_button_disp" id="tmp_ge_thyroid_button_disp" style="float: left; display: <?php echo $dt['tmp_ge_thyroid_disp']; ?>;"><a href="javascript:;" tabindex="-1" class="css_button_small" onClick="clearGESection('<?php echo $client_id; ?>', 'ge_thy_');"><span>Clear</span></a></div></td>
		</tr>
		</table>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
    	...
    	<tr>
      	<td colspan="3"><textarea name="ge_thy_nt" id="ge_thy_nt" class="wmtFullInput" rows="3" onchange="document.getElementById('ge_thy_norm_exam').checked = false;" ><?php echo htmlspecialchars($dt{'ge_thy_nt'}, ENT_QUOTES, '', FALSE); ?></textarea></td>
    	</tr>
		</table>
		</fieldset>
		</div>
    ...
    <tr>
      ...
      <td class="wmtBody" style="width: 30%;"><input name="ge_lym_norm_exam" id="ge_lym_norm_exam" type="checkbox" value="1" <?php echo (($dt['ge_lym_norm_exam'] == 1)?' checked':''); ?> onChange="setGELymphNormal('<?php echo $client_id; ?>',this);" /><label for="ge_lym_norm_exam">Set Lymphadenopathy Exam Normal</label></td>
			<td><div name="tmp_ge_lymph_button_disp" id="tmp_ge_lymph_button_disp" style="float: left; display: <?php echo $dt['tmp_ge_lymph_disp']; ?>;"><a href="javascript:;" tabindex="-1" class="css_button_small" onClick="clearGESection('<?php echo $client_id; ?>', 'ge_lym_');"><span>Clear</span></a></div></td>
		</tr>
		</table>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
    	...
    	<tr>
      	<td colspan="3"><textarea name="ge_lym_nt" id="ge_lym_nt" class="wmtFullInput" rows="3" onchange="document.getElementById('ge_lym_norm_exam').checked = false;"><?php echo htmlspecialchars($dt{'ge_lym_nt'}, ENT_QUOTES, '', FALSE); ?></textarea></td>
    	</tr>
		</table>
		</fieldset>
		</div>
    ...
    <tr>
      ...
      <td class="wmtBody" style="width: 30%;"><input name="ge_br_norm_exam" id="ge_br_norm_exam" type="checkbox" value="1" <?php echo (($dt['ge_br_norm_exam'] == 1)?' checked':''); ?> onChange="setGEBreastNormal('<?php echo $client_id; ?>',this);" /><label for="ge_br_norm_exam">Set Breast Exam Normal</label></td>
			<td><div name="tmp_ge_breast_button_disp" id="tmp_ge_breast_button_disp" style="float: left; display: <?php echo $dt['tmp_ge_breast_disp']; ?>;"><a href="javascript:;" tabindex="-1" class="css_button_small" onClick="clearGESection('<?php echo $client_id; ?>', 'ge_br'); clearGESection('<?php echo $client_id; ?>', 'ge_nip'); "><span>Clear</span></a></div></td>
		</tr>
		</table>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
    	...
    	<tr>
      	<td colspan="3"><textarea name="ge_brr_nt" id="ge_brr_nt" class="wmtFullInput" rows="3" onchange="document.getElementById('ge_br_norm_exam').checked = false;"><?php echo htmlspecialchars($dt{'ge_brr_nt'}, ENT_QUOTES, '', FALSE); ?></textarea></td>
    	</tr>
    	<tr>
    	...
    	<tr>
      	<td colspan="3"><textarea name="ge_nipr_nt" id="ge_nipr_nt" class="wmtFullInput" rows="2" onchange="document.getElementById('ge_br_norm_exam').checked = false;"><?php echo htmlspecialchars($dt{'ge_nipr_nt'}, ENT_QUOTES, '', FALSE); ?></textarea></td>
    	</tr>
    	<tr>
    	...
    	<tr>
      	<td colspan="3"><textarea name="ge_brl_nt" id="ge_brl_nt" class="wmtFullInput" rows="3" onchange="document.getElementById('ge_br_norm_exam').checked = false;"><?php echo htmlspecialchars($dt{'ge_brl_nt'}, ENT_QUOTES, '', FALSE); ?></textarea></td>
    	</tr>
    	<tr>
    	...
    	<tr>
      	<td colspan="3"><textarea name="ge_nipl_nt" id="ge_nipl_nt" class="wmtFullInput" rows="2" onchange="document.getElementById('ge_br_norm_exam').checked = false;"><?php echo htmlspecialchars($dt{'ge_nipl_nt'}, ENT_QUOTES, '', FALSE); ?></textarea></td>
    	</tr>
		</table>
		</fieldset>
		</div>
    ...
    <tr>
      ...
      <td class="wmtBody" style="width: 30%;"><input name="ge_cr_norm_exam" id="ge_cr_norm_exam" type="checkbox" value="1" <?php echo (($dt['ge_cr_norm_exam'] == 1)?' checked':''); ?> onChange="setGECardioNormal('<?php echo $client_id; ?>',this);" /><label for="ge_cr_norm_exam">Set Cardiovascular Exam Normal</label></td>
			<td><div name="tmp_ge_cardio_button_disp" id="tmp_ge_cardio_button_disp" style="float: left; display: <?php echo $dt['tmp_ge_cardio_disp']; ?>;"><a href="javascript:;" tabindex="-1" class="css_button_small" onClick="clearGESection('<?php echo $client_id; ?>', 'ge_cr_');"><span>Clear</span></a></div></td>
		</tr>
		</table>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
    	...
    	<tr>
      	...
      	<td class="wmtBody wmtClick" onclick="toggleThroughSelect('ge_cr_mur'); document.getElementById('ge_cr_norm_exam').checked = false; " >Murmur&nbsp;&nbsp;
      	...
      	<td><input name="ge_cr_mur_nt" id="ge_cr_mur_nt" class="wmtFullInput" type="text" value="<?php echo htmlspecialchars($dt{'ge_cr_mur_nt'}, ENT_QUOTES, '', FALSE); ?>" onchange="document.getElementById('ge_cr_norm_exam').checked=false;" /></td>
    	</tr>
			<?php
    	...
    	<tr>
      	<td colspan="3"><textarea name="ge_cr_nt" id="ge_cr_nt" class="wmtFullInput" rows="3" onchange="document.getElementById('ge_cr_norm_exam').checked = false;"><?php echo htmlspecialchars($dt{'ge_cr_nt'}, ENT_QUOTES, '', FALSE); ?></textarea></td>
    	</tr>
		</table>
		</fieldset>
		</div>
    ...
    <tr>
      ...
      <td class="wmtBody" style="width: 30%;"><input name="ge_pul_norm_exam" id="ge_pul_norm_exam" type="checkbox" value="1" <?php echo (($dt['ge_pul_norm_exam'] == 1)?' checked':''); ?> onChange="setGEPulmoNormal('<?php echo $client_id; ?>',this);" /><label for="ge_pul_norm_exam">Set Pulmonary Exam Normal</label></td>
			<td><div name="tmp_ge_pulmo_button_disp" id="tmp_ge_pulmo_button_disp" style="float: left; display: <?php echo $dt['tmp_ge_pulmo_disp']; ?>;"><a href="javascript:;" tabindex="-1" class="css_button_small" onClick="clearGESection('<?php echo $client_id; ?>', 'ge_pul_');"><span>Clear</span></a></div></td>
		</tr>
		</table>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
    	<tr>
      	...
      	<td class="wmtBody" onclick="toggleThroughSelect('ge_pul_clear'); document.getElementById('ge_pul_norm_exam').checked = false; " >Clear to Auscultation</td>
      	<td class="wmtBody" style="width: 70%;">Notes:</td>
    	</tr>
			<?php
    ...
    <tr>
      ...
      <td class="wmtBody" style="width: 30%;"><input name="ge_gi_norm_exam" id="ge_gi_norm_exam" type="checkbox" value="1" <?php echo (($dt['ge_gi_norm_exam'] == 1)?' checked':''); ?> onChange="setGEGastroNormal('<?php echo $client_id; ?>',this);" /><label for="ge_gi_norm_exam">Set Gastrointestinal Exam Normal</label></td>
			<td><div name="tmp_ge_gastro_button_disp" id="tmp_ge_gastro_button_disp" style="float: left; display: <?php echo $dt['tmp_ge_gastro_disp']; ?>;"><a href="javascript:;" tabindex="-1" class="css_button_small" onClick="clearGESection('<?php echo $client_id; ?>', 'ge_gi_');"><span>Clear</span></a></div></td>
		</tr>
		</table>
    	...
    	<tr>
      	...
      	<td class="wmtBody"><span onclick="toggleThroughSelect('ge_gi_tend'); document.getElementById('ge_gi_norm_exam').checked = false; " >Tender&nbsp;&nbsp;</span><select name="ge_gi_tend_loc" id="ge_gi_tend_loc" class="Input" onchange="document.getElementById('ge_gi_norm_exam').checked = false;" >
					<?php ListSel($dt{'ge_gi_tend_loc'},'EE1_GI_Location'); ?>
				</select></td>
				<td><input name="ge_gi_tend_nt" id="ge_gi_tend_nt" class="wmtFullInput" type="text" value="<?php echo htmlspecialchars($dt{'ge_gi_tend_nt'}, ENT_QUOTES, '', FALSE); ?>" onchange="document.getElementById('ge_gi_norm_exam').checked=false;" /></td> 
    	</tr>
			<?php
    	...
    	<tr>
      	...
      	<td class="wmtBody" onclick="toggleThroughSelect('ge_gi_bowel'); document.getElementById('ge_gi_norm_exam').checked = false; " >Bowel Sounds&nbsp;&nbsp;
      	...
      	<td><input name="ge_gi_bowel_nt" id="ge_gi_bowel_nt" class="wmtFullInput" type="text" value="<?php echo htmlspecialchars($dt{'ge_gi_bowel_nt'}, ENT_QUOTES, '', FALSE); ?>" onchange="document.getElementById('ge_gi_norm_exam').checked=false;" /></td>
    	</tr>
			...
			<tr>
				<td class="wmtLabel">Notes:</td>
			<tr>
				<td colspan="3"><textarea name="ge_gi_nt" id="ge_gi_nt" class="wmtFullInput" rows="3" onchange="document.getElementById('ge_gi_norm_exam').checked = false;"><?php echo htmlspecialchars($dt{'ge_gi_nt'}, ENT_QUOTES, '', FALSE); ?></textarea></td>
			</tr>
		</table>
		</fieldset>
		</div>
    ...
    <tr>
      ...
      <td class="wmtBody" style="width: 30%;"><input name="ge_neu_norm_exam" id="ge_neu_norm_exam" type="checkbox" value="1" <?php echo (($dt['ge_neu_norm_exam'] == 1)?' checked':''); ?> onChange="setGENeuroNormal('<?php echo $client_id; ?>',this);" /><label for="ge_neu_norm_exam">Set Neurological Exam Normal</label></td>
			<td><div name="tmp_ge_neuro_button_disp" id="tmp_ge_neuro_button_disp" style="float: left; display: <?php echo $dt['tmp_ge_neuro_disp']; ?>;"><a href="javascript:;" tabindex="-1" class="css_button_small" onClick="clearGESection('<?php echo $client_id; ?>', 'ge_neu_');"><span>Clear</span></a></div></td>
		</tr>
		</table>
    	...
    	<tr>
				<td colspan="3"><textarea name="ge_neu_sense" id="ge_neu_sense" class="wmtFullInput" rows="3" onchange="document.getElementById('ge_neu_norm_exam').checked = false;"><?php echo htmlspecialchars($dt{'ge_neu_sense'}, ENT_QUOTES, '', FALSE); ?></textarea></td>
    	</tr>
		</table>
		</fieldset>
		</div>
    ...
    <tr>
      ...
      <td class="wmtBody" style="width: 30%;"><input name="ge_ms_norm_exam" id="ge_ms_norm_exam" type="checkbox" value="1" <?php echo (($dt['ge_ms_norm_exam'] == 1)?' checked':''); ?> onChange="setGEMuscNormal('<?php echo $client_id; ?>',this);" /><label for="ge_ms_norm_exam">Set Musculoskeletal/Back Exam Normal</label></td>
			<td><div name="tmp_ge_musc_button_disp" id="tmp_ge_musc_button_disp" style="float: left; display: <?php echo $dt['tmp_ge_musc_disp']; ?>;"><a href="javascript:;" tabindex="-1" class="css_button_small" onClick="clearGESection('<?php echo $client_id; ?>', 'ge_ms_');"><span>Clear</span></a></div></td>
		</tr>
		</table>
    	...
    	<tr>
				<td colspan="3"><textarea name="ge_ms_nt" id="ge_ms_nt" class="wmtFullInput" rows="4" onchange="document.getElementById('ge_ms_norm_exam').checked = false;"><?php echo htmlspecialchars($dt{'ge_ms_nt'}, ENT_QUOTES, '', FALSE); ?></textarea></td>
    	</tr>
		</table>
		</fieldset>
		</div>
    ...
    <tr>
      ...
      <td class="wmtBody" style="width: 30%;"><input name="ge_ext_norm_exam" id="ge_ext_norm_exam" type="checkbox" value="1" <?php echo (($dt['ge_ext_norm_exam'] == 1)?' checked':''); ?> onChange="setGEExtNormal('<?php echo $client_id; ?>',this);" /><label for="ge_ext_norm_exam">Set Extremities Exam Normal</label></td>
			<td><div name="tmp_ge_ext_button_disp" id="tmp_ge_ext_button_disp" style="float: left; display: <?php echo $dt['tmp_ge_ext_disp']; ?>;"><a href="javascript:;" tabindex="-1" class="css_button_small" onClick="clearGESection('<?php echo $client_id; ?>', 'ge_ext_');"><span>Clear</span></a></div></td>
		</tr>
		</table>
    	...
    	<tr>
      	...
      	<td class="wmtBody" onclick="toggleThroughSelect('ge_ext_edema'); document.getElementById('ge_ext_norm_exam').checked = false; " >Edema&nbsp;&nbsp;&nbsp;<select name="ge_ext_edema_chc" id="ge_ext_edema_chc" class="Input" style="display: <?php echo (($dt{'ge_ext_edema'} == 'y')? 'inline' : 'none'); ?>;" >
					<?php ListSel($dt{'ge_ext_edema_chc'},'Edema'); ?>
				</select></td>
      	<td style="width: 70%;"><input name="ge_ext_edema_nt" id="ge_ext_edema_nt" class="wmtFullInput" type="text" value="<?php echo htmlspecialchars($dt{'ge_ext_edema_nt'}, ENT_QUOTES, '', FALSE); ?>" onchange="document.getElementById('ge_ext_norm_exam').checked=false; "/></td>
			</tr>
    	...
    	<tr>
				<td colspan="3"><textarea name="ge_ext_nt" id="ge_ext_nt" class="wmtFullInput" rows="3" onchange="document.getElementById('ge_ext_norm_exam').checked = false;"><?php echo htmlspecialchars($dt{'ge_ext_nt'}, ENT_QUOTES, '', FALSE); ?></textarea></td>
    	</tr>
		</table>
		</fieldset>
		</div>
    ...
    <tr>
      ...
      <td class="wmtBody" style="width: 30%;"><input name="ge_db_norm_exam" id="ge_db_norm_exam" type="checkbox" value="1" <?php echo (($dt['ge_db_norm_exam'] == 1)?' checked':''); ?> onChange="setGEFootNormal('<?php echo $client_id; ?>',this);" /><label for="ge_db_norm_exam">Set Diabetic Foot Exam Normal</label></td>
			<td><div name="tmp_ge_dia_button_disp" id="tmp_ge_dia_button_disp" style="float: left; display: <?php echo $dt['tmp_ge_dia_disp']; ?>;"><a href="javascript:;" tabindex="-1" class="css_button_small" onClick="clearGESection('<?php echo $client_id; ?>', 'ge_db_');"><span>Clear</span></a></div></td>
			</div></td>
		</tr>
		</table>
    	...
    	<tr>
				<td colspan="3"><textarea name="ge_db_nt" id="ge_db_nt" class="wmtFullInput" rows="3" onchange="document.getElementById('ge_db_norm_exam').checked = false;"><?php echo htmlspecialchars($dt{'ge_db_nt'}, ENT_QUOTES, '', FALSE); ?></textarea></td>
    	</tr>
			</table>
		</fieldset>
		</div>
    ...
    <tr>
      ...
      <td class="wmtBody" style="width: 30%;"><input name="ge_te_norm_exam" id="ge_te_norm_exam" type="checkbox" value="1" <?php echo (($dt['ge_te_norm_exam'] == 1)?' checked':''); ?> onChange="setGETestesNormal('<?php echo $client_id; ?>',this);" /><label for="ge_te_norm_exam">Set Genitalia Exam Normal</label></td>
			<td><div name="tmp_ge_test_button_disp" id="tmp_ge_test_button_disp" style="float: left; display: <?php echo $dt['tmp_ge_test_disp']; ?>;"><a href="javascript:;" tabindex="-1" class="css_button_small" onClick="clearGESection('<?php echo $client_id; ?>', 'ge_te_');"><span>Clear</span></a></div></td>
		</tr>
		</table>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			if($pat_sex == 'm') {
				...
				EE1_GESelLine('ge_te','palp','Palpitation',$dt{'ge_te_palp'}, $dt{'ge_te_palp_nt'}, 'HardSoft');
    	...
    	<tr>
				<td colspan="3"><textarea name="ge_te_nt" id="ge_te_nt" class="wmtFullInput" rows="3" onchange="document.getElementById('ge_te_norm_exam').checked = false;"><?php echo htmlspecialchars($dt{'ge_te_nt'}, ENT_QUOTES, '', FALSE); ?></textarea></td>
    	</tr>
		</table>
		</fieldset>
		</div>
    ...
    <tr>
      ...
      <td class="wmtBody" style="width: 30%;"><input name="ge_rc_norm_exam" id="ge_rc_norm_exam" type="checkbox" value="1" <?php echo (($dt['ge_rc_norm_exam'] == 1)?' checked':''); ?> onChange="setGERectalNormal('<?php echo $pat_sex; ?>','<?php echo $client_id; ?>',this);" /><label for="ge_rc_norm_exam">Set Rectal Exam Normal</label></td>
			<td><div name="tmp_ge_rectal_button_disp" id="tmp_ge_rectal_button_disp" style="float: left; display: <?php echo $dt['tmp_ge_rectal_disp']; ?>;"><a href="javascript:;" tabindex="-1" class="css_button_small" onClick="clearGESection('<?php echo $client_id; ?>', 'ge_rc_');"><span>Clear</span></a></div></td>
		</tr>
		</table>
    	...
    	<tr>
				<td colspan="3"><textarea name="ge_rc_nt" id="ge_rc_nt" class="wmtFullInput" rows="3" onchange="document.getElementById('ge_rc_norm_exam').checked = false;"><?php echo htmlspecialchars($dt{'ge_rc_nt'}, ENT_QUOTES, '', FALSE); ?></textarea></td>
    	</tr>
		</table>
		</fieldset>
		</div>
    ...
    <tr>
      ...
      <td class="wmtBody" style="width: 30%;"><input name="ge_skin_norm_exam" id="ge_skin_norm_exam" type="checkbox" value="1" <?php echo (($dt['ge_skin_norm_exam'] == 1)?' checked':''); ?> onChange="setGESkinNormal('<?php echo $client_id; ?>',this);" /><label for="ge_skin_norm_exam">Set Skin Exam Normal</label></td>
			<td><div name="tmp_ge_skin_button_disp" id="tmp_ge_skin_button_disp" style="float: left; display: <?php echo $dt['tmp_ge_skin_disp']; ?>;"><a href="javascript:;" tabindex="-1" class="css_button_small" onClick="clearGESection('<?php echo $client_id; ?>', 'ge_skin_');"><span>Clear</span></a></div></td>
		</tr>
		</table>
    ...
    <tr>
			<td colspan="3"><textarea name="ge_skin_nt" id="ge_skin_nt" class="wmtFullInput" rows="4" onchange="document.getElementById('ge_skin_norm_exam').checked = false;"><?php echo htmlspecialchars($dt{'ge_skin_nt'}, ENT_QUOTES, '', FALSE); ?></textarea></td>
    </tr>
		</table>
		</fieldset>
		</div>
    ...
    <tr>
      ...
      <td class="wmtBody" style="width: 30%;"><input name="ge_psych_norm_exam" id="ge_psych_norm_exam" type="checkbox" value="1" <?php echo (($dt['ge_psych_norm_exam'] == 1)?' checked':''); ?> onChange="setGEPsychNormal('<?php echo $client_id; ?>',this);" /><label for="ge_psych_norm_exam">Set Psychiatric Exam Normal</label></td>
			<td><div name="tmp_ge_psych_button_disp" id="tmp_ge_psych_button_disp" style="float: left; display: <?php echo $dt['tmp_ge_psych_disp']; ?>;"><a href="javascript:;" tabindex="-1" class="css_button_small" onClick="clearGESection('<?php echo $client_id; ?>', 'ge_psych_');"><span>Clear</span></a></div></td>
		</tr>
		</table>
		<div id="tmp_ge_psych_disp" style="display: <?php echo $dt['tmp_ge_psych_disp']; ?>;">
		<input name="tmp_ge_psych_disp" id="tmp_ge_psych_disp" type="hidden" value="<?php echo $dt['tmp_ge_psych_disp']; ?>" />
		<fieldset style="margin: 5px; padding: 5px;">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<?php 
    	...
    	<tr>
				<td colspan="3"><textarea name="ge_psych_nt" id="ge_psych_nt" class="wmtFullInput" rows="4" onchange="document.getElementById('ge_psych_norm_exam').checked = false;"><?php echo htmlspecialchars($dt{'ge_psych_nt'}, ENT_QUOTES, '', FALSE); ?></textarea></td>
    	</tr>
    </table>
		</fieldset>
		</div>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			...
			<td><div style="float: left; padding-right: 10px;"><a class="css_button_small" tabindex="-1" onClick="showAllExamSections('<?php echo $pat_sex; ?>');" href="javascript:;"><span>Show ALL Sections</span></a></div>&nbsp;&nbsp;&nbsp;&nbsp;
			<div style="float: right; padding-right: 10px;"><a class="css_button_small" tabindex="-1" onClick="hideAllExamSections('<?php echo $pat_sex; ?>');" href="javascript:;"><span>Hide ALL Sections</span></a></div>
			<!-- div style="float: left; padding-right: 10px;"><a class="css_button_small" href="javascript:;" onclick="wmtOpen('../../../custom/document_popup.php?pid=<?php echo $pid; ?>', '_blank', 800, 600);"><span>View Documents</span></a></div --></td>
		</tr>
		</table>
<?php 
} // END OF DRAW DISPLAY
