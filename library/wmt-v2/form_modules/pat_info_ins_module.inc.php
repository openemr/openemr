...
$local_fields = array('DOB', 'age', 'race', 'status', 
	...
	'state', 'postal_code', 'phone_home', 'phone_biz', 'phone_cell', $email_field);
...
<table width="100%"	border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse; padding: 0px;">
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
			<tr>
				<td colspan="3"><span class="wmtLabel2">E-mail</span><input name="<?php echo $field_prefix . $email_field; ?>" id="<?php echo $field_prefix . $email_field; ?>" type="text" class="wmtFullInput" value="<?php echo attr($dt[$field_prefix.$email_field]); ?>" /></td>
