...
$local_fields = array('DOB', 'age', 'race', 'status', 
	...
	'phone_home', 'phone_biz', 'phone_cell', $email_field, 'fyi');
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td colspan="2" class="wmtBody"><span class="wmtBody4">E-mail</span><input name="<?php echo $field_prefix . $email_field; ?>" id="<?php echo $field_prefix . $email_field; ?>" type="text" class="wmtFullInput2" value="<?php echo attr($dt{$field_prefix.$email_field}); ?>" /></td>
			</tr>
