...
function DateToYYYYMMDD_js(value){
    ...
    var date_display_format = <?php echo js_escape((empty(\OpenEMR\Core\OEGlobalsBag::getInstance()->get('date_display_format')) ? 0 : \OpenEMR\Core\OEGlobalsBag::getInstance()->get('date_display_format'))) ?>;
