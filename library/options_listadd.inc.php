...
<script>
    ...
    var stateCustomFlag = <?php echo json_encode(\OpenEMR\Core\OEGlobalsBag::getInstance()->get('state_custom_addlist_widget')); ?>;
...
$(function () {
    ...
    //  Second, validate form specific fields
        ...
        // the new list item
        $.getJSON("<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('webroot'); ?>/library/ajax/addlistitem.php",
