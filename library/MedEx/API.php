...
class Display extends base
{
    public function navigation($logged_in)
    {
        ...
        <div id="hide_nav" style="<?php if ($setting_bootstrap_submenu == 'hide') {
            ...
            <nav id="navbar_oe" class="navbar navbar-expand-sm p-0 ps-1" name="kiosk_hide" data-role="page banner navigation">
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#oer-navbar-collapse-1" aria-controls="oer-navbar-collapse-1" aria-expanded="false" aria-label="Toggle navigation">
                    ...
                    <ul class="navbar-nav">
                        <?php if ($GLOBALS['medex_enable'] == '1') { ?>
                            <li class="nav-item dropdown">
                                <a class="nav-link" data-bs-toggle="dropdown" id="menu_dropdown_file" role="button" aria-expanded="true"><?php echo xlt("File"); ?> </a>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link" data-bs-toggle="dropdown" id="menu_dropdown_msg" role="button" aria-expanded="true"><?php echo xlt("Messages"); ?> </a>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link" data-bs-toggle="dropdown" id="menu_dropdown_recalls" role="button" aria-expanded="true"><?php echo xlt("Appt. Reminders"); ?></a>
                            ...
                            if ($logged_in) {
                                ?>
                                <li class="dropdown-divider"></li>
                                <li id="menu_pend_recalls" name="menu_pend_recalls"> <a href='https://medexbank.com/cart/upload/index.php?route=information/campaigns&g=rem' target="_medex" class='dropdown-item nowrap text-start' id="BUTTON_pend_recalls_menu"> <?php echo xlt("Reminder Campaigns"); ?></a></li>
                                    <?php
                            }
                            ?>
                            </ul>
                                ...
                                if ($GLOBALS['disable_rcb'] != '1') { ?>
                                    <li class="nav-item dropdown">
                                        <a class="nav-link" data-bs-toggle="dropdown" id="menu_dropdown_recalls" role="button" aria-expanded="true"><?php echo xlt("Patient Recalls"); ?> </a>
                                        <ul class="bgcolor2 dropdown-menu" aria-labelledby="menu_dropdown_recalls">
                                        ...
                                        if ($logged_in) {
                                            ?>
                                            <li class="dropdown-divider"></li>
                                            <li id="menu_pend_recalls" name="menu_pend_recalls"> <a href='https://medexbank.com/cart/upload/index.php?route=information/campaigns&g=rec' target="_medex" class='dropdown-item nowrap text-start' id="BUTTON_pend_recalls_menu"> <?php echo xlt("Recall Campaigns"); ?></a></li>
                                            <?php
                                        }
                                        ?>
                                        </ul>
                                            ...
                                            <div class="divTableRow">
                                                ...
                                                <div class="divTableRow">
                                                    ...
                                                    <input type="checkbox" class="update" name="LABELS_local" id="LABELS_local" value="1" <?php if ($prefs['LABELS_local']) {
                                                            echo "checked='checked'";} ?> />
                                                        <label for="LABELS_local" class="input-helper input-helper--checkbox" data-bs-toggle='tooltip' data-placement='auto' title='<?php echo xla('Check if you plan to use Avery Labels for Reminders or Recalls'); ?>'>
                                                ...
                                                <div class="divTableRow">
                                                    ...
                                                    <!--
                                                        <input type="checkbox" class="update" name="POSTCARDS_local" id="POSTCARDS_local" value="1" <?php if ($prefs['POSTCARDS_local']) {
                                                            echo "checked='checked'";} ?>" />
                                                        <label for="POSTCARDS_local" name="POSTCARDS_local" class="input-helper input-helper--checkbox" data-bs-toggle='tooltip' data-placement='auto'  title='<?php echo xla('Check if you plan to print postcards locally'); ?>'><?php echo xlt('Print locally'); ?></label><br />
                                                        <input type="checkbox" class="update" name="POSTCARDS_remote" id="POSTCARDS_remote" value="1" <?php if ($prefs['POSTCARDS_remote']) {
                                                            echo "checked='checked'";} ?>" />
                                                        <label for="POSTCARDS_remote" name="POSTCARDS_remote" class="input-helper input-helper--checkbox" data-bs-toggle='tooltip' data-placement='auto'  title='<?php echo xla('Check if you plan to send postcards via MedEx'); ?>'><?php echo xlt('Print remotely'); ?></label>
                                                    -->
                                                        <label for="postcards_top" data-bs-toggle="tooltip" data-placement="auto" title="<?php echo xla('Custom text for Flow Board postcards. After changing text, print samples before printing mass quantities!'); ?>"><u><?php echo xlt('Custom Greeting'); ?>:</u></label><br />
    ...
    <div class="container text-center">
            <div class="showRecalls mx-auto" id="show_recalls">
                ...
                <span class="text-end fa-stack fa-lg pull_right small" id="rcb_caret" onclick="toggleRcbSelectors();" data-bs-toggle="tooltip" data-placement="auto" title="Show/Hide the Filters" style="color: <?php echo $color = (!empty($setting_selectors) && ($setting_selectors == 'none')) ? 'var(--danger)' : 'var(--black)'; ?>; position: relative; float: right; right: 0; top: 0;">
    ...
    private function recall_board_process($logged_in, $recalls, $events = '')
    {
        ...
        foreach ($recalls as $recall) {
            ...
            if ($GLOBALS['ptkr_show_pid']) {
                echo '<br /><span data-bs-toggle="tooltip" data-placement="auto" title="' . xla("Patient ID") . '" class="small">' . xlt('PID') . ': ' . text($recall['pid']) . '</span>';
            }
            echo '<br /><span data-bs-toggle="tooltip" data-placement="auto" title="' . xla("Most recent visit") . '" class="small">' . xlt("Last Visit") . ': ' . text(oeFormatShortDate($last_visit)) . '</span>';
            echo '<br /><span class="small" data-bs-toggle="tooltip" data-placement="auto" title="' . xla("Date of Birth and Age") . '">' . xlt('DOB') . ': ' . text($DOB) . ' (' . $age . ')</span>';
            echo '</td>';
            ...
            if ($count_providers > '1') {
                echo "<br /><span data-bs-toggle='tooltip' data-placement='auto'  title='" . xla('Provider') . "'>" . text($provider[$recall['r_provider']]) . "</span>";
            }
            if (( $count_facilities > '1' ) && ( $_REQUEST['form_facility'] == '' )) {
                echo "<br /><span data-bs-toggle='tooltip' data-placement='auto'  title='" . xla('Facility') . "'>" . text($facility[$recall['r_facility']]) . "</span><br />";
            }
            ...
            if ($recall['email'] > '') {
                ...
                echo 'E: <a data-bs-toggle="tooltip" data-placement="auto" title="' . xla('Send an email to ') . attr($mailto) . '" href="mailto:' . attr($mailto) . '">' . text($recall['email']) . '</a><br />';
            }
            if ($logged_in) {
            ...
            echo '    <span data-bs-toggle="tooltip" data-placement="auto" title="' . xla('Scheduling') . '" class="fa fa-calendar-check-o fa-fw" onclick="newEvt(\'' . attr($recall['pid']) . '\',\'\');">
                </span>';
            echo '</td>';

            echo '  <td class="divTableCell text-start msg_resp">';
            ...
            if ($show['appt']) {
                echo "<span onclick=\"newEvt('" . attr($prog['pid']) . "','" . attr($show['pc_eid']) . "');\" class='btn btn-danger text-center' data-bs-toggle='tooltip' data-placement='auto'  title='" . xla('Appointment made by') . " " . attr($prog['who']) . " " . xla('on') . " " . attr($prog['when']) . "'><b>" . xlt('Appt{{Abbreviation for appointment}}') . ":</b> " . text($show['appt']) . "<br />";
            }
            echo '</td>';
            echo '</tr>';
            $content = ob_get_clean();
    ...
    public function show_progress_recall($recall, $events = '')
    {
        ...
        while ($progress = sqlFetchArray($result)) {
            ...
            if (is_numeric($progress['msg_reply'])) { // it was manually added by id
                ...
                if ($progress['msg_type'] == 'phone') { //ie. a manual phone call, not an AVM
                    $show['progression'] .= "<span class='left' data-bs-toggle='tooltip' data-placement='auto'  title='" . xla('Phone call made by') . " " . text($who_name) . "'><b>" . xlt('Phone') . "</b> " . text($when) . "</span></br />\n";
                } elseif ($progress['msg_type'] == 'notes') {
                    $show['progression'] .= "<span class='left' data-bs-toggle='tooltip' data-placement='auto'  title='" . xla('Notes by') . " " . text($who_name) . " on " . text($when) . "'><b>" . xlt('Note') . ":</b> " . text($progress['msg_extra_text']) . "</span></br />\n";
                } elseif ($progress['msg_type'] == 'postcards') {
                    $show['progression'] .= "<span class='left' data-bs-toggle='tooltip' data-placement='auto'  title='" . xla('Postcard printed by') . " " . text($who_name) . "'><b>" . xlt('Postcard') . ":</b> " . text($when) . "</span></br />\n";
                } elseif ($progress['msg_type'] == 'labels') {
                    $show['progression'] .= "<span class='left' data-bs-toggle='tooltip' data-placement='auto'  title='" . xla('Label printed by') . " " . text($who) . "'><b>" . xlt('Label') . ":</b> " . text($when) . "</span></br />";
                }
            } else {
                $who_name = "MedEx";
        ...
        if (is_countable($events)) {
            foreach ($events as $event) {
                ...
                $show['progression'] .= "<a href='https://medexbank.com/cart/upload/index.php?route=information/campaigns' class='nowrap text-start' target='_MedEx'>" .
            ...
            <form class="prefs p-4 row" name="addRecall" id="addRecall">
                ...
                <div class="col-4 divTable m-2 ms-auto">
                    <div class="row divTableBody prefs">
                            <div class="divTableCell divTableHeading text-end mb-3 col-4 col-md-4"><label><?php echo xlt('Name'); ?></label></div>
                    ...
                    <div class="row divTableBody prefs">
                        ...
                        <div class="mb-3 col-8 col-md-8 divTableCell indent20">
                            ...
                            <span class="fw-bold"> <?php echo xlt('Date'); ?>:</span>
                ...
                <div class="col-4 divTable m-2 me-auto">
                    <div class="row divTableBody prefs">
                        <div class="text-end btn-group-vertical mb-3 col-4 col-md-4 divTableCell divTableHeading">
                    ...
                    <div class="row divTableBody prefs">
                        <div class="text-end btn-group-vertical mb-3 col-4 col-md-4 divTableCell divTableHeading">
                            <label data-bs-toggle="tooltip" data-placement="top" title="<?php echo xla('Text Message permission'); ?>"><?php echo xlt('SMS OK'); ?></label>
                        </div>
                    ...
                    <div class="row divTableBody prefs">
                        <div class="text-end btn-group-vertical mb-3 col-4 col-md-4 divTableCell divTableHeading">
                            <label data-bs-toggle="tooltip" data-placement="top" title="<?php echo xla('Automated Voice Message permission'); ?>"><?php echo xlt('AVM OK'); ?></label>
                        </div>
                        <div class="divTableCell indent20 mb-3 col-8 col-md-8 form-check-inline">
    ...
    public function MedExBank($stage)
    {
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <form name="medex_start" id="medex_start" class="mb-4 bg-light rounded-3 p-5">
                        <div id="setup_1">
                            ...
                            <div id="ihvread" name="ihvread" class="text-start showReminders">
                                <input type="checkbox" class="updated required" name="TERMS_yes" id="TERMS_yes" required />
                                <label for="TERMS_yes" class="input-helper input-helper--checkbox" data-bs-toggle="tooltip" data-placement="auto" title="Terms and Conditions"><?php echo xlt('I have read and my practice agrees to the'); ?>
                                ...
                                <label for="BusAgree_yes" class="input-helper input-helper--checkbox" data-bs-toggle="tooltip" data-placement="auto" title="BAA"><?php echo xlt('I have read and accept the'); ?>
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header text-white fw-bold" style="background-color: #0d4867;">
                                                <button type="button" class="close text-white" data-bs-dismiss="modal" style="opacity:1;box-shadow:unset !important;">&times;</button>
                                            ...
                                            <div class="modal-body" style="padding: 10px 45px;">
                                                <p>You are opening a secure connection to MedExBank.com.  During this step your EHR will synchronize with the MedEx servers.  <br />
                                                    ...
                                                    <ul class="text-start mx-auto" style="width: 90%;">
        ...
        $(function () {
            ...
            $("#actualSignUp").click(function() {
                ...
                var email = $("#new_email").val();
                $("#actualSignUp").html('<i class="fa fa-spinner fa-pulse fa-fw"></i><span class="visually-hidden">Loading...</span>');
