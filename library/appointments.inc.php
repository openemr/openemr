...
{
    if (\OpenEMR\Core\OEGlobalsBag::getInstance()->has('calendar_interval')) {
        return \OpenEMR\Core\OEGlobalsBag::getInstance()->get('calendar_interval') * 60;
    }
                ...
                if ($appointments[$j]['uprovider_id'] == $provider_id) {
                    ...
                    if (
                        ...
                        if ($appointments[$i]['pc_duration'] == 0) {
                            $next_appointment_time = \OpenEMR\Core\OEGlobalsBag::getInstance()->get('schedule_end') . ":00";
                        } else {
                            $next_appointment_time = $appointments[$i]['pc_endTime'];
                        }
                    } else {
