...
class PatInstModule extends BaseModule {
	/**
	...
	public function __construct(&$sec_data, &$form_data) {
		if (!$sec_data || !$sec_data['key'])
			throw new \Exception('wmtPatInstModule::No module key provided for construct.');
		...
		<div class='wmtMainContainer wmtColorMain'>
			...
			<div id='<?php echo $this->key ?>Box' class='wmtCollapseBox wmtColorBox' style='display:<?php echo $this->toggle ?>'>
				<div class="wmtLabel" style="position:absolute;float:right;right:30px">
					<a class="css_button nolock" tabindex="-1" onClick="ajaxPrint('inst');return false;" href="javascript:;"><span>Printable Instructions</span></a>
				</div><br>
				...
				<table style="width:100%;margin-top:15px">
					<tr>
						...
						<td>
						<?php 
						if($use_snippets && isSnippetModule('inst_notes')) {
							$field_prefix = '';
							$field_name = 'inst_notes';
					...
					<tr>
						<td colspan="4">
							<textarea name="inst_notes" id="inst_notes" class="wmtFullInput" rows="4"><?php echo $this->form_data->inst_notes; ?></textarea>
						</td>
					</tr>
				</table>
			</div>
...
<?php }
	...
	public function report() { 
		if (empty($this->form_data->inst_notes)) return; ?>
				...
				<table class='wmtPrnContent'>
					...
					<tr>
						<td style='line-height:14px' colspan="2">
							<span class='wmtPrnLabel'>Patient / Parent Instructions:</span>
						</td>
					</tr><tr>
						<td style="width:25px"></td><td style='line-height:14px'>
							<span class='wmtPrnBody'><?php echo $this->form_data->inst_notes . "\n"; ?></span>
						</td>
					</tr>
...
<?php }
	...
	public function store() {
		...
		// Push data to form
		$this->form_data->inst_notes = strip_tags($dt['inst_notes']);
