...
class PediAROSModule extends BaseModule {
	/**
	...
	public function __construct(&$sec_data, &$form_data) {
		if (!$sec_data || !$sec_data['key'])
			throw new \Exception('wmtPediAROSModule::No module key provided for construct.');
