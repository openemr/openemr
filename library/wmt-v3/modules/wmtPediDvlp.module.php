...
class PediDvlpModule extends BaseModule {
	...
	public function __construct(&$sec_data, &$form_data) {
		if (!$sec_data || !$sec_data['key'])
			throw new \Exception('wmtPediDvlpModule::No module key provided for construct.');
...
?>
					<tr>
						<td class="wmtGroup" style="padding-top:10px" colspan="6">Developmental Notes:</td>
					</tr>
					<tr>
						<td colspan="6">
							<textarea class="wmtFullInput" rows="4" name="agui_notes"><?php echo $this->form_data->dvlp_notes ?></textarea>
						</td>
					</tr>
				</table>
			</div>
