<?php
/**
 * Custom translations for ckeditor
 *
 * Only translating applicable terms to prevent bad performance.
 *
 * @package OpenEMR
...
CKEDITOR.lang['en']=
    ...
    "basicstyles":
    {
    	"bold":"<?php echo xla('Bold'); ?>",
    	"italic":"<?php echo xla('Italic'); ?>",
    	"strike":"<?php echo xla('Strikethrough'); ?>",
    	"subscript":"<?php echo xla('Subscript'); ?>",
    	"superscript":"<?php echo xla('Superscript'); ?>",
    	"underline":"<?php echo xla('Underline'); ?>"
    },
    "bidi":
    {
    ...
    "wsc":
    {
    	...
    	"noMispell":"Spell check complete: No misspellings found","noSuggestions":"- No suggestions -",
    	"notAvailable":"Sorry, but service is unavailable now.",
    	"notInDic":"Not in dictionary",
    	"oneChange":"Spell check complete: One word changed",
    	"progress":"Spell check in progress...",
    	"title":"Spell Checker","toolbar":"Check Spelling"
    }
};
</script>