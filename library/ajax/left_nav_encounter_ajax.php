...
top.left_nav.setPatient(<?php echo js_escape(($prow['fname']) . " " . ($prow['lname'])) .
  "," . js_escape($pid) . "," . js_escape($prow['pubpid']) .
  ",''," . js_escape(" " . xl('DOB') . ": " . oeFormatShortDate($prow['DOB_YMD']) . " " . xl('Age') . ": " . getPatientAge($prow['DOB_YMD'])); ?>);
