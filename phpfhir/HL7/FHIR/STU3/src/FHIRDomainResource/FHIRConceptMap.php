...
class FHIRConceptMap extends FHIRDomainResource implements \JsonSerializable
{
     ...
     * @var \HL7\FHIR\STU3\FHIRResource\FHIRConceptMap\FHIRConceptMapGroup[]
     */
    public $group = [];
    ...
    /**
     * @param \HL7\FHIR\STU3\FHIRElement\FHIRUri $targetUri
     * @return $this
     */
    ...
    /**
     * A group of mappings that all have the same source and target system.
     * @return \HL7\FHIR\STU3\FHIRResource\FHIRConceptMap\FHIRConceptMapGroup[]
     */
    ...
    /**
     * A group of mappings that all have the same source and target system.
     * @param \HL7\FHIR\STU3\FHIRResource\FHIRConceptMap\FHIRConceptMapGroup $group
     * @return $this
     */
    ...
    {
        if (null === $sxe) {
            $sxe = new \SimpleXMLElement('<ConceptMap xmlns="https://hl7.org/fhir"></ConceptMap>');
        }
