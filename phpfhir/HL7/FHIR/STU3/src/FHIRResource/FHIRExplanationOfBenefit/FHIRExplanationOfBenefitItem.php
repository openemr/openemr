...
class FHIRExplanationOfBenefitItem extends FHIRBackboneElement implements \JsonSerializable
{
     ...
     * @var \HL7\FHIR\STU3\FHIRResource\FHIRExplanationOfBenefit\FHIRExplanationOfBenefitDetail[]
     */
    public $detail = [];
    ...
    /**
     * Second tier of goods and services.
     * @return \HL7\FHIR\STU3\FHIRResource\FHIRExplanationOfBenefit\FHIRExplanationOfBenefitDetail[]
     */
    ...
    /**
     * Second tier of goods and services.
     * @param \HL7\FHIR\STU3\FHIRResource\FHIRExplanationOfBenefit\FHIRExplanationOfBenefitDetail $detail
     * @return $this
     */
    ...
    {
        if (null === $sxe) {
            $sxe = new \SimpleXMLElement('<ExplanationOfBenefitItem xmlns="https://hl7.org/fhir"></ExplanationOfBenefitItem>');
        }
