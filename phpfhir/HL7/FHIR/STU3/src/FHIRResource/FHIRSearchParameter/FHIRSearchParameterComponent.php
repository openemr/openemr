<?php namespace HL7\FHIR\STU3\FHIRResource\FHIRSearchParameter;
 ...
 */
class FHIRSearchParameterComponent extends FHIRBackboneElement implements \JsonSerializable
{
    /**
     ...
     * @var string
     */
    private $_fhirElementName = 'SearchParameter.Component';
