...
class FHIRTestScriptRule1 extends FHIRBackboneElement implements \JsonSerializable
{
     ...
     * @var \HL7\FHIR\STU3\FHIRResource\FHIRTestScript\FHIRTestScriptParam1[]
     */
    public $param = [];
     ...
     * @var string
     */
    private $_fhirElementName = 'TestScript.Rule1';
    ...
    /**
     * Each rule template can take one or more parameters for rule evaluation.
     * @return \HL7\FHIR\STU3\FHIRResource\FHIRTestScript\FHIRTestScriptParam1[]
     */
    ...
    /**
     * Each rule template can take one or more parameters for rule evaluation.
     * @param \HL7\FHIR\STU3\FHIRResource\FHIRTestScript\FHIRTestScriptParam1 $param
     * @return $this
     */
    ...
    {
        if (null === $sxe) {
            $sxe = new \SimpleXMLElement('<TestScriptRule1 xmlns="https://hl7.org/fhir"></TestScriptRule1>');
        }
