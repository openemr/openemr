 ...
 */
class FHIRTestScriptParam2 extends FHIRBackboneElement implements \JsonSerializable
{
    /**
     ...
     * @var string
     */
    private $_fhirElementName = 'TestScript.Param2';
    ...
    {
        if (null === $sxe) {
            $sxe = new \SimpleXMLElement('<TestScriptParam2 xmlns="https://hl7.org/fhir"></TestScriptParam2>');
        }
