...
class FHIRTestScriptTest extends FHIRBackboneElement implements \JsonSerializable
{
     ...
     * @var \HL7\FHIR\STU3\FHIRResource\FHIRTestScript\FHIRTestScriptAction1[]
     */
    public $action = [];
    ...
    /**
     * Action would contain either an operation or an assertion.
     * @return \HL7\FHIR\STU3\FHIRResource\FHIRTestScript\FHIRTestScriptAction1[]
     */
    ...
    /**
     * Action would contain either an operation or an assertion.
     * @param \HL7\FHIR\STU3\FHIRResource\FHIRTestScript\FHIRTestScriptAction1 $action
     * @return $this
     */
    ...
    {
        if (null === $sxe) {
            $sxe = new \SimpleXMLElement('<TestScriptTest xmlns="https://hl7.org/fhir"></TestScriptTest>');
        }
