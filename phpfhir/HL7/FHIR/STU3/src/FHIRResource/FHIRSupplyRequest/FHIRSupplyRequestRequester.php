<?php namespace HL7\FHIR\STU3\FHIRResource\FHIRSupplyRequest;
 ...
 */
class FHIRSupplyRequestRequester extends FHIRBackboneElement implements \JsonSerializable
{
    /**
     ...
     * @var string
     */
    private $_fhirElementName = 'SupplyRequest.Requester';
    ...
    {
        if (null === $sxe) {
            $sxe = new \SimpleXMLElement('<SupplyRequestRequester xmlns="https://hl7.org/fhir"></SupplyRequestRequester>');
        }
