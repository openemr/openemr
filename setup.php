...
STP5TOP;
                        ...
                        $short_tag_style = strcmp($short_tag, 'Off') ? '' : 'text-danger';
                        $display_errors = ini_get('display_errors') ? 'On' : 'Off';
                        $display_errors_style = strcmp($display_errors, 'Off') ? '' : 'text-danger';
                        $register_globals = ini_get('register_globals') ? 'On' : 'Off';
                        $register_globals_style = strcmp($register_globals, 'Off') ? '' : 'text-danger';
                        ...
                        $max_input_time_style = strcmp($max_input_time, '-1') ? '' : 'text-danger';
                        ...
                        $mysqli_allow_local_infile_style = strcmp($mysqli_allow_local_infile, 'On') ? '' : 'text-danger';
