...
<li>The OpenEMR project home page, documentation, and forums can be found at <a href = "http://www.open-emr.org" rel='noopener' target="_blank">http://www.open-emr.org</a></li>
...
<TR VALIGN='TOP'><TD><span class='text'>Password: </span></TD><TD><INPUT TYPE='PASSWORD' VALUE='' NAME='pass' SIZE='30' minlength=12></TD><TD><span class='text'>(This is the Login Password for when PHP accesses MySQL - it should be at least 12 characters long and composed of both numbers and letters)</span><br></TD></TR>\n";
            if ($inst != 2) {
...
<TR VALIGN='TOP' class='noclone'><TD><span class='text'>Initial User Password:</span></TD><TD><INPUT SIZE='30' TYPE='PASSWORD' NAME='iuserpass' VALUE='' minlength=12></TD><TD><span class='text'>(This is the password for the initial user account above - it should be at least 12 characters long.)</span></TD></TR>
