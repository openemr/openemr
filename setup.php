...
ENDDIV;
            ...
            switch ($state) {
                case 1:
                    ...
                    $csrf_id_esc = attr((string) CsrfUtils::collectCsrfToken($session, 'state2'));
                    $step1 = <<<STP1
...
STP1;
                ...
                case 2:
                    ...
                    $site_id_esc = attr($site_id);
                    $inst_esc = attr($inst);
                    $csrf_id_esc = attr((string) CsrfUtils::collectCsrfToken($session, 'state3'));
                    $step2top = <<<STP2TOP
                ...
                case 3:
                    ...
                    if (!$pass_step2_validation) {
                        ...
                        <form method='post' id='validate-error'>
                            ...
                            <input name='csrf_token_form' type='hidden' value='" . attr((string) CsrfUtils::collectCsrfToken($session, 'state2')) . "' />
...
TOTP;
                    ...
                    echo "<form method='post'>
                          ...
                          <input name='csrf_token_form' type='hidden' value='" . attr((string) CsrfUtils::collectCsrfToken($session, 'state' . $next_state)) . "' />
                          <input name='site' type='hidden' value='" . attr($site_id) . "' />
...
STP4TOP;
                    ...
                    <form method='post'>
                        ...
                        <input name='csrf_token_form' type='hidden' value='" . attr((string) CsrfUtils::collectCsrfToken($session, 'state5')) . "' />
                ...
                case 5:
                    ...
                    <form method='post'>
                        ...
                        <input name='csrf_token_form' type='hidden' value='" . attr((string) CsrfUtils::collectCsrfToken($session, 'state6')) . "' />
                        <input type='hidden' name='site' value='" . attr($site_id) . "' />
                        <input type='hidden' name='iuser' value='" . attr($installer->iuser) . "' />
                        <input type='hidden' name='iuserpass' value='" . attr($installer->iuserpass) . "' />
                        <input name='login' type='hidden' value='" . attr($installer->login) . "' />
                ...
                case 6:
                    ...
                    <div class='col-12'>
                        <form method='post'>
                            ...
                            <input name='csrf_token_form' type='hidden' value='" . attr((string) CsrfUtils::collectCsrfToken($session, 'state7')) . "' />
                            <input type='hidden' name='site' value='" . attr($site_id) . "' />
                            <input type='hidden' name='iuser' value='" . attr($installer->iuser) . "' />
                            <input type='hidden' name='iuserpass' value='" . attr($installer->iuserpass) . "' />
                            <input name='login' type='hidden' value='" . attr($installer->login) . "' />
...
CHKDIR;
                        ...
                        $site_id_esc = attr($site_id);
                        $csrf_id_esc = attr((string) CsrfUtils::collectCsrfToken($session, 'state1'));
                        $form = <<<FRM
