...
final class Version20260000020125 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $table->addColumn('diagnoses', Types::TEXT, ['notnull' => false, 'length' => 65535, 'comment' => 'diagnoses and maybe other coding (e.g. ICD9:111.11)']);
        $this->addBooleanColumn($table, 'do_not_send', default: false, comment: '0 = normal, 1 = do not transmit to lab');
        ...
        $this->addPrimaryKey($table, 'procedure_order_id', 'procedure_order_seq');
