 ...
 * Gacl aro map table
 */
final class Version20260000010029 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Create gacl_aro_map table';
    }

    public function up(Schema $schema): void
    {
        $table = $schema->createTable('gacl_aro_map');
