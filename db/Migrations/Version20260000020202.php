...
final class Version20260000020202 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $table->addColumn('onetime_token', Types::TEXT);
        $table->addColumn('redirect_url', Types::TEXT);
        ...
        $table->addColumn('scope', Types::TEXT, ['comment' => 'context scope for this token']);
        $table->addColumn('profile', Types::TEXT, ['comment' => 'profile of scope for this token']);
        $table->addColumn('onetime_actions', Types::TEXT, ['comment' => 'JSON array of actions that can be performed with this token']);
