...
final class Version20260000020007 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $table->addColumn('approval_status', CustomTypes::TINYINT, ['comment' => '1-Pending,2-Approved,3-Denied,4-Appointment directly updated to calendar table,5-Cancelled appointment']);
        ...
        $table->addColumn('type', CustomTypes::TINYINT, ['comment' => '1-new patient,2-existing patient,3-change is only in the document,4-Patient upload,5-random key,10-Appointment']);
