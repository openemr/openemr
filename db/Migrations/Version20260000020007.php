...
final class Version20260000020007 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addBooleanColumn($table, 'is_qrda_document', default: false, notnull: false);
        $this->addBooleanColumn($table, 'is_unstructured_document', default: false, notnull: false);
