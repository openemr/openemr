...
final class Version20260000020065 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $table->addColumn('data_type', CustomTypes::TINYINT, ['length' => 3, 'default' => 0]);
        ...
        $table->addColumn('titlecols', CustomTypes::TINYINT, ['length' => 3, 'default' => 1]);
        $table->addColumn('datacols', CustomTypes::TINYINT, ['length' => 3, 'default' => 1]);
        ...
        $table->addColumn('conditions', Types::TEXT, ['notnull' => false, 'length' => 65535, 'comment' => 'serialized array of skip conditions']);
