...
final class Version20260000020073 extends AbstractMigration
{
    ...
    {
        $table = new Table('module_configuration');
        ...
        $table->addColumn('date_modified', Types::DATETIME_MUTABLE, ['notnull' => false, 'comment' => 'Datetime the record was last modified', 'default' => 'CURRENT_TIMESTAMP']);
        $table->addColumn('date_created', Types::DATETIME_MUTABLE, [
            'notnull' => false,
            'default' => null,
            'comment' => 'Datetime the record was created',
        ]);
        $this->addPrimaryKey($table, 'module_config_id');
