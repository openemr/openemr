...
final class Version20260000020086 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addBooleanColumn($table, 'active', default: true, comment: '1 if active and 0 if not active');
        ...
        $this->addBooleanColumn($table, 'voice_status', default: false, comment: '0 if not sent and 1 if sent');
        $this->addBooleanColumn($table, 'sms_status', default: false, comment: '0 if not sent and 1 if sent');
        $this->addBooleanColumn($table, 'email_status', default: false, comment: '0 if not sent and 1 if sent');
        $this->addBooleanColumn($table, 'mail_status', default: false, comment: '0 if not sent and 1 if sent');
