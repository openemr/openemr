...
final class Version20260000020163 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addBooleanColumn($table, 'active', default: null, notnull: false);
        $this->addBooleanColumn($table, 'diagnosis_reporting', notnull: false);
        $this->addBooleanColumn($table, 'financial_reporting', default: null, notnull: false);
        ...
        $this->addPrimaryKey($table, 'log_id');
