...
final class Version20260000020124 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $table->addColumn('activity', Types::BOOLEAN, ['default' => 1, 'comment' => '0 if deleted']);
        ...
        $table->addColumn('order_psc', CustomTypes::TINYINT, ['notnull' => false, 'default' => null]);
        ...
        $this->addPrimaryKey($table, 'procedure_order_id');
