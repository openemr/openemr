...
final class Version20260000010066 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $table->addColumn('ACT', Types::STRING, ['default' => 'on']);
        ...
        $table->addColumn('MOTILITYNORMAL', Types::STRING, ['default' => 'on']);
        $table->addColumn('MOTILITY_RS', Types::STRING, ['default' => 0]);
        $table->addColumn('MOTILITY_RI', Types::STRING, ['default' => 0]);
        $table->addColumn('MOTILITY_RR', Types::STRING, ['default' => 0]);
        $table->addColumn('MOTILITY_RL', Types::STRING, ['default' => 0]);
        $table->addColumn('MOTILITY_LS', Types::STRING, ['default' => 0]);
        $table->addColumn('MOTILITY_LI', Types::STRING, ['default' => 0]);
        $table->addColumn('MOTILITY_LR', Types::STRING, ['default' => 0]);
        $table->addColumn('MOTILITY_LL', Types::STRING, ['default' => 0]);
        ...
        $table->addColumn('STEREOPSIS', Types::STRING, ['notnull' => false, 'default' => null]);
        ...
        $table->addColumn('NPC', Types::STRING, ['notnull' => false, 'default' => null]);
        $table->addColumn('DACCDIST', Types::STRING, ['notnull' => false, 'default' => null]);
        $table->addColumn('DACCNEAR', Types::STRING, ['notnull' => false, 'default' => null]);
        $table->addColumn('CACCDIST', Types::STRING, ['notnull' => false, 'default' => null]);
        $table->addColumn('CACCNEAR', Types::STRING, ['notnull' => false, 'default' => null]);
        ...
        $table->addColumn('ODREDDESAT', Types::STRING, ['notnull' => false, 'default' => null]);
        $table->addColumn('OSREDDESAT', Types::STRING, ['notnull' => false, 'default' => null]);
