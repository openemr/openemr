...
final class Version20260000010060 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $table->addColumn('drug_info_erx', Types::TEXT);
        ...
        $table->addColumn('indication', Types::TEXT);
        ...
        $table->addColumn('diagnosis', Types::TEXT, ['comment' => 'Diagnosis or reason for the prescription']);
