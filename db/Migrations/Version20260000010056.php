...
final class Version20260000010056 extends AbstractMigration
{
    ...
    {
        $table = $schema->createTable('patient_data');
        ...
        $table->addColumn('interpreter_needed', Types::TEXT, ['comment' => 'fk to list_options.option_id where list_id=yes_no_unknown used to determine if patient needs an interpreter']);
        ...
        $table->addColumn('guardiansname', Types::TEXT);
        ...
        $table->addColumn('care_team_status', Types::TEXT);
        $table->addColumn('county', Types::STRING, ['length' => 40, 'default' => '']);
        $table->addColumn('industry', Types::TEXT);
        $table->addColumn('imm_reg_status', Types::TEXT);
        $table->addColumn('imm_reg_stat_effdate', Types::TEXT);
        $table->addColumn('publicity_code', Types::TEXT);
        $table->addColumn('publ_code_eff_date', Types::TEXT);
        $table->addColumn('protect_indicator', Types::TEXT);
        $table->addColumn('prot_indi_effdate', Types::TEXT);
        $table->addColumn('guardianrelationship', Types::TEXT);
        $table->addColumn('guardiansex', Types::TEXT);
        $table->addColumn('guardianaddress', Types::TEXT);
        $table->addColumn('guardiancity', Types::TEXT);
        $table->addColumn('guardianstate', Types::TEXT);
        $table->addColumn('guardianpostalcode', Types::TEXT);
        $table->addColumn('guardiancountry', Types::TEXT);
        $table->addColumn('guardianphone', Types::TEXT);
        $table->addColumn('guardianworkphone', Types::TEXT);
        $table->addColumn('guardianemail', Types::TEXT);
        $table->addColumn('sexual_orientation', Types::TEXT);
        $table->addColumn('gender_identity', Types::TEXT);
        $table->addColumn('birth_fname', Types::TEXT);
        $table->addColumn('birth_lname', Types::TEXT);
        $table->addColumn('birth_mname', Types::TEXT);
        $table->addColumn('dupscore', Types::INTEGER);
        $table->addColumn('name_history', Types::TEXT);
        $table->addColumn('suffix', Types::TEXT);
        $table->addColumn('street_line_2', Types::TEXT);
        $table->addColumn('patient_groups', Types::TEXT);
        $table->addColumn('prevent_portal_apps', Types::TEXT);
        $table->addColumn('provider_since_date', Types::TEXT);
        ...
        $table->addColumn('preferred_name', Types::TEXT);
        $table->addColumn('nationality_country', Types::TEXT);
        $table->addColumn('last_updated', Types::DATETIME_MUTABLE);
        $table->addColumn('tribal_affiliations', Types::TEXT);
        $table->addColumn('sex_identified', Types::TEXT, ['comment' => 'Patient reported current sex']);
