...
final class Version20260000020097 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addBooleanColumn($table, 'include_flag', default: false, comment: '0 is exclude and 1 is include');
        $this->addBooleanColumn($table, 'required_flag', default: false, comment: '0 is optional and 1 is required');
