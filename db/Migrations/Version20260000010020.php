 ...
 * Gacl aco table
 */
final class Version20260000010020 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Create gacl_aco table';
    }

    public function up(Schema $schema): void
    {
        $table = $schema->createTable('gacl_aco');
        ...
        $table->addIndex(['hidden'], 'gacl_hidden_aco');
        $table->addUniqueIndex(['section_value', 'value'], 'gacl_section_value_value_aco');
        $table->addOption('engine', 'InnoDB');
    }

    public function down(Schema $schema): void
    {
        $schema->dropTable('gacl_aco');
    }
}
