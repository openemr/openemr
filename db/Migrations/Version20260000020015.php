...
final class Version20260000020015 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addBooleanColumn($table, 'active_alert_flag', notnull: false, comment: 'Active Alert Widget Module flag - note not yet utilized');
        $this->addBooleanColumn($table, 'passive_alert_flag', notnull: false, comment: 'Passive Alert Widget Module flag');
        ...
        $this->addBooleanColumn($table, 'amc_flag', notnull: false, comment: 'Automated Measure Calculation flag (unable to customize per patient)');
        $this->addBooleanColumn($table, 'amc_2011_flag', notnull: false, comment: '2011 Automated Measure Calculation flag for (unable to customize per patient)');
        $this->addBooleanColumn($table, 'amc_2014_flag', notnull: false, comment: '2014 Automated Measure Calculation flag for (unable to customize per patient)');
        $this->addBooleanColumn($table, 'amc_2015_flag', default: null, notnull: false, comment: '2015 Automated Measure Calculation flag for (unable to customize per patient)');
        ...
        $this->addBooleanColumn($table, 'amc_2014_stage1_flag', notnull: false, comment: '2014 Stage 1 - Automated Measure Calculation flag for (unable to customize per patient)');
        $this->addBooleanColumn($table, 'amc_2014_stage2_flag', notnull: false, comment: '2014 Stage 2 - Automated Measure Calculation flag for (unable to customize per patient)');
        $this->addBooleanColumn($table, 'patient_reminder_flag', notnull: false, comment: 'Clinical Reminder Module flag');
        ...
        $table->addColumn('patient_dob_usage', Types::TEXT, ['notnull' => false, 'length' => 65535, 'comment' => 'Description of how patient DOB is used by this rule']);
        $table->addColumn('patient_ethnicity_usage', Types::TEXT, ['notnull' => false, 'length' => 65535, 'comment' => 'Description of how patient ethnicity is used by this rule']);
        $table->addColumn('patient_health_status_usage', Types::TEXT, ['notnull' => false, 'length' => 65535, 'comment' => 'Description of how patient health status assessments are used by this rule']);
        $table->addColumn('patient_gender_identity_usage', Types::TEXT, ['notnull' => false, 'length' => 65535, 'comment' => 'Description of how patient gender identity information is used by this rule']);
        $table->addColumn('patient_language_usage', Types::TEXT, ['notnull' => false, 'length' => 65535, 'comment' => 'Description of how patient language information is used by this rule']);
        $table->addColumn('patient_race_usage', Types::TEXT, ['notnull' => false, 'length' => 65535, 'comment' => 'Description of how patient race information is used by this rule']);
