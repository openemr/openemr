...
/**
 * Form dictation table
 */
final class Version20260000010009 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Create form_dictation table';
    }

    public function up(Schema $schema): void
    {
        $table = $schema->createTable('form_dictation');
    ...
    {
        $schema->dropTable('form_dictation');
    }
}
