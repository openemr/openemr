...
/**
 * Standard Admin Global Setting API Routes
 *
 * @package   OpenEMR
 *
...
return [
     ...
     *     description="Retrieves a list of All Global Setting Sections",
     *     tags={
     *         "standard",
     *         "admin",
     *         "global-setting",
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/global-setting",
     *     description="Retrieves a list of all Global Settings",
     *     tags={
     *         "standard",
     *         "admin",
     *         "global-setting",
     ...
     * @OA\Get(
     *     path="/api/admin/global-setting/{section}",
     *     description="Retrieves a list of all Global Settings by Section",
     *     tags={
     *         "standard",
     *         "admin",
     *         "global-setting",
     ...
     *     description="Returns Global Setting Value by Key",
     *     tags={
     *         "standard",
     *         "admin",
     *         "global-setting",
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/global-setting/{section}/reset",
     *     description="Resets All Global Settings to Defaults by Section",
     *     tags={
     *         "standard",
     *         "admin",
     *         "setting",
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/global-setting/{section}/{key}/reset",
     *     description="Resets Global Setting to Default Value by Setting Key",
     *     tags={
     *         "standard",
     *         "admin",
     *         "global-setting",
