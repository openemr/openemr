...
function writeFieldLine($linedata): void
{
    ...
    if (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('translate_layout') && $_SESSION['language_choice'] > 1) {
    ...
    while ($row = sqlFetchArray($res)) {
        ...
        if ($group_id != $prevgroup) {
            ...
            $t_vars = [
                ...
                'translate_layout' => (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('translate_layout') && $_SESSION['language_choice'] > 1) ? xlt($gdispname) : "",
