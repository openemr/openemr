...
<html>
   ...
   <div class="container">
                  ...
                  <div class="card">
                     ...
                     <div class="card-body">
                        <div class="form-file">
                           ...
                           <input type="file" name="form_file" size="40" class="form-file-input" id="customFile" />
                           <label class="form-file-label" for="customFile"><?php echo xlt('Choose file'); ?></label>
                        </div>
      ...
      //display file name
        ...
        $(this).siblings(".form-file-label").addClass("selected").html(jsText(fileName));
        });
        </script>
   </body>
</html>
