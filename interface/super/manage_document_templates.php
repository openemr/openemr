...
if (!empty($_POST['bn_upload'])) {
    ...
    if (is_uploaded_file($tmp_name) && $_FILES['form_file']['size']) {
        ...
        $storedData = OEGlobalsBag::getInstance()->getBoolean('drive_encryption') ? $cryptoGen->encryptStandard($fileData !== false ? $fileData : null, null, KeySource::Database) : $fileData;
