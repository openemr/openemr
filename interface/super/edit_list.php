...
<?php } else { ?>
  <th title=<?php xl('Click to edit','e','\'','\''); ?>><b><?php  xl('ID','e'); ?></b></th>
  <th><b><?php xl('Title'  ,'e'); ?></b></th>
  <?php //show translation column if not english and the translation lists flag is set
  if ($GLOBALS['translate_lists'] && $_SESSION['language_choice'] > 1) {
    echo "<th><b>".xl('Translation')."</b><span class='help' title='".xl('The translated Title that will appear in current language')."'> (?)</span></th>";
...
<?php } else if ($list_id == 'lbfnames' || $list_id == 'transactions') { ?>
  <th title='<?php xl('Number of past history columns','e'); ?>'><b><?php xl('Repeats','e'); ?></b></th>
...
<?php } else if ($list_id == 'immunizations') { ?>
  <th><b>&nbsp;&nbsp;&nbsp;&nbsp;<?php xl('CVX Code Mapping','e'); ?></b></th>
...
<p>
    <button type="submit" name='form_save' id='form_save' class="btn btn-default btn-save"><?php xl('Save','e'); ?></button>
</p>
