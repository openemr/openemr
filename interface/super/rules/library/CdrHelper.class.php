...
class CdrResults
{
    ...
    function __construct($rule_id = "", $active_alert_flag = "", $passive_alert_flag = "", $patient_reminder_flag = "", $provider_alert_flag ="", $access_control = "")
    {
        $this->id = $rule_id;
        ...
        $this->provider_flag = $provider_alert_flag;
    ...
    function provider_alert_flag()
    {
            return $this->provider_flag;
    }
    ...
    function update_table()
    {
        ...
        sqlStatement($query, array($this->active_flag,$this->passive_flag,$this->reminder_flag,$this->provider_flag,$this->id));
