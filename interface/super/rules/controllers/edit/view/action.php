  ...
  <tr>
        ...
        <td>
            <div class="btn-group">
                ...
                <a href="index.php?action=detail!view&id=<?php echo $action->id ?>" class="iframe_medium btn btn-link btn-cancel" onclick="top.restoreSession()"><?php echo out(xl('Cancel')); ?></a>
            </div>
        </td>
  </tr>
</table>
