  ...
  <tr>
        ...
        <td>
            <div class="btn-group">
                ...
                <a href="index.php?action=detail!view&id=<?php echo out($rule->id); ?>" class="iframe_medium btn btn-link btn-save" onclick="top.restoreSession()"><?php echo out(xl('Cancel')); ?></a>
            </div>
        </td>
  </tr>
</table>
