...
<div class="row">
    <div class="col-xs-12">
        <div class="text">
            ...
            <fieldset>
                ...
                <p>
                    <div>
                        ...
                        <span class="end_col co lhead"><u><?php echo out(xl('Detail')); ?></u></span>
                    </div>
            ...
            <fieldset>
                <legend>
                    <?php echo out(xl('Demographics filter criteria')); ?> <a href="index.php?action=edit!add_criteria&id=<?php echo out($rule->id); ?>&criteriaType=filter" class="action_link" onclick="top.restoreSession()">(<?php echo out(xl('add')); ?>)</a>
                </legend>
                <div class='col-xs-12'>
                <p>
            ...
            <fieldset>
            <legend><?php echo out(xl('Target/Action Groups')); ?></legend>
             <div class='col-xs-12'>
             <div class='col-xs-12'>
            <?php $groupId = 0;
