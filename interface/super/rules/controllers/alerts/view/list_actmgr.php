...
<div class="row">
    <div class="col-xs-12">
         <div class="page-header clearfix">
           <h2 class="clearfix"><span id='header_text'><?php echo out(xl('Clinical Decision Rules Alert Manager')); ?></span><a class="pull-right" data-target="#myModal" data-toggle="modal" href="#" id="help-href" name="help-href" style="color:#000000"><i class="fa fa-question-circle" aria-hidden="true"></i></a></h2>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-xs-12">
     <a href="javascript:document.cdralertmgr.submit();" class="btn btn-default btn-save" onclick="top.restoreSession()"><span><?php echo out(xl('Save')); ?></span></a>
     <a href="javascript:document.cdralertmgr.reset();" class="btn btn-default btn-undo" onclick="top.restoreSession()"><span><?php echo out(xl('Reset')); ?></span></a>
     <br><br>
