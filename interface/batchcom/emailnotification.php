...
<span class="title"><?xl('Email Notification','e')?></span>
<br><br>
...
<div class="text">
	<div class="main_box">
		...
		?>
		<?xl('Email Sender','e')?> :
		<INPUT TYPE="text" NAME="email_sender" size="40" value="<?=$email_sender?>">
		<br>
		<?xl('Email Subject','e')?> :
		<INPUT TYPE="text" NAME="email_subject" size="60" value="<?=$email_subject?>">
		<br>
