            ...
            <form name='translation' id='translation' method='get' action='language.php' onsubmit="return top.restoreSession()">
                ...
                <ui class="nav nav-pills">
                    <li class="nav-item" id="li-definition">
                        <a href="?m=definition&csrf_token_form=<?php echo CsrfUtils::collectCsrfToken(session: $session); ?>" onclick="top.restoreSession()" class="nav-link fw-bold" id="definition-link"><?php echo xlt('Edit Definitions'); ?></a>
                    </li>
                    <li class="nav-item" id="li-language">
                        <a href="?m=language&csrf_token_form=<?php echo CsrfUtils::collectCsrfToken(session: $session); ?>" onclick="top.restoreSession()" class="nav-link fw-bold" id="language-link"><?php echo xlt('Add Language'); ?></a>
                    </li>
                    <li class="nav-item" id="li-constant">
                        <a href="?m=constant&csrf_token_form=<?php echo CsrfUtils::collectCsrfToken(session: $session); ?>" onclick="top.restoreSession()" class="nav-link fw-bold" id="constant-link"><?php echo xlt('Add Constant'); ?></a>
                    </li>
                    <li class="nav-item" id="li-manage">
                        <a href="?m=manage&csrf_token_form=<?php echo CsrfUtils::collectCsrfToken(session: $session); ?>" onclick="top.restoreSession()" class="nav-link fw-bold" id="manage-link"><?php echo xlt('Manage Translations'); ?></a>
                    </li>
                    <li class="nav-item" id="li-csv">
                        <a href="?m=csv&csrf_token_form=<?php echo CsrfUtils::collectCsrfToken(session: $session); ?>" onclick="top.restoreSession()" class="nav-link fw-bold" id="csv-link"><?php echo xlt('Load from CSV'); ?></a>
                    </li>
                </ui>
            </form>
