...
$searchcolor = empty(\OpenEMR\Core\OEGlobalsBag::getInstance()->get('layout_search_color')) ?
  'var(--yellow)' : \OpenEMR\Core\OEGlobalsBag::getInstance()->get('layout_search_color');

$WITH_SEARCH = (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('full_new_patient_form') == '1' || \OpenEMR\Core\OEGlobalsBag::getInstance()->get('full_new_patient_form') == '2' );
$SHORT_FORM  = (in_array(\OpenEMR\Core\OEGlobalsBag::getInstance()->get('full_new_patient_form'), ['2', '3', '4']));
...
function validate(f) {
  var errMsgs = new Array();
    ...
    <?php if (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('erx_enable')) { ?>
  alertMsg='';
        ...
        <div class="row">
            <div class="<?php echo $BS_COL_CLASS; ?>-12">
                ...
                <form action='new_comprehensive_save.php' name='demographics_form' id='DEM'
                      method='post'
                      onsubmit='return submitme(<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('new_validate') ? 1 : 0;?>,event,"DEM",constraints)'>
                    ...
                    if (!\OpenEMR\Core\OEGlobalsBag::getInstance()->get('simplified_demographics')) {
                        ...
                        <div class="row p-3">
                          ...
                          <div class="col-md-5 mb-2">
                            ...
                            <?php echo (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('omit_employers')) ? "<div class='d-none'>" : ""; ?>
                            ...
                            <?php echo (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('omit_employers')) ? "</div>" : ""; ?>
                          ...
                          <div class="col-md-5 mb-2">
                            ...
                            <?php echo (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('omit_employers')) ? "<div class='d-none'>" : ""; ?>
                          <label class='col-form-label col-md-1 mb-2 required'><?php echo (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('phone_country_code') == '1') ? xlt('SE State') : xlt('SE Locality') ?>:</label>
                          <div class="col-md-5 mb-2">
                            <?php
                            generate_form_field(['data_type' => \OpenEMR\Core\OEGlobalsBag::getInstance()->get('state_data_type'),'field_id' => ('i' . $i . 'subscriber_employer_state'),'list_id' => \OpenEMR\Core\OEGlobalsBag::getInstance()->get('state_list'),'fld_length' => '15','max_length' => '63','edit_options' => 'C', 'smallform' => 'true'], ($result3['subscriber_employer_state'] ?? ''));
                            ?>
                          </div>
                            <?php echo (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('omit_employers')) ? "</div>" : ""; ?>
                          <label class='col-form-label col-md-1 mb-2 required'><?php echo (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('phone_country_code') == '1') ? xlt('State') : xlt('Locality') ?>:</label>
                          <div class="col-md-5 mb-2">
                            <?php
                            generate_form_field(['data_type' => \OpenEMR\Core\OEGlobalsBag::getInstance()->get('state_data_type'), 'field_id' => ('i' . $i . 'subscriber_state'),'list_id' => \OpenEMR\Core\OEGlobalsBag::getInstance()->get('state_list'),'fld_length' => '15','max_length' => '63','edit_options' => 'C', 'smallform' => 'true'], ($result3['subscriber_state'] ?? ''));
                            ?>
                          </div>
                            <?php echo (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('omit_employers')) ? "<div class='d-none'>" : ""; ?>
                          <label class='col-form-label col-md-1 mb-2 required'><?php echo (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('phone_country_code') == '1') ? xlt('SE Zip Code') : xlt('SE Postal Code') ?>: </label>
                          <div class="col-md-5 mb-2">
                            ...
                            <?php echo (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('omit_employers')) ? "</div>" : ""; ?>
                          <label class='col-form-label col-md-1 mb-2 required'><?php echo (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('phone_country_code') == '1') ? xlt('Zip Code') : xlt('Postal Code') ?>: </label>
                          <div class="col-md-5 mb-2">
                          ...
                          <div class="col-md-5 mb-2">
                            <?php
                            generate_form_field(['data_type' => \OpenEMR\Core\OEGlobalsBag::getInstance()->get('country_data_type'),'field_id' => ('i' . $i . 'subscriber_employer_country'),'list_id' => \OpenEMR\Core\OEGlobalsBag::getInstance()->get('country_list'),'fld_length' => '10','max_length' => '63','edit_options' => 'C', 'smallform' => 'true'], ($result3['subscriber_employer_country'] ?? ''));
                            ?>
                          </div>
                          <label class='col-form-label col-md-1 mb-2 required'><?php echo xlt('Country'); ?>:</label>
                          <div class="col-md-5 mb-2">
                            <?php
                            generate_form_field(['data_type' => \OpenEMR\Core\OEGlobalsBag::getInstance()->get('country_data_type'),'field_id' => ('i' . $i . 'subscriber_country'),'list_id' => \OpenEMR\Core\OEGlobalsBag::getInstance()->get('country_list'),'fld_length' => '10','max_length' => '63','edit_options' => 'C', 'smallform' => 'true'], ($result3['subscriber_country'] ?? ''));
                            ?>
                          </div>
                            <?php echo (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('omit_employers')) ? "</div>" : ""; ?>
...
<?php if (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('new_validate') == 0) { ?>
...
$(function () {
    ...
    var check = function(e) {
        var f = document.forms[0];
        <?php if (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('new_validate')) {?>
            var valid = submitme(<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('new_validate') ? 1 : 0;?>, e, "DEM", constraints);
        <?php } else {?>
            top.restoreSession();
        ...
        ?>
        <?php if ((\OpenEMR\Core\OEGlobalsBag::getInstance()->get('full_new_patient_form') == '4') && (checkIfPatientValidationHookIsActive())) :?>
            // Use zend module patient validation hook to open the controller and send the dup-checker fields.
            var url ='<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('web_root') . "/interface/modules/zend_modules/public/patientvalidation"; ?>';
        <?php else :?>
...
$use_validate_js = \OpenEMR\Core\OEGlobalsBag::getInstance()->get('new_validate');
