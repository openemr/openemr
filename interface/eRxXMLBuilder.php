...
class eRxXMLBuilder {
	...
	public function getUserRole($authUserId) {
		...
		switch ($eRxUserRole) {
			case 'admin':
			case 'manager':
			case 'nurse':				$newCropUser = 'Staff';					break;
			case 'doctor':				$newCropUser = 'LicensedPrescriber';	break;
			case 'supervisingDoctor':	$newCropUser = 'SupervisingDoctor';		break;
			case 'midlevelPrescriber':	$newCropUser = 'MidlevelPrescriber';	break;
			default:					$newCropUser = '';
		}
