...
class EncounterccdadispatchController extends AbstractActionController
{
    ...
    public function indexAction()
    {
        ...
        if ($this->getRequest()->getQuery('doctype') === 'qrda3') {
            ...
            echo $document;
            EventAuditLogger::instance()->newEvent("qrda3-export", $session->get('authUser'), $session->get('authProvider'), 1, "QRDA3 view");
            exit;
        }
        ...
        if ($this->getRequest()->getQuery('doctype') === 'qrda3_consolidated') {
            ...
            echo $document;
            EventAuditLogger::instance()->newEvent("qrda3-consolidated-export", $session->get('authUser'), $session->get('authProvider'), 1, "QRDA3 Consolidated view");
            exit;
        }
