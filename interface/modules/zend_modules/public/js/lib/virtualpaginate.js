...
document.write('<style>'  + '.hidepiece{display:none}\n' + '@media print{.hidepiece{display:block !important;}}\n' + '</style>');
...
virtualpaginate.prototype.buildpagination = function(divids, optnavtext) {
    divids = (typeof divids == "string") ? [divids] : divids; //force divids to be an array of ids
...
virtualpaginate.prototype.paginate_build_selectmenu = function(paginatedropdown, divpos, anchortext) {
    ...
    setTimeout(function() {
        paginatedropdown.selectedIndex = instanceOfBox.currentpage;
    }, 500); //refresh currently selected option (for IE's sake)
