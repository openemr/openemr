                ...
                if (arr_id[1] == 0 && !user_delete && !invalid_group) {
                    ...
                    if (index != -1) {
                        ...
                        $("#li_" + selected_user).find("li").each(function () {
                            ...
                            if (index_1 != -1) {
                                allowed_array.splice(index_1, 1);
                            }
                        });
                    }
                }
...
function saveGroupAcl()
{
    ...
    $("#table_acl").find("input:checkbox").each(function () {
        ...
        if ($(this).is(":checked")) {
            i++;
            if (!ACL_DATA['allowed'][id_arr[0]]) {
                ACL_DATA['allowed'][id_arr[0]] = {};
            }
            ACL_DATA['allowed'][id_arr[0]][i] = id_arr[1];
        } else {
            i++;
            if (!ACL_DATA['denied'][id_arr[0]]) {
                ACL_DATA['denied'][id_arr[0]] = {};
            }
