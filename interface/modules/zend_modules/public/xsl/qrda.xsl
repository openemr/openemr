               ...
               <xsl:for-each select="n1:documentationOf">
                  ...
                  <xsl:for-each select="n1:serviceEvent/n1:performer">
                     ...
                     <tr>
                        ...
                        <td width="30%">
						   <u>Person</u><br/>
                           <xsl:call-template name="show-nameAndId">
                              <xsl:with-param name="name" select="n1:assignedEntity/n1:assignedPerson/n1:name"/>
                        ...
                        <td width="50%" colspan="2">
                           ...
                           <xsl:call-template name="show-nameAndId">
                              ...
                              <xsl:with-param name="id" select="n1:assignedEntity/n1:representedOrganization/n1:id" />
                           </xsl:call-template>
                        </td>
                     </tr>
                  </xsl:for-each>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:if test="not($id/@nullFlavor)">
               ...
               <xsl:if test="$id[@root and @assigningAuthorityName]">
				   <xsl:text> (</xsl:text>
   ...
   <xsl:template name="translateRoleAssoCode">
      ...
      <xsl:choose>
         ...
         <xsl:when test="$classCode='RGPR'">
			 <xsl:text>EHR Certification Number</xsl:text>
         </xsl:when>
         <xsl:otherwise>
