 ...
 * Otherwise the modules are found inside the modules/laminas_modules folder.  The uninstalled script will dynamically find them
 * in the filesystem.
 */
function oemr_laminas_load_modules_from_db()
{
...
$plugin_modules = oemr_laminas_load_modules_from_db();
