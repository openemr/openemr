 ...
 * 2. in the 'globals settings' screen go to 'Rx' tab and save your action in the 'Name of laminas template for pdf export' label
...
class PdfTemplatesController extends PrescriptionTemplatesController
{
    ...
    /**
     * default template for prescription using laminas module
     */
