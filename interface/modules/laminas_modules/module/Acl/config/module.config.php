<?php
/**
 * interface/modules/laminas_modules/module/Acl/config/module.config.php
 *
 * @package   OpenEMR
    ...
    'controllers' => array(
        'factories' => [
            Controller\AclController::class => function (ContainerInterface $container, $requestedName) {
                 ...
                 * @see https://github.com/laminasframework/laminas-view/blob/master/src/Helper/EscapeHtml.php
                 */
