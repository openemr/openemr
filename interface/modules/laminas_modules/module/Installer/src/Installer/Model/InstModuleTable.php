<?php
/**
 * interface/modules/laminas_modules/module/Installer/src/Installer/Model/InstModuleTable.php
 *
 * @package   OpenEMR
...
class InstModuleTable
{
    ...
    /**
     * The path for the laminas modules locations
     *
     * @var string
     */
    private $module_laminas_path;
    ...
    public function __construct(TableGateway $tableGateway, ContainerInterface $container)
    {
        ...
        $this->module_laminas_path = $GLOBALS['srcdir']. DIRECTORY_SEPARATOR
            . ".." . DIRECTORY_SEPARATOR . $GLOBALS['baseModDir'] . $GLOBALS['laminasModDir'] . DIRECTORY_SEPARATOR . "module";
    }
...
*/
   ...
   **/
    ...
    private function getModuleConfigFilePathForDirectory($moduleDirectory)
    {
        ...
        $searchDirectories = [
            $moduleDirectory
            , $this->module_laminas_path . DIRECTORY_SEPARATOR . $moduleDirectory
        ];
