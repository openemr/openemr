<?php
/**
 * interface/modules/laminas_modules/module/Documents/config/module.config.php
 *
 * @package   OpenEMR
    ...
    'router' => array(
        'routes' => array(
            'documents' => array(
                'type'    => Segment::class,
                'options' => array(
                        // laminas framework 3 get's rid of the old /:controller terminology however to be backwards compatible
