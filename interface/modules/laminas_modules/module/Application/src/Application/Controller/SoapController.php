<?php
/**
 * interface/modules/laminas_modules/module/Application/src/Application/Controller/SoapController.php
 *
 * @package   OpenEMR
...
class SoapController extends AbstractActionController
{
    ...
    public function indexAction()
    {
        ...
        // @see https://framework.laminas.com/blog/2017-01-24-laminas-soap-server.html for more details
        $server = new Server(
            null,
