/**
 * interface/modules/laminas_modules/public/js/application/sendTo.js
 *
 * @package   OpenEMR
  ...
  var comp = '';
    ...
    if(count == 0) {
      ...
      if(download_format == 'ccda') {
        if($('#ccda_pid').val()) {
          window.location.assign(WEB_ROOT+"/interface/modules/laminas_modules/public/encountermanager/index?pid_ccda="+pid+"&downloadccda=download_ccda&components="+comp+"&latest_ccda="+latest_ccda);
        }
        else {
          $('#components').val(comp);
        ...
        if($('#ccda_pid').val()) {
          window.location.assign(WEB_ROOT+"/interface/modules/laminas_modules/public/encountermanager/index?pid_ccr="+pid+"&downloadccr=download_ccr");
        }
        else {
        ...
        if($('#ccda_pid').val()) {
          window.location.assign(WEB_ROOT+"/interface/modules/laminas_modules/public/encountermanager/index?pid_ccd="+pid+"&downloadccd=download_ccd");
        }
        else {
