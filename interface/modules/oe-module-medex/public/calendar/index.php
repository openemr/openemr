...
<body class="medex-theme-<?php echo attr($prefTheme); ?>">
    ...
    <script type="text/javascript">
        ...
        function switchToOpenEMRCalendar() {
            if (!window.medexOpenEmrCalendarCompatible) {
                showMedexStatusToast('OpenEMR calendar is unavailable in this runtime. Staying in MedEx calendar.', 'error', 2800);
                return;
            }
            saveFilterSelections();
        ...
        function openSearchFromToolbar() {
            if (!window.medexOpenEmrCalendarCompatible) {
                showMedexStatusToast('OpenEMR search is unavailable in this runtime. Staying in MedEx calendar.', 'error', 2800);
                return;
            }
            if (typeof top !== 'undefined' && typeof top.restoreSession === 'function') {
                top.restoreSession();
