...
class Display extends base
{
    public function navigation($logged_in)
    {
        ...
        function SMS_bot_list() {
            top.restoreSession();
            var myWindow = window.open('<?php echo OEGlobalsBag::getInstance()->get('webroot'); ?>/interface/main/messages/messages.php?nomenu=1&go=SMS_bot&dir=back&show=new','_blank', 'width=400,height=780');
            myWindow.focus();
            return false;
        }
        </script>
    ...
    <script>
        ...
        function SMS_bot(pid) {
            ...
            window.open('<?php echo OEGlobalsBag::getInstance()->get('webroot'); ?>/interface/main/messages/messages.php?nomenu=1&go=SMS_bot&pid=' + pid,'_blank', 'width=400,height=780,resizable=1');
            return false;
        }
        $(function () {
            show_this();
...
$force=1;
        ...
        if (is_array($statusPayload) && isset($statusPayload['error'])) {
            ...
            // Background services are no longer managed by the module; do not alter background_services.
