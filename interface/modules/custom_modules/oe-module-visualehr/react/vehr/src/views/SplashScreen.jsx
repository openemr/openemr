            ...
            <div className="fixed z-50 flex flex-col w-full h-full right-0 left-0 top-0 bottom-0 bg-white">
                <div className="grid h-screen place-items-center">
                    <div className="flex flex-col">
                      ...
                      <div className={`h-1 w-full transition-width transition-slowest ease ${(this.state.hasError) ? 'bg-red-500' : ' bg-gray-500'}`} style={{width:`${this.props.progressLoaded}%`}}></div>
                      {
                          (this.state.hasError) ? <div className="text-red-600 my-2">Connection lost ... Check your internet connectivity</div> : <div className="font-sfuidisplayBlack text-4xl my-4 mx-auto text-primaryColor">Visual EHR</div>
                      }
