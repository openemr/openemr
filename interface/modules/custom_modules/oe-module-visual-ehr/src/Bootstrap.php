...
use OpenEMR\Modules\VisualEhr\CustomSkeletonRestController;


class Bootstrap
{
    const MODULE_INSTALLATION_PATH = "/interface/modules/custom_modules/";
    const MODULE_NAME = "oe-module-visual-ehr";
    /**
    ...
    public function addCustomModuleMenuItem(MenuEvent $event)
    {
        ...
        $token =  js_escape(CsrfUtils::collectCsrfToken('api'));
        $patientId = $_COOKIE["pid_vehr"];
        $userId = $_SESSION["authUserID"];
        $menuItem->url = "/interface/modules/custom_modules/oe-module-visual-ehr/public/index.html?pid=$patientId&userid=$userId";
        $menuItem->children = [];
         ...
         */
        $menuItem->acl_req = ["patients","demo"]; //activate visual dashboard tab when a patient is selected.
