...
class GlobalConfig
{
    ...
    const CONFIG_ENABLE_VISUAL_EHR = "oe_enable_visual_ehr";
 ...
 */
    ...
    public function getVisualEhrOption()
    {
        return $this->getGlobalSetting(self::CONFIG_ENABLE_VISUAL_EHR);
    }
    ...
    public function getGlobalSettingSectionConfiguration()
    {
        $settings = [
            ...
            ,*/self::CONFIG_ENABLE_VISUAL_EHR => [
                'title' => 'Enable Visual EHR dashboard'
                ,'description' => 'This dashboard when activated will replace the Medical Record Dashboard'
                ,'type' => GlobalSetting::DATA_TYPE_BOOL
                ,'default' => ''
            ]
        ];
