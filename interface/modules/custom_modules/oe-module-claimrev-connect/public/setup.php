...
if (!empty($_POST)) {
    if (!CsrfUtils::verifyCsrfToken($_POST["csrf_token_form"], "ClaimRevModule", $session)) {
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <form method="post" action="setup.php">
                            ...
                            <input type="hidden" name="csrf_token_form" value="<?php echo attr(CsrfUtils::collectCsrfToken('ClaimRevModule', $session)); ?>" />
                        </form>
                    </li>
                    <li>
                        <h6>
