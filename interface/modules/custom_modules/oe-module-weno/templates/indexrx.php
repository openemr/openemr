...
<body>
    <div id="trigger-debug" class="container-xl">
        ...
        <footer>
            <a href="<?php echo OEGlobalsBag::getInstance()->getWebRoot() ?>/interface/patient_file/summary/demographics.php?resync=true&set_pid=<?php echo urlencode(attr($session->get('pid') ?? $pid)) ?>" class="btn btn-primary float-end mt-2 mb-4 me-3"><?php echo xlt("Return to Demographics"); ?></a>
