...
<script>
    function setPrescribeLocation() {
        ...
        window.location.href = "<?php echo OEGlobalsBag::getInstance()->getWebRoot(); ?>/interface/modules/custom_modules/oe-module-weno/templates/indexrx.php?location=" + encodeURIComponent(newLocation);
    }
</script>
...
<?php if ($pharmacyCount > 0) {
    ...
    <div id="trigger-debug" class="mb-3 mb-0">
        <div class="input-group small">
            <label role="button" id="label-primary" class="text-primary mb-0 me-2" for="select-primary" title="<?php echo $titleMessage ?>" data-bs-toggle="popover" data-bs-content="<?php echo $popoverContent ?>">
        ...
        <div class="input-group small">
            <label role="button" id="label-alternate" class="text-primary mb-1 me-1" for="select-alternate" title="<?php echo $titleMessage ?>" data-bs-toggle="popover" data-bs-content="<?php echo $popoverContent ?>">
        ...
        <div class="mb-3">
            <label role="button" id="label-location" class="text-primary mb-1 me-1" for="facilitySelect" title="<?php echo $titleLocation ?>" data-bs-toggle="popover" data-bs-content="<?php echo $popoverLocation ?>">
