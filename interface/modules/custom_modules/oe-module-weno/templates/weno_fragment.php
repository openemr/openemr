...
?>
<script src="<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('webroot') ?>/interface/modules/custom_modules/oe-module-weno/public/assets/js/synch.js"></script>
<style>
  .dialog-alert {
    font-size: 14px;
  }
...
<script>
    function setPrescribeLocation() {
        ...
        window.location.href = "<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('webroot'); ?>/interface/modules/custom_modules/oe-module-weno/templates/indexrx.php?location=" + encodeURIComponent(newLocation);
    }
</script>
