...
class OeModuleLegacyMaviq extends OeModule
{

    function __construct() {
        $this->setProp('Name', 'Maviq');
    }
    ...
    public function actionInstall() {
        print('<p>Installing Maviq module related database tables and settings.</p>');
        return true;
    }
    ...
    public function actionEnable() {
        print('<p>Enabling Maviq module for productive use.</p>');
        $this->modProp['boolActive'] = true;
        return true;
    }

    public function actionDisable() {
        print('<p>Disabling Maviq module.</p>');
    ...
    public function getConfig() {
        print('<p>Configuration data for Maviq module.</p>');
        return true;
    }
}
