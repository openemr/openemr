...
$assetBase = \OpenEMR\Core\OEGlobalsBag::getInstance()->get('web_root') . "/interface/modules/custom_modules/oe-module-faxsms/public";
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('assets_static_relative'); ?>/dropzone/dist/dropzone.css">
    <script src="<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('assets_static_relative'); ?>/utif2/UTIF.js"></script>
    <?php
    ...
    ?>
    <script type="text/javascript" src="<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('assets_static_relative'); ?>/dropzone/dist/dropzone.js"></script>
    ...
    <script>
        $(function () {
            $('.datepicker').datetimepicker({
                ...
                require(\OpenEMR\Core\OEGlobalsBag::getInstance()->get('srcdir') . '/js/xl/jquery-datetimepicker-2-5-4.js.php');
                ?>
            });
