...
<body class="body_top">
    ...
    <div class="sticky-top">
        <nav class="navbar navbar-expand-xl navbar-light bg-light">
            <div class="container">
                <a class="navbar-brand" href="#"><h4><?php echo $title; // nosemgrep: echoed-request -- $title is translated and HTML-escaped via xlt() inside ServiceType::getTranslatedDisplayName(); wrapping again would double-escape (see review). ?><i class="brand ms-1" id="brand-top"></i></h4></a>
                ...
                <div id="dashboard" class="card">
                    ...
                    <ul id="tab-menu" class="nav nav-pills mb-1" role="tablist">
                        <li class="nav-item" role="tab">
                            <a class="nav-link" href="#received" aria-controls="received" role="tab" data-bs-toggle="tab"><?php echo xlt("Received") ?>
                        ...
                        <li class="nav-item" role="tab">
                            <a class="nav-link" href="#sent" aria-controls="sent" role="tab" data-bs-toggle="tab"><?php echo xlt("Sent") ?></a>
                        </li>
                        <li class="nav-item rc-fax-hide etherfax-hide email-hide" role="tab">
                            <a class="nav-link" href="#messages" aria-controls="messages" role="tab" data-bs-toggle="tab"><?php echo xlt("SMS Log") ?></a>
                        </li>
                        <li class="nav-item email-hide" role="tab">
                            <a class="nav-link" href="#logs" aria-controls="logs" role="tab" data-bs-toggle="tab"><?php echo xlt("Call Log") ?></a>
                        </li>
                        <li class="nav-item etherfax-hide rc-fax-hide" role="tab">
                            <a class="nav-link" href="#alertlogs" aria-controls="alertlogs" role="tab" data-bs-toggle="tab"><?php echo xlt("Reminder Notifications Log") ?><span class="fa fa-redo ms-1" onclick="getNotificationLog(event, this)"
                        ...
                        <li class="nav-item sms-hide email-hide etherfax" role="tab">
                            <a class="nav-link" href="#upLoad" aria-controls="logs" role="tab" data-bs-toggle="tab"><?php echo xlt("Fax Drop Box") ?></a>
                        </li>
                        <?php if ($serviceType == 'email') { ?>
                            <?php
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-sm table-striped" id="sent-details">
                                            ...
                                            <tr>
                                                ...
                                                <th><?php echo xlt("Status") ?></th>
                                                <th><?php echo xlt("Actions") ?></th>
                                                <th><i role="button" id="delete-selected-sent" title="<?php echo xla("Delete selected fax documents") ?>" class="delete-selected-items text-danger fa fa-trash"></i></th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <tr>
