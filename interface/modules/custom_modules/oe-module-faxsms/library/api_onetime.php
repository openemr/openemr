...
function doOnetimeInvoiceRequest(): void
{
    ...
    $data = [
        ...
        'html_message' => "",
        'redirect_url' => OEGlobalsBag::getInstance()->getWebRoot() . "/portal/home.php?" . \OpenEMR\Common\Http\QueryString::build(['site' => (string) $session->get('site_id'), 'landOn' => 'MakePayment']),
        'phone' => $patient['phone'] ?? '',
        'email' => $patient['email'] ?? '',
        'actions' => [
