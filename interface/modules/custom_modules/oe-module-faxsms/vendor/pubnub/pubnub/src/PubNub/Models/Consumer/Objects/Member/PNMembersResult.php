   ...
   * @param integer $totalCount
    ...
    public static function fromPayload(array $payload)
    {
        ...
        if (array_key_exists("data", $payload))
        {
            ...
            {
                array_push($data, PNMembersResultItem::fromPayload($value));
            }
        }

        return new PNMembersResult($totalCount, $prev, $next, $data);
    }
}