...
class a {
    ...
    connect(t) {
        let i;
        try {
            i = this.A.createMediaStreamSource(t), i.connect(this.j)
        } catch (t) {
            return
        }
...
class d {
    ...
    Dt() {
        this.Rt ? this.Tt(new Error("Event stream closed unexpectedly")) : (i((() => this.onbridgeinactive(this))), this.shutdown())
    }
    ...
    start() {
        t(!this.Rt, "Video bridge already active"), console.log("CVB v1.1.5. " + o), this.ft.createBridge(this.At, this.Bt, this.jt).then((t => t.body)).then((t => {
    ...
    shutdown() {
        t(this.Rt, "Video bridge not active"), console.log("CVB v1.1.5. " + o), Object.values(this.Ot).slice().forEach((t => t.stop())), this.xt.cancel(), this.closeLocalMediaStream(), this.Rt = !1
    }
