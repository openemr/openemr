...
class c {
    ...
    attachActivityMonitor(s, e) {
        t(null == this.K, "Activity notifier already attached"), t(null != e, "Activity monitor callback not defined"), this.K = new r, this.K.dbthreshold = s, this.K.ondbthresholdexceeded = t => i.invokeAndIgnoreExceptions((() => e(this))), this.t && this.K.connect(this.t)
    }
