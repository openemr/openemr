...
class CalendarUtils
{
    ...
    public static function isUserLastSeenTimeInActiveRange(\DateTime $dateTime)
    {
        ...
        (\OpenEMR\BC\ServiceContainer::getLogger())->debug("checking time ", ['user_last_update_time' => $currentDateTime->format("Y-m-d H:i:s"), 'now' => $currentDateTime->format("Y-m-d H:i:s")]);
