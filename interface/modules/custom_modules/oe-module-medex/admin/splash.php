<?php
/**
 * MedEx SaaS launcher for unconfigured or not-yet-connected accounts.
 *
 * This page intentionally stays thin. It should not contain a local onboarding
 * wizard or marketing surface; it only redirects admins into the MedEx SaaS
 * registration/dashboard flow and provides a small fallback UI if redirect is
 * not possible.
 */
...
<div class="wrap">
    ...
    <p>
        <?php echo text($connected
            ...
            : xlt('This local page is now a thin launcher. New MedEx onboarding starts in the hosted MedEx application.')); ?>
    </p>
