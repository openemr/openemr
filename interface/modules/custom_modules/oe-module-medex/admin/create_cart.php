<?php
/**
 * Legacy onboarding cart endpoint compatibility stub.
 *
 * Local MedEx cart creation is retired. Subscription selection now continues in
 * the hosted MedEx application.
 */
...
echo json_encode([
    'success' => false,
    'retired' => true,
    'error' => xlt('Local MedEx cart creation is retired. Continue in the hosted MedEx application.'),
