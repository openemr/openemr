...
$syncStats = ['total_synced' => 0, 'last_sync' => null];
$messages = [];

if ($chatSyncTableExists) {
    // Get stats
    $syncStats = sqlQuery(
...
<body>
    <div class="container-fluid">
        ...
        <?php if (!$chatSyncTableExists): ?>
            <div class="alert alert-warning">
                <strong><?php echo xlt('Portal sync is not active for this site.'); ?></strong>
                <div><?php echo xlt('The sync table is missing, so portal-linked chat history is unavailable. Enable portal integration for this customer, then refresh this page.'); ?></div>
            </div>
        <?php endif; ?>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="stat-card">
                    ...
                    <p>
                        <?php if ($chatSyncTableExists): ?>
                            <?php echo xlt('Portal messaging integration is active. Messages sent via MedEx secure chat automatically sync to the portal.'); ?>
                        <?php else: ?>
                            <?php echo xlt('Portal messaging integration is currently inactive for this customer.'); ?>
                        <?php endif; ?>
                    </p>
                    <p>
