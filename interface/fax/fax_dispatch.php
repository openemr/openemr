...
if ($_POST['form_save']) {
    ...
    if ($_POST['form_cb_forward']) {
        ...
        fclose($tmph);
        $tmp0 = exec("cd " . escapeshellarg($webserver_root . '/custom') . "; " . escapeshellcmd((\OpenEMR\BC\ServiceContainer::getCrypto())->decryptStandard($GLOBALS['more_secure']['hylafax_enscript'])) .
