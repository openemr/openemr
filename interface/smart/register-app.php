...
<form id="app_form" method="POST" autocomplete="off">
    <div class="<?php echo $loginrow; ?> card m-5">
        <div class="<?php echo attr($logoarea); ?>">
            ...
            <?php } ?>
            <p class="text-center lead fw-normal login-bg-text-color text-white"><?php echo xlt('The most popular open-source Electronic Health Record and Medical Practice Management solution.'); ?></p>
            ...
            <div>
                ...
                <div class="row" id="systemSetup">
                    <div class="col">
                        ...
                        <hr />
                        <div class="mb-3">
                            <label for="jwksUri" class="text-end"><?php echo xlt('JSON Web Key Set URI'); ?>:</label>
                            <input type="text" class="form-control" id="jwksUri" name="jwksUri" placeholder="<?php echo xla('URI'); ?>" />
                        </div>
                        <div class="mb-3">
                            <label for="jwks" class="text-end"><?php echo xlt('JSON Web Key Set (Note a hosted web URI is preferred and this feature may be removed in future SMART versions)'); ?>:</label>
                ...
                <div class="apiResponse hidden">
                    <div class="mb-3">
                        <label for="clientID" class="text-end"><?php echo xlt('Client APP ID:'); ?></label>
                        <textarea class="form-control" id="clientID" name="clientID"></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="clientSecretID" class="text-end"><?php echo xlt('Client Secret APP ID:'); ?></label>
                        <textarea class="form-control" id="clientSecretID" name="clientSecretID"></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="audURL" class="text-end"><?php echo xlt('Aud URI (use this in the "aud" claim of your JWT)'); ?></label>
