...
<script>
    ...
    function refreshme() {
        top.restoreSession();
        location.href = <?php echo js_escape(OEGlobalsBag::getInstance()->getWebRoot()); ?> + '/interface/therapy_groups/index.php?method=groupDetails&group_id=' + <?php echo js_url($groupId); ?>;
    }
