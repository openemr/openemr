<div class="row" xmlns="http://www.w3.org/1999/html">
    ...
    <div class="col-md-5">
        <a href="<?php echo "javascript:dlgopen('{$GLOBALS['rootdir']}/main/calendar/add_edit_event.php?group=true&groupid={$groupData['group_id']}', '_blank', 775, 500)"; ?>"><button class="float-right"><?php echo xlt('Adding')?></button></a>
    </div>
</div>
        ...
        <div class="col-md-12">
            <?php foreach ($events as $event){ ?>
                ...
                <div class="event_details">
                    <a href="<?php echo "javascript:dlgopen('{$GLOBALS['rootdir']}/main/calendar/add_edit_event.php?group=true&groupid={$groupData['group_id']}&date={$date_for_url}&eid={$event['pc_eid']}', '_blank', 775, 500)"; ?>">
