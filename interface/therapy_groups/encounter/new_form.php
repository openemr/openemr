...
if (!empty($reg)) {
  ...
  if(isset($hide)){
    ...
    $StringEcho.= "<li><a href='JavaScript:void(0);' id='enc2' onclick=\" return top.window.parent.left_nav.loadFrame2('enc2','RBot','therapy_groups/encounter/encounter_top.php')\">" . htmlspecialchars( xl('Encounter Summary'),ENT_NOQUOTES) . "</a></li>";
  }
  if ( $encounterLocked === false ) {
      foreach ($reg as $entry) {
        ...
        $StringEcho.= "<tr><td style='border-top: 1px solid #000000;padding:0px;'><a onclick=\"openNewForm('" . $rootdir .'/therapy_groups/encounter/load_form.php?formname=' .urlencode($entry['directory']) .
...
if ( $encounterLocked === false ) {
    ...
    if (sqlNumRows($lres)) {
      ...
      $title = $lrow['title'];
      $StringEcho.= "<tr><td style='border-top: 1px solid #000000;padding:0px;'><a href='" . $rootdir .'/therapy_groups/encounter/load_form.php?formname='
