...
$group_encounter = $_GET['encounter'];
            ...
            <div class='encounter-summary-column'>
                <div>
                    ...
                    if (is_numeric($group_id)) {
                        ...
                        //todo - add function $result = getGroupData($pid, "fname,lname,squad");
                        $result = array('therapy_group_name' => 'test1');
                        echo htmlspecialchars( xl('for group','',' ',' ') . $result['therapy_group_name'] );
                       /* if ($result['squad'] && ! acl_check('squads', $result['squad'])) {
                        ...
                        $result = sqlQuery("SELECT sensitivity FROM form_groups_encounter WHERE " .
                            "group_id = '$group_id' AND encounter = '$group_encounter' LIMIT 1");
