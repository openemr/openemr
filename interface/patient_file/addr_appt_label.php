...
if (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('chart_label_type') == '1') {
    ...
    $last = 30;
} elseif (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('chart_label_type') == '2') {
    $pdf = new PDF_Label('5161');
    $last = 20;
} elseif (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('chart_label_type') == '3') {
    $pdf = new PDF_Label('5162');
    $last = 14;
} elseif (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('chart_label_type') == '4') {
    $pdf = new PDF_Label('5163');
    $last = 14; //not sure about $last from here on down
} elseif (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('chart_label_type') == '5') {
    $pdf = new PDF_Label('5164');
    $last = 14;
} elseif (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('chart_label_type') == '6') {
    $pdf = new PDF_Label('8600');
    $last = 14;
} elseif (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('chart_label_type') == '7') {
    $pdf = new PDF_Label('L7163');
    $last = 14;
} elseif (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('chart_label_type') == '8') {
