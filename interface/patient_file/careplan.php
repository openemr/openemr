...
<tr style="mso-yfti-irow:1;height:18.75pt"><!-- First Row -->
  ...
  <select name="provider_1">
     <option value="2" <?php if($result['provider_1'] == 2){echo "selected";}?>>Kim Dunn</option>
	 <option value="3" <?php if($result['provider_1'] == 3){echo "selected";}?>>Julie</option>
  </select>  
 ...
 <tr style="mso-yfti-irow:2;height:18.75pt"><!--Second Row -->
  ...
  <select name="provider_2">
     <option value="2" <?php if($result['provider_2'] == 2){echo "selected";}?>>Kim Dunn</option>
	 <option value="3" <?php if($result['provider_2'] == 3){echo "selected";}?>>Julie</option>
  </select>
 ...
 if(!empty($result['diag_2']) && !empty($result['diag_1'])){
  ...
  <select name="provider_3">
     <option value="2" <?php if($result['provider_3'] == 2){echo "selected";}?>>Kim Dunn</option>
	 <option value="3" <?php if($result['provider_3'] == 3){echo "selected";}?>>Julie</option>
  </select>
 ...
 if(!empty($result['diag_2']) && !empty($result['diag_3'])){
  ...
  <select name="provider_4">
     <option value="2" <?php if($result['provider_4'] == 2){echo "selected";}?>>Kim Dunn</option>
	 <option value="3" <?php if($result['provider_4'] == 3){echo "selected";}?>>Julie</option>
  </select>
 ...
 if(!empty($result['diag_3']) && !empty($result['diag_4'])){
  ...
  <select name="provider_5">
     <option value="2" <?php if($result['provider_5'] == 2){echo "selected";}?>>Kim Dunn</option>
	 <option value="3" <?php if($result['provider_5'] == 3){echo "selected";}?>>Julie</option>
  </select>
