...
$fake_register_globals=false;
	...
	require_once("$srcdir/careplan.inc");
...
<tr style="mso-yfti-irow:1;height:18.75pt"><!-- First Row -->
  ...
  <?php  $code = $result['diag_1'];  echo "<font size='2'>".codeNameTxt($code)."</font>"; ?>
  </td>
...
<?php echo trim($result['assessment_1'], " ") . "\n"; if(!empty($result['assessment_1']) && $result['audit'] == 0){echo $date . "--";}?></textarea>
...
<?php echo $result['goal_1'] . "\n"; if(!empty($result['goal_1']) && $result['audit'] == 0){ echo $date . "--";}?>
  </textarea>
 ...
 <tr style="mso-yfti-irow:2;height:18.75pt"><!--Second Row -->
  ...
  <input type="text" name="diagnosis_2" id="codesearch" value="<?php echo $result['diag_2']; ?>"
         onclick='sel_diagnosis(this)' title='<?php echo htmlspecialchars(xl('Click to select or change diagnoses'),ENT_QUOTES); ?>' readonly />
    <?php  $code = $result['diag_2'];  echo "<font size='2'>".codeNameTxt($code)."</font>"; ?>
  </td>
  <td width="68" valign="top" style="width:50.9pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
...
<?php echo $result['assessment_2'] . "\n"; if(!empty($result['assessment_2']) && $result['audit'] == 0){ echo $date . "--";}?></textarea>
  </td>
  <td width="105" valign="top" style="width:78.95pt;border:solid windowtext 1.0pt;
  border-left:none;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
  solid windowtext .5pt;height:41.6pt">
...
<?php echo $result['goal_2'] . "\n"; if(!empty($result['goal_2']) && $result['audit'] == 0){ echo $date . "--";}?></textarea>
  </td>
  <td width="69" valign="top" style="width:51.7pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
 ...
 if(!empty($result['diag_2']) && !empty($result['diag_1'])){
  ...
  <input type="text" name="diagnosis_3"  value="<?php echo $result['diag_3'] ?>"
         onclick='sel_diagnosis(this)' title='<?php echo htmlspecialchars(xl('Click to select or change diagnoses'),ENT_QUOTES); ?>' readonly />
<?php  $code = $result['diag_3'];  echo "<font size='2'>".codeNameTxt($code)."</font>"; ?> 
   </td>
  <td width="68" valign="top" style="width:50.9pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
...
<?php echo $result['assessment_3'] . "\n"; if(!empty($result['assessment_3']) && $result['audit'] == 0){ echo $date . "--";}?></textarea>
  </td>
  <td width="105" valign="top" style="width:78.95pt;border:solid windowtext 1.0pt;
  border-left:none;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
  solid windowtext .5pt;height:41.6pt">
...
<?php echo $result['goal_3'] . "\n"; if(!empty($result['goal_3']) && $result['audit'] == 0){echo $date . "--";}?></textarea>
  </td>
  <td width="69" valign="top" style="width:51.7pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
 ...
 if(!empty($result['diag_2']) && !empty($result['diag_3'])){
  ...
  <input type="text" name="diagnosis_4"  value="<?php echo $result['diag_4'] ?>"
         onclick='sel_diagnosis(this)' title='<?php echo htmlspecialchars(xl('Click to select or change diagnoses'),ENT_QUOTES); ?>' readonly />
<?php  $code = $result['diag_4'];  echo "<font size='2'>".codeNameTxt($code)."</font>"; ?> 
  </td>
  <td width="68" valign="top" style="width:50.9pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
...
<?php echo $result['goal_4'] . "\n"; if(!empty($result['goal_4']) && $result['audit'] == 0){echo $date . "--";}?></textarea>
  </td>
  <td width="69" valign="top" style="width:51.7pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
 ...
 if(!empty($result['diag_3']) && !empty($result['diag_4'])){
  ...
  <input type="text" name="diagnosis_5"  value="<?php echo $result['diag_5'] ?>"
         onclick='sel_diagnosis(this)' title='<?php echo htmlspecialchars(xl('Click to select or change diagnoses'),ENT_QUOTES); ?>' readonly />
<?php  $code = $result['diag_5'];  echo "<font size='2'>".codeNameTxt($code)."</font>"; ?>
  </td>
  <td width="68" valign="top" style="width:50.9pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
...
<?php echo $result['assessment_5'] . "\n"; if(!empty($result['assessment_5']) && $result['audit'] == 0){ echo $date . "--"; }?></textarea>
  </td>
  <td width="105" valign="top" style="width:78.95pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
...
<?php echo $result['goal_5'] . "\n"; if(!empty($result['goal_5']) && $result['audit'] == 0){ echo $date . "--";}?></textarea>
  </td>
  <td width="69" valign="top" style="width:51.7pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
 ...
 <!-- PM History  -->
  ...
  mso-border-alt:solid windowtext .5pt;height:19.75pt">
      &nbsp;
  <textarea name='pmh' cols="90" <?php if($result['audit'] == 1){echo "readonly"; } ?>><?php
  echo "\n";
  echo " -----\n";
...
?></textarea>
 ...
 <tr style="mso-yfti-irow:4;height:19.75pt">
  ...
  mso-border-alt:solid windowtext .5pt;height:19.75pt">
    &nbsp;
    <textarea name='psh' cols="90" readonly<?php ///if($result['audit'] == 1){echo "readonly"; } ?>><?php //echo $result['psh']; ?><?php 
...
?></textarea>
 ...
 <tr style="mso-yfti-irow:5;mso-yfti-lastrow:yes;height:24.95pt">
  ...
  mso-border-alt:solid windowtext .5pt;height:24.95pt">
    &nbsp;
  <textarea name='sh' cols="90" <?php if($result['audit'] == 1){echo "readonly"; } ?>><?php
  echo "\n";
  echo "----- \n";
   $his_date = explode( " ", $his_array['date']);
   $newInfo = $his_date[0];
