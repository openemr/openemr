...
if ($authorized && $pid > 0) {
    ...
    foreach ($questionnaireRecords as $questionnaireRecord) {
        $questionnaireId = $assessmentPositiveInt($questionnaireRecord['id'] ?? null);
...
<div class="<?php echo attr($container); ?> mt-3">
    ...
    <?php else : ?>
        ...
        <div id="assessment-catalog">
            <div class="card my-3">
                <div class="card-header">
                    <span class="font-weight-bold"><?php echo xlt('Available Assessments'); ?></span>
                </div>
                <div class="card-body">
                        ...
                        <?php foreach ($questionnairesByCategory as $categoryTitle => $questionnaires) : ?>
                            ...
                            <div class="row">
                                <?php foreach ($questionnaires as $questionnaire) : ?>
                                    <?php
                                    $questionnaireId = $assessmentPositiveInt($questionnaire['id'] ?? null);
                                    if ($questionnaireId === null) {
                                        continue;
                                    }
                                    ...
                                    <div class="col-12 col-lg-6 col-xl-4 mb-3">
                                        <div class="card h-100">
                                            <div class="card-body d-flex flex-column">
                                                <h6 class="card-title font-weight-bold"><?php echo text($name); ?></h6>
                                                <?php if ($description !== '') : ?>
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <span class="font-weight-bold"><?php echo xlt('Assessment History'); ?></span>
                </div>
                <div class="card-body">
