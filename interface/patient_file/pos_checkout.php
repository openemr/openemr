...
//
function generate_receipt($patient_id, $encounter=0) { //REMEMBER the entire receipt is generated here, have to echo DOC type etc and closing tags to create a valid webpsge
				...
				<div class="form-group clearfix">
					<div class="col-sm-12 text-center" id="hideonprint">
						<div class="btn-group" role="group">
							<a href='#' class="btn btn-default btn-print"  id='printbutton'><?php echo xlt('Print'); ?></a> 
							<?php if (acl_check('acct','disc')) { ?> 
								<a href='#' class="btn btn-default btn-undo" onclick='return deleteme();'><?php echo xlt('Undo Checkout'); ?></a> 
							<?php } ?>
							<?php if ($details) { ?> 
								<a href='pos_checkout.php?details=0&ptid=<?php echo attr($patient_id); ?>&enc=<?php echo attr($encounter); ?>' class="btn btn-default btn-hide" onclick='top.restoreSession()'><?php echo xlt('Hide Details'); ?></a> 
							<?php } else { ?> 
								<a href='pos_checkout.php?details=1&ptid=<?php echo attr($patient_id); ?>&enc=<?php echo attr($encounter); ?>' class="btn btn-default btn-show" onclick='top.restoreSession()'><?php echo xlt('Show Details'); ?></a> 
							<?php } ?>
						</div>
					</div>
				</div>
