...
function receiptDetailLine(
    ...
    echo "  <td class='text-end'>" . text(oeFormatMoney($price, false, true)) . "</td>\n";

    if (!empty($GLOBALS['gbl_checkout_charges'])) {
        echo "  <td class='text-end'>" . text(oeFormatMoney($charge, false, true)) . "</td>\n";
    }

    if (!$TAXES_AFTER_ADJUSTMENT) {
        // Write tax amounts.
        foreach ($aTaxes as $tax) {
            echo "  <td class='text-end'>" . text(oeFormatMoney($tax, false, true)) . "</td>\n";
        }
    }
    ...
    if (!empty($GLOBALS['gbl_checkout_line_adjustments'])) {
        ...
        echo "  <td class='text-end'>" . text(oeFormatMoney($adjust, false, true)) . "</td>\n";
    }
