...
<body>
    <div id="container_div" class="<?php echo $oemr_ui->oeContainer();?> mt-3">
        <div id="patient_reports"> <!-- large outer DIV -->
            ...
            <?php
            if (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('activate_ccr_ccd_report')) { // show CCR/CCD reporting options ?>
                    ...
                    <form name='ccr_form' id='ccr_form' method='post' action='../../../ccr/createCCR.php'>
                        <fieldset>
                            <div class="col-sm-12">
                                ...
                                <?php
                                if (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('phimail_enable') == true && \OpenEMR\Core\OEGlobalsBag::getInstance()->get('phimail_ccr_enable') == true) { ?>
                        ...
                        <fieldset>
                            <div class="col-sm-12">
                                ...
                                <?php
                                if (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('phimail_enable') == true && \OpenEMR\Core\OEGlobalsBag::getInstance()->get('phimail_ccd_enable') == true) { ?>
...
$(function () {
    ...
    <?php if (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('phimail_enable') == true && \OpenEMR\Core\OEGlobalsBag::getInstance()->get('phimail_ccr_enable') == true) { ?>
