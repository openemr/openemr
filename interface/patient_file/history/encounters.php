...
<td><span class=bold>Patient Notes</span></td>
...
if ($result = getEncounters($pid)) {
	foreach ($result as $iter ) {
		...
		if ($count >= $N) {
			...
			print "<tr><td colspan=5 align=center><a target=Main href='encounters_full.php' class=alert>Some encounters were not displayed. Click here to view all.</a></td></tr>\n";
			break;
		}
		//print_r($iter);print "<br/>";
