...
function sel_related(e) {
 ...
 dlgopen('../encounter/find_code_popup.php<?php echo (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('ippf_specific')) ? '?codetype=REF' : ''?>', '_blank', 500, 400);
}
...
<div id="container_div" class="container-xl mt-3">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <form action="history_save.php" id="HIS" name='history_form' method='post' onsubmit="submitme(<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('new_validate') ? 1 : 0;?>,event,'HIS',constraints)">
