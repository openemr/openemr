...
<td>
    <a href="#" id="close" class="btn btn-default btn-large" onclick="parent.$.fn.fancybox.close(); return false;">
        <span class='btn btn-default btn-large'><?php echo htmlspecialchars(xl('Close'), ENT_NOQUOTES);?></span>
    </a>
</td>
</tr>
</table>
