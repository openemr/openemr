...
<dd><a class="text" href="superbill_codes.php" target="Main"><?php xl('Superbill','e'); ?></a></dd>

<?php foreach ($code_types as $key => $value) { ?>
<dd><a class="text" href="search_code.php?type=<? echo $key ?>" target="Codes"><?php echo $key; ?> <?php xl('Search','e'); ?></a></dd>
<?php } ?>
