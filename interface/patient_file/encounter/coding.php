...
<dd><a class="text" href="<?=$GLOBALS['webroot']?>/controller.php?<?=$pres?>&list&id=<?=$pid?>" target="Codes"><?php xl('List Prescriptions','e'); ?></a></dd>
<dd><a class="text" href="<?=$GLOBALS['webroot']?>/controller.php?<?=$pres?>&edit&id=&pid=<?=$pid?>" target="Codes"><?php xl('Add Prescription','e'); ?></a></dd>
</dl>
