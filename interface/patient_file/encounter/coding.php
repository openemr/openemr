...
<?php if (!\OpenEMR\Core\OEGlobalsBag::getInstance()->get('disable_prescriptions')) { ?>
<dt><span href="coding.php" class="title"><?php echo xlt('Prescriptions'); ?></span></dt>
<dd><a class="text" href="<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('webroot')?>/controller.php?prescription&list&id=<?php echo attr_url($pid); ?>"
 target="Codes" onclick="top.restoreSession()"><?php echo xlt('List Prescriptions'); ?></a></dd>
<dd><a class="text" href="<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('webroot')?>/controller.php?prescription&edit&id=&pid=<?php echo attr_url($pid); ?>"
