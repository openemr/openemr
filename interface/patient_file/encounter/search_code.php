...
<div id="searchspinner" style="display: inline; visibility: hidden;"><img src="<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('webroot') ?>/interface/pic/ajax-loader.gif"></div>
