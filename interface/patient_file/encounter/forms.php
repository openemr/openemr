...
<div class="container-fluid">
    <div class="row">
        <div class="col-xs-12 col-sm-2 sidebar sidebar-md-show <?php echo $_SESSION['language_direction'] == 'rtl' ? 'sidebar-right' : 'sidebar-left'; ?>">            <ul class="nav navbar-stacked mainmenu">
