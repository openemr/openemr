...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          ...
          media="screen"/>
    <style
        type="text/css">@import url(../../../library/dynarch_calendar.css);</style>
        ...
        <div class='encounter-summary-column'>
            ...
            <div style='margin-top:8px;'>
                ...
                <a href="#" class="btn btn-default btn-sm"
                   onClick='expandcollapse("expand");'><?php xl('Expand All', 'e'); ?></a>
                <a href="#" class="btn btn-default btn-sm"
                   onClick='expandcollapse("collapse");'><?php xl('Collapse All', 'e'); ?></a>
            </div>
        </div>
