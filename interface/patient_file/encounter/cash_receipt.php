...
<table>
<tr><td><?php xl('Generated on','e');
?>:</td><td> <?php print oeFormatShortDate(date("Y-m-d"));?></td></tr>
<?php
...
?>
<tr><td><?php xl('Date Of Service','e');
?>: </td><td> <?php print oeFormatShortDate($raw_encounter_date);?></td></tr>
</table>
<br><br>
<?php
...
?>
<tr><td><?php xl('code type','e');
?></td><td><?php xl('code','e');
?></td><td><?php xl('description','e');
?></td><td><?php xl('fee','e'); ?></td></tr>
<?php
    $key = "ICD9";
