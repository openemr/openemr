...
<form name=icd9_form method=post action=hcpcs_codes.php>
<input type=hidden name=mode value="search">

<span class="title" href="hcpcs_codes.php">HCPCS Codes</span><br>
...
if ($res = sqlStatement("select * from codes where (code_text like '%".$_POST["text"]."%' or code like '%".$_POST["text"]."%') and code_type = '" . CODE_TYPE_HCPCS . "' order by code limit " . ($M + 1)) ) {
