...
<?php Header::setupHeader(['opener']);?>
    <?php if (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('payment_gateway') == 'Stripe') { ?>
        <script src="https://js.stripe.com/v3/"></script>
    <?php } ?>
    <?php if (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('payment_gateway') == 'AuthorizeNet') {
        // Must be loaded from their server
        $script = "https://jstest.authorize.net/v1/Accept.js"; // test script
        if (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('gateway_mode_production')) {
        ...
        <div class="row">
            ...
            <div class="col-12 justify-content-center">
                ...
                <div class="main-section mb-5 mt-10">
                    ...
                    <div class="section-1">
                        <?php if (file_exists(\OpenEMR\Core\OEGlobalsBag::getInstance()->get('OE_SITE_WEBROOT') . "/images/logo_1.png")) { ?>
                            <img src=<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('OE_SITE_WEBROOT') . "/images/logo_1.png" ?> alt="facility_logo" class="img-fluid">
                        <?php } ?>
...
<script src="<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('assets_static_relative'); ?>/jquery-creditcardvalidator/jquery.creditCardValidator.js"></script>

<script>
    var chargeMsg = <?php echo xlj('Payment was successfully authorized and charged. Thank You.'); ?>;
    var publicKey = <?php echo json_encode($cryptoGen->decryptStandard(\OpenEMR\Core\OEGlobalsBag::getInstance()->get('gateway_public_key'))); ?>;
$(function() {
...
<tr id="tr_<?=$idx?>">
    ...
    <td class="text-right">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12 text-left position-override">
                            <div class="form-group" role="group" id="button-group">
                                ...
                                <?php if (!empty(\OpenEMR\Core\OEGlobalsBag::getInstance()->get('cc_front_payments')) && \OpenEMR\Core\OEGlobalsBag::getInstance()->get('payment_gateway') != 'InHouse') {
                                    if (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('payment_gateway') == 'Sphere') {
                                        ...
                                        if (!empty(\OpenEMR\Core\OEGlobalsBag::getInstance()->get('cc_stripe_terminal'))) {
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <?php }
                        if (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('payment_gateway') == 'Stripe') { ?>
                    ...
                    <div class="modal-footer">
                        <div class="button-group">
                            ...
                            <?php
                            if (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('payment_gateway') == 'AuthorizeNet') { ?>
        ...
        <?php if (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('payment_gateway') == 'Stripe') { // Begin Include Stripe ?>
            <script>
                ...
                // terminal
                <?php if (!empty(\OpenEMR\Core\OEGlobalsBag::getInstance()->get('cc_stripe_terminal'))) { ?>
