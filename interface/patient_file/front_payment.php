            ...
            <div class = "container">
                ...
                <div class= "row ">        
                    <div class="form-group clearfix">
                        <div class="col-sm-12 text-center position-override" id="hideonprint">
                            <div class="btn-group" role="group">
                                ...
                                <?php if (acl_check('admin', 'super')) { ?>
                                    <button type='button'  class="btn btn-link btn-cancel btn-delete btn-separate-left" onclick='deleteme()'><?php echo xlt('Delete'); ?></button>
                                <?php } ?>
