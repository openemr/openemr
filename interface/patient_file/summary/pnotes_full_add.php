...
if (isset($mode)) {
    ...
    if ($mode == "update") {
        ...
        if ($noteid) {
            deletePnote($noteid);
            EventAuditLogger::getInstance()->newEvent("delete", $_SESSION['authUser'], $_SESSION['authProvider'], "pnotes: id " . $noteid);
        }
            ...
            <form class='border-0' method='post' name='new_note' id="new_note" action='pnotes_full.php?<?php echo $urlparms; ?>'>
                ...
                <div class="mb-3 mt-3">
                    ...
                    // Modified 6/2009 by BM to incorporate the patient notes into the list_options listings
                        ...
                        "<span class='fw-bold'> &quot;" . generate_display_field(['data_type' => '1','list_id' => 'note_type'], $title) . "&quot;</span>\n";
                    } else {
