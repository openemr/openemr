...
<a href="demographics_full.php" target=Main><font class=title>Demographics</font><font class=more><?echo $tmore;?></font></a>
...
<tr>
<td valign=top><span class=bold>Name: </span><span class=text><?echo $result{"title"}?> <?echo $result{"fname"}?> <?echo $result{"mname"}?> <?echo $result{"lname"}?></span><br>
...
<tr><td><? if ($result3{"copay"} != "") {?><span class=bold>CoPay: </span><span class=text><?=$result3{"copay"}?></span><?}?></td></tr>
<?
}
?>
...
<tr><td><? if ($result4{"copay"} != "") {?><span class=bold>CoPay: </span><span class=text><?=$result4{"copay"}?></span><?}?></td></tr>
<?
}
?>
...
<tr><td><? if ($result5{"copay"} != "") {?><span class=bold>CoPay: </span><span class=text><?=$result5{"copay"}?></span><?}?></td></tr>
<?
}
?>
