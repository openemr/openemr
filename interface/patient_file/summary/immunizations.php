...
$clickoptions_category = "immunization";
...
if ($mode == "update") {
	...
	addList($pid,"immunization",$_POST["title"],$_POST["comments"],1);
}
}
...
<form border=0 method=post name=new_note action="immunizations.php">
...
<br>
<a href="javascript:document.new_note.submit();" class=link_submit>[Add New Immunization]</a>
</form>


<form border=0 method=post name=update_activity action="immunizations.php">
...
<a href="immunizations.php?offset=0&active=all" class=<?echo $all_class;?>>[All]</a>
<a href="immunizations.php?offset=0&active=1" class=<?echo $active_class;?>>[Only Active]</a>
<a href="immunizations.php?offset=0&active=0" class=<?echo $inactive_class;?>>[Only Inactive]</a>
...
<span class=text>
<?
if ($result = getListByType($pid, "immunization", "id,title,comments,activity,date", $active, "all", 0)){
