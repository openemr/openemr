                    ...
                    <?php if(count($imm_obs_data) > 0) {
                        foreach($imm_obs_data as $key=>$value) {
                          ...
                          <tr id="or_tr_<?php echo $key + 1 ;?>">
                            ...
                            $style = 'display : table-cell;width:765px !important';
                            ?>
                            <td id="observation_criteria_td_<?php echo $key + 1 ;
?>" style="<?php echo $style;?>">
                          ...
                          <select id="observation_criteria_<?php echo $key + 1 ;?>" name="observation_criteria[]" onchange="selectCriteria(this.id,this.value);" style="width: 220px;">
                              ...
                              <option value="<?php echo attr($valo['option_id']);
?>" <?php if($valo['option_id'] == $value['imo_criteria'] && $id !=0) echo 'selected = "selected"' ;
?> ><?php echo text($valo['title']);?></option>
                            ...
                            <td <?php if($value['imo_criteria'] != 'funding_program_eligibility' || $id == 0) { ?> style="display: none;" <?php } ?> class="observation_criteria_value_td" id="observation_criteria_value_td_<?php echo $key + 1 ;?>">
                              ...
                              <option value="<?php echo attr($valoc['option_id']);
?>" <?php if($valoc['option_id'] == $value['imo_criteria_value']  && $id != 0) echo 'selected = "selected"' ;
?>><?php echo text($valoc['title']);?></option>
                            ...
                            <td <?php if($value['imo_criteria'] != 'disease_with_presumed_immunity' || $id == 0) { ?> style="display: none;" <?php } ?> class="code_serach_td" id="code_search_td_<?php echo $key + 1 ;?>">
                              ...
                              <input type="text" id="sct_code_<?php echo $key_snomed;
?>" style="width:140px" name="sct_code[]" class="code" value="<?php if($id != 0 && $value['imo_criteria'] == 'disease_with_presumed_immunity') echo attr($value['imo_code']);?>"  onclick='sel_code(this.id);'><br>
                              <span id="displaytext_<?php echo $key_snomed;
?>" style="width:210px !important;display: block;font-size:13px;color: blue;" class="displaytext"><?php  echo text($value['imo_codetext']);?></span>
                              <input type="hidden" id="codetext_<?php echo $key_snomed;
?>" name="codetext[]" class="codetext" value="<?php echo attr($value['imo_codetext']); ?>">
                            ...
                            <td <?php if($value['imo_criteria'] != 'vaccine_type' || $id == 0) { ?> style="display: none;" <?php } ?> class="code_serach_vaccine_type_td" id="code_serach_vaccine_type_td_<?php echo $key + 1 ;?>">
                              ...
                              <div class="imm-imm-add-12" id="imm-imm-add-12<?php echo $key_cvx ;
?>"><?php if($id != 0 && $value['imo_criteria'] == 'vaccine_type') echo text($value['imo_codetext']);?></div>
                              <input type="hidden"  value="CVX" name="code_type_hidden[]" id="code_type_hidden<?php echo $key_cvx ;?>" />
                              <input type="hidden" class="code_text_hidden" name="code_text_hidden[]" id="code_text_hidden<?php echo $key_cvx ;
?>" value="<?php if($id != 0 && $value['imo_criteria'] == 'vaccine_type') echo attr($value['imo_codetext']);?>"/>
                            </td>
                            <td <?php if($value['imo_criteria'] != 'vaccine_type' || $id == 0) { ?> style="display: none;" <?php } ?> class="vis_published_date_td" id="vis_published_date_td_<?php echo $key + 1 ;?>">
                              <label><?php echo htmlspecialchars( xl('Date VIS Published'), ENT_QUOTES); ?></label>
                                ...
                                ?>
                              <input type="text" class='datepicker' name="vis_published_date[]" value="<?php if($id != 0 && $vis_published_dateval != 0) echo attr($vis_published_dateval);
?>" id="vis_published_date_<?php echo $key + 1 ;?>" style="width:140px">
                            ...
                            <td <?php if($value['imo_criteria'] != 'vaccine_type' || $id == 0) { ?> style="display: none;" <?php } ?> class="vis_presented_date_td" id="vis_presented_date_td_<?php echo $key + 1 ;?>">
                              <label><?php echo htmlspecialchars( xl('Date VIS Presented'), ENT_QUOTES); ?></label>
                                ...
                                ?>
                              <input type="text" class='datepicker' name="vis_presented_date[]" value="<?php if($id != 0 && $vis_presented_dateval !=0) echo attr($vis_presented_dateval);
?>" id="vis_presented_date_<?php echo $key + 1 ;?>" style="width:140px">
                            </td>
                            <?php if($key != 0 && $id != 0) {?>
                        <td>
                          <img src='../../pic/remove.png' id ="<?php echo $key +1;
?>" onclick="RemoveRow(this.id);" align='absbottom' width='24' height='22' border='0' style='cursor:pointer;cursor:hand' title='<?php echo xla('Click here to delete the row'); ?>'>
                        </td>
                        <?php } ?>
                          </tr>
                        <?php }
