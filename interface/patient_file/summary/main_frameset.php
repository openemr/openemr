...
<title><?php echo $featureData[$feature]['title']; ?></title>
</head>

<frameset cols="18%,*" id="main_frame">
 <frame src="left_frame.php?feature=<?php echo attr($feature); ?>" name="leftFrame" scrolling="auto"/>
 <?php if ( $id ) { ?>
 	<frame src="<?php echo $GLOBALS['webroot'] ?>/interface/patient_file/summary/<?php echo attr($featureData[$feature]['addLink']); ?>?id=<?php echo $id ?>"
		name="rightFrame" scrolling="auto"/>
 <?php } else { ?>
	<frame src="<?php echo $GLOBALS['webroot'] ?>/interface/patient_file/summary/<?php echo attr($featureData[$feature]['listLink']); ?>?id=<?php echo $pid ?>"
		name="rightFrame" scrolling="auto"/>
 <?php } ?>
</frameset>
