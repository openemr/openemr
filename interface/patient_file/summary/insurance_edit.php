...
$insurancei = \OpenEMR\Core\OEGlobalsBag::getInstance()->get('insurance_information') != '0' ? getInsuranceProvidersExtra() : getInsuranceProviders();
...
$state_data_type = \OpenEMR\Core\OEGlobalsBag::getInstance()->get('state_data_type') === '26' ? '1' : \OpenEMR\Core\OEGlobalsBag::getInstance()->get('state_data_type');
$country_data_type = \OpenEMR\Core\OEGlobalsBag::getInstance()->get('country_data_type') === '26' ? '1' : \OpenEMR\Core\OEGlobalsBag::getInstance()->get('country_data_type');
echo $twig->render(
    ...
    [
        ...
        ,'enableSwapSecondaryInsurance' => \OpenEMR\Core\OEGlobalsBag::getInstance()->get('enable_swap_secondary_insurance')
        ,'include_employers' => empty(\OpenEMR\Core\OEGlobalsBag::getInstance()->get('omit_employers')) === true
        ,'useStateTerminology' => \OpenEMR\Core\OEGlobalsBag::getInstance()->get('phone_country_code') === '1'
        ,'state_list' => \OpenEMR\Core\OEGlobalsBag::getInstance()->get('state_list')
        ,'state_data_type' => $state_data_type
        ,'country_data_type' => $country_data_type
        ,'country_list' => \OpenEMR\Core\OEGlobalsBag::getInstance()->get('country_list')
        // policy_types is defined in patient.inc.php
        ,'policy_types' => \OpenEMR\Core\OEGlobalsBag::getInstance()->get('policy_types')
        ,'uspsVerifyAddress' => \OpenEMR\Core\OEGlobalsBag::getInstance()->get('usps_apiv3_client_id')
        ,'languageDirection' => \OpenEMR\Core\OEGlobalsBag::getInstance()->get('language_direction') ?? ''
        ,'rightJustifyLabels' => \OpenEMR\Core\OEGlobalsBag::getInstance()->get('right_justify_labels_demographics')
    ]
);
exit;
