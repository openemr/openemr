...
?>
<title><?php echo xlt('Edit Insurance'); ?></title>
...
<form action='insurance_save.php' name='insurance_form' id="INS" method='post' class='form-inline'
 onsubmit="submitme(<?php echo $GLOBALS['new_validate'] ? 1 : 0;?>,event,'INS',constraints)">
...
<input type="hidden" name="isSwapClicked" value="" />
    ...
    <div class="container-xl">
        <div class="row">
            <div class="col-12">
                <h2><?php echo xlt('Edit Insurance');?></h2>
            </div>
            <div class="col-12">
                <div class="btn-group">
