                        ...
                        <div class="list-group-item p-1">
                            <div class="summary m-0 p-0 d-flex w-100 justify-content-end align-content-center">
                                ...
                                <div class="flex-fill ps-2">
                                    <div class="btn-group" role="group">
                                        <button type="button" class="btn btn-outline-text btn-sm collapsed" data-bs-toggle="collapse" data-bs-target="#details_<?php echo attr($row['id']); ?>" aria-expanded="false" aria-controls="details_<?php echo attr($row['id']); ?>"><span aria-hidden="true" class="fa fa-fw fa-chevron-right"></span></button>
                                    ...
                                    <a href="#" data-issue-id="<?php echo attr($row['id']); ?>" class="fw-bold issue_title" data-bs-toggle="tooltip" data-bs-placement="right" title="<?php echo text(($diag ?? '') . ": " . ($codedesc ?? '')); ?>">
...
$(function () {
    ...
    $('[data-action="toggle"]').on('click', function(e) {
        ...
        let selector = (isExp === "false") ? "[data-bs-toggle='collapse'].collapsed" : "[data-bs-toggle='collapse']";
