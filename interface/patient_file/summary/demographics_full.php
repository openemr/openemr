...
<body class="body_top">
        ...
        onsubmit="submitme(<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('new_validate') ? 1 : 0; ?>,event,'DEM',constraints)">
    ...
    <script>
        ...
        if (f.form_phone_cell) phonekeyup(f.form_phone_cell, mypcc);
            ...
            <?php if (!\OpenEMR\Core\OEGlobalsBag::getInstance()->get('simplified_demographics')) { ?>
    ...
    <script>
        ...
        <?php if ((\OpenEMR\Core\OEGlobalsBag::getInstance()->get('gbl_edit_patient_form') == '1') && (checkIfPatientValidationHookIsActive())) :?>
        ...
        $("#btnSubmit").click(function (event) {
            ...
            if (!submitme(<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('new_validate') ? 1 : 0;?>, event, 'DEM', constraints)) {
        ...
        $(function () {
            ...
            <?php if (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('usps_apiv3_client_id')) { ?>
