...
if ($mode == "update") {
	...
	addList($pid,"surgery",$_POST["title"], $_POST["comments"],1);
}
}
...
<a href="patient_summary.php" target="Main"><font class="title">Surgeries</font><font class=back><?echo $tback;?></font></a>
<br>
...
<br>
<a href="javascript:document.new_note.submit();" class=link_submit>[Add New Surgery]</a>
</form>


<form border=0 method=post name=update_activity action="surgeries.php">
...
<a href="surgeries.php?offset=0&active=all" class=<?echo $all_class;?>>[All]</a>
<a href="surgeries.php?offset=0&active=1" class=<?echo $active_class;?>>[Only Active]</a>
<a href="surgeries.php?offset=0&active=0" class=<?echo $inactive_class;?>>[Only Inactive]</a>
...
<span class=text>
<?
if ($result = getListByType($pid, "surgery", "id,title,comments,activity,date", $active, "all", 0)){
