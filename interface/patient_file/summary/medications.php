...
if ($mode == "update") {
	...
	addList($pid,"medication",$_POST["title"],$_POST["comments"],1);
}
}
...
<a href="patient_summary.php" target="Main"><font class="title">Medications</font><font class=back><?echo $tback;?></font></a>
<br>
...
<form border=0 method=post name=update_activity action="medications.php">
...
<a href="medications.php?offset=0&active=all" class=<?echo $all_class;?>>[All]</a>
<a href="medications.php?offset=0&active=1" class=<?echo $active_class;?>>[Only Active]</a>
<a href="medications.php?offset=0&active=0" class=<?echo $inactive_class;?>>[Only Inactive]</a>
...
<span class=text>
<?
if ($result = getListByType($pid, "medication", "id,title,comments,activity,date", $active, "all", 0)){
