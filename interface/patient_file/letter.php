...
<?php echo $optto; ?>
 ...
 <tr>
  <td colspan='4'>
    ...
    <option value="<?php echo '{'.$FIELD_TAG['DATE'].'}';
?>"><?php xl('Today\'s Date','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['FROM_TITLE'].'}';
?>"><?php xl('FROM','e');
?> - <?php xl('Title','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['FROM_FNAME'].'}';
?>"><?php xl('FROM','e');
?> - <?php xl('First name','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['FROM_MNAME'].'}';
?>"><?php xl('FROM','e');
?> - <?php xl('Middle name','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['FROM_LNAME'].'}';
?>"><?php xl('FROM','e');
?> - <?php xl('Last name','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['FROM_STREET'].'}';
?>"><?php xl('FROM','e');
?> - <?php xl('Street','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['FROM_CITY'].'}';
?>"><?php xl('FROM','e');
?> - <?php xl('City','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['FROM_STATE'].'}';
?>"><?php xl('FROM','e');
?> - <?php xl('State','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['FROM_POSTAL'].'}';
?>"><?php xl('FROM','e');
?> - <?php xl('Postal Code','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['FROM_VALEDICTORY'].'}';
?>"><?php xl('FROM','e');
?> - <?php xl('Valedictory','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['FROM_PHONECELL'].'}';
?>"><?php xl('FROM','e');
?> - <?php xl('Cell Phone','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['FROM_PHONE'].'}';
?>"><?php xl('FROM','e');
?> - <?php xl('Phone','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['FROM_EMAIL'].'}';
?>"><?php xl('FROM','e');
?> - <?php xl('email','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['TO_TITLE'].'}';
?>"><?php xl('TO','e');
?> - <?php xl('Title','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['TO_FNAME'].'}';
?>"><?php xl('TO','e');
?> - <?php xl('First name','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['TO_MNAME'].'}';
?>"><?php xl('TO','e');
?> - <?php xl('Middle name','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['TO_LNAME'].'}';
?>"><?php xl('TO','e');
?> - <?php xl('Last name','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['TO_STREET'].'}';
?>"><?php xl('TO','e');
?> - <?php xl('Street','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['TO_CITY'].'}';
?>"><?php xl('TO','e');
?> - <?php xl('City','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['TO_STATE'].'}';
?>"><?php xl('TO','e');
?> - <?php xl('State','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['TO_POSTAL'].'}';
?>"><?php xl('TO','e');
?> - <?php xl('Postal Code','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['TO_VALEDICTORY'].'}';
?>"><?php xl('TO','e');
?> - <?php xl('Valedictory','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['TO_ORGANIZATION'].'}';
?>"><?php xl('TO','e');
?> - <?php xl('Organization','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['TO_FAX'].'}';
?>"><?php xl('TO','e');
?> - <?php xl('Fax number','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['TO_PHONE'].'}';
?>"><?php xl('TO','e');
?> - <?php xl('Phone number','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['TO_PHONECELL'].'}';
?>"><?php xl('TO','e');
?> - <?php xl('Cell phone number','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['PT_FNAME'].'}';
?>"><?php xl('PATIENT','e');
?> - <?php xl('First name','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['PT_MNAME'].'}';
?>"><?php xl('PATIENT','e');
?> - <?php xl('Middle name','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['PT_LNAME'].'}';
?>"><?php xl('PATIENT','e');
?> - <?php xl('Last name','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['PT_STREET'].'}';
?>"><?php xl('PATIENT','e');
?> - <?php xl('Street','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['PT_CITY'].'}';
?>"><?php xl('PATIENT','e');
?> - <?php xl('City','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['PT_STATE'].'}';
?>"><?php xl('PATIENT','e');
?> - <?php xl('State','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['PT_POSTAL'].'}';
?>"><?php xl('PATIENT','e');
?> - <?php xl('Postal Code','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['PT_PHONE_HOME'].'}';
?>"><?php xl('PATIENT','e');
?> - <?php xl('Phone Home','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['PT_PHONE_CELL'].'}';
?>"><?php xl('PATIENT','e');
?> - <?php xl('Phone Cell','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['PT_SSN'].'}';
?>"><?php xl('PATIENT','e');
?> - <?php xl('SSN','e'); ?></option>
    <option value="<?php echo '{'.$FIELD_TAG['PT_DOB'].'}';
?>"><?php xl('PATIENT','e');
?> - <?php xl('Date of birth','e'); ?></option>
    </select>
    </div>
   <textarea name='form_body' id="form_body" rows='20' cols='30' style='width:100%'
    title=<?php xl('Enter body of letter here','e','\'','\'');
?> /><?php echo $bodytext; ?></textarea>
  </td>
 </tr>
