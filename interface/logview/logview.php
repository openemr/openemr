...
<input class="datetimepicker" type="text" size="18" name="start_date" id="start_date" value="<?php echo $start_date ? $start_date : (date("Y-m-d") . " 00:00");
?>" title="<?php  xl('yyyy-mm-dd H:m Start Date','e'); ?>" />
</td>
<td>
<span class="text"><?php  xl('End Date','e'); ?>: </span>
</td><td>
<input class="datetimepicker" type="text" size="18" name="end_date" id="end_date" value="<?php echo $end_date ? $end_date : (date("Y-m-d") . " 23:59");
?>" title="<?php  xl('yyyy-mm-dd H:m End Date','e'); ?>" />
</td>
...
<td>
<input type='text' size='20' name='form_patient' style='width:100%;cursor:pointer;cursor:hand' value='<?php echo $form_patient ? $form_patient : htmlspecialchars(xl('Click To Select'),ENT_QUOTES);
?>' onclick='sel_patient()' title='<?php echo htmlspecialchars(xl('Click to select patient'),ENT_QUOTES); ?>' />
...
<table>
 <tr>
  <!-- <TH><?php  xl('Date', 'e'); ?><TD> -->
  <th id="sortby_date" class="text sortby" title="<?php xl('Sort by date/time','e');
?>"><?php xl('Date','e'); ?></th>
  <th id="sortby_event" class="text sortby" title="<?php xl('Sort by Event','e');
?>"><?php  xl('Event','e'); ?></th>
  <th id="sortby_category" class="text sortby" title="<?php xl('Sort by Category','e');
?>"><?php  xl('Category','e'); ?></th>
  <th id="sortby_user" class="text sortby" title="<?php xl('Sort by User','e');
?>"><?php  xl('User','e'); ?></th>
  <th id="sortby_cuser" class="text sortby" title="<?php xl('Sort by Crt User','e');
?>"><?php  xl('Certificate User','e'); ?></th>
  <th id="sortby_group" class="text sortby" title="<?php xl('Sort by Group','e');
?>"><?php  xl('Group','e'); ?></th>
  <th id="sortby_pid" class="text sortby" title="<?php xl('Sort by PatientID','e');
?>"><?php  xl('PatientID','e'); ?></th>
  <th id="sortby_success" class="text sortby" title="<?php xl('Sort by Success','e');
?>"><?php  xl('Success','e'); ?></th>
  <th id="sortby_comments" class="text sortby" title="<?php xl('Sort by Comments','e');
?>"><?php  xl('Comments','e'); ?></th>
    <?php  if($check_sum) {?>
  <th id="sortby_checksum" class="text sortby" title="<?php xl('Sort by Checksum','e');
?>"><?php  xl('Checksum','e'); ?></th>
    <?php } ?>
 </tr>
<?php
