...
if (!AclMain::aclCheckCore('admin', 'users')) {
    echo (new TwigContainer(null, OEGlobalsBag::getInstance()->getKernel()))->getTwig()->render('core/unauthorized.html.twig', ['pageTitle' => xl("Logs Viewer")]);
    exit;
}
                            ...
                            <form method="get" name="theform" id="theform">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        $event_types = ["select", "update", "insert", "delete", "replace"];
