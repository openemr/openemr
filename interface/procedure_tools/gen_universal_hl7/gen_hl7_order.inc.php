...
/**
 * Guard: This file is meant to be included, not accessed directly
 * Generated by GitHub Copilot
 */
if (PHP_SAPI !== 'cli' && !isset($webserver_root)) {
    error_log("Direct access attempt to include file: " . __FILE__);
