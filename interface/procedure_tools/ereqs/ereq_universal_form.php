...
function universal_ereqForm($pid, $encounter, $form_id, $reqStr = null, $doDoc = true, $gbl_lab = null): void
{
...
STYLES;
    ...
    try {
        ...
        $pdfContent .= '<td style="border:0px;text-align:center;width:25%;"><h3 class="h3"><div class="span">' . $gbl_lab . '</div><div class="span">EREQ</div><div class="span">OpenEMR</div></h3></td>';
        ...
        $pdfContent .= '<tr>';
        $pdfContent .= '<td style="border:0px;text-align:left;padding-left:20px;"><h4>Universal®</h4></td>';
...
if ($_REQUEST['debug']) {
    universal_ereqForm($pid, $encounter, $form_id);
}
