...
<script>
function SearchPayment() {//Search  validations.
...
function DeletePayments(DeleteId) {//Confirms deletion of payment and all its distribution.
...
function OnloadAction() {//Displays message after deletion.
            ...
            <div class="form-group clearfix">
                <div class="col-sm-12 text-left position-override">
                    <div class="btn-group" role="group">
                        <a class="btn btn-secondary btn-search" href="#" onclick="javascript:return SearchPayment();"><span><?php echo xlt('Search'); ?></span></a>
                    </div>
                </div>
            </div>
            <?php
