    ...
    <div class = "container">
        <div class="row">
            <div class="page-header">
                <h2><?php echo xlt('Billing Manager') ?></h2>
            </div>
        </div>
        <div class="row">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group col-xs-12">
                            ...
                            <div  class= 'text'>
                                ...
                                <?php if ($daysheet) { ?>
                                    <a class='link_submit'  href="#" onclick="javascript:return SubmitTheEndDayPrint();"><i class="fa fa-circle" style="margin-right:5px; font-size:.75em" aria-hidden="true"></i><strong><?php echo xlt('End Of Day Report').' - ' ?></strong></a> 
                                    <?php if ($daysheet_total) { ?> 
                                        <span class="text"><strong><?php echo xlt('Totals'); ?></strong></span> <input name="end_of_day_totals_only" type="checkbox" value="1"> 
                                        <?php } ?> 
                                    <?php if ($provider_run) { ?> <span class="text"><strong><?php echo xlt('Provider'); ?></strong></span><input name="end_of_day_provider_only" type="checkbox" value="1"> <?php } ?>
                                <?php } ?>
                                </span> 
                                <?php if (! file_exists($EXPORT_INC)) { ?>
