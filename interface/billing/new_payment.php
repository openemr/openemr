...
<script type="text/javascript" src="../../library/textformat.js?v=<?php //echo $v_js_includes; ?>"></script>-->
	...
	.navbar-default .navbar-toggle {
	   border-color: #4a4a4a; /*#68171A;*/
	}
	.navbar-default .navbar-toggle:focus, .navbar-default .navbar-toggle:hover {
	   background-color: #f2f2f2; !Important; /*#F5D6D8*/
	   font-weight:900 !Important;
	   color:#000000 !Important;
	}
	
	.navbar-color{
		background-color: #E5E5E5; /* #f8f8f8 #999;*/
		}
	...
	.navbar-toggle {
	 display: block;
	 background-color:#f2f2f2; /*#D95459;*/
	}
	...
	.navbar-collapse.collapse.in{
	 z-index:100;
	 background-color: #dfdfdf; /* #E5E5E5; #D95459;*/
	 font-weight:700;
	 color:#000000 !Important;
	}
	/*.navbar-collapse.collapse{
	 z-index:100;
	 background-color: magenta; /*#D95459;*/
	 font-weight:700;
	 color:#000000 !Important;
	}*/
    ...
    background: purple;/*#999;*/
}
	
	
	</style>
	<title><?php xlt('New Payment'); ?></title>
</head>
							...
							<div class="form-group">
								<div class="col-sm-12 text-center">
									<div class="btn-group" role="group">
										<a class="btn btn-default btn-save" href="#" onclick="javascript:return PostPayments();"><span><?php echo xlt('Post Payments');?></span></a>
										<a class="btn btn-default btn-save" href="#" onclick="javascript:return FinishPayments();"><span><?php echo xlt('Finish Payments');?></span></a>
										<a class="btn btn-default btn-cancel" href="#" onclick="CancelDistribute()"><span><?php echo xlt('Cancel');?></span></a>
									</div>
								</div>
							</div>
						<?php
