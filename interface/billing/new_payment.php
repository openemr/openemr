...
<head>
    ...
    function PostPayments() {//Used in saving the allocation
    ...
    function FinishPayments() {//Used in finishig the allocation.Usually done when the amount gets reduced to zero.
    ...
    function CompletlyBlank() {//Checks whether any of the allocation row is filled.
    ...
    function FillUnappliedAmount() {//Filling the amount
