	...
	<div class = "row">
		<form method='post' action='sl_eob_patient_note.php?patient_id=<?php  echo $patient_id ?>'>
			...
			<div class="form-group clearfix">
				<div class="col-sm-12 text-center " id="invoice-note">
					<div class="btn-group" role="group">
						<button type="submit" class="btn btn-default btn-save" name='form_save' id='form_save' ><?php xl("Save","e")?></button>
						<button type="button" class="btn btn-default btn-cancel" name='cancel_btn' id='cancel_btn'onclick='window.close()'><?php xl("Cancel","e")?></button>
					</div>
				</div>
			</div>
		</form>
