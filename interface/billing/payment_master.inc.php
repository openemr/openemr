...
if (($screen == 'new_payment' && $payment_id * 1 == 0) || ($screen == 'edit_payment' && $payment_id * 1 > 0)) {//New entry or edit in edit screen comes here.
    ...
    <div class="col-xs-12 oe-custom-line">
        ...
        <div class="forms col-xs-2">
            ...
            <div id="TdUnappliedAmount" class="form-control" style="border-color:red;font-weight: bolder;color:red;background-color:#EFEFEF;"><?php echo ($UndistributedAmount * 1 == 0) ? attr("0.00") : attr(number_format($UndistributedAmount, 2, '.', ',')); ?>
            </div>
