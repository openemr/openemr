...
?>
                ...
                <table class="table-sm" id="TableDistributePortion">
                  ...
                  <tr class="text" bgcolor='<?php echo attr($bgcolor); ?>' id="trCharges<?php echo attr($CountIndex); ?>">
                    ...
                    <td class="<?php echo attr($StringClass); ?>">
                        <input name="HiddenCodetype<?php echo attr($CountIndex); ?>" value="<?php echo attr($Codetype); ?>" type="hidden" /><input name="HiddenCode<?php echo attr($CountIndex); ?>" value="<?php echo attr($Code); ?>" type="hidden" /><?php echo text($Codetype . "-" . $Code . $ModifierString); ?><input name="HiddenModifier<?php echo attr($CountIndex); ?>" value="<?php echo attr($Modifier); ?>" type="hidden" />
                      </td>
                    <td align="right" class="<?php echo attr($StringClass); ?>">
                        <input name="HiddenChargeAmount<?php echo attr($CountIndex); ?>"
                     id="HiddenChargeAmount<?php echo attr($CountIndex); ?>"  value="<?php echo attr($Fee); ?>" type="hidden"/><?php echo text($Fee); ?>
                      </td>
                    <td align="right" class="<?php echo attr($StringClass); ?>">
                    ...
                    <td align="right" id="RemainderTd<?php echo attr($CountIndex); ?>" class="<?php echo attr($StringClass); ?>">
                    ...
                    <td class="<?php echo attr($StringClass); ?> right">
                        <textarea name="FollowUpReason<?php echo attr($CountIndex); ?>" onKeyDown="PreventIt(event)" id="FollowUpReason<?php echo attr($CountIndex); ?>" class="form-control class4" cols="5" rows="2" readonly></textarea>
                      </td>
                  </tr>
                        <?php
