...
?>
			...
			<!--<table width="705" border="0" cellspacing="0" cellpadding="0" bgcolor="#DEDEDE">
				<tr><td>
					<table width="799" border="0" cellspacing="0" cellpadding="0" style="border:1px solid black" >
						<tr>
						...
						<td width="265"><input type="hidden" id="hidden_ajax_patient_close_value" value="<?php echo $Message=='' ? htmlspecialchars($NameNew) : '' ;?>" />
							...
							value="<?php echo $Message=='' ? htmlspecialchars($NameNew) : '' ;?>"  autocomplete="off" />-->
						</td> <!--onKeyUp="ajaxFunction(event,'patient','edit_payment.php');" -->
						<!--<td width="55" colspan="2" style="padding-left:5px;" >
							<div  class="text" name="patient_name" id="patient_name" style="border:1px solid black; ; padding-left:5px; width:55px; height:17px;">
								<?php echo $Message=='' ? htmlspecialchars(formData('hidden_patient_code')) : '' ;?>
							</div>
						</td>
						<td width="84" class="text">&nbsp;
							<input type="radio" name="RadioPaid" onClick="SearchOnceMore()" <?php echo $_REQUEST['RadioPaid']=='Non_Paid' || $_REQUEST['RadioPaid']=='' ? 'checked' : '' ; ?>  value="Non_Paid" id="Non_Paid"  /><?php echo htmlspecialchars( xl('Non Paid'), ENT_QUOTES) ?></td>
						<td width="168" class="text">
							<input type="radio" name="RadioPaid" onClick="SearchOnceMore()" <?php echo $_REQUEST['RadioPaid']=='Show_Primary_Complete' ? 'checked' : '' ; ?>  value="Show_Primary_Complete" 
							id="Show_Primary_Complete" /><?php echo htmlspecialchars( xl('Show Primary Complete'), ENT_QUOTES) ?></td>
						<td width="157" class="text">
							<input type="radio" name="RadioPaid" onClick="SearchOnceMore()" <?php echo $_REQUEST['RadioPaid']=='Show_Paid' ? 'checked' : '' ; ?>  value="Show_Paid" id="Show_Paid" /><?php echo htmlspecialchars( xl('Show All Transactions'), ENT_QUOTES) ?>
						</td>
						</tr>
						<tr>
						<td align="left" class="text"></td>
						<td><div id='ajax_div_patient_section1'>
							  <div id='ajax_div_patient_error1'>
							  </div>
							  <div id="ajax_div_patient1" style="display:none;"></div>
							  </div>
							 </div>
						</td>
						<td></td>
...
<table class="table"  id="TablePatientPortion">		
	<tr>
		<td colspan="13" align="left" >-->
			    ...
			    <table class="table-condensed"   id="TableDistributePortion">	
				  <thead class="" bgcolor="#dddddd">
					...
					<td width="70" class="left top" ><?php echo htmlspecialchars( xl('MSP Code'), ENT_QUOTES) ?></td>
				  ...
				  <tr class="text"  bgcolor='<?php echo $bgcolor; ?>' id="trCharges<?php echo $CountIndex; ?>">
					<td align="left" class="<?php echo $StringClass; ?>" ><input name="HiddenIns<?php echo $CountIndex; ?>" style="width:70px;text-align:right; font-size:12px" id="HiddenIns<?php echo $CountIndex; ?>" 
					 value="<?php echo htmlspecialchars($Ins); ?>" type="hidden"/><?php echo generate_select_list("payment_ins$CountIndex", "payment_ins", "$Ins", "Insurance/Patient",'','payment_select class3','ActionOnInsPat("'.$CountIndex.'")');?></td>
					...
					<td class="<?php echo $StringClass; ?>" ><input  name="Takeback<?php echo $CountIndex; ?>"  onKeyDown="PreventIt(event)"   autocomplete="off"  
					 ...
					 onChange="ValidateNumeric(this);ScreenAdjustment(this,<?php echo $CountIndex; ?>);UpdateTotalValues(<?php echo $CountIndexAbove*1+1; ?>,<?php echo $TotalRows; ?>,'Takeback','initialtakebacktotal');RestoreValues(<?php echo $CountIndex; ?>)"  
					  type="text"   style="width:70px;text-align:right; font-size:12px" /></td>
					<td align="left" class="<?php echo $StringClass; ?>" ><input name="HiddenReasonCode<?php echo $CountIndex; ?>" id="HiddenReasonCode<?php echo $CountIndex; ?>"  value="<?php echo htmlspecialchars($ReasonCodeDB); ?>" type="hidden"/><?php echo generate_select_list( "ReasonCode$CountIndex", "msp_remit_codes", "", "MSP Code", "--", "payment_select class3" ); ?></td>							
