					...
					<div class="col-xs-12" style="padding-bottom:5px">
						...
						<div class="col-xs-2">
							...
							<?php
								...
								$insurance = "1: Jonathan Livingstone Seagull\n2: Jonathan Livingstone Seagull";
						...
						<table class= "table">
							<thead>
								<tr bgcolor="#CCCCCC">
									...
									<th class="dehead"><?php xl('Reason','e')?></th><?php if ($ALLOW_DELETE) { ?>
									<th class="dehead"><?php xl('Del','e')?></th><?php } ?>
								</tr>
							</thead>
								<?php
								...
								<tr bgcolor='<?php echo $bgcolor ?>'>
									...
									<td class="detail"><?php echo $ddata['rsn'] ?></td><?php if ($ALLOW_DELETE) { ?>
									<td class="detail"><?php if (!empty($ddata['arseq'])) { ?><input name="form_del[<?php echo $ddata['arseq']; ?>]" type="checkbox"> <?php } else { ?> &nbsp; <?php } ?></td><?php } ?>
								</tr><?php
				...
				<div class="form-group clearfix">
					<div class="col-sm-12 text-center show-hide" id="search-btn">
						<div class="btn-group" role="group">
							<button type='submit' class="btn btn-default btn-save" name='form_save' id="btn-save" ><?php xl("Save","e"); ?></button>
							<button type='submit' class="btn btn-default btn-cancel" name='form_cancel' id="btn-cancel"  onclick='window.close();'><?php xl("Cancel","e"); ?></button>
						</div>
					</div>
				</div>
			</form>
