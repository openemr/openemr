        ...
        <div class="col-lg">
            <form id="formSearch" action="" enctype='multipart/form-data' method='post'>
                        ...
                        <table class="table table-striped table-sm">
                            ...
                            while ($row = sqlFetchArray($t_res)) {
                                ...
                                <tr>
                                    ...
                                    <td class="detail text-end"><?php echo text(bucks($row['charges'])); ?>&nbsp;
                                    </td>
                                    <td class="detail text-end"><?php echo text(bucks($row['adjustments'])); ?>
                                        &nbsp;
                                    </td>
                                    <td class="detail text-end"><?php echo text(bucks($row['payments'] - $row['copays'])); ?>
                                        &nbsp;
                                    </td>
                                    <td class="detail text-end"><?php echo text(bucks($balance)); ?>&nbsp;</td>
                ...
                <div class="mb-3 clearfix">
                    <div class="form-row text-start position-override oe-show-hide" id="statement-download">
                        <div class="btn-group" role="group">
                            <?php
                            if ($eracount) { ?>
...
// We can watch for our custom `fileselect` event like this
    ...
    ?>
    $(function () {
        $('#select-method-tooltip').attr({"title": <?php echo xlj('Click on either the Invoice Search button on the far right, for manual entry or ERA Upload button for uploading an entire electronic remittance advice ERA file'); ?>, "data-bs-toggle":"tooltip", "data-placement":"bottom"}).tooltip();
    });
</script>
<?php
