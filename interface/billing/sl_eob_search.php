	...
	<div class="container">
		<div class="row">
			<div class="page-header">
				<h2><?php echo xlt('EOB Posting - Search'); ?></h2>
			</div>
		</div>
		<div class="row">
			<form action='sl_eob_search.php' enctype='multipart/form-data' method='post'>
				<fieldset id="payment-allocate" class="show-hide">
					<legend>
				...
				<fieldset id="search-upload">
					...
					<div class="col-xs-12 show-hide" style="padding-bottom:5px" id = 'inv-search'>
						<div class="col-xs-3">
						...
						<div class="col-xs-2">
							<label class="control-label oe-large" for="form_date"><?php echo xlt('Svc Date From'); ?>:</label>
						...
						<div class="col-xs-2">
							<label class="control-label" for="form_to_date"><?php echo xlt('Svc Date To'); ?>:</label>
					...
					<div class="col-xs-12 show-hide" style="padding-bottom:5px" id = 'era-upld'>
				...
				<div class="form-group clearfix">
					<div class="col-sm-12 text-center show-hide" id="search-btn">
						<div class="btn-group" role="group">
							<input type='submit' class="btn btn-default btn-save show-hide" name='form_search' id="btn-inv-search" value='<?php xl("Search","e"); ?>'>
							<input type='submit' class="btn btn-default btn-save show-hide" name='form_search' id="btn-era-upld" value='<?php xl("Upload","e"); ?>'>
						</div>
					</div>
				</div>
				<fieldset id="search-results" class= "show-hide">
						...
						<table class="table">
							<thead>
								<tr>
									...
									<th align="center" class="dehead"><?php xl('Prv','e'); ?></th><?php if (!$eracount) { ?>
									<th align="left" class="dehead"><?php xl('Sel','e'); ?></th>
									<th align="center" class="dehead"><?php xl('Email','e'); ?></th><?php } ?>
								</tr>
							</thead>
							<?php
							$orow = -1;
				...
				<div class="form-group clearfix">
					<div class="col-sm-12 text-center show-hide" id="statement-download">
						<div class="btn-group" role="group">
							<?php if ($eracount) { ?>
								<!--<input type='button' value='<?php xl('Process ERA File','e')?>' onclick='processERA()' /> &nbsp;-->
								<button type="button" class="btn btn-default btn-save" name="Submit" onclick='processERA()'><?php xl('Process ERA File','e')?></button>
							<?php } 
							else { ?>
								...
								<button type="button" class="btn btn-default btn-save" name="Submit1" onclick='checkAll(true)'><?php xl('Select All','e')?></button>
								<button type="button" class="btn btn-default btn-undo" name="Submit2" onclick='checkAll(false)'><?php xl('Clear All','e')?></button>
								<?php if ($GLOBALS['statement_appearance'] != '1') { ?>
									...
									<button type="submit" class="btn btn-default btn-print" name='form_print' ><?php xl('Print Selected Statements','e')?></button>
									<button type="submit" class="btn btn-default btn-download" name='form_download' ><?php xl('Download Selected Statements','e')?></button>
								<?php } ?>
								...
								<button type="submit" class="btn btn-default btn-download" name='form_pdf' ><?php xl('PDF Download Selected Statements','e')?></button>
								<button type="submit" class="btn btn-default btn-mail" name='form_download' ><?php xl('Email Selected Statements','e')?></button>
								<?php if ($is_portal ){?>
									<!--<input type='submit' name='form_portalnotify' value='<?php xl('Notify via Patient Portal','e'); ?>' /> &nbsp;-->
									<button type="submit" class="btn btn-default btn-save"  name='form_portalnotify' ><?php xl('Notify via Patient Portal','e')?></button>
								<?php } 
							}?>
				...
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						...
						<div class="modal-footer" style="margin-top:0px;">
							...
							<button class="btn btn-default btn-print pull-right"  onclick= "window.print();"type="button"><?php echo xlt('print'); ?></button>
						</div>
					</div>
				</div>
			</div>
