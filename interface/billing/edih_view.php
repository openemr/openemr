...
<body class="body_top">
    ...
    <div id="tabs">
        <ul class="nav nav-tabs mb-3">
            <li class="nav-item"><a class="nav-link active" href="#newfiles" id="btn-newfiles" data-toggle="collapse" data-target="#newfiles"><?php echo xlt("New Files"); ?></a></li>
            <li class="nav-item"><a class="nav-link" href="#csvdatatables" id="btn-csvdatatables" data-toggle="collapse" data-target="#csvdatatables"><?php echo xlt("CSV Tables"); ?></a></li>
            <li class="nav-item"><a class="nav-link" href="#x12text" id="btn-x12text" data-toggle="collapse" data-target="#x12text"><?php echo xlt("EDI File"); ?></a></li>
            <li class="nav-item"><a class="nav-link" href="#edinotes" id="btn-edinotes" data-toggle="collapse" data-target="#edinotes"><?php echo xlt("Notes"); ?></a></li>
            <li class="nav-item"><a class="nav-link" href="#archive" id="btn-archive" data-toggle="collapse" data-target="#archive"><?php echo xlt("Archive"); ?></a></li>
        </ul>

        <div id="newfiles" class="collapse show">
            <div class="container-fluid row">
                <div class="col-sm">
                    <form id="formupl" name="form_upl" action="edih_main.php" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="csrf_token_form" value="<?php echo attr(CsrfUtils::collectCsrfToken()); ?>" />
                        <div class="custom-file">
                            <label class="custom-file-label"><?php echo xlt("Select one or more files to upload"); ?></label>
                ...
                <div class="col-sm">
                    <form id="processnew" name="process_new" action="edih_main.php" method="GET">
                        ...
                        <fieldset>
                            ...
                            <input type="submit" class="btn btn-primary" id="fuplprocess" name="process" form="processnew" value="<?php echo xla("Process"); ?>" />
                        </fieldset>
                    </form>
                </div>
            </div>
        ...
        <div id="csvdatatables" class="collapse">
            <div class="container-fluid row">
                <div class="col-sm">
                    <form id="formcsvtables" name="form_csvtables" action="edih_main.php" method="GET">
                        <input type="hidden" name="csrf_token_form" value="<?php echo attr(CsrfUtils::collectCsrfToken()); ?>" />
                        <p class="font-weight-bold"><?php echo xlt("View CSV tables"); ?>:</p>
                        <p class="font-weight-bold"><?php echo xlt("Choose a period or dates (YYYY-MM-DD)"); ?></p>
                        <div class="form-row">
                            <div class="col-sm=2">
                                <label class="col-form-label"><?php echo xlt("Choose CSV table"); ?>:</label>
                                <select class="form-control" id="csvselect" name="csvtables"></select>
                            </div>
                            <div class="col-sm">
                                <label class="col-form-label"><?php echo xlt("From Period"); ?></label>
                                <select class="form-control" id="csvperiod" name="csv_period">
                            ...
                            <div class="col-sm">
                                <label class="col-form-label"><?php echo xlt("Start Date"); ?>:</label>
                                <input type='text' size='10' class='form-control datepicker' name="csv_date_start" id="caldte1" value="" title="<?php echo xla('yyyy-mm-dd Start Date'); ?>" />
                            </div>
                            <div class="col-sm">
                                <label class="col-form-label"><?php echo xlt("End Date"); ?>:</label>
                                <input type="text" size="10" class="form-control datepicker" name="csv_date_end" id="caldte2" value="" title="<?php echo xla('yyyy-mm-dd End Date'); ?>" />
                ...
                <div class="col-sm">
                    <form id="formcsvhist" name="hist_csv" action="edih_main.php" method="get">
                        <input type="hidden" name="csrf_token_form" value="<?php echo attr(CsrfUtils::collectCsrfToken()); ?>" />
                        <p class="font-weight-bold"><?php echo xlt("Per Encounter"); ?></p>
                        <label for="histenctr"><?php echo xlt("Enter Encounter Number"); ?></label>
                        <div class="input-group">
                            <input class="form-control" id="histenctr" type="text" size="10" name="hist_enctr" value="" />
                            <div class="input-group-append">
                                <input class="btn btn-primary" id="histsbmt" type="submit" name="hist_sbmt" form="formcsvhist" value="<?php echo xla("Submit"); ?>" />
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <fieldset>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="text-left"><input id="x12file" type="file" size="30" name="fileUplx12" /></td>
        ...
        <div id="edinotes" class="collapse">
            <div class="container-fluid">
                <p><a href="<?php echo $web_root; ?>/Documentation/Readme_edihistory.html" rel="noopener" target="_blank"><?php echo xlt("View the README file"); ?></a></p>
                <div class="row">
                    <div class="col-sm">
                        <form id="formlog" name="form_log" action="edih_main.php" enctype="multipart/form-data" method="post">
                            <input type="hidden" name="csrf_token_form" value="<?php echo attr(CsrfUtils::collectCsrfToken()); ?>" />
                            <fieldset>
                                <legend><?php echo xlt("Inspect the log"); ?></legend>
                                <label for="logfile"><?php echo xlt("View Log"); ?></label>
                                <select class="form-control" id="logselect" name="log_select"> </select>
                                ...
                                <input class="btn btn-danger" id="logarch" type="button" form="formlog" value="<?php echo xla("Archive"); ?>" />
                            </fieldset>
                        </form>
                    </div>
                    <div class="col-sm">
                        <form id="formnotes" name="form_notes" action="edih_main.php" enctype="multipart/form-data" method="post">
                            ...
                            <fieldset>
                                ...
                                <input class="btn btn-secondary" id="notesget" type="button" name="notes_get" form="formnotes" value="<?php echo xla("Open"); ?>" />
        ...
        <div id="archive" class="collapse">
            <div class="container-fluid">
                <p><?php echo xlt("Selected files and data will be removed from folders and tables"); ?></p>
                <div class="row">
                    <div class="col-sm">
                        <form id="formarchive" name="form_archive" action="edih_main.php" enctype="multipart/form-data" method="POST">
                            <input type="hidden" name="csrf_token_form" value="<?php echo attr(CsrfUtils::collectCsrfToken()); ?>" />
                            <fieldset>
                                <legend><?php echo xlt("Archive old files"); ?></legend>
                                <label for="archive_sel"><?php echo xlt("Older than"); ?>:</label>
                                <select class="form-control" id="archiveselect" name="archive_sel">
                                ...
                                <input class="btn btn-primary" type="button" id="archiverpt" name="archivereport" form="formarchive" value="<?php echo xla("Report"); ?>" />
                                <input type="hidden" name="ArchiveRequest" form="formarchive" value="requested" />
                                <label for="archivesbmt"><?php echo xlt("Archive"); ?>:</label>
                                <input class="btn btn-danger" type="submit" id="archivesbmt" name="archive_sbmt" form="formarchive" value="<?php echo xla("Archive"); ?>" />
                            </fieldset>
                        </form>
                    </div>
                    <div class="col-sm">
                        <form id="formarchrestore" name="form_archrestore" action="edih_main.php" enctype="multipart/form-data" method="POST">
                            <input type="hidden" name="csrf_token_form" value="<?php echo attr(CsrfUtils::collectCsrfToken()); ?>" />
                            <fieldset>
                                <legend><?php echo xlt("Restore Archive"); ?></legend>
                                <label for="archrestore_sel"><?php echo xlt("Restore"); ?>:</label>
                                <select class="form-control" id="archrestoresel" name="archrestore_sel"> </select>
                                ...
                                <input class="btn btn-primary" type="submit" id="archrestore" name="arch_restore" form="formarchrestore" value="<?php echo xla("Restore"); ?>" />
                            </fieldset>
                        </form>
                    </div>
                </div>
    ...
    <script>
        ...
        // Handle collapse hiding
        $('#newfiles').on('show.bs.collapse', function() {
            $('#btn-newfiles').addClass('active');
            $('#btn-csvdatatables').removeClass('active');
            $('#btn-x12text').removeClass('active');
            $('#btn-edinotes').removeClass('active');
            $('#btn-archive').removeClass('active');
            $('#csvdatatables').collapse('hide');
            $('#x12text').collapse('hide');
            $('#edinotes').collapse('hide');
            $('#archive').collapse('hide');
        });

        $('#csvdatatables').on('show.bs.collapse', function() {
            $('#btn-newfiles').removeClass('active');
            $('#btn-csvdatatables').addClass('active');
            $('#btn-x12text').removeClass('active');
            $('#btn-edinotes').removeClass('active');
            $('#btn-archive').removeClass('active');
            $('#newfiles').collapse('hide');
            $('#x12text').collapse('hide');
            $('#edinotes').collapse('hide');
            $('#archive').collapse('hide');
        });

        $('#x12text').on('show.bs.collapse', function() {
            $('#btn-newfiles').removeClass('active');
            $('#btn-csvdatatables').removeClass('active');
            $('#btn-x12text').addClass('active');
            $('#btn-edinotes').removeClass('active');
            $('#btn-archive').removeClass('active');
            $('#newfiles').collapse('hide');
            $('#csvdatatables').collapse('hide');
        ...
        $('#edinotes').on('show.bs.collapse', function() {
            $('#btn-newfiles').removeClass('active');
            $('#btn-csvdatatables').removeClass('active');
            $('#btn-x12text').removeClass('active');
            $('#btn-edinotes').addClass('active');
            $('#btn-archive').removeClass('active');
            $('#newfiles').collapse('hide');
            $('#csvdatatables').collapse('hide');
            $('#x12text').collapse('hide');
