 ...
 */
    ...
    $('#notessave').on('click', function(e) {
        ...
        $.post(noteURL, { putnotes: 'yes', tnotes: notetxt, csrf_token_form: <?php echo js_escape((string) CsrfUtils::collectCsrfToken(session: $session)); ?> },
 ...
 */
    ...
    $('#archiverpt').on('click', function(event) {
        ...
        $.ajax({
            ...
            //cache: false,
            dataType: 'html',
            data: { archivereport: 'yes', period: sprd, csrf_token_form: <?php echo js_escape((string) CsrfUtils::collectCsrfToken(session: $session)); ?> },
