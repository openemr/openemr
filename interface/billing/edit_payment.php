...
<head>
    ...
    <!--<?php // (function_exists('html_header_show')) html_header_show(); ?>
    ...
    <!--<link href="<?php echo $GLOBALS['assets_static_relative']; ?>/jquery-datetimepicker-2-5-4/build/jquery.datetimepicker.min.css" rel="stylesheet"><!-- supporting javascript code -->
    ...
    var mypcc = '1';
    </script><?php include_once("{$GLOBALS['srcdir']}/payment_jav.inc.php"); ?><?php include_once("{$GLOBALS['srcdir']}/ajax/payment_ajax_jav.inc.php"); ?>
...
<body class="body_top" onload="OnloadAction()">
    ...
    ?>
    <div class="row">
        <form name='new_payment' method='post'  action="edit_payment.php" onsubmit='<?php  if($payment_id*1==0)  { echo "top.restoreSession();return SavePayment();"; }  else  {echo "return false;"; } ?> ' style="display:inline" >
