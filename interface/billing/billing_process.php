...
function process_form($ar)
{
    ...
    if ($validatePass) {
        if (isset($ar['bn_hcfa_txt_file'])) {
            ...
            $wrap = "<!DOCTYPE html><html><head></head><body><div><pre>$format_bat</pre></div></body></html>";
            echo $wrap;
            exit();
            ...
            $wrap = "<!DOCTYPE html><html><head></head><body><div style='overflow: hidden;'><pre>$format_bat</pre></div></body></html>";
            echo $wrap;
            exit();
        } else {
