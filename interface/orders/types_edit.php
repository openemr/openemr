...
function sel_related(varname) {
    ...
    rcvarname = varname;
    dlgopen('../patient_file/encounter/find_code_popup.php', '_blank', 500, 700);
}
                ...
                <div class="form-group clearfix">
                    <div class="col-xs-12 text-left position-override">
                        <div class="btn-group btn-group-pinch" role="group">
                            <button type='submit' name='form_save'  class="btn btn-default btn-save"><?php echo xlt('Save'); ?></button>
