                ...
                <fieldset>
                    ...
                    <div class="col-xs-12 ">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div id="npi_info" class="collapse">
                                <a href="#npi_info" data-toggle="collapse" class="pull-right"><i class="fa fa-times" style="color:gray" aria-hidden="true"></i></a>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div id="usage_info" class="collapse">
                            <a href="#usage_info" data-toggle="collapse" class="pull-right"><i class="fa fa-times" style="color:gray" aria-hidden="true"></i></a>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div id="sender_id_info" class="collapse">
                            <a href="#sender_id_info" data-toggle="collapse" class="pull-right"><i class="fa fa-times" style="color:gray" aria-hidden="true"></i></a>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div id="receiver_id_info" class="collapse">
                            <a href="#receiver_id_info" data-toggle="collapse" class="pull-right"><i class="fa fa-times" style="color:gray" aria-hidden="true"></i></a>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div id="protocol_info" class="collapse">
                            <a href="#protocol_info" data-toggle="collapse" class="pull-right"><i class="fa fa-times" style="color:gray" aria-hidden="true"></i></a>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div id="login_info" class="collapse">
                            <a href="#login_info" data-toggle="collapse" class="pull-right"><i class="fa fa-times" style="color:gray" aria-hidden="true"></i></a>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div id="remote_host_info" class="collapse">
                            <a href="#remote_host_info" data-toggle="collapse" class="pull-right"><i class="fa fa-times" style="color:gray" aria-hidden="true"></i></a>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div id="orders_path_info" class="collapse">
                            <a href="#orders_path_info" data-toggle="collapse" class="pull-right"><i class="fa fa-times" style="color:gray" aria-hidden="true"></i></a>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div id="results_path_info" class="collapse">
                            <a href="#results_path_info" data-toggle="collapse" class="pull-right"><i class="fa fa-times" style="color:gray" aria-hidden="true"></i></a>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div id="notes_info" class="collapse">
                            <a href="#notes_info" data-toggle="collapse" class="pull-right"><i class="fa fa-times" style="color:gray" aria-hidden="true"></i></a>
