...
if ($_POST['form_submit'] && ! empty($_POST['form_line'])) {
    ...
    if($form_batch==1 && $form_review==0) {
        $title = 'Procedure Results - Batch';
        $title_header =  $title;
    }
    else if ($form_batch==0 && $form_review==1){
        $title = 'Pending Review';
         $title_header =  $title . " - $patient";
    }
    else if ($form_batch==0 && $form_review==0){
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="page-header clearfix">
                   <h2 class="clearfix"><?php echo xlt("$title_header"); ?><a class="pull-right" data-target="#myModal" data-toggle="modal" href="#" id="help-href" name="help-href" style="color:#000000"><i class="fa fa-question-circle" aria-hidden="true"></i></a></h2>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            onsubmit='return validate(this)'>
                    ...
                    <div class="col-xs-12">
                        <?php
                            ...
                            ?>
                            <button type="submit" class="btn btn-default btn-refresh" value="<?php echo xla('Refresh'); ?>" ><?php echo xlt('Refresh'); ?></button>
                               <br><br>
                            <fieldset>
                                ...
                                <div class="col-xs-12 oe-custom-line">
                                    <div class="forms col-xs-4">
                                        <label class="control-label" for="form_proc_type_desc"><?php echo xlt('Procedure'); ?>:</label>
                                        <input type='text' class='form-control' name='form_proc_type_desc' id='form_proc_type_desc'
                                        ...
                                        if ($form_review) {
                                         // if user authorized for pending review.
                                            if ($reviewauth) { ?>
                                                ...
                                                <button type='submit' class="btn btn-default btn-save" value="<?php echo xla('Sign Results'); ?>"><?php echo xlt('Sign Results'); ?></button>
                                            <?php
                                            } else {
                                            ?>
                                                <!--<input type='button' name='form_submit' value='<?php xl('Sign Results', 'e'); ?>' onclick="alert('<?php xl('Not authorized', 'e') ?>');" />-->
                                                <button type='button' class="btn btn-default btn-save" value="<?php echo xla('Sign Results'); ?>"><?php echo xlt('Sign Results'); ?></button>
                                            <?php
                                            }
                                        } else {
                                        ?>
                                        <!--<input type='submit' name='form_submit' value='<?php xl('Save', 'e'); ?>' />-->
                                        <button type='submit' name='form_submit' id='form_submit' class="btn btn-default btn-save" value="<?php echo xla('Save'); ?>"><?php echo xlt('Save'); ?></button>
                                        <?php
                                        }
                                        ?>
                                    </div>
    ...
    <script>
        $( document ).ready(function() {
            $('#help-href').click (function(){
                document.getElementById('targetiframe').src ='orders_results_help.php';
            })
