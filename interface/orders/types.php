    ...
    <div class="container">
        <div class="row">
            <div class="page-header clearfix">
                <h2 class='col-xs-11'><?php echo xlt('Configure Orders and Results'); ?></h2>
                <a class="h2 pull-right" data-target="#myModal" data-toggle="modal" href="#" id="help-href" name="help-href" style="color:#000000"><i class="fa fa-question-circle" aria-hidden="true"></i></a>
            </div>
        </div>
        <div class="row">
                ...
                <div class="form-group clearfix">
                    <div class="col-sm-12 text-left position-override">
                        <div class="btn-group btn-group-pinch" role="group">
                            <?php if ($popup) { ?>
                                <button type="submit" class="btn btn-default btn-save" name='form_save' value='<?php echo xlt('Save'); ?>'><?php echo xlt('Save2');?></button>
    ...
    <script>
        $( document ).ready(function() {
            $('#help-href').click (function(){
                document.getElementById('targetiframe').src ='http://www.open-emr.org/wiki/index.php/Procedures_Module_Configuration_for_Manual_Result_Entry';
            })
