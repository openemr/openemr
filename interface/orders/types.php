...
<body>
    ...
    <script>
        $(function () {
            (function() {
                var tooltips = [
                    {id: 'name-tooltip', title: <?php echo xlj('The actual tests or procedures that can be searched for and ordered are highlighted in yellow'); ?> + ". " + <?php echo xlj('Click on the blue plus sign under Name to reveal test names'); ?>},
                    {id: 'order-tooltip', title: <?php echo xlj('The entries highlighted in yellow can be ordered as a test or procedure those highlighted in pink can be ordered as a Custom Group'); ?> + ". " + <?php echo xlj('Click on the blue plus sign under Name to reveal test names'); ?>},
                    {id: 'code-tooltip', title: <?php echo xlj('Category - Order, Result and Recommendation need an identifying code');?> + ". " + <?php echo xlj('Red Triangle indicates a required code that is missing')?> + "."},
                    {id: 'tier-tooltip', title: <?php echo xlj('Shows the hierarchal level of this line');?> + ". " + <?php echo xlj('Tier 1 entries should be of Category Top Group')?> + "."}
                ];
                tooltips.forEach(function(t) {
                    var el = document.getElementById(t.id);
                    if (el) { new bootstrap.Tooltip(el, {title: t.title, placement: 'right'}); }
                });
