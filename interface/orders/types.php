    ...
    <div class="container">
        <div class="row">
            <div class="page-header clearfix">
                <h2 class="clearfix">Configure Orders and Results <a class="pull-right" data-target="#myModal" data-toggle="modal" href="#" id="help-href" name="help-href" style="color:#000000"><i class="fa fa-question-circle" aria-hidden="true"></i></a></h2>
            </div>
        </div>
        <div class="row">
