...
function doedclick_add() {
 top.restoreSession();
 dlgopen('procedure_provider_edit.php?ppid=0', '_blank', 800, 750, false, '&nbsp;&nbsp;&nbsp;<i class="fa fa-plus"  aria-hidden="true"></i>&nbsp;' + '<?php echo xlt("Add Mode"); ?>&nbsp;&nbsp;&nbsp;');
}

// Process click to pop up the edit window.
function doedclick_edit(ppid) {
 top.restoreSession();
 dlgopen('procedure_provider_edit.php?ppid=' + ppid, '_blank', 800, 750, false, '&nbsp;&nbsp;&nbsp;<i class="fa fa-pencil"  aria-hidden="true"></i>&nbsp;' + '<?php echo xlt("Edit Mode"); ?>&nbsp;&nbsp;&nbsp;');
}
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            while ($row = sqlFetchArray($res)) {
                                ...
                                echo "  <td class=\"text-center\"><span style=\"color:#000000;\" onclick=\"enode($chid)\" class=\"haskids fa fa-pencil\" title='" . attr($trTitle) . "'></span></td>\n";
                                echo " </tr>\n";
                            }
                            ?>
                        </tbody>
