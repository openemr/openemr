...
<ol>
<li><?php echo xlt("The first step is to open an account with the Unified Medical Language System web site"); ?> <b><a href="https://utslogin.nlm.nih.gov/cas/login" target="_blank" rel="noopener"><?php echo xlt("here"); ?></a></b></li>
