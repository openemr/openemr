...
<ol>
<li><?php echo xlt("The first step is to open an account with the Unified Medical Language System web site");
?> <b><a href="https://utslogin.nlm.nih.gov/cas/login"><?php echo xlt("here"); ?></a></b></li>
<li><?php echo xlt("Then the raw data feed release can be obtained from");
?> <b><a href="http://www.nlm.nih.gov/research/umls/rxnorm/docs/rxnormfiles.html"><?php echo xlt("this location"); ?></a></b>
