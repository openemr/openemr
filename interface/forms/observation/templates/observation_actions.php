...
<button type="button" class="btn btn-danger btn-sm btn-delete" onclick="deleteRow(event, this.parentElement.parentElement.parentElement.id);" title='<?php echo xla('Click here to delete the row'); ?>'>
    <?php echo xlt('Delete'); ?>
</button>
