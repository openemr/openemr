...
<head>
    ...
    <script>
        ...
        function sel_code(id) {
            ...
            dlgopen('<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('webroot') . "/interface/patient_file/encounter/" ?>find_code_popup.php?codetype=SNOMED-CT', '_blank', 700, 400);
        }
