...
function assessment_form_report($pid, $encounter, $cols, $id) {
 ...
 if ($data) {
  ...
  $in_clinic_test_head = Array( "Urinalysis Test", "Nitrites", "Protein", "Blood", "Ketones", "Glucose", "Specific Gravity", "pH", "Leukocyte", "Urobilirubin", "Bilirubin", "Pregnancy Test", "Flu Test", "Pregnancy Test", "Strep Test", "Finger Stick", "Comments" );
