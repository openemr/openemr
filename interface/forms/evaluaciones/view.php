...
<div class="evaluaciones-view container-fluid mt-3">
    ...
    <div class="registro-card">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div>
                <a href="<?php echo attr(OEGlobalsBag::getInstance()->getString('webroot') . '/interface/forms/evaluaciones/new.php?pid=' . $pid . '&encounter=' . $encounter . '&id=' . (int)($row['id'] ?? 0)); ?>"
                   class="btn btn-primary mr-1" onclick="top.restoreSession()"><i class="fas fa-pen mr-1"></i><?php echo xlt('Edit'); ?></a>
                <a href="<?php echo attr(OEGlobalsBag::getInstance()->getString('webroot') . '/interface/forms/evaluaciones/print.php?pid=' . $pid . '&encounter=' . $encounter . '&id=' . (int)($row['id'] ?? 0)); ?>"
        ...
        <div class="alert alert-<?php echo attr($g_class); ?> py-2">
            <strong><?php echo xlt('Glasgow'); ?>: <?php echo text((string)$glasgow); ?>/15</strong>
