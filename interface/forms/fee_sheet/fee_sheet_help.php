    ...
    <body>
        <div class="container">
            ...
            <div class= "row">
                ...
                <p><i class="fa fa-exclamation-circle" style="color:orange" aria-hidden="true"></i> <strong><?php echo xlt("Before beginning to use the Fee Sheet read through this help page and do some perliminary setup.");?></strong>
