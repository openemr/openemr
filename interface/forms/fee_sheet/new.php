...
<body class="body_top">
         ...
         <div class="row">
            <div class="col-sm-12">
                <div class="page-header clearfix">
                    <h2 id="header_title" class="clearfix"><span id='header_text'><?php echo join(" ", $title); ?></span> <i class="fa <?php echo attr($expand_icon_class);?> oe-superscript-small expand_contract" title="<?php echo attr($expand_title); ?>" aria-hidden="true"></i><?php echo $help_icon; ?>
                    </h2>
                </div>
            </div>
           </div>
    ...
    <?php
        ...
        // leave as such if you do not want to target anchor tags
        $target_div = '#myNavbar';
