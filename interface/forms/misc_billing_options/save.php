...
if ($session->has('billencounter')) {
    ...
    echo "<script src='" . $webroot . "/interface/main/tabs/js/include_opener.js?" . \OpenEMR\Common\Http\QueryString::build(['v' => OEGlobalsBag::getInstance()->getString('v_js_includes')]) . "'></script>";
}
