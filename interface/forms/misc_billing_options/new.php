...
<tr>
  <td><span class=text><?php echo xlt('BOX 15. Other date with a qualifier to specify what the date indicates.');?></span></td>
 ...
 <td>
       <?php echo generate_select_list('date_initial_treatment', 'date_initial_treatment',$obj{"date_initial_treatment"}, 'Date Initial Treatment');?>
 </td>
 <tr><td>
   <span class=text><?php echo xlt('Box 16. Date unable to work from');?>:</span></td>
