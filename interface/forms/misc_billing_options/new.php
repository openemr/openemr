    ...
    <div class="container">
       <div class="row">
            ...
            <div class="page-header clearfix">
               <h2 id="header_title" class="clearfix"><span id='header_text'><?php echo xlt('Misc Billing Options for HCFA-1500'); ?></span><?php echo $help_icon; ?></h2>
            </div>
                    ...
                    <div class='col-sm-11 col-offset-sm-1'>
                        ...
                        <div class="form-group">
                            ...
                            <label><?php echo xlt('State'); ?>:
                                <input type="text" name="accident_state" id="box10bstate" size="1" value="<?php echo attr($obj{"accident_state"});?>" >
                            </label>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label><?php echo xlt('Box 10 D. EPSDT Referral Code');?>
                                <input type="text" name="medicaid_referral_code" id="box10d" value="<?php echo attr($obj{"medicaid_referral_code"});?>" >
                            </label>
                        ...
                        <div class="form-group clearfix">
                            <label><?php echo xlt('Box 15. Other Date:'); ?>
                               ...
                               <input type="text" size="10" class='datepicker' name='date_initial_treatment' id='date_initial_treatment' value='<?php echo attr($date_initial_treatment); ?>'
                        ...
                        <div class="form-group clearfix">
                            <label for='hospitalization_date_from' class="col-sm-3 form-inline"><?php echo xlt('Box 18. Hospitalization date from');?>:</label>
                                <?php $hospitalization_date_from = $obj{"hospitalization_date_from"}; ?>
                                    <input type="text" class='datepicker col-sm-2 ' name='hospitalization_date_from' id='hospitalization_date_from' value='<?php echo attr($hospitalization_date_from); ?>' title='<?php echo xla('yyyy-mm-dd'); ?>'>
                            <label for='off_work_to'class="col-sm-3 form-inline"><?php echo xlt('Box 18. Hospitalization date to');?>:</label>
                                <?php $hospitalization_date_to = $obj{"hospitalization_date_to"}; ?>
                                    <input type="text"  class='datepicker col-sm-2'  name='hospitalization_date_to' id='hospitalization_date_to' value='<?php echo attr($hospitalization_date_to); ?>' title='<?php echo xla('yyyy-mm-dd'); ?>'>
                        </div>
                        <div class="form-group">
