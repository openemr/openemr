                    ...
                    <div class='col-sm-11 col-offset-sm-1'>
                        ...
                        <div class="form-group">
                            <label><?php echo xlt('BOX 10 A. Employment related '); ?>:
                                <input type="checkbox" name="employment_related" id="employment_related" value="1" <?php if ($obj['employment_related'] == "1") {
                                    echo "checked";}?>>
                            </label>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label><?php echo xlt('BOX 10 C. Other Accident '); ?>:
                                <input type="checkbox" name="other_accident" value="1" <?php if ($obj['other_accident'] == "1") {
                                    echo "checked";}?>>
                            </label>
                        </div>
                        <div class="form-group">
                            ...
                            <label><?php echo xlt('EPSDT'); ?> :
                                 <input type="checkbox" name="epsdt_flag" value="1" <?php if ($obj['epsdt_flag'] == "1") {
                                        echo "checked";}?>>
                            </label>
                        </div>
                        ...
                        <div class="form-group">
                            <label><?php echo xlt('BOX 20. Is Outside Lab used?'); ?>:
                                <input type="checkbox" name="outside_lab" value="1" <?php if ($obj['outside_lab'] == "1") {
                                    echo "checked";}?>>
                            </label>
                        ...
                        <div class="form-group">
                            <label><?php echo xlt('X12 only: Replacement Claim '); ?>:
                                <input type="checkbox" name="replacement_claim" value="1" <?php if ($obj['replacement_claim'] == "1") {
                                    echo "checked";}?>>
                            </label>
