                    ...
                    <div class='col-sm-11 col-offset-sm-1'>
                        ...
                        <div class="form-group">
                            <label><?php echo xlt('BOX 10 A. Employment related '); ?>:
                                <input type="checkbox" name="employment_related" id="employment_related" value="1"
                                <?php
                        ...
                        <div class="form-group">
                            <label><?php echo xlt('BOX 10 C. Other Accident '); ?>:
                                <input type="checkbox" name="other_accident" value="1"
                                <?php
                        ...
                        <div class="form-group">
                            ...
                            <label><?php echo xlt('EPSDT'); ?> :
                                <input type="checkbox" name="epsdt_flag" value="1"
                                <?php
                                if ($obj['epsdt_flag'] == "1") {
                                    echo "checked";
                                }?>>
