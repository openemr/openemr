...
<body>
<div class="container">
    <div class="m-5"><H2><?php echo xlt('Treatment Planning'); ?></h2></div>
    <br />
    <?php
    ...
    <table  border="0">
        ...
        <tr>
            <td align="left"  class="forms"><strong><?php echo xlt('Client Number'); ?>:</strong></td>
            <td class="forms">
                <label class="forms-data" > <?php if (is_numeric($pid)) {
                        $result = getPatientData($pid, "*");
        ...
        <tr>
            <td align="left" class="forms"><strong><?php echo xlt('Provider'); ?>:</strong></td>
        ...
        <tr>
            <td align="left" class="forms"><strong><?php echo xlt('Presenting Issue(s)'); ?>:</strong></td>
        ...
        <tr>
            <td align="left" class="forms"><strong><?php echo xlt('Patient History'); ?>:</strong></td>
        ...
        <tr>
            ...
            <td align="left" class="forms"><strong><?php echo xlt('Medications'); ?>:</strong></td>
            <td colspan="3"><textarea name="medications" rows="2" cols="60" wrap="virtual name"><?php echo text($obj["medications"]);?></textarea></td>


        </tr>
        <tr>
            <td align="left" class="forms"><strong><?php echo xlt('Anyother Relevant Information'); ?>:</strong></td>
        ...
        <tr>
            <td align="left" class="forms"><strong><?php echo xlt('Diagnosis'); ?>:</strong></td>
            <td colspan="3"><textarea name="diagnosis" rows="2" cols="60" wrap="virtual name"><?php echo text($obj["diagnosis"]);?></textarea></td>

        </tr>
        <tr>
            <td align="left" class="forms"><strong><?php echo xlt('Treatment Received'); ?>:</strong></td>
        ...
        <tr>
            <td align="left" class="forms"><strong><?php echo xlt('Recommendation For Follow Up'); ?>:</strong></td>
