            ...
            while ($row = sqlFetchArray($dispensed)) {
                ...
                ?>
                    <div class="position-relative text-center mt-2 mb-2 mx-auto" id="RXID_<?php echo attr($row['id']); ?>">
                        <i class="float-end fas fa-times"
                        ...
                        <div class="table-responsive">
                            <table class="table mt-1 mb-1 mx-auto">
                                <tr>
                                    <td class="text-end align-middle fw-bold" style="width:250px;">
                                ...
                                <tr>
                                    <td class="text-end align-middle fw-bold"><?php echo xlt('Refraction Method'); ?>:</td>
                                    <td>&nbsp;&nbsp;<?php
                                    if ($row['REFTYPE'] == "W") {
                                    ...
                                    if ($row['REFTYPE'] != "CTL") { ?>
                                                <table id="SpectacleRx" name="SpectacleRx" class="refraction" style="top:0px;">
                                                    <tr class="fw-bold">
                                                        <td></td>
                                                        <td></td>
                                                        <td class="center fw-bold underline"><?php echo xlt('Sph{{Sphere}}'); ?></td>
                                                        <td class="center fw-bold underline"><?php echo xlt('Cyl{{Cylinder}}'); ?></td>
                                                        <td class="center fw-bold underline"><?php echo xlt('Axis{{Axis in a glasses prescription}}'); ?></td>
                                                        <td rowspan="5" class="text-end align-middle fw-bold underline" colspan="2"
                                                    ...
                                                    <tr>
                                                        <td class="fw-bold text-end" rowspan="2"><?php echo xlt('Distance'); ?></td>
                                                        <td class="fw-bold"><?php echo xlt('OD{{right eye}}'); ?></td>
                                                    ...
                                                    <tr>
                                                        <td class="fw-bold"><?php echo xlt('OS{{left eye}}'); ?></td>
                                                    ...
                                                    <tr class="NEAR">
                                                        <td class="text-nowrap" rowspan="2"><span class="fw-bold text-decoration-none"><?php echo xlt('ADD'); ?>
                                                    ...
                                                    <tr>
                                                        <td colspan="2" class="up" class="fw-bold text-end align-top"
                                                            style="top:0px;"><?php echo xlt('Comments'); ?>
                                                            :
                                                        </td>
                                                        <td colspan="4" class="up text-start"></td>
                                        ...
                                        ?>
                                                <table id="CTLRx" name="CTLRx" class="refraction">
                                                    <tr>
                                                        <td colspan="4"
                                                            class="fw-bold text-start align-middle text-uppercase text-top" style="display: flex;
                                                align-items:top"><u><?php echo xlt('Right Lens'); ?></u>
                                                        </td>
                                                    </tr>
                                                    <tr class="fw-bold underline">
                                                        <td></td>
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        <td colspan="2" class="text-end align-middle fw-bold">
                                                            <?php echo xlt('Brand'); ?>: <br />
                                                            <?php echo xlt('Quantity'); ?>: <br />
                                                            <?php echo xlt('Supplier'); ?>: </td>
                                                        <td colspan="5" class="text-start align-middle align-middle align-top" style="padding-left:10px;">
                                                    ...
                                                    <tr>
                                                        <td colspan="4"
                                                            class="fw-bold text-start align-middle text-uppercase text-top d-flex align-items-start">
                                                    ...
                                                    <tr>
                                                        <td colspan="2" class="text-end align-middle fw-bold">
                                                            ...
                                                            <?php echo xlt('Quantity'); ?>: <br />
                                                            <?php echo xlt('Supplier'); ?>: </td>
                                                        <td colspan="5" class="text-start align-middle align-top" style="padding-left:10px;"><?php echo text($row['CTLBRANDOS']); ?>
                                                            <?php
                                                    ...
                                                    <?php if (!empty($row['COMMENTS'])) { ?>
                                                        ...
                                                        <tr>
                                                            <td colspan="3" class="fw-bold text-end align-middle"><?php echo xlt('Comments'); ?>:
                                                            </td>
                                                            <td colspan="3" class="text-start align-middle" style="padding-left:10px;top:0px;">
...
if ($REFTYPE == "CTL") {
    ...
    $expir_date = oeFormatShortDate($expir);
?>
<p><span class="fw-bold"><?php echo xlt('Expiration Date'); ?>: </span>
                    ...
                    if ($REFTYPE != "CTL") { ?>
                            <table id="SpectacleRx" name="SpectacleRx" class="refraction bordershadow"
                                ...
                                <tr class="fw-bold text-center">
                                    ...
                                    <td rowspan="5" class="text-end align-middle fw-bold" colspan="1" >
                                        <span class="fw-bold underline"><?php echo xlt('Rx Type'); ?></span>
                                        <br/><br/>
                                ...
                                <tr class="center">
                                    <td rowspan="2" colspan="1" class="text-end align-middle fw-bold"><?php echo xlt('Distance'); ?>: </td>
                                    <td class="text-end align-middle fw-bold"><?php echo xlt('OD{{right eye}}'); ?></td>
                                ...
                                <tr class="center">
                                    <td name="W_wide" class="text-end align-middle fw-bold"><?php echo xlt('OS{{left eye}}'); ?></td>
                                ...
                                <tr class="NEAR center">
                                    <td rowspan="2" colspan="1" class="text-end align-middle fw-bold text-nowrap"><?php echo xlt('ADD'); ?>:<br/>
                                ...
                                <tr class="NEAR center">
                                    <td class="text-end align-middle fw-bold"><?php echo xlt('OS{{left eye}}'); ?></td>
                                    <td name="COLADD1">
                                ...
                                <tr>
                                    <td colspan="2" class="center fw-bold"><?php echo xlt('Comments'); ?>: </td>
                                    <td colspan="4">
