...
`ODDRAWING` mediumblob,
`OSDRAWING` mediumblob,
...
INSERT INTO `user_settings` (`setting_user`, `setting_label`, `setting_value`)
    VALUES
(0, 'eye_mag_AntSeg', 'text'),
(0, 'eye_mag_External', 'text'),
(0, 'eye_mag_ImpPlan', 'text'),
(0, 'eye_mag_Neuro', 'text'),
(0, 'eye_mag_Physical', 'text'),
(0, 'eye_mag_Physical_Draw_Objects', 'on'),
(0, 'eye_mag_Physical_Text_QP', 'on'),
(0, 'eye_mag_PMH', '4'),
(0, 'eye_mag_PostSeg', 'graphic'),
(0, 'eye_mag_refraction', '7'),
(0, 'eye_mag_Refraction_Additional', '0'),
(0, 'eye_mag_Refraction_AR', '1'),
(0, 'eye_mag_Refraction_CR', '0'),
(0, 'eye_mag_Refraction_CTL', '0'),
(0, 'eye_mag_Refraction_IOL', '0'),
(0, 'eye_mag_Refraction_MR', '1'),
(0, 'eye_mag_Refraction_W', '1'),
(0, 'eye_mag_Refraction_W_Hx', '0'),
(0, 'eye_mag_sections', '6'),
(0, 'eye_mag_Vision', '6');
