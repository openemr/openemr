...
<head>
	...
	<link rel="shortcut icon" href="../css/AnythingSlider/demos/images/favicon.ico" type="image/x-icon">
	<link rel="apple-touch-icon" href="../css/AnythingSlider/demos/images/apple-touch-icon.png">

	<!-- jQuery (required) -->
	<script type="text/javascript" src="<?php echo $GLOBALS['webroot'] ?>/library/js/jquery-1.9.1.min.js"></script>
   	<script>window.jQuery || document.write('<script src="../css/AnythingSlider/js/jquery.min.js"><\/script>')</script>

	<!-- Demo stuff -->
	<link rel="stylesheet" href="../css/AnythingSlider/demos/css/page.css">
 ...
 <script src="../css/AnythingSlider/js/jquery.easing.1.2.js"></script>

 <!-- Anything Slider -->
 <link href="../css/AnythingSlider/css/anythingslider.css" rel="stylesheet">
 <script src="../css/AnythingSlider/js/jquery.anythingslider.min.js"></script>

<link rel="stylesheet" href="../css/AnythingSlider/css/theme-metallic.css">
	<link rel="stylesheet" href="../css/AnythingSlider/css/theme-minimalist-round.css">
	<link rel="stylesheet" href="../css/AnythingSlider/css/theme-minimalist-square.css">
	<link rel="stylesheet" href="../css/AnythingSlider/css/theme-construction.css">
	<link rel="stylesheet" href="../css/AnythingSlider/css/theme-cs-portfolio.css">


 <!-- ColorBox -->
 <link href="../css/AnythingSlider/demos/colorbox/colorbox.css" rel="stylesheet">
	 <script src="..css/AnythingSlider/demos/colorbox/jquery.colorbox-min.js"></script>
			...
			<tr>
				<td colspan="2" rowspan="2">
					...
					if ($documents['docs_in_name']['Patient Photograph'][0]['id']) {
						?>
						<object><embed src="<?php echo $GLOBALS['webroot'] ?>/controller.php?document&amp;retrieve&amp;patient_id=<?php echo $pid; ?>&amp;document_id=<?php echo $documents['docs_in_name']['Patient Photograph'][0]['id']; ?>&amp;as_file=false" frameborder="0"
						 type="<?php 
						...
						?>
						<object><embed src="../images/anon.gif" frameborder="0"
