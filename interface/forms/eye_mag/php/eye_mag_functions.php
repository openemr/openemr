...
function display_GlaucomaFlowSheet($pid, $bywhat = 'byday')
{
    ...
    if ((array)$priors) {
        ...
        if ($encounter_data['ODIOPAP']>'') {
            if (!is_int($encounter_data['ODIOPAP'])) { $ODIOP[$k]['IOP']='';} else { $ODIOP[$i]['IOP'] = $encounter_data['ODIOPAP']; }
            $ODIOP[$i]['method'] = "AP";
        ...
        if ($encounter_data['OSIOPAP']>'') {
            if (!is_int($encounter_data['OSIOPAP'])) { $OSIOP[$k]['IOP']='';} else { $OSIOP[$i]['IOP'] = $encounter_data['OSIOPAP']; }
            $OSIOP[$i]['method'] = "AP";
