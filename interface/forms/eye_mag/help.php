        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container">
                <a class="navbar-brand" href="#">
                    <img src="<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('webroot'); ?>/sites/default/images/login_logo.gif" width="30" height="30" alt="">
                ...
                <div class="card">
                    ...
                    <div id="hpi" class="collapse show" data-parent="#hpiAccordion">
                        <div class="card-body">
                            ...
                            <br />
                            <img src="<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('webroot'); ?>/interface/forms/eye_mag/images/sh_hpi.png" class="img-fluid" alt="Shorthand Example: Anterior Segment" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div id="pmh" class="collapse show" data-parent="#pmhAccordion">
                        <div class="card-body">
                            ...
                            <img src="<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('webroot'); ?>/interface/forms/eye_mag/images/sh_pmh.png" class="img-fluid" alt="Shorthand Example: Anterior Segment" />
                            <br />
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div id="externalShorthandWalkThrough" class="collapse show" data-parent="#externalAccordion">
                      <div class="card-body">
                        ...
                        <img src="<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('webroot'); ?>/interface/forms/eye_mag/images/sh_ext.png" class="img-fluid" alt="Shorthand Example: Anterior Segment" />
                        <br />
                      </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="border border-dark p-2">
                                        <h4>Eye Exam</h4>
                                        <img src="<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('webroot'); ?>/interface/forms/eye_mag/images/sh_ext_EMR.png" class="img-fluid" width="95%" alt="Shorthand Example: openEMR">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="border border-dark p-2">
                                        <h4>Reports</h4>
                                        <img src="<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('webroot'); ?>/interface/forms/eye_mag/images/sh_ext_report.png" class="img-fluid" width="75%" alt="Shorthand Example: Reports">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div id="anteriorSegmentShorthandWalkThrough" class="collapse show" data-parent="#anteriorSegmentAccordion">
                        <div class="card-body">
                            ...
                            <img src="<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('webroot'); ?>/interface/forms/eye_mag/images/sh_antseg.png" class="img-fluid" alt="Shorthand Example: Anterior Segment" />
                            <br />
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="border border-dark p-2">
                                        <h4>Eye Exam</h4>
                                        <img src="<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('webroot'); ?>/interface/forms/eye_mag/images/sh_antseg_EMR.png" class="img-fluid" width="90%" alt="Shorthand Example: openEMR">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="border border-dark p-2">
                                        <h4>Reports</h4>
                                        <img src="<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('webroot'); ?>/interface/forms/eye_mag/images/sh_antseg_report.png" class="img-fluid" width="95%" alt="Shorthand Example: Reports">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div id="retinaShorthandWalkThrough" class="collapse show" data-parent="#retinaAccordion">
                        <div class="card-body">
                            ...
                            <img src="<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('webroot'); ?>/interface/forms/eye_mag/images/sh_retina.png" class="img-fluid" alt="Shorthand Example: Anterior Segment">
                            <br />
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="border border-dark p-2">
                                        <h4>Eye Exam</h4>
                                        <img src="<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('webroot'); ?>/interface/forms/eye_mag/images/sh_retina_EMR.png" width="95%" alt="Shorthand Example: openEMR" />
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="border border-dark p-2">
                                        <h4>Reports</h4>
                                        <img src="<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('webroot'); ?>/interface/forms/eye_mag/images/sh_retina_report.png" width="95%" alt="Shorthand Example: Reports" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div id="neuroShorthandWalkThrough" class="collapse show" data-parent="#neuroAccordion">
                        <div class="card-body">
                            ...
                            <img src="<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('webroot'); ?>/interface/forms/eye_mag/images/sh_neuro.png" class="img-fluid" alt="Shorthand Example: Anterior Segment" />
                            <br />
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                    ...
                                    <div class="border border-dark p-2">
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-6 text-sm-center">
                                                <img src="<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('webroot'); ?>/interface/forms/eye_mag/images/sh_neuro_EMR1.png" class="img-fluid" alt="Shorthand Example: openEMR" />
                                            </div>
                                            <div class="col-12 col-md-6 text-sm-center">
                                                <img src="<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('webroot'); ?>/interface/forms/eye_mag/images/sh_neuro_EMR2.png" class="img-fluid" alt="Shorthand Example: openEMR" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="border border-dark p-2">
                                        <h4>Reports</h4>
                                        <img src="<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('webroot'); ?>/interface/forms/eye_mag/images/sh_neuro_report.png" class="img-fluid" width="75%" alt="Shorthand Example: Reports" />
                                    </div>
                                </div>
                            </div>
                        </div>
