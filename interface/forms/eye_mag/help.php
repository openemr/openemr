        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container">
                <a class="navbar-brand" href="#">
                    <img src="<?php echo OEGlobalsBag::getInstance()->getWebRoot(); ?>/sites/default/images/login_logo.gif" width="30" height="30" alt="">
        ...
        <div class="container" name="container_group" >
            ...
            <div id="introductionAccordion">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">
                            <button class="btn btn-link text-decoration-none" data-bs-toggle="collapse" data-bs-target="#introduction">
                                Introduction: Paper vs. EHR
                            </button>
                        </h5>
                    </div>
                    <div id="introduction" class="collapse show" data-bs-parent="#introductionAccordion">
                        <div class="card-body">
                            ...
                            <p>
                                Click on any <span class="fw-bold">Shorthand</span> icon <i class="fa fa-user-md fa-sm fa-2" name="Shorthand_kb" title="Open the Shorthand Window and display Shorthand Codes" data-bs-toggle="tooltip" data-bs-placement="top"></i> in the Eye Form and two things occur:
                            </p>
                            <ol>
                            ...
                            <br />
                            <small class="text-body-secondary">Now imagine documenting this without typing, without a scribe?  It is not that far away...</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">
                            <button class="btn btn-link text-decoration-none collapsed" data-bs-toggle="collapse" data-bs-target="#shorthand">
                                Shorthand Structure
                            </button>
                        </h5>
                    </div>
                    <div id="shorthand" class="collapse" data-bs-parent="#introductionAccordion">
                        <div class="card-body">
                            <h4>
                            ...
                            <div class="ms-4">
                                <p>
                                    ...
                                    <br />
                                    <span class="fst-italic text-body-secondary">The semi-colon separates entries.</span>
                                    <br />
            ...
            <div class="d-none" id="hpiAccordion">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">
                            <button class="btn btn-link text-decoration-none" data-bs-toggle="collapse" data-bs-target="#hpi">
                                History of Present Illness: Shorthand Walk Through
                            </button>
                        </h5>
                    </div>
                    <div id="hpi" class="collapse show" data-bs-parent="#hpiAccordion">
                        <div class="card-body">
                            <h4><u>Shorthand</u></h4>
                            ...
                            <br />
                            <img src="<?php echo OEGlobalsBag::getInstance()->getWebRoot(); ?>/interface/forms/eye_mag/images/sh_hpi.png" class="img-fluid" alt="Shorthand Example: Anterior Segment" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-none" id="pmhAccordion">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">
                            <button class="btn btn-link text-decoration-none" data-bs-toggle="collapse" data-bs-target="#pmh">
                                Past Medical History: Shorthand Walk Through
                            </button>
                        </h5>
                    </div>
                    <div id="pmh" class="collapse show" data-bs-parent="#pmhAccordion">
                        <div class="card-body">
                            <h4><u>Shorthand</u></h4>
                            ...
                            <img src="<?php echo OEGlobalsBag::getInstance()->getWebRoot(); ?>/interface/forms/eye_mag/images/sh_pmh.png" class="img-fluid" alt="Shorthand Example: Anterior Segment" />
                            <br />
                        </div>
                    </div>
                </div>
            ...
            <div class="d-none" id="externalAccordion">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">
                            <button class="btn btn-link text-decoration-none" data-bs-toggle="collapse" data-bs-target="#externalShorthandWalkThrough">
                                External: Shorthand Walk Through
                            </button>
                        </h5>
                    </div>
                    <div id="externalShorthandWalkThrough" class="collapse show" data-bs-parent="#externalAccordion">
                      <div class="card-body">
                        <h4><u>Shorthand</u></h4>
                        <textarea class="form-control">D;bll:+2 meibomitis;rll:frank ect, 7x6mm lid margin bcc lat.a;bul:2mm ptosis;rul.+3 dermato.a
                        </textarea>
                        <img src="<?php echo OEGlobalsBag::getInstance()->getWebRoot(); ?>/interface/forms/eye_mag/images/sh_ext.png" class="img-fluid" alt="Shorthand Example: Anterior Segment" />
                        <br />
                      </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">
                            <button class="btn btn-link text-decoration-none collapsed" data-bs-toggle="collapse" data-bs-target="#externalExampleOutput">
                                External: Example Output
                            </button>
                        </h5>
                    </div>
                    <div id="externalExampleOutput" class="collapse" data-bs-parent="#externalAccordion">
                        <div class="card-body">
                            <p>
                                Input:
                                <br />
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="border border-dark p-2">
                                        <h4>Eye Exam</h4>
                                        <img src="<?php echo OEGlobalsBag::getInstance()->getWebRoot(); ?>/interface/forms/eye_mag/images/sh_ext_EMR.png" class="img-fluid" width="95%" alt="Shorthand Example: openEMR">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="border border-dark p-2">
                                        <h4>Reports</h4>
                                        <img src="<?php echo OEGlobalsBag::getInstance()->getWebRoot(); ?>/interface/forms/eye_mag/images/sh_ext_report.png" class="img-fluid" width="75%" alt="Shorthand Example: Reports">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">
                            <button class="btn btn-link text-decoration-none collapsed" data-bs-toggle="collapse" data-bs-target="#externalFieldCodesAndShorthand">
                                External: Field Codes and Shorthand/Abbreviations
                            </button>
                        </h5>
                    </div>
                    <div id="externalFieldCodesAndShorthand" class="collapse" data-bs-parent="#externalAccordion">
                        <div class="card-body">
            ...
            <div class="d-none" id="anteriorSegmentAccordion">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">
                            <button class="btn btn-link text-decoration-none" data-bs-toggle="collapse" data-bs-target="#anteriorSegmentShorthandWalkThrough">
                                Anterior Segment: Shorthand Walk Through
                            </button>
                        </h5>
                    </div>
                    <div id="anteriorSegmentShorthandWalkThrough" class="collapse show" data-bs-parent="#anteriorSegmentAccordion">
                        <div class="card-body">
                            <h4><u>Shorthand</u></h4>
                            <textarea class="form-control">D;bc:+2 inj;bk:med pter;rk:mod endo gut.a;bac:+1 fc, +1 pig cells
                            </textarea>
                            <img src="<?php echo OEGlobalsBag::getInstance()->getWebRoot(); ?>/interface/forms/eye_mag/images/sh_antseg.png" class="img-fluid" alt="Shorthand Example: Anterior Segment" />
                            <br />
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">
                            <button class="btn btn-link text-decoration-none collapsed" data-bs-toggle="collapse" data-bs-target="#anteriorSegmentExampleOutput">
                                Anterior Segment: Example Output
                            </button>
                        </h5>
                    </div>
                    <div id="anteriorSegmentExampleOutput" class="collapse" data-bs-parent="#anteriorSegmentAccordion">
                        <div class="card-body">
                            <p>
                                Input:
                                <br />
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="border border-dark p-2">
                                        <h4>Eye Exam</h4>
                                        <img src="<?php echo OEGlobalsBag::getInstance()->getWebRoot(); ?>/interface/forms/eye_mag/images/sh_antseg_EMR.png" class="img-fluid" width="90%" alt="Shorthand Example: openEMR">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="border border-dark p-2">
                                        <h4>Reports</h4>
                                        <img src="<?php echo OEGlobalsBag::getInstance()->getWebRoot(); ?>/interface/forms/eye_mag/images/sh_antseg_report.png" class="img-fluid" width="95%" alt="Shorthand Example: Reports">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">
                            <button class="btn btn-link text-decoration-none collapsed" data-bs-toggle="collapse" data-bs-target="#anteriorSegmentFieldCodesAndShorthand">
                                Anterior Segment: Field Codes and Shorthand/Abbreviations
                            </button>
                        </h5>
                    </div>
                    <div id="anteriorSegmentFieldCodesAndShorthand" class="collapse" data-bs-parent="#anteriorSegmentAccordion">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    <tr class="table-dark">
                                    ...
                                    <tr>
                                        ...
                                        <td>D or d</td>
                                        <td>
                                            <span class="fw-light text-danger">d</span>;
                                            <br />
                                            <span class="fw-light text-danger">D</span>;
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="fw-light text-danger">rk:</span>+3 spk
                                            <br />
                                            <span class="fw-light text-danger">k:</span>+2 end gut<span class="fw-bold text-success">;</span><span class="fw-light text-danger">rk:</span>+1 str edema<span class="fw-bold text-success">.a</span>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="fw-light text-danger">rac:</span>+1 fc
                                            <br />
                                            <span class="fw-light text-danger">ac:</span>+2 flare
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="fw-light text-danger">RL:</span>+2 NS
                                            <br />
                                            <span class="fw-light text-danger">ll:</span>+2 NS<span class="text-weight-bold text-success">;</span><span class="fw-light text-danger">l:</span>+3 ant cort spokes.a
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <br />
                                            <span class="fw-light text-danger">ri:</span>+2 TI defects<span class="fw-bold text-success">.a</span>;<span class="fw-light text-danger">li</span>.round
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="fw-light text-danger">rg:</span>ss 360
                                            <br />
                                            <span class="fw-light text-danger">lg:</span>3-5 o angle rec
                                        </td>
                                        <td>
                                            SS 360
                                            <br />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="fw-light text-danger">lp:</span>625 um
                                            <br />
                                            <span class="fw-light text-danger">p:</span>550 um
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="fw-light text-danger">rsch1:</span>5mm
                                            <br />
                                            <span class="fw-light text-danger">sch1:</span>&lt; 10mm/5 minutes
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="fw-light text-danger">rsch2:</span>9 mm
                                            <br />
                                            <span class="fw-light text-danger">sch2:</span>&lt; 10mm/5 minutes
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="fw-light text-danger">tbut:</span>&lt; 10 seconds
                                            <br />
                                            <span class="fw-light text-danger">Rtbut:</span>5 secs<span class="fw-bold text-success">;</span><span class="fw-light text-danger">ltbut:</span>9 seconds<span class="fw-bold text-success">;</span>
                                        </td>
                                        <td>
            ...
            <div class="d-none" id="retinaAccordion">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">
                            <button class="btn btn-link text-decoration-none" data-bs-toggle="collapse" data-bs-target="#retinaShorthandWalkThrough">
                                Retina: Shorthand Walk Through
                            </button>
                        </h5>
                    </div>
                    <div id="retinaShorthandWalkThrough" class="collapse show" data-bs-parent="#retinaAccordion">
                        <div class="card-body">
                            <h4><u>Shorthand</u></h4>
                            ...
                            <img src="<?php echo OEGlobalsBag::getInstance()->getWebRoot(); ?>/interface/forms/eye_mag/images/sh_retina.png" class="img-fluid" alt="Shorthand Example: Anterior Segment">
                            <br />
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">
                            <button class="btn btn-link text-decoration-none collapsed" data-bs-toggle="collapse" data-bs-target="#retinaExampleOutput">
                                Retina: Example Output
                            </button>
                        </h5>
                    </div>
                    <div id="retinaExampleOutput" class="collapse" data-bs-parent="#retinaAccordion">
                        <div class="card-body">
                            <p>
                                Input:
                                <br />
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="border border-dark p-2">
                                        <h4>Eye Exam</h4>
                                        <img src="<?php echo OEGlobalsBag::getInstance()->getWebRoot(); ?>/interface/forms/eye_mag/images/sh_retina_EMR.png" width="95%" alt="Shorthand Example: openEMR" />
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="border border-dark p-2">
                                        <h4>Reports</h4>
                                        <img src="<?php echo OEGlobalsBag::getInstance()->getWebRoot(); ?>/interface/forms/eye_mag/images/sh_retina_report.png" width="95%" alt="Shorthand Example: Reports" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">
                            <button class="btn btn-link text-decoration-none collapsed" data-bs-toggle="collapse" data-bs-target="#retinaFieldCodesAndShorthand">
                                Retina: Field Codes and Shorthand/Abbreviations
                            </button>
                        </h5>
                    </div>
                    <div id="retinaFieldCodesAndShorthand" class="collapse" data-bs-parent="#retinaAccordion">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    <tr class="table-dark">
                                    ...
                                    <tr >
                                        ...
                                        <td>
                                            <span class="fw-light text-danger">rd:</span>temp pallor, PPA
                                            <br />
                                            <span class="fw-light text-danger">bd:</span>NVD at 5 o
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="fw-light text-danger">rcup:</span>0.5 w/ inf notch
                                            <br />
                                            <span class="fw-light text-danger">cup:</span>temp scalloping, 0.5<span class="fw-bold text-success">.a</span><span class="fw-bold text-success">;</span>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="fw-light text-danger">rmac:</span>central scar 500um
                                            <br />
                                            <span class="fw-light text-danger">mac:</span>soft drusen, - heme.a
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="fw-light text-danger">RV:</span>1:2, +2 BDR
                                            <br />
                                            <span class="fw-light text-danger">lv:</span>+CSME w/ hard exudate sup to fov (300um)<span class="fw-bold text-success">;</span>
                                            <br />
                                            <span class="fw-light text-danger">v:</span>narrow arterioles, 1:2<span class="fw-bold text-success">.a;</span>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="fw-light text-danger">rp:</span>12 0 ht, no heme, amenable to bubble<span class="fw-bold text-success">;</span>
                                            <br />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="fw-light text-danger">rcmt:</span>254
                                            <br />
                                            <span class="fw-light text-danger">cmt:</span>flat
                                        </td>
                                        <td>
                                            254 (right CMT only)
                                            <br />
            ...
            <div class="d-none" id="neuroAccordion">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">
                            <button class="btn btn-link text-decoration-none" data-bs-toggle="collapse" data-bs-target="#neuroShorthandWalkThrough">
                                Neuro: Shorthand Walk Through
                            </button>
                        </h5>
                    </div>
                    <div id="neuroShorthandWalkThrough" class="collapse show" data-bs-parent="#neuroAccordion">
                        <div class="card-body">
                            <h4><u>Shorthand</u></h4>
                            <textarea class="form-control">scDist;5:8ix 1rht;4:10ix;6:6ix;2:15xt;8:5ix;ccDist;4:5ix;5:ortho;6:ortho;
                            </textarea>
                            <img src="<?php echo OEGlobalsBag::getInstance()->getWebRoot(); ?>/interface/forms/eye_mag/images/sh_neuro.png" class="img-fluid" alt="Shorthand Example: Anterior Segment" />
                            <br />
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">
                            <button class="btn btn-link text-decoration-none collapsed" data-bs-toggle="collapse" data-bs-target="#neuroExampleOutput">
                                Neuro: Example Output
                            </button>
                        </h5>
                    </div>
                    <div id="neuroExampleOutput" class="collapse" data-bs-parent="#neuroAccordion">
                        <div class="card-body">
                            <p>
                                Input:
                                <br />
                            ...
                            <div class="row">
                                    ...
                                    <div class="border border-dark p-2">
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-6 text-sm-center">
                                                <img src="<?php echo OEGlobalsBag::getInstance()->getWebRoot(); ?>/interface/forms/eye_mag/images/sh_neuro_EMR1.png" class="img-fluid" alt="Shorthand Example: openEMR" />
                                            </div>
                                            <div class="col-12 col-md-6 text-sm-center">
                                                <img src="<?php echo OEGlobalsBag::getInstance()->getWebRoot(); ?>/interface/forms/eye_mag/images/sh_neuro_EMR2.png" class="img-fluid" alt="Shorthand Example: openEMR" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="border border-dark p-2">
                                        <h4>Reports</h4>
                                        <img src="<?php echo OEGlobalsBag::getInstance()->getWebRoot(); ?>/interface/forms/eye_mag/images/sh_neuro_report.png" class="img-fluid" width="75%" alt="Shorthand Example: Reports" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">
                            <button class="btn btn-link text-decoration-none collapsed" data-bs-toggle="collapse" data-bs-target="#neuroFieldCodesAndShorthand">
                                Neuro: Field Codes and Shorthand/Abbreviations
                            </button>
                        </h5>
                    </div>
                    <div id="neuroFieldCodesAndShorthand" class="collapse" data-bs-parent="#neuroAccordion">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    <tr class="table-dark">
