                ...
                <div class="card">
                    ...
                    <div id="introduction" class="collapse show" data-parent="#introductionAccordion">
                        <div class="card-body">
                            ...
                            <p>
                                Click on any <span class="fw-bold">Shorthand</span> icon <i class="fa fa-user-md fa-sm fa-2" name="Shorthand_kb" title="Open the Shorthand Window and display Shorthand Codes" data-bs-toggle="tooltip" data-placement="top"></i> in the Eye Form and two things occur:
                            </p>
                            <ol>
