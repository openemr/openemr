...
function build_DX_list(obj) {
    ...
    if ($('#inc_PE').is(':checked') && obj.Clinical) {
        $.each(obj.Clinical, function(key, value) {
               ...
               diagnosis = "<code class='float-end ICD_CODE'>"+obj.Clinical[key][0].code+"</code>";
               }
    ...
    if ($('#inc_POH').is(':checked') && (obj.PMSFH['POH']||obj.PMSFH['POS'])) {
        $.each(obj.PMSFH['POH'], function(key, value) {
               ...
               diagnosis = "<code class='float-end ICD_CODE'>"+obj.PMSFH['POH'][key].code+"</code>";
               }
        ...
        $.each(obj.PMSFH['POS'], function(key, value) {
               ...
               diagnosis = "<code class='float-end ICD_CODE'>"+obj.PMSFH['POS'][key].code+"</code>";
               }
    ...
    if ($('#inc_PMH').is(':checked') && obj.PMSFH['PMH']) {
        $.each(obj.PMSFH['PMH'], function(key, value) {
               ...
               diagnosis = "<code class='float-end ICD_CODE'>"+obj.PMSFH['PMH'][key].code+"</code>";
               }
        ...
        $.each(items, function( index, value ) {
            ...
            if (typeof nodisplay !== "undefined") {
              return;
               ...
               value.title +"</span>"+
               " <span contenteditable class='float-end' onclick='sel_diagnosis("+index+",\""+title2+"\");' title='"+value.codetext+"' id='CODE_"+index+"'>"+
               value.code + "</span>"+
               ...
               $('#IMPPLAN_zone').append('<div id="IMPPLAN_zone_'+index+'" class="IMPPLAN_class">'+
                                         '<i class="float-end fa fa-times" id="BUTTON_IMPPLAN_'+index+'"></i>'+
                                         contents_here+'</div>');
