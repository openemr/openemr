...
function addProcLine(flag = false) {
    ...
    let cell = "<table class='table table-sm proc-table'><tr><td class='itemDelete'><button type='button' class='btn btn-danger btn-delete' onclick='deleteRow(event)'></button></td>" +
        ...
        "<td class='diagnosis-div input-group'><span class='btn btn-secondary'>" +
        "<i onclick='current_diagnoses(this)' class='input-group-prepend fa fa-search fa-lg' title='<?php echo xla('Click to search past and current diagnoses history'); ?>'></i></span>" +
