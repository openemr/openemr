...
function sel_proc_type(formseq) {
 ...
 dlgopen('../../orders/find_order_popup.php' +
  ...
  '&formseq=' + formseq,
  '_blank', 800, 500, '', '<?php echo xla("Find Procedure Order"); ?>');
}
...
function sel_related(varname) {
 ...
 dlgopen('find_code_dynamic.php?codetype=<?php echo attr(collect_codetypes("diagnosis", "csv")); ?>', '_blank', 985, 750, '', '<?php echo xla("Select Diagnosis Codes"); ?>');
}
// This is for callback by the find-code popup.
...
<div class="container">
    ...
    <div class="row">
        <form class="form-horizontal" method="post" action="<?php echo $rootdir ?>/forms/procedure_order/new.php?id=<?php echo $formid ?>" onsubmit="return validate(this)">
            <fieldset>
                <legend class=""><?php echo xlt('Select Options for Current Procedure') ?></legend>
                <div class="col-xs-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <textarea name="form_clinical_hx" id="form_clinical_hx" class="form-control" rows="3"><?php echo attr($row['clinical_hx']); ?></textarea>
                        </div>
                    </div>
            ...
            <fieldset>
                ...
                <div class="col-md-12 procedure-order-container table-responsive">
                    <div class="form-group">
                        ...
                        <label for="procedure_type_names" class="control-label col-sm-2 col-sm-offset-3"><?php xl('Procedure Type', 'e'); ?></label>
                        <div class="col-sm-3">
                    ...
                    foreach ($oparr as $oprow) {
                        ...
                        ?>
                        <table class="table table-condensed" id="procedures">
                            <thead>
                            <tr>
