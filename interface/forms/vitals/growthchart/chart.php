...
if ($charttype == 'birth') {
    ...
    $delta_y2   = 28;     //pixels per pound - weight

    $HC_dot_x   = 228;     //months starts here for Head circumference chart
    ...
    if (preg_match('/^male/i', $patient_data['sex'])) {
        ...
        $HC_dot_x_ds    = 196.4;     //months starts here for Head circumference chart
    ...
    elseif (preg_match('/^female/i', $patient_data['sex'])) {
        ...
        $dot_x      = 240;         //months starts here (pixel)
        $delta_x    = 32.5;     //pixels per month  - length
        $dot_y1     = 953.6;        //height starts here ~14 inches for girls
        $delta_y1   = 30.7;    //pixels per inch  - height
        ...
        $HC_dot_x_ds    = 190;     //months starts here for Head circumference chart
    ...
    if (preg_match('/^male/i', $patient_data['sex'])) {
        ...
        //2-20 yo boys, HC, DS
        $HC_dot_x_ds    = 186.521;     //months starts here for Head circumference chart
    ...
    elseif (preg_match('/^female/i', $patient_data['sex'])) {
        ...
        $HC_dot_x_ds    = 168.820;     //months starts here for Head circumference chart
...
if ($_GET['html'] == 1) {
    ...
    foreach ($datapoints as $data) {
        ...
        if($height == "" && $weight == "" && $head_circ == "") continue;
