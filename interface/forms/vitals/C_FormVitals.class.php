...
class C_FormVitals
{
    ...
    {
        $this->units_of_measurement = \OpenEMR\Core\OEGlobalsBag::getInstance()->get('units_of_measurement');
    ...
    public function default_action()
    {
        ...
        $records = $vitalsService->getVitalsHistoryForPatient(\OpenEMR\Core\OEGlobalsBag::getInstance()->get('pid'), $form_id);
        ...
        $vitalFields = [
            ...
            ,[
                ...
                ,'precision' => 2
                // hide_circumferences
                ,'hide' => \OpenEMR\Core\OEGlobalsBag::getInstance()->get('gbl_vitals_options') > 0
                ,'codes' => "LOINC:9843-4"
            ]
            ,[
                'type' => 'textbox_conversion'
        ...
        $maxHistoryCols = \OpenEMR\Core\OEGlobalsBag::getInstance()->get('gbl_vitals_max_history_cols') ?? 2;
        ...
        $data = [
            ...
            ,'FORM_ACTION' => \OpenEMR\Core\OEGlobalsBag::getInstance()->get('web_root')
            ,'DONT_SAVE_LINK' => \OpenEMR\Core\OEGlobalsBag::getInstance()->get('form_exit_url')
            ,'STYLE' => \OpenEMR\Core\OEGlobalsBag::getInstance()->get('style')
            ...
            ,'hide_circumferences' => \OpenEMR\Core\OEGlobalsBag::getInstance()->get('gbl_vitals_options') > 0
    ...
    public function populate_object(&$obj)
    {
        ...
        if (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('encounter') < 1) {
            \OpenEMR\Core\OEGlobalsBag::getInstance()->set('encounter', date("Ymd"));
        }

        // have to set these global settings in order for us to save.
        $obj->set_encounter(\OpenEMR\Core\OEGlobalsBag::getInstance()->get('encounter'));
        $obj->set_pid(\OpenEMR\Core\OEGlobalsBag::getInstance()->get('pid'));
