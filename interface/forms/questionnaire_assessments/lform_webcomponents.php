...
$root =  \OpenEMR\Core\OEGlobalsBag::getInstance()->get('webroot') . "/interface/forms/questionnaire_assessments";
...
if (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('questionnaire_display_style') == 1) {
