<?php
/** **************************************************************************
 *	QUEST_RESULT/LINK_SELECT.PHP
 *
 *	Copyright (c)2013 - Williams Medical Technology, Inc.
 *
 *	Adapted from PATIENT_SELECT.PHP
...
<form method='post' action='link_select.php' name='theform'>
<input type='hidden' name='fstart'  value='<?php echo htmlspecialchars( $fstart, ENT_QUOTES); ?>' />
<input type='hidden' name='id'  value='<?php echo htmlspecialchars( $form_id, ENT_QUOTES); ?>' />
