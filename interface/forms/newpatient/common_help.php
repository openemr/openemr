    ...
    <body>
        <div class="container">
            ...
            <div class= "row" id="visit_details">
                ...
                <p><?php echo xlt("Sensitivity - lets you limit the information in this encounter to those with appropriate privileges. The default is 'Normal', i.e. it is visible to everyone. Selecting 'High' will restrict it to users belonging to the Physicians and Administrators groups by deafult. Access can be given to other groups by editing User Memberships or Groups and Access Controls in Administration > ACL"); ?>

                <p><?php echo xlt("Onset/hosp. date - is used for billing hospital encounters"); ?>

                <p><i class="fa fa-exclamation-triangle" style="color:red" aria-hidden="true"></i> <strong><?php echo xlt("You need administrator privileges to perform the changes to the values in the drop-down boxes."); ?></strong>
            </div>
