    ...
    <body>
        <div class="container">
            ...
            <div class= "row" id="visit_details">
                ...
                <p><i class="fa fa-exclamation-triangle" style="color:red" aria-hidden="true"></i> <strong><?php echo xlt("You need administrator privileges to give access to other groups");?>.</strong>
            ...
            <div class= "row" id="link_issue">
                ...
                <a href="#" class="css_button_small" style="float:none"><?php echo xlt("Add Issue");?></a>
