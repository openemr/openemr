...
// CODE GENERATED BY CLAUDE.AI - START
    const initializeTooltips = function() {
        (function() {
            var el = document.getElementById('sensitivity-tooltip');
            if (el) {
                el.setAttribute('title', xl('If set as high will restrict visibility of encounter to users belonging to certain groups (AROs). By default - Physicians and Administrators'));
        ...
        (function() {
            var el = document.getElementById('onset-tooltip');
            if (el) {
                el.setAttribute('title', xl('Hospital date needed for successful billing of hospital encounters'));
                el.setAttribute('data-bs-toggle', 'tooltip');
                el.setAttribute('data-bs-placement', 'bottom');
