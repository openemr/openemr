...
try {
     ...
     * @global $rootdir
     */
    $controller = new C_EncounterVisitForm(__DIR__, OEGlobalsBag::getInstance()->getKernel(), \OpenEMR\Core\OEGlobalsBag::getInstance()->get('ISSUE_TYPES'), $rootdir, 'newpatient/common.php');
    /**
     * @global $pid
     */
