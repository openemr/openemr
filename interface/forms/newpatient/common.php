...
<head>
    ...
    if ($GLOBALS['enable_help'] == 1) {
        $help_icon = '<a class="float-end oe-help-redirect" data-bs-target="#myModal" data-bs-toggle="modal" href="#" id="help-href" name="help-href" style="color:#676666" title="' . xla("Click to view Help") . '"><i class="fa fa-question-circle" aria-hidden="true"></i></a>';
    } elseif ($GLOBALS['enable_help'] == 2) {
        $help_icon = '<a class="float-end oe-help-redirect" data-bs-target="#myModal" data-bs-toggle="modal" href="#" id="help-href" name="help-href" style="color:#DCD6D0 !Important" title="' . xla("To enable help - Go to  Administration > Globals > Features > Enable Help Modal") . '"><i class="fa fa-question-circle" aria-hidden="true"></i></a>';
...
<body <?php echo $body_javascript; ?>>
    <div id="container_div" class="<?php echo attr($oemr_ui->oeContainer()); ?> mt-3">
        ...
        <form class="mt-3" id="new-encounter-form" method='post' action="<?php echo $rootdir ?>/forms/newpatient/save.php" name='new_encounter'>
                ...
                <div id="visit-details" class="px-3">
                    <div class="form-row align-items-center">
                        <div class="col-sm <?php displayOption('enc_enable_visit_category'); ?>">
                            <div class="mb-3">
                                <label for="pc_catid" class="text-end"><?php echo xlt('Visit Category:'); ?></label>
                        ...
                        <div class="col-sm <?php displayOption('enc_enable_class');?>">
                            <div class="mb-3">
                                <label for='class' class="text-end"><?php echo xlt('Class'); ?>:</label>
                        ...
                        <div class="col-sm <?php displayOption('enc_enable_type');?>">
                            <div class="mb-3">
                                <label for='encounter_type' class="text-end"><?php echo xlt('Type'); ?>:</label>
                                <?php
                        ...
                        if ($sensitivities && count($sensitivities)) :
                            ...
                            <div class="col-sm <?php displayOption('enc_sensitivity_visibility');?>">
                                <div class="mb-3">
                                    <label for="pc_catid" class="text-end"><?php echo xlt('Sensitivity:'); ?> <i id='sensitivity-tooltip' class="fa fa-info-circle text-primary" aria-hidden="true"></i></label>
                    ...
                    <div class="form-row align-items-center">
                        <div class="col-sm <?php displayOption('enc_service_date');?>">
                            <div class="mb-3">
                                <label for='form_date' class="text-end"><?php echo xlt('Date of Service:'); ?></label>
                        ...
                        <div class="col-sm <?php echo ($GLOBALS['gbl_visit_onset_date'] == 1) ?: 'd-none'; ?>">
                            <div class="mb-3">
                                <label for='form_onset_date' class="text-end"><?php echo xlt('Onset/hosp. date:'); ?> &nbsp;<i id='onset-tooltip' class="fa fa-info-circle text-primary" aria-hidden="true"></i></label>
                        ...
                        <div class="col-sm <?php echo ($GLOBALS['gbl_visit_referral_source'] == 1) ?: 'd-none';?>">
                            <div class="mb-3">
                                <label for="form_referral_source" class="text-end"><?php echo xlt('Referral Source'); ?>:</label>
                        ...
                        <div class="col-sm <?php echo ($GLOBALS['set_pos_code_encounter'] == 1) ?: 'd-none';?>">
                            <div class="mb-3">
                                <label for='pos_code' class="text-end"><?php echo xlt('POS Code'); ?>:</label>
                    ...
                    <div class="form-row align-items-center">
                        <div class="col-sm">
                            <div class="mb-3">
                                <label for='provider_id' class="text-end"><?php echo xlt('Encounter Provider'); ?>:</label>
                        ...
                        <div class="col-sm <?php displayOption('enc_enable_referring_provider');?>">
                            <div class="mb-3">
                                <label for='referring_provider_id' class="text-end"><?php echo xlt('Referring Provider'); ?>:</label>
                                <?php
                        ...
                        <div class="col-sm <?php displayOption('enc_enable_facility'); ?>">
                            <div class="mb-3">
                                <label for='facility_id' class="text-end"><?php echo xlt('Facility'); ?>:</label>
                        ...
                        <div class="col-sm <?php echo ($GLOBALS['hide_billing_widget'] != 1) ?: 'd-none'; ?>">
                            <div class="mb-3">
                                <label for='billing_facility' class="text-end"><?php echo xlt('Billing Facility'); ?>:</label>
                                <?php
                    ...
                    <div class="form-row align-items-center">
                        ...
                        <div class="col-sm <?php displayOption('enc_enable_discharge_disposition'); ?>">
                            <div class="mb-3">
                                <label for='facility_id' class="text-end"><?php echo xlt('Discharge Disposition'); ?>:</label>
                        ...
                        <div class="col-sm <?php echo ($GLOBALS['enable_group_therapy'] == 1) ?: 'd-none'; ?>">
                            <div class="mb-3">
                                <label for="form_group" class="text-end"><?php echo xlt('Group name'); ?>:</label>
            ...
            <div class="form-row">
                <div class="col-sm-12 text-start position-override ps-3">
...
<script>
    ...
    $(function () {
        $('#sensitivity-tooltip').attr({"title": <?php echo xlj('If set as high will restrict visibility of encounter to users belonging to certain groups (AROs). By default - Physicians and Administrators'); ?>, "data-bs-toggle": "tooltip", "data-placement": "bottom"}).tooltip();
        $('#onset-tooltip').attr({"title": <?php echo xlj('Hospital date needed for successful billing of hospital encounters'); ?>, "data-bs-toggle": "tooltip", "data-placement": "bottom"}).tooltip();
    });
