                    ...
                    <fieldset>
                        ...
                        <div id = "visit-details">
                            <div class="form-group ">
                                    <label for="pc_catid" class="control-label col-sm-2 text-to-side"><?php echo xlt('Visit Category:'); ?></label>
                                    <div class="col-sm-3">
                                    ...
                                    if ($sensitivities && count($sensitivities)) {
                                        ...
                                        ?>
                                        <label for="pc_catid" class="control-label col-sm-2 text-to-side"><?php echo xlt('Sensitivity:'); ?> &nbsp;<i id='sensitivity-tooltip' class="fa fa-info-circle text-primary" aria-hidden="true"></i></label>
                                        <div class="col-sm-3">
                                ...
                                <div class="form-group">
                                    <label for='form_date' class="control-label col-sm-2 text-to-side"><?php echo xlt('Date of Service:'); ?></label>
                                    <div class="col-sm-3">
                                    ...
                                    <div
                                        ...
                                        <label for='form_onset_date' class="control-label col-sm-2 text-to-side"><?php echo xlt('Onset/hosp. date:'); ?> &nbsp;<i id='onset-tooltip' class="fa fa-info-circle text-primary" aria-hidden="true"></i></label>
                                        <div class="col-sm-3">
                                ...
                                <div class="form-group"
                                    ...
                                    <label  class="control-label col-sm-2 text-to-side"><?php echo xlt('Referral Source'); ?>:</label>
                                    <div class="col-sm-3">
                                ...
                                <div class="form-group"id="therapy_group_name" style="display: none">
                                    <label for="form_group" class="control-label col-sm-2 text-to-side"><?php echo xlt('Group name'); ?>:</label>
                                    <div class="col-sm-3">
                                ...
                                <div class="form-group">
                                    <label for='facility_id' class="control-label col-sm-2 text-to-side"><?php echo xlt('POS Code'); ?>:</label>
                                    <div class="col-sm-8">
                                ...
                                <?php }?>
                                <div class="form-group">
                                    <label for='facility_id' class="control-label col-sm-2 text-to-side"><?php echo xlt('Facility'); ?>:</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    <label for='billing_facility' class="control-label col-sm-2 text-to-side"><?php echo xlt('Billing Facility'); ?>:</label>
