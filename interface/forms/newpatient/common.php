					...
					<legend><?php echo xlt('Reason for Visit')?></legend>
						<div class="form-group">
							<div class="col-sm-10 col-sm-offset-1">
								<textarea name="reason"	id="reason" class="form-control" cols="80" rows="6" ><?php echo $viewmode ? text($result['reason']) : text($GLOBALS['default_chief_complaint']); ?></textarea>
					...
					<div class="form-group">
						<div class="col-sm-6 col-sm-offset-3">
							...
							?>
								...
								<div class="col-sm-10  text-center" style="padding-top:15px">
