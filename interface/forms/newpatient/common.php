            ...
            <div class="col-xs-12">
                ...
                <div class="">
                    <div class="page-header">
                        ...
                        <?php } else { ?>
                            <h2><?php echo xlt('New Encounter Form'); ?><a class="pull-right oe-help-redirect help-href" data-target="#myModal" data-toggle="modal" href="#" id="help-href2" name="help-href2" style="color:#000000"><i class="fa fa-question-circle" aria-hidden="true"></i></a></h2>
                        <?php } ?>
                    </div>
                </div>
            </div>
