            ...
            <div class="col-xs-12">
                ...
                <div class="">
                    <div class="page-header">
                        <?php if ($viewmode) { ?>
                            <h2><?php echo xlt('Patient Encounter Form'); ?><a class="pull-right help-href" data-target="#myModal" data-toggle="modal" href="#" id="help-href1" name="help-href1" style="color:#000000"><i class="fa fa-question-circle" aria-hidden="true"></i></a></h2>
                        <?php } else { ?>
