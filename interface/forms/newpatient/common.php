...
function getIssuesForTemplate($ISSUE_TYPES, $pid, $viewmode, $encounter_id, $selectedIssue = null) {
...
function getGroupDataForTemplate($encounter = null)
{
    ...
    $categories = getTherapyGroupCategoriesForTemplate();
...
$t->addFunction(new TwigFunction('displayOptionClass', 'displayOption'));
...
if ($viewmode) {
    ...
    if ($encounter['sensitivity'] && !AclMain::aclCheckCore('sensitivities', $encounter['sensitivity'])) {
        $twig->render("templates/newpatient/unauthorized.html.twig");
        exit();
    }
}
...
if (!$viewmode) {
    ...
    $encounter = [
        ...
        ,'facility_id' => getDefinedFacility()
...
$facilities = getFacilitiesForTemplate($facilityService, $viewmode, $encounter);
$posCode = '';
...
$billingFacilities = getBillingFacilityForTemplate($facilityService, $encounter['billing_facility_id'] ?? null);
$inCollectionOptions = getInCollectionOptionsForTemplate($encounter);
$dischargeDispositions = getDischargeDispositionsForTemplate($viewmode ? $encounter : null);
$groupData = getGroupDataForTemplate($viewmode ? $encounter : null);
// Add therapy group categories to template data
$therapyGroupCategories = getTherapyGroupCategoriesForTemplate();
$posOptions = getPosOptionsForTemplate($facilityPosCode);
// END AI GENERATED CODE

if (empty($encounter) || $encounter['onset_date'] == '0000-00-00 00:00:00') {
...
// Render template
// START AI GENERATED CODE
echo $t->render("templates/newpatient/common.html.twig", [
    'globals' => $GLOBALS,
    'viewmode' => $viewmode,
    'mode' => $mode,
    ...
    'providers' => getProvidersForTemplate(new UserService(), $encounter),
    'visitCategories' => getVisitCategoriesForTemplate($viewmode, $encounter, $GLOBALS['default_visit_category']),
    'sensitivities' => getSensitivitiesForTemplate(),
    'issuesEnabled' => $issuesEnabled,
    'issuesAuth' => $issuesAuth,
    'canAddIssues' => AclMain::aclCheckCore('patients', 'med', '', 'write'),
    'issues' => $issuesEnabled && $issuesAuth ? getIssuesForTemplate($ISSUE_TYPES, $pid, $viewmode, $encounter['encounter'] ?? null, $_REQUEST['issue'] ?? null) : [],
    // END AI GENERATED CODE
    ...
    'selectedFacilityId' => getDefinedFacility(),
    'defaultClassCodeValue' => $viewmode ?  $encounter['class_code'] : '',
    'defaultEncounterTypeValue' => $viewmode ? getDefaultEncounterType($viewmode, $encounter) : '',
    'pid' => $pid,
