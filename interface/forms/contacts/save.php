...
if ($_GET["mode"] == "new") {
    $newid = formSubmit("form_contacts", $_POST, ($_GET["id"] ?? null), $userauthorized);
    ...
    $_POST["material"], $_POST["color"], $_POST["bifocal_type"], $_POST["add_value"], $_POST["va_far"], $_POST["va_near"], $_POST["additional_notes"], $_GET["id"]));
}
