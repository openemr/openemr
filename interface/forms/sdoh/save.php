...
WHERE id=?",
        ...
        ($_POST["transportotherinput"] ?? null),
        ...
        ($_POST["medicalotherinput"] ?? null),
        ($_POST["dentist"] ?? null),
        ($_POST["dentistotherinput"] ?? null),
        ($_POST["social"] ?? null),
        ($_POST["stress"] ?? null),
        ($_POST["stressno"] ?? null),
        ...
        ($_POST["displaceotherinput"] ?? null),
        ($_POST["contact"] ?? null),
        ($_POST["contactotherinput"] ?? null),
