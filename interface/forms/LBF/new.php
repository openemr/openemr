...
$LBF_ENABLE_SAVE_CLOSE = !empty(\OpenEMR\Core\OEGlobalsBag::getInstance()->get('gbl_form_save_close'));
...
if (!$from_trend_form) {
    $fname = \OpenEMR\Core\OEGlobalsBag::getInstance()->get('OE_SITE_DIR') . "/LBF/" . check_file_dir_name($formname) . ".plugin.php";
...
<head>
    ...
    <?php require_once \OpenEMR\Core\OEGlobalsBag::getInstance()->get('srcdir') . "/options.js.php"; ?>
        ...
        function set_related(codetype, code, selector, codedesc) {
            ...
            if (!current_sel_name) {
                if (code) {
                    ...
                    $.getScript('<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('web_root') ?>/library/ajax/code_attributes_ajax.php?' + params);
                }
                return '';
            }
            <?php } ?>
        ...
        <div class="row w-100 overflow-auto">
            <div class="col-12">
                ...
                if (isset($LBF_SERVICES_SECTION)) {
                    ...
                    $ctype = \OpenEMR\Core\OEGlobalsBag::getInstance()->get('ippf_specific') ? 'MA' : '';
