...
<form id="group_attendance_form" method=post action="<?php echo $rootdir;?>/forms/group_attendance/save.php?mode=update&id=<?php echo $_GET['id'] ;?>" name="my_form">
                ...
                <td align="center">
                    <select name="<?php echo "patientData[" . $participant['pid'] . "][status]" ;?>">
                        <?php foreach ($statuses_in_meeting as $key => $status_in_meeting){?>
                            <option value="<?php echo $key; ?>" <?php if($participant['meeting_patient_status'] == $key) echo 'selected';?> > <?php echo $status_in_meeting; ?></option>
                        <?php } ?>
                    </select>
                </td>
                <td align="center">
                    <input type="text" name="<?php echo "patientData[" . $participant['pid'] . "][comment]";  ?>" value="<?php echo $participant['meeting_patient_comment'] ;?>"></input>
                </td>
            </tr>
        <?php } ?>
        </tbody>
