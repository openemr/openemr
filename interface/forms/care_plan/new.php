...
<head>
    ...
    <script src="<?php echo attr(OEGlobalsBag::getInstance()->get('webroot')); ?>/interface/forms/care_plan/careplan.js?v=<?php echo attr(OEGlobalsBag::getInstance()->get('v_js_includes')); ?>" type="text/javascript"></script>
    <script>
        window.addEventListener('DOMContentLoaded', function () {
            window.careplanForm.init(<?php echo js_url(OEGlobalsBag::getInstance()->get('webroot')); ?>);
        });
                                        ...
                                        <div class="form-row">
                                            <div class="forms col-md-4">
                                                ...
                                                <input type="text" id="code_<?php echo attr($key) + 1; ?>" name="code[]" class="form-control code"
                                                    value="<?php echo attr($obj["code"]); ?>" onclick='sel_code(<?php echo attr_js(OEGlobalsBag::getInstance()->get('webroot')) ?>,
                                ...
                                <div class="tb_row" id="tb_row_1">
                                    <div class="form-row">
                                        <div class="forms col-md-2">
                                            ...
                                            <input type="text" id="code_1" name="code[]" class="form-control code" value="<?php echo attr($obj["code"] ?? ''); ?>" onclick='sel_code(<?php echo attr_js(OEGlobalsBag::getInstance()->get('webroot')) ?>, this.parentElement.parentElement.parentElement.id || "");'>
