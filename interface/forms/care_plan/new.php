...
<head>
    ...
    <script src="<?php echo attr(OEGlobalsBag::getInstance()->getWebRoot()); ?>/interface/forms/care_plan/careplan.js?v=<?php echo attr(OEGlobalsBag::getInstance()->get('v_js_includes')); ?>" type="text/javascript"></script>
    <script>
        window.addEventListener('DOMContentLoaded', function () {
            window.careplanForm.init(<?php echo js_url(OEGlobalsBag::getInstance()->getWebRoot()); ?>);
        });
