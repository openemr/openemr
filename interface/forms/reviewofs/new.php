						 ...
						 <div class="col-xs-12">
							<div class="col-sm-3">
								<div class="form-group"> 
									<div class="checkbox">
										<label>
											<input type="checkbox" name='fever'><?php echo xlt('Fever','e');?>
										</label>
									</div>
									<div class="checkbox">
										<label>
											<input type="checkbox" name='chills'><?php echo xlt('Chills','e');?>
										</label>
									</div>
									<div class="checkbox">
										<label>
						 ...
						 <div class="col-xs-12">
							<div class="col-sm-3">
								<div class="form-group"> 
									<div class="checkbox">
										<label>
											<input type="checkbox" name='cataracts'><?php echo xlt('Cataracts','e');?>
										</label>
									</div>
									<div class="checkbox">
										<label>
