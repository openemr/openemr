...
<div class="container">
    ...
    <form method=post action="<?php echo $rootdir . "/forms/" . $form_name . "/save.php?mode=update&id=" . attr_url($_GET["id"]);?>" name="my_form" id="my_form">
        ...
        <span class="ml-3"><?php echo xlt('Date'); ?></span>
           <input type='text' size='10' class='form-control datepicker ml-3' name='date_of_signature' id='date_of_signature'
        ...
        <div style="margin: 10px;">
            ...
            <input type="button" class="btn btn-success" value="<?php echo xla('View Printable Version'); ?>">
        </div>
    </form>
</div>
</body>
