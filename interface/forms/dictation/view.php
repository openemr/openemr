...
<span class=text>Dictation: </span><br><textarea cols=80 rows=24 wrap=virtual name="dictation" ><?echo stripslashes($obj{"dictation"});?></textarea><br>
<span class=text>Additional Notes: </span><br><textarea cols=80 rows=8 wrap=virtual name="additional_notes" ><?echo stripslashes($obj{"additional_notes"});?></textarea><br>
<br>
