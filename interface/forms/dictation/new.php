...
<div class="container">
  ...
  <form method=post action="<?php echo $rootdir;?>/forms/dictation/save.php?mode=new" name="my_form" onclick="top.restoreSession()">
     ...
     <div class="form-group">
       <label for="dictation"><?php echo xlt('Dictation: '); ?></label><br><textarea class="form-control" name="dictation" id="dictation"></textarea>
       <script>
          CKEDITOR.replace('dictation');
       </script>
    </div>
    <div class="form-group">
       <label for="additional_notes"><?php echo xlt('Additional Notes:'); ?> </label><br><textarea class="form-control" name="additional_notes" id="additional_notes"></textarea>
       <script>
