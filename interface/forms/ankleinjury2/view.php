...
$obj = formFetch("form_ankleinjury2", $_GET["id"]);
?>
<form method=post action="<?php echo $rootdir?>/forms/ankleinjury2/save.php?mode=update&id=<?php echo attr_url($_GET["id"]); ?>" name="my_form">
<input type="hidden" name="csrf_token_form" value="<?php echo attr(CsrfUtils::collectCsrfToken()); ?>" />

<span class="title"><?php echo xlt('Ankle Evaluation Form 2'); ?></span><br /><br />
