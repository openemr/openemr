...
if ($_GET["mode"] == "new") {
    $newid = formSubmit("form_ankleinjury2", $_POST, $_GET["id"], $userauthorized);
    addForm($encounter, "Ankle Evaluation Form", $newid, "ankleinjury2", $pid, $userauthorized);
} elseif ($_GET["mode"] == "update") {
    sqlStatement(
        "update form_ankleinjury2 set pid = ?,
            groupname = ?,
            user = ?,
            authorized = ?,
            activity = 1,
