...
<script>
    ...
    alert_string = "The onset date is read as ";
    alert_string += onset_str;
    alert(alert_string);
    return;
   }
</script>
...
<br /><br />
<span class="title" ><?php echo xlt('Bronchitis Form Rev 01 - Respiratory Disease'); ?></span>
<br /><br />
...
<table><tr>
   ...
   <select name="diagnosis1_bronchitis_form" >
       ...
       <option value="J12.1, Respiratory syncytial virus pneumonia"><?php
           echo xlt('J12.1, Respiratory syncytial virus pneumonia'); ?></option>
       <option value="J12.82, Pneumonia due to coronavirus disease 2019"><?php
           echo xlt('J12.82, Pneumonia due to coronavirus disease 2019'); ?></option>
       <option value="J12.89, Other viral pneumonia (influenza etc.)"><?php
           echo xlt('J12.89, Other viral pneumonia (influenza etc.)'); ?></option>
       <br /><br />
   </select>
   </td>
</tr>
