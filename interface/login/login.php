...
<script type="text/javascript">
    ...
    // We hide all buttons and attributes of the UI unless Google Sign on is enabled
    $('#google-signout').hide();
    ...
    $.getScript('https://apis.google.com/js/platform.js', function(data, textStatus, jqxh ) {
        // When the auth2 libary is loaded, log out so the user has to sign into google
