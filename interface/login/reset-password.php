...
try {
    ...
    // $success = $authUtilsUpdatePassword->updatePassword("", $_POST['authUser'], "", $_POST['clearPass']);

    $targetUser = $_POST['authUser'];
    $newPwd = $_POST['clearPass'];
    ...
    if (empty($newHash)) {
        ...
        echo("OpenEMR Error : OpenEMR is not working because unable to create a hash.");
        die();
    }
