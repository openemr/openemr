         ...
         <div id="wrap">
            ...
            ";
                    ...
                    { 
						...
						$on_click1 = "onClick=\"calculateTotal(this.parentNode.cells[1].firstChild.data, this.parentNode.cells[11].firstChild.nodeValue)\"";
						...
						else{$td_pay_method = "<td class = 'prominent' style = 'cursor:url(../favicon/favicon_bills.ico), cell;' $on_click1 >$styled_pay_method";}
						...
						if($count != 1  && $charge_date != $prev_charge_date)   {
							echo "
								<tr class = 'totals' style  = 'background-color: yellow;'>
									<td colspan ='10' style='text-align:right'>{$lang['total_for']} $prev_charge_date : </td>
				...
				if($grand_total_pay_amount  != 0){
					echo "
									<tr class = 'totals' style  = 'background-color: yellow;'>
										<td colspan ='10' style='text-align:right'>{$lang['total_for']} $charge_date : </td>
										<td style='text-align:right'> $grand_total_pay_amount </td>
