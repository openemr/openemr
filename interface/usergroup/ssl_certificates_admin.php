        ...
        <tr class='text'>
          ...
          <td>
            <input name='isClientAuthenticationEnabled' type='radio' value='Yes'
                <?php if ($GLOBALS['is_client_ssl_enabled']) echo "checked";
?> > <?php xl('Yes', 'e'); ?>
            <input name='isClientAuthenticationEnabled' type='radio' value='No'  <?php if (!$GLOBALS['is_client_ssl_enabled']) echo "checked";
?> > <?php xl('No', 'e'); ?>
          </td>
        </tr>
        <tr><td>&nbsp;</td></tr>
      ...
      <input type='hidden' name='clientCertValidity_hidden' value=''>
        ...
        <?php xl('Set', 'e');
?> 'is_client_ssl_enabled' <?php xl('to', 'e'); ?> 'true' </br></br>
        <?php xl('Provide absolute path of file', 'e'); ?> CertificateAuthority.key</br>
        <?php xl('Set', 'e');
?> 'certificate_authority_key' <?php xl('to absolute path of file', 'e'); ?> 'CertificateAuthority.key'</br></br>
        <?php xl('Provide absolute path of file', 'e'); ?> CertificateAuthority.crt</br>
            <?php xl('Set', 'e');
?> 'certificate_authority_crt' <?php xl('to absolute path of file', 'e'); ?> 'CertificateAuthority.crt'</br>
     <br>
    </br><?php xl('Note','e'); ?>:
    <ul>
      ...
      <li><?php xl('To Disable client side SSL certificates, comment above lines in Apache configuration file and set', 'e');
?> 'false' <?php xl('for variable', 'e');
?> 'is_client_ssl_enabled' (globals.php) <?php xl('and restart Apache server.', 'e'); ?>
    </form>
  </div>
  <br>
  <div class="borderbox">
