...
if (!empty($_POST['form_save'])) {
 ...
 //  (ie. patient vs company centric)
    $type_sql_row = sqlQuery("SELECT `option_value` FROM `list_options` WHERE `list_id` = 'abook_type' AND `option_id` = ? AND activity = 1", array(trim((string) $_POST['form_abook_type'])));
