...
?>
<span class="text">Once you change your password, you will have to re-login.<br></span>
<FORM NAME="user_form" METHOD="GET" ACTION="user_info.php">
<TABLE>
<TR>
<TD><span class=text>Real Name: </span></TD>
...
<TR>
<TD><span class=text>Password (Again): </span></TD>
...
&nbsp;&nbsp;&nbsp;
[<a href="../main/main_screen.php" target="_top" class=link_submit>Back</font></a>]
</FORM>
