...
<div class="container">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <form name='userlist' method='post' style="display: inline;" class="d-flex flex-wrap align-items-center gap-2" class="float-end" action='usergroup_admin.php' onsubmit='return top.restoreSession()'>
