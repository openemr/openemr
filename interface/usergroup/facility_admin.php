...
<tr>
	...
	<td width="145"><span class=text><? xl('Phone','e'); ?> <? xl('as','e'); ?> (000) 000-0000:</span></td><td width="210"><input type=entry name=phone size=20 value="<?=$facility['phone']?>"></td>
</tr>
<tr>
        <td>&nbsp;</td><td>&nbsp;</td>
...
<tr>
	 <td>&nbsp;</td><td>&nbsp;</td>
	<td width="21"><span class=text><? xl('Facility NPI','e'); ?>: </span></td><td><input type=entry size=20 name=facility_npi value="<?echo $facility{"facility_npi"}?>"></td>
