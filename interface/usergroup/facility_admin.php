...
<form name='facility-form' id="facility-form" method='post' action="facilities.php">
    ...
    <table border=0 cellpadding=0 cellspacing=1 style="width:630px;">
        <tr>
            ...
            <td width='220px'>
                <input type='entry' name='facility' size='20' value='<?php echo attr($facility['name']); ?>'></td>
            <td width='200px'>
                <span class='text'><?php echo xlt('Phone'); ?> <?php echo xlt('as'); ?> (000) 000-0000:</span></td>
            <td width='220px'>
                <input type='entry' name='phone' size='20' value='<?php echo attr($facility['phone']); ?>'></td>
        </tr>
        <tr>
            <td><span class=text><?php echo xlt('Address'); ?>: </span></td>
            <td><input type=entry size=20 name="street" value="<?php echo attr($facility["street"]); ?>"></td>
        ...
        <tr>
            ...
            <td><input type=entry size=20 name=postal_code value="<?php echo attr($facility["postal_code"]); ?>"></td>
        </tr>
        <?php
        $ssn = '';
        $ein = '';
        ...
        <tr>
            ...
            <td><input type=entry size=20 name=state value="<?php echo attr($facility["state"]); ?>"></td>
            <td><span class=text><?php echo xlt('Tax ID'); ?>: </span></td>
            <td><select name=tax_id_type>
                    <option value="EI" <?php echo $ein; ?>><?php echo xlt('EIN'); ?></option>
                    <option value="SY" <?php echo $ssn; ?>><?php echo xlt('SSN'); ?></option>
                </select><input type=entry size=11 name=federal_ein value="<?php echo attr($facility["federal_ein"]); ?>">
            </td>
        </tr>
        <tr>
            <td><span class=text><?php echo xlt('Country'); ?>: </span></td>
            <td><input type=entry size=20 name=country_code value="<?php echo attr($facility["country_code"]); ?>"></td>
            <td width="21"><span class=text><?php echo($GLOBALS['simplified_demographics'] ? xlt('Facility Code') : xlt('Facility NPI')); ?>:
          </span></td>
            <td><input type=entry size=20 name=facility_npi value="<?php echo attr($facility["facility_npi"]); ?>"></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td><span class=text><?php echo xlt('Facility Taxonomy'); ?>:</span></td>
            <td>
                <input type=entry size=20 name=facility_taxonomy value="<?php echo attr($facility["facility_taxonomy"]); ?>">
            </td>
        </tr>

        <tr>
            <td><span class=text><?php echo xlt('Website'); ?>: </span></td>
            <td><input type=entry size=20 name=website value="<?php echo attr($facility["website"]); ?>"></td>
            <td><span class=text><?php echo xlt('Email'); ?>: </span></td>
            <td><input type=entry size=20 name=email value="<?php echo attr($facility["email"]); ?>"></td>
        </tr>
        <tr>
            <td><span class=text><?php echo xlt('IBAN'); ?>: </span></td>
            <td><input type=entry size=20 name=iban value="<?php echo attr($facility["iban"]); ?>"></td>
            <td></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <input type='checkbox' name='service_location' value='1' <?php echo ($facility['service_location'] == 1) ? 'checked' : ''; ?>>
            </td>
            <td>&nbsp;</td>
        </tr>
        <?php
        ...
        <tr>
            <td><span class='text'><?php echo xlt('Color'); ?>: </span></td>
            <td><input type=entry name=ncolor id=ncolor size=20 value="<?php echo attr($facility["color"]); ?>"></td>
            <td>
        ...
        <tr>
            ...
            <td colspan="4"><input type="entry" name="attn" size="45" value="<?php echo attr($facility['attn']); ?>">
            </td>
        </tr>
        <tr>
            <td><span class="text"><?php echo xlt('CLIA Number'); ?>:</span></td>
            <td colspan="4">
                <input type="entry" name="domain_identifier" size="45" value="<?php echo attr($facility['domain_identifier']); ?>">
            </td>
        </tr>
        <tr>
            <td><span class="text"><?php echo xlt('Facility ID'); ?>:</span></td>
            <td colspan="4">
                <input type="entry" name="facility_id" size="45" value="<?php echo attr($facility['facility_code']); ?>">
            </td>
        </tr>
        <tr>
            <td>
