...
<tr>
	<td><span class=text><?php  xl('Name','e'); ?>: </span></td><td><input type=entry name=facility size=20 value="<?php echo $facility['name']?>"></td><td rowspan="10" width="15"></d>
	<td><span class=text><?php  xl('Phone','e'); ?> <?php  xl('as','e'); ?> (000) 000-0000:</span></td><td><input type=entry name=phone size=20 value="<?php echo $facility['phone']?>"></td>
</tr>
<tr>
        <td>&nbsp;</td><td>&nbsp;</td>
        <td><span class=text><?php  xl('Fax','e'); ?> <?php  xl('as','e'); ?> (000) 000-0000:</span></td><td><input type=entry name=f
ax size=20 value="<?php echo $facility['fax']?>"></td>
</tr>
<tr>
...
<tr>
	<td><span class=text><?php  xl('Billing Location','e'); ?>: </span></td><td><input type=checkbox name="billing_location" value="1" <?php if ($facility['billing_location'] == 1) echo "checked"?>"></td>
	<td><span class=text><?php  xl('Accepts Assignment','e'); ?><br>(<?php  xl('only if billing location','e'); ?>): </span></td><td><input type=checkbox name="accepts_assignment" value="1" <?php if ($facility['accepts_assignment'] == 1) echo "checked"?>"></td>
</tr>
<tr>
