...
<head>
    ...
    <script>
        $(function () {
            ...
            $('#advanced-tooltip').attr({"title": <?php echo xlj('Click to manually configure access control, recommended for advanced users'); ?>, "data-bs-toggle":"tooltip", "data-placement":"bottom"}).tooltip();
            $('#user-tooltip').attr({"title": <?php echo xlj('Click the pencil icon to grant and remove access privileges to the selected user'); ?>, "data-bs-toggle":"tooltip", "data-placement":"bottom"}).tooltip();
            $('#group-tooltip').attr({"title": groupTitle, "data-bs-toggle":"tooltip", "data-placement":"bottom"}).tooltip();
            $('#new-group-tooltip').attr({"title": <?php echo xlj('Enter values in this section to create a new group also known as Access Request Object (ARO)'); ?>, "data-bs-toggle":"tooltip", "data-placement":"bottom"}).tooltip();
            $('#remove-group-tooltip').attr({"title": <?php echo xlj('Use this section to delete existing groups or Access Request Objects (AROs)'); ?>, "data-bs-toggle":"tooltip", "data-placement":"bottom"}).tooltip();
