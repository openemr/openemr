...
if (!AclMain::aclCheckCore('admin', 'acl')) {
    echo (new TwigContainer(null, OEGlobalsBag::getInstance()->getKernel()))->getTwig()->render('core/unauthorized.html.twig', ['pageTitle' => xl("Access Control List Administration")]);
    exit;
}
?>
