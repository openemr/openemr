...
<tr>
<td><span class="text"<?php echo (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('disable_non_default_groups')) ? " style='display: none'" : ""; ?>><?php echo xlt('Groupname'); ?>: </span></td>
<td>
<select name="groupname" class="form-control"<?php echo (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('disable_non_default_groups')) ? " style='display:none'" : ""; ?>>
<?php
 ...
 <tr title="<?php echo xla('If nothing is selected here then all are permitted.'); ?>">
  ...
  <td colspan="3">
   <select name="schedule_facility[]" multiple style="width:490px;">
    ...
    $userFacilities = getUserFacilities($user_id, 'id', \OpenEMR\Core\OEGlobalsBag::getInstance()->get('gbl_fac_warehouse_restrictions'));
    $ufid = [];
...
<tr<?php echo (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('disable_non_default_groups')) ? " style='display:none'" : ""; ?>>
