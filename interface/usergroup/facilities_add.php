...
if (!AclMain::aclCheckCore('admin', 'users')) {
    echo TwigFactory::createInstance()->render('core/unauthorized.html.twig', ['pageTitle' => xl("Facility Add")]);
    exit;
}
...
echo TwigFactory::createInstance()->render("super/facilities/form.html.twig", $args);
