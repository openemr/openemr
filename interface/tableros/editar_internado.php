...
$paciente = sqlQuery("SELECT * FROM patient_data WHERE pid = ?", array($result['pid']));
...
<head>
    ...
    <script language="JavaScript">
        ...
        function cancelClickedNew() {
            top.RTop.location = "../../tableros/lista_internados.php";
            return false;
        }
...
<div id="container_div" class="<?php echo attr($oemr_ui->oeContainer()); ?>">
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="page-header clearfix">
                <h2>
                    Editar Internación del Paciente - <?php echo $paciente['fname'].' '.$paciente['lname'];?>
                </h2>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <form id="new-encounter-form" method='post' action="<?php echo $rootdir ?>/forms/newpatient/update.php" name='new_encounter'>
                <?php if ($viewmode) { ?>
                ...
                <fieldset>
                    ...
                    <div id = "visit-details">
                            ...
                            <div
                                ...
                                <div class="col-sm-3">
                                    <input type='text' class='form-control datepicker col-sm-12' name='form_onset_date' id='form_onset_date'
                                           value='<?php echo $viewmode && $result['onset_date']!='0000-00-00 00:00:00' ? attr(oeFormatShortDate(substr($result['onset_date'], 0, 10))) : attr(oeFormatShortDate(date('Y-m-d'))); ?>'
                        ...
                        <?php }?>
                        <div class="form-group other_data">
                        ...
                        <div class="form-group internacion">
                            <label class="control-label col-sm-2 oe-text-to-right" for="departamento">Departamento</label>
                            <div class="col-sm-8">
                                <select class="form-control col-sm-9" name="departamento" id="departamento">
                                    <option <?php
                                    if ($result['departamento'] ==='terapia_adulto') {
                                        echo "selected";
                                    }?> value="terapia_adulto">Terapia adulto</option>
                                    <option <?php
                                    if ($result['departamento'] ==='terapia_kids') {
                                        echo "selected";
                                    }?>  value="terapia_kids">Terapia niños</option>
                                </select>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <br>
                        <div class="form-group internacion">
                            <label class="control-label col-sm-2 oe-text-to-right" for="servicio">Servicio</label>
                            <div class="col-sm-8">
                                <select class="form-control  col-sm-9" name="servicio" id="servicio">
                                    <option <?php
                                            if ($result['servicio'] ==='intensivo') {
                                                echo "selected";
                                            }?> value="intensivo">Intensivo</option>
                                    <option <?php
                                    if ($result['servicio'] ==='intermedia') {
                                        echo "selected";
                                    }?> value="intermedia">Intermedia</option>
                                    <option  <?php
                                             if ($result['servicio'] ==='minima') {
                                                 echo "selected";
                                             }?> value="minima">Mínima</option>
                                </select>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <br>
                        <div class="form-group internacion">
                            <label class="control-label col-sm-2 oe-text-to-right" for="cuarto">Cuarto</label>
                            <div class="col-sm-8">
                        ...
                        <br>
                        <div class="form-group internacion">
                            <label class="control-label col-sm-2 oe-text-to-right" for="cama">Cama</label>
                            <div class="col-sm-8">
...
<script language="javascript">
    ...
    $(function (){
        ...
        $('#pc_catid').on('change', function () {
            const val_selected = $(this).children('option:selected').data('name');
            if(val_selected==='Internación'){
                $('.internacion').show();
                $('.other_data').hide();
            } else {
                $('.internacion').hide();
