 ...
 onsubmit='return validate(this);'>
    ...
    <div class="mb-3 mt-3">
        ...
        <input class="form-control w-100" type="text" size="50" name="form_drug_code" value='<?php echo attr($row['drug_code']) ?>'
             onclick='sel_related("?codetype=RXCUI&limit=1&target_element=form_drug_code")' title='<?php echo xla('Click to select RXCUI code'); ?>' data-bs-toggle="tooltip" data-bs-placement="top" readonly />
    </div>
...
<?php
            ...
            <tr>
                ...
                <td class="align-top">
                    <input class="form-control" size='5' name='form_reorder_point' maxlength='7' value='<?php echo attr($row['reorder_point']) ?>' title='<?php echo xla('Reorder point, 0 if not applicable'); ?>' data-bs-toggle="tooltip" data-bs-placement="top" />
                </td>
                <?php
                foreach ($pwarr as $pwrow) {
                    ...
                    "title='" . xla('Warehouse minimum, 0 if not applicable') . "' data-bs-toggle='tooltip' data-bs-placement='top' />";
                    echo "&nbsp;&nbsp;</td>\n";
                }
                ?>
            </tr>
            <tr>
                ...
                <td>
                    <input class='form-control' size='5' name='form_max_level' maxlength='7' value='<?php echo attr($row['max_level']) ?>' title='<?php echo xla('Maximum reasonable inventory, 0 if not applicable'); ?>' data-bs-toggle="tooltip" data-bs-placement="top" />
                </td>
                <?php
                foreach ($pwarr as $pwrow) {
                    echo "     <td class='align-top'>";
                    ...
                    "title='" . xla('Warehouse maximum, 0 if not applicable') . "' data-bs-toggle='tooltip' data-bs-placement='top' />";
                    echo "</td>\n";
                }
                ?>
            </tr>
    ...
    <div class="mb-3 mt-3 drugsonly">
        ...
        <input class="form-control w-100" type="text" size="50" name="form_related_code" value='<?php echo attr($row['related_code']) ?>'
             onclick='sel_related("?target_element=form_related_code")' title='<?php echo xla('Click to select related code'); ?>' data-bs-toggle="tooltip" data-bs-placement="top" readonly />
    </div>
