...
<table class='table-borderless w-100'>
 ...
 <tr>
  <td class="text-nowrap align-top fw-bold" width='1%'><?php echo xlt('Lot Number'); ?>:</td>
  <td>
 ...
 <tr>
  <td class="text-nowrap align-top fw-bold"><?php echo xlt('Manufacturer'); ?>:</td>
  <td>
 ...
 <tr>
  <td class="text-nowrap align-top fw-bold"><?php echo xlt('Quantity On Hand'); ?>:</td>
  <td>
 ...
 <tr>
  <td class="text-nowrap align-top fw-bold"><?php echo xlt('Expiration Date'); ?>:</td>
  <td>
 ...
 <tr>
  <td class="text-nowrap align-top fw-bold"><?php echo xlt('Date Destroyed'); ?>:</td>
  <td>
 ...
 <tr>
  <td class="text-nowrap align-top fw-bold"><?php echo xlt('Method of Destruction'); ?>:</td>
  <td>
 ...
 <tr>
  <td class="text-nowrap align-top fw-bold"><?php echo xlt('Witness'); ?>:</td>
  <td>
 ...
 <tr>
  <td class="text-nowrap align-top fw-bold"><?php echo xlt('Notes'); ?>:</td>
  <td>
