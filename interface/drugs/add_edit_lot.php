...
<table class="table table-borderless w-100">
 ...
 <tr id='row_sale_date'>
  <td class="fw-bold text-nowrap align-top"><?php echo xlt('Date'); ?>:</td>
  <td>
 ...
 <tr>
  <td class="fw-bold text-nowrap align-top"><?php echo xlt('Transaction Type'); ?>:</td>
  <td>
...
?>
 ...
 <tr id='row_lot_number'>
  <td class="fw-bold text-nowrap align-top"><?php echo xlt('Lot Number'); ?>:</td>
  <td>
 ...
 <tr id='row_manufacturer'>
  <td class="fw-bold text-nowrap align-top"><?php echo xlt('Manufacturer'); ?>:</td>
  <td>
 ...
 <tr id='row_expiration'>
  <td class="fw-bold text-nowrap align-top"><?php echo xlt('Expiration'); ?>:</td>
  <td>
 ...
 <tr id='row_source_lot'>
  <td class="fw-bold text-nowrap align-top"><?php echo xlt('Source Lot'); ?>:</td>
  <td>
...
?>
 ...
 <tr id='row_vendor'>
  <td class="fw-bold text-nowrap align-top"><?php echo xlt('Vendor'); ?>:</td>
  <td>
<?php
...
?>
 ...
 <tr id='row_warehouse'>
  <td class="fw-bold text-nowrap align-top" id="label_warehouse"><?php echo xlt('Warehouse'); ?>:</td>
  <td>
<?php
if (
    !genWarehouseList(
...
?>
 ...
 <tr id='row_on_hand'>
  <td class="fw-bold text-nowrap align-top"><?php echo xlt('On Hand'); ?>:</td>
  <td>
 ...
 <tr id='row_quantity'>
  <td class="fw-bold text-nowrap align-top"><?php echo xlt('Quantity'); ?>:</td>
  <td>
 ...
 <tr id='row_cost'>
  <td class="fw-bold text-nowrap align-top"><?php echo xlt('Total Cost'); ?>:</td>
  <td>
 ...
 <tr id='row_notes' title='<?php echo xla('Include your initials and details of reason for transaction.'); ?>'>
  <td class="fw-bold text-nowrap align-top"><?php echo xlt('Comments'); ?>:</td>
  <td>
