...
$tinylogocode1 = "<img class='img-responsive center-block' src='$web_root/sites/" . $_SESSION['site_id'] . "/images/logo_1.png'>";
$tinylogocode2 = "<img class='img-responsive center-block' src='$web_root/sites/" . $_SESSION['site_id'] . "/images/logo_2.png'>";
