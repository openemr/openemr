...
$GLOBALS['customModDir'] = "custom_modules"; // non laminas modules
$GLOBALS['laminasModDir'] = "laminas_modules"; // laminas modules
...
try {
    ...
    // TODO: why do we have 3 different directories we need to pass in for the laminas dir path. shouldn't laminasModDir already have all the paths set up?
    /** @var ModulesApplication */
    $GLOBALS['modules_application'] = new ModulesApplication(
        $GLOBALS["kernel"],
        $GLOBALS['fileroot'],
        $GLOBALS['baseModDir'],
        $GLOBALS['laminasModDir']
    );
} catch (\Exception $ex) {
