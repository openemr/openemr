...
function patient_data_view_model(pname, pid, pubpid, str_dob) {
    ...
    self.patient_picture = ko.computed(function () {
        return `${webroot_url}/controller.php?document&retrieve&patient_id=${encodeURIComponent(pid)}&document_id=-1&as_file=false&original_file=true&disable_exit=false&show_original=true&context=patient_picture`;
    }, self);
