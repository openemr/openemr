...
$menu_json='[
  ...
  {"label":"Patient/Client","menu_id":"patimg","children":[
    {"label":"List","menu_id":"fin0","target":"fin","url":"/interface/main/finder/dynamic_finder.php","children":[],"requirement":0},
    ...
    {"label":"Appointments","menu_id":"Popup:Appts","url":"/interface/reports/appointments_report.php?patient=","target":"pop","children":[],"requirement":1,"global_req":"!disable_calendar"},
    {"label":"Procedures","menu_id":"proimg","icon":"fa-caret-right","children":[
      {"label":"Pending Review","menu_id":"orp1","target":"proc","url":"/interface/orders/orders_results.php?review=1","children":[],"requirement":1},
      {"label":"Patient Results","menu_id":"orr1","target":"proc","url":"/interface/orders/orders_results.php","children":[],"requirement":1},
      {"label":"Lab Overview","menu_id":"lda1","target":"enc","url":"/interface/patient_file/summary/labdata.php","children":[],"requirement":1},
      {"label":"Batch Results","menu_id":"orb0","target":"proc","url":"/interface/orders/orders_results.php?batch=1","children":[],"requirement":0},
      {"label":"Electronic Reports","menu_id":"ore0","target":"proc","url":"/interface/orders/list_reports.php","children":[],"requirement":0},
      {"label":"Lab Documents","menu_id":"dld0","target":"proc","url":"/interface/main/display_documents.php","children":[],"requirement":0}],"requirement":0},
    {"label":"Modules","menu_id":"modimg","icon":"fa-caret-right","children":[
    ...
    {"label":"Reminders","menu_id":"adm0","target":"adm","url":"/interface/patient_file/reminder/patient_reminders.php?mode=admin&patient_id=","children":[],"requirement":0,"acl_req":["admin","super"],"global_req":"enable_cdr"},
    {"label":"Manage Records","icon":"fa-caret-right","children":[
      {"label":"Record Request","menu_id":"prq1","target":"enc","url":"/interface/patient_file/transaction/record_request.php","children":[],"requirement":1},
      {"label":"CCR Upload","menu_id":"ccr0","target":"pat","url":"/interface/patient_file/ccr_import.php","children":[],"requirement":0},
      {"label":"Approve Import","menu_id":"apr0","target":"pat","url":"/interface/patient_file/ccr_pending_approval.php","children":[],"requirement":0},
      {"label":"Merge Records","menu_id":"adm0","target":"adm","url":"/interface/patient_file/merge_patients.php","children":[],"requirement":0,"acl_req":["admin","super"]},
      ...
      {"label":"Address Label","menu_id":"Popup:Address Label","url":"/interface/patient_file/addr_label.php","target":"pop","children":[],"requirement":1,"global_req":"addr_label_type"}],"requirement":0}],"requirement":0},
    {"label":"Visits","children":[
     ...
     {"label":"New","menu_id":"nen1","target":"enc","url":"/interface/forms/newpatient/new.php?autoloaded=1&calenc=","children":[],"requirement":1},
     ...
     {"label":"History","menu_id":"ens1","target":"enc","url":"/interface/patient_file/history/encounters.php","children":[],"requirement":1}],"requirement":0},
  {"label":"Fees","menu_id":"feeimg","children":[
    ...
    {"label":"Batch Payments","menu_id":"npa0","target":"pat","url":"/interface/billing/new_payment.php","children":[],"requirement":0,"global_req":"enable_batch_payment"},
    {"label":"Posting","menu_id":"eob","target":"pat","url":"/interface/billing/sl_eob_search.php","children":[],"requirement":0,"global_req":"enable_posting","acl_req":["acct","eob"]},
  ...
  {"label":"Administration","menu_id":"admimg","children":[
    {"label":"Operations","icon":"fa-caret-right","children":[
      {"label":"Manage Backups","menu_id":"adm0","target":"adm","url":"/interface/main/backup.php","children":[],"requirement":0,"acl_req":["admin","super"]},
      ...
      {"label":"Maintain Users","menu_id":"adm0","target":"adm","url":"/interface/usergroup/usergroup_admin.php","children":[],"requirement":0,"acl_req":["admin","users"]}],"requirement":0},
    {"label":"Settings","icon":"fa-caret-right","children":[
      {"label":"Global Settings","menu_id":"adm0","target":"adm","url":"/interface/super/edit_globals.php","children":[],"requirement":0,"acl_req":["admin","super"]},
    ...
    {"label":"Enable Forms","menu_id":"adm0","target":"adm","url":"/interface/forms_admin/forms_admin.php","children":[],"requirement":0,"acl_req":["admin","forms"]},
    {"label":"Maintain Form Layouts","menu_id":"adm0","target":"adm","url":"/interface/super/edit_layout.php","children":[],"requirement":0,"acl_req":["admin","super"]},
    {"label":"Proc. & Diag. Codes","menu_id":"sup0","target":"adm","url":"/interface/patient_file/encounter/superbill_custom_full.php","children":[],"requirement":0,"acl_req":["admin","superbill"]},
    {"label":"Options Lists","menu_id":"adm0","target":"adm","url":"/interface/super/edit_list.php","children":[],"requirement":0,"acl_req":["admin","super"]},
    {"label":"User Access Control","menu_id":"adm0","target":"adm","url":"/interface/usergroup/adminacl.php","children":[],"requirement":0,"acl_req":["admin","acl"]},
    {"label":"Multi-Language Tool","menu_id":"adm0","target":"adm","url":"/interface/language/language.php","children":[],"requirement":0,"acl_req":["admin","language"]},
    {"label":"Config. Files","menu_id":"adm0","target":"adm","url":"/interface/super/manage_site_files.php","children":[],"requirement":0,"acl_req":["admin","super"]}],"requirement":0},
    {"label":"Procedures","menu_id":"proimg","icon":"fa-caret-right","children":[
      {"label":"Providers","menu_id":"orl0","target":"adm","url":"/interface/orders/procedure_provider_list.php","children":[],"requirement":0},
      {"label":"Configuration","menu_id":"ort0","target":"adm","url":"/interface/orders/types.php","children":[],"requirement":0},
      {"label":"Load Compendium","menu_id":"orc0","target":"adm","url":"/interface/orders/load_compendium.php","children":[],"requirement":0}],"requirement":0},
    {"label":"Inventory","menu_id":"invimg","icon":"fa-caret-right","children":[
      {"label":"Manage","menu_id":"adm0","target":"adm","url":"/interface/drugs/drug_inventory.php","children":[],"requirement":0,"acl_req":[["admin","super"],["admin","drugs"]]},
      {"label":"Destroy","menu_id":"adm0","target":"adm","url":"/interface/destroyed_drugs_report.php","children":[],"requirement":0}],"requirement":0,"acl_req":["admin","drugs"],"global_req":"inhouse_pharmacy"},
    ...
    {"label":"Rules Engine","icon":"fa-caret-right","children":[
      {"label":"Care Plan/Rules","menu_id":"adm0","target":"adm","url":"/interface/super/rules/index.php?action=browse!list","children":[],"requirement":0,"acl_req":["admin","super"],"global_req":"enable_cdr"},
      {"label":"Alerts Manager","menu_id":"adm0","target":"adm","url":"/interface/super/rules/index.php?action=alerts!listactmgr","children":[],"requirement":0,"acl_req":["admin","super"],"global_req":"enable_cdr"}],"global_req":"enable_cdr"},
    ...
    {"label":"System","icon":"fa-caret-right","children":[
      {"label":"Database Admin","menu_id":"adm0","target":"adm","url":"/phpmyadmin/index.php","children":[],"requirement":0,"acl_req":["admin","database"],"global_req":"!disable_phpmyadmin_link"},
      {"label":"SSL Certificates","menu_id":"adm0","target":"adm","url":"/interface/usergroup/ssl_certificates_admin.php","children":[],"requirement":0,"acl_req":["admin","users"]},
      ...
      {"label":"External Data Loads","menu_id":"adm0","target":"adm","url":"/interface/code_systems/dataloads_ajax.php","children":[],"requirement":0,"acl_req":["admin","super"]}],"requirement":0},
