...
<script type="text/javascript" src="<?php echo $GLOBALS['assets_static_relative']; ?>/knockout-3-4-0/dist/knockout.js?v=<?php echo $v_js_includes; ?>"></script>
<script type="text/JavaScript" src="<?php echo $GLOBALS['assets_static_relative']; ?>/jquery-min-2-2-0/index.js?v=<?php echo $v_js_includes; ?>"></script>
