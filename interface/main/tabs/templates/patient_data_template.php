...
$search_any_type = \OpenEMR\Core\OEGlobalsBag::getInstance()->get('search_any_patient');
    ...
    <div class="d-lg-inline-flex w-100">
        <div class="flex-fill">
            <div class="float-left mx-2">
                ...
                <div data-bind="with: patient" class="patientPicture">
                    <img data-bind="attr: {src: patient_picture}"
                        ...
                        width="75"
                        height="75"
                        onError="this.src = '<?php echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('images_static_relative'); ?>/patient-picture-default.png'" />
                </div>
                <!-- /ko -->
            </div>
            <div class="form-group">
                ...
                $classes = "";
                $closeAnchorClasses = '';
                switch (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('patient_name_display')) :
                    case 'btn':
