...
<script type="text/html" id="menu-header">
    ...
    <div class="menuSection dropdown">
        <div class='menuLabel px-1 dropdown-toggle oe-dropdown-toggle' data-bind="text:label" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></div>
