...
<td align="right">
	<table cellspacing="0" cellpadding="1" style="margin:0px 3px 0px 0px;"><tr>
		...
		<td id='tinylogocontainer' class='tinylogocontainer'><span><?php if ($GLOBALS['tiny_logos_1'])  {echo $tinylogocode1;} if ($GLOBALS['tiny_logos_2']) {echo $tinylogocode1;} ?></span></td>
