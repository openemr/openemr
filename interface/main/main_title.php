    ...
    <table cellspacing="0" cellpadding="1" style="margin:0px 3px 0px 0px;">
        <tr>
            <td align="right" class="text" style="vertical-align:text-bottom;">
                ...
                <a href="http://<?php echo attr($url); ?>" rel="noopener" target="_blank" id="help_link" title = "<?php echo xla('Manual'); ?>"><i class='fa fa-question fa-2x top-nav-icons' aria-hidden='true'></i></a>
