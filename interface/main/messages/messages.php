...
<?php
if ((\OpenEMR\Core\OEGlobalsBag::getInstance()->get('medex_enable') == '1') && (empty($_REQUEST['nomenu'])) && (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('disable_rcb') != '1')) {
...
if (!empty($_REQUEST['go'])) { ?>
    ...
    if (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('disable_rcb') != '1') {
...
<body class='body_top'>
        ...
        <div class="row my-3">
            <div class="col-sm-12">
                <ul class="nav nav-pills bg-light" id="main-nav-pills" role="tablist">
                    ...
                    <?php if (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('disable_rcb') != '1') { ?>
            ...
            <div class="row tab-pane active" role="tabpanel" id="messages-div">
                <div class="col-sm-12">
                    ...
                    if ($task == "addnew" or $task == "edit") {
                                    ...
                                    if ($noteid) {
                                        ...
                                        if (sqlNumRows($tmp)) {
                                            ...
                                            while ($gprow = sqlFetchArray($tmp)) {
                                                echo "   <a href='";
                                                echo \OpenEMR\Core\OEGlobalsBag::getInstance()->get('webroot') . "/interface/orders/single_order_results.php?orderid=";
                                            ...
                                            <table class='table table-sm table-hover w-100'>
                                                ...
                                                <thead class='table-primary'>
                                                    <tr height='24'>
                                                        ...
                                                        <th width='15%' class='font-weight-bold'>&nbsp;" . xlt(\OpenEMR\Core\OEGlobalsBag::getInstance()->get('messages_due_date') ? 'Due date' : 'Date') . " $sortlink[3]</th>
                        ...
                        if (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('phimail_enable')) {
    ...
    <script>
        ...
        $(function () {
            var webRoot = <?php echo js_escape(\OpenEMR\Core\OEGlobalsBag::getInstance()->get('web_root')); ?>;
            ...
            <?php if (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('phimail_enable')) : ?>
