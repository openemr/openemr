    ...
    $patientname = xl('Click to select');
                                  ...
                                  <tr>
                                    <td class='text form-group'>
                                     ...
                                     <input type='textbox' name='assigned_to_text' class='form-control' id='assigned_to_text' size='40' readonly='readonly'
                                  ...
                                  <tr>
                                    <td>
                                        ...
                                        ?>
                                        <textarea name='note' id='note'  class='form-control' style='margin:6px; background-color:white; color: gray; border:1px solid #999; padding: 5px; height:100px; width: 640px;'><?php echo nl2br(text($note)); ?></textarea>
                                    </td>
                                  </tr>
                                </table>
                            ...
                            <input type="button" class="form-control" id="newnote" value="<?php echo xla('Send message'); ?>">
                            <input type="button" class="form-control" id="printnote" value="<?php echo xla('Print message'); ?>">
