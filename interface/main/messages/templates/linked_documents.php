...
<div class="row mt-2 mb-2 messages-document-row <?php echo $record['requiresValidation'] ? "messages-document-validate" : ""; ?>"
    ...
    <span class='fw-bold'><?php echo xlt('Linked document'); ?>:</span>
        ...
        <span class="validation-totals validation-totals-success badge bg-pill bg-success p-2 d-none">
            <?php echo xlt("Errors"); ?> <span class="validation-totals-count">0</span>
        </span>
            <span class="validation-totals validation-totals-failed badge bg-pill bg-danger p-2 d-none">
            <?php echo xlt("Errors"); ?> <span class="validation-totals-count">0</span>
        </span>
        <?php endif; ?>
        <?php if ($record['isCda']) : ?>
