...
try {
    ...
    <span class='fw-bold'><?php echo xlt('Linked document'); ?>:</span>
        ...
        <span class="validation-totals validation-totals-success badge rounded-pill bg-success p-2 d-none">
                <?php echo xlt("Errors"); ?> <span class="validation-totals-count">0</span>
        </span>
        <span class="validation-totals validation-totals-failed badge rounded-pill bg-danger p-2 d-none">
                <?php echo xlt("Errors"); ?> <span class="validation-totals-count">0</span>
        </span>
        <?php } ?>
            <?php if ($record['isCda']) { ?>
