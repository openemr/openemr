...
// --- initialize $output as blank
    $output = '';
    $output = '<div><fieldset id="error_info" class="bg-danger text-white fw-bod" style="border: 1px solid var(--danger) !important; font-family: sans-serif; border-radius: 5px; padding: 20px 5px !important;">';// needs in-line styling because stylesheets not yet initialized
