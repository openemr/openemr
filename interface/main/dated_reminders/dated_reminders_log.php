...
<body>
    ...
    <!-- Required for the popup date selectors -->
        ...
        <div class="row">
            <div class="col-12">
                <h2><?php echo xlt('Dated Message Log');?> &nbsp;<i id="show_hide" class="fa fa-eye-slash fa-2x small" data-bs-toggle="tooltip" data-placement="top" title="<?php echo xla('Click to Hide Filters'); ?>"></i></h2>
            </div>
