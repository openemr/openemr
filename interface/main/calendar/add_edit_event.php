...
// =======================================
                        ...
                        <tr id="days_every_week_row">
                            ...
                            <td></td>
                            <td>
                                <input type='checkbox' id='days_every_week' name='days_every_week' onclick='set_days_every_week()' <?php echo (isDaysEveryWeek($repeats)) ? " checked" : ""; ?>/>
                            </td>
                        ...
                        <tr id='dob_row' style='display:<?php echo $dobstyle ?>'>
                            <td colspan='4' nowrap>
                                <b><font color='red'><?php echo xlt('DOB is missing, please enter if possible'); ?>
                                        :</font></b>
                            </td>
                            <td nowrap>
