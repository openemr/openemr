...
array('function', 'assign', 'default/views/day/ajax_template.html', 346, false),
array('function', 'pc_sort_events', 'default/views/day/ajax_template.html', 351, false),
array('modifier', 'date_format', 'default/views/day/ajax_template.html', 346, false),
array('modifier', 'string_format', 'default/views/day/ajax_template.html', 347, false),)); ?>
...
foreach ($providers as $provider) {
    ...
    echo "<td class='schedule' title='".htmlspecialchars($provider["fname"],ENT_QUOTES)." ".htmlspecialchars($provider["lname"],ENT_QUOTES)."'>";
