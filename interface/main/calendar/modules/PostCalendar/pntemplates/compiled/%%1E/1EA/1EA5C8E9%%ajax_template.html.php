...
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'default/views/day/ajax_template.html', 10, false),array('function', 'pc_sort_events', 'default/views/day/ajax_template.html', 368, false),array('modifier', 'date_format', 'default/views/day/ajax_template.html', 363, false),array('modifier', 'string_format', 'default/views/day/ajax_template.html', 364, false),)), $this); ?>
    ...
    foreach ($A_EVENTS as $date => $events) {
        ...
        foreach ($times as $slottime) {
            ...
            foreach ($events as $e1) {
                ...
                if ($providerid != $e1['aid']  && $event['aid']!=0) { continue; }
