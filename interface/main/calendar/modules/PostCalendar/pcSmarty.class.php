...
class pcSmarty extends Smarty_Legacy
{
    function __construct()
    {
        ...
        $this->compile_dir      =   \OpenEMR\Core\OEGlobalsBag::getInstance()->get('OE_SITE_DIR') . '/documents/smarty/main';
        $this->caching      =   0;
        $this->left_delimiter   =   '[-';
        ...
        $this->assign('TPL_IMAGE_PATH', \OpenEMR\Core\OEGlobalsBag::getInstance()->get('rootdir') . "/main/calendar/modules/$pcDir/pntemplates/$template_name/images");
        $this->assign('TPL_ROOTDIR', \OpenEMR\Core\OEGlobalsBag::getInstance()->get('rootdir'));
