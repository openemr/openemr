...
function pnLocalReferer()
{
    ...
    if (empty($referer) || preg_match("!^https://$server/!", $referer)) {
        return true;
    } else {
        return false;
    }
