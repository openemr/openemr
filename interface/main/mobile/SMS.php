...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
            <img src="<?php echo $GLOBALS['images_static_relative']; ?>/SMSBot.png" id="head_img" alt="OpenEMR <?php echo xla('SMS Bot'); ?>">
        </div>
...
'                    </div>');
        ...
        $.ajax({
                   type: "POST",
                   url: "m_save.php?go=sms_search&term=" + encodeURIComponent(pid)
               }).done(function(result) {
                console.log(result);
                results = JSON.parse(result);
                if (!results.mobile) {
                    results.mobile = results.home_phone + "  - " + <?php echo xlj('Home'); ?>;
                } else {
                    results.mobile = results.mobile + " - " + <?php echo xlj('Mobile'); ?>;
                }
