...
$(document).ready(function(){
  if(1 == <?php echo $GLOBALS['menu_styling_vertical'] ?>){
    ...
    $("#navigation-slide > li  > a#rcb0").prepend('<i class="fa fa-fw fa-calendar-minus-o"></i>&nbsp;');
    ...
    $("#navigation-slide > li  > a#aop0").prepend('<i class="fa fa-fw fa-tachometer"></i>&nbsp;');
...
?>
  ...
  <li class="open"><a class="collapsed" id="patimg" ><i class="fa fa-fw fa-user"></i>&nbsp;<span><?php xl('Patient/Client', 'e') ?></span></a>
    <ul>
