 ...
 */
 ...
 $primary_docs = array(
  ...
  'aop' => array(xl('Onsite Dashboard')  , 0, '../patients/patient/provider'),
...
<?php } ?>
  ...
  <?php if($GLOBALS['portal_onsite_enable'] && acl_check('patientportal','portal'))  genTreeLink('RTop','aop',xl('Onsite Dashboard')); ?>
  <?php
