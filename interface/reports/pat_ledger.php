...
function PrintEncHeader($dt, $rsn, $dr): void
{
    ...
    echo "<td colspan='4'><span class='fw-bold'>" . xlt('Encounter Dt / Rsn') . ": </span><span class='detail'>" . text(substr((string) $dt, 0, 10)) . " / " . text($rsn) . "</span></td>";
                            ...
                            <table class="table table-borderless">
                                <tr>
                                    ...
                                    <td class="align-middle h-100 text-start">
                                        <table class="w-100 h-100 border-start" >
                                                <tr>
                                                    <td>
...
if ($_REQUEST['form_refresh'] || $_REQUEST['form_csvexport']) {
    ...
    if ($_REQUEST['form_csvexport']) {
      // CSV headers:
        ...
        <div id="report_results" class="bg-body-tertiary rounded-3 py-4">
            <table>
                <tr>
