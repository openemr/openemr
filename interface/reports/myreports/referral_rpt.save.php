...
function ReferralPop(pid, id, enc, form)
{
	...
	wmtOpen('<?php echo $GLOBALS['webroot']; ?>/interface/forms/'+form+'/print_referral.php?mode=update&pid='+pid+'&id='+id+'&enc='+enc, '_blank', 900, 900);
}
...
<tr>
	...
	<td><a href='javascript:;' class='css_button' onclick='PrintSelected();'><span><?php xl('Print Forms','e'); ?></span></a></td>
</tr>
