...
<div class="form-group col-xs-6">
	<fieldset>
		...
		<div class="form-group col-xs-6 oe-nopad-left">
			...
			?>
				<div class="form-group col-xs-6" id="table_<?php echo attr($ThisPageSearchCriteriaKey[$ThisPageSearchCriteriaIndex]) ?>" style="display:none">
					<div class= "col-xs-12">
						...
						<?php echo generate_select_list("date_master_criteria_$DateNamePart",
				...
				<div class="form-group col-xs-6" id="table_<?php echo attr($ThisPageSearchCriteriaKey[$ThisPageSearchCriteriaIndex]) ?>" style="display:none">
					<div class= "col-xs-12">
						...
						<div <?php //Don't Use class =  'form-control'?>>
							<?php $FunctionName=$ThisPageSearchCriteriaIncludeMaster[$ThisPageSearchCriteriaInclude[$ThisPageSearchCriteriaIndex]];$FunctionName();?>
						</div>
					</div>
				</div>
			<?php 
