...
<span class='title'><?php echo xlt('Patient Flow Board');
?> - <?php echo xlt('Drug Screen Report'); ?></span>
<?php } else { ?>
...
?>>&nbsp;<?php echo xlt('Show Details'); ?></label></td>
            ...
            <td colspan="2"><label><input type="checkbox" name="show_drug_screens" id="show_drug_screens" <?php if($chk_show_drug_screens) echo "checked";
?>>&nbsp;<?php echo xlt('Show Selected for Drug Screens'); ?></label></td>
            <td colspan="2"><label><input type="checkbox" name="show_completed_drug_screens" id="show_completed_drug_screens" <?php if($chk_show_completed_drug_screens) echo "checked";
?>>&nbsp;<?php echo xlt('Show Status of Drug Screens'); ?></label></td>
            </tr>
            <?php } ?>
...
if($timecheck > $alert_time && ($alert_time != '0')) {
 ...
 <td class="detail" bgcolor='<?php echo attr($alert_color) ?>'><b>&nbsp;<?php echo text($tracker_time); ?></b></td>
    ...
    <tr>
        ...
        <td colspan="10" align="left"><?php echo xlt('Total number of Patient Flow Board entries');
?>&nbsp;<?php echo text($j);
?>&nbsp;<?php echo xlt('Patients'); ?></td>
        <?php } else { ?>
        <td colspan="10" align="left"><?php echo xlt('Total number of Drug Screen entries');
?>&nbsp;<?php echo text($j);
?>&nbsp;<?php echo xlt('Patients'); ?></td>
        <?php } ?>
    </tr>
