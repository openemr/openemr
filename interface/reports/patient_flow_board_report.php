...
<?php if (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('drug_screen')) { #setting the title of the page based o if drug screening is enabled ?>
...
<table>
    <tr>
        ...
        <table class='text'>
            ...
            <?php if (\OpenEMR\Core\OEGlobalsBag::getInstance()->get('drug_screen')) { ?>
            <tr>
