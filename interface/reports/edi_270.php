...
<html>
	...
	<body class="body_top">
		...
		<p class='title title-custom'><b><?php echo htmlspecialchars( xl('Report'), ENT_NOQUOTES); ?> - <?php echo htmlspecialchars( xl('Eligibility 270 Inquiry Batch'), ENT_NOQUOTES); ?></b></p>
