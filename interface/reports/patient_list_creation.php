        ...
        <script>
            ...
            $(function () {
                ...
                $('.datetimepicker').datetimepicker({
                    ...
                    include \OpenEMR\Core\OEGlobalsBag::getInstance()->get('srcdir') . '/js/xl/jquery-datetimepicker-2-5-4.js.php';
...
if (!empty($_POST['form_refresh'])) {
    ...
    for ($i = 0; $i < count($sort); $i++) {
        $sortlink[$i] = "<a href=\"#\" onclick=\"sortingCols(" . attr_js($sort[$i]) . ",'asc');\" ><img src='" .  \OpenEMR\Core\OEGlobalsBag::getInstance()->get('images_static_relative') . "/sortdown.gif' border='0' alt=\"" . xla('Sort Up') . "\"></a>";
    }
    ...
    for ($i = 0; $i < count($sort); $i++) {
        if ($sortby == $sort[$i]) {
            switch ($sortorder) {
                case "asc":
                    $sortlink[$i] = "<a href=\"#\" onclick=\"sortingCols(" . attr_js($sortby) . ",'desc');\" ><img src='" .  \OpenEMR\Core\OEGlobalsBag::getInstance()->get('images_static_relative') . "/sortup.gif' border='0' alt=\"" . xla('Sort Up') . "\"></a>";
                    break;
                case "desc":
                    $sortlink[$i] = "<a href=\"#\" onclick=\"sortingCols('" . attr_js($sortby) . "','asc');\" onclick=\"top.restoreSession()\"><img src='" . \OpenEMR\Core\OEGlobalsBag::getInstance()->get('images_static_relative') . "/sortdown.gif' border='0' alt=\"" . xla('Sort Down') . "\"></a>";
                    break;
            }
            break;
        }
