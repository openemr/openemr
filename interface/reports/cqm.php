    ...
    <table class='text'>
        ...
        <?php if (($type_report == "amc") || ($type_report == "amc_2011") || ($type_report == "amc_2014_stage1") || ($type_report == "amc_2014_stage2")) { ?>
                   <tr>
                      ...
                      <td>
                         <input <?php echo $dis_text;
?> type='text' name='form_begin_date' id="form_begin_date" size='20' value='<?php echo htmlspecialchars( $begin_date, ENT_QUOTES); ?>'
                            class='datepicker'
        ...
        <?php } ?>
                ...
                <tr>
                        ...
                        <td>
                           <input <?php echo $dis_text;
?> type='text' name='form_target_date' id="form_target_date" size='20' value='<?php echo htmlspecialchars( $target_date, ENT_QUOTES); ?>'
                                class='datepicker'
                                title='<?php echo htmlspecialchars( xl('yyyy-mm-dd hh:mm:ss'), ENT_QUOTES); ?>'>
                            <?php if (empty($report_id)) { ?>
                            <?php } ?>
            ...
            <td>
                ...
                <?php if (($type_report == "amc") || ($type_report == "amc_2011") || ($type_report == "amc_2014_stage1") || ($type_report == "amc_2014_stage2")) { ?>
                  <tr>
                        ...
                        <td>
                               <input <?php echo $dis_text;
?> type="text" id="labs_manual_entry" name="labs_manual_entry" value="<?php echo htmlspecialchars($labs_manual,ENT_QUOTES); ?>">
                        </td>
                  </tr>
                <?php } ?>
