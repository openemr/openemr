...
This package contains distribution files required to style [ColReorder extension](https://datatables.net/extensions/colreorder) for [DataTables](https://datatables.net/) .
