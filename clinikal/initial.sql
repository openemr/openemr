...
INSERT INTO `layout_options` (`form_id`,`field_id`,`group_name`,`title`,`seq`,`data_type`,`uor`,`fld_length`,`max_length`,`list_id`,`titlecols`,`datacols`,`default_value`,`edit_options`,`description`,`fld_rows`,`list_backup_id`,`source`,`conditions`) VALUES ('DEM','passportCountry','1Who','Country of Issue',8,1,1,0,0,'country',1,1,'','','Country of Issue (passpor) when passport is selected',0,'','F','a:1:{i:0;a:5:{s:2:\"id\";s:7:\"type_id\";s:6:\"itemid\";N;s:8:\"operator\";s:2:\"ne\";s:5:\"value\";s:8:\"Passport\";s:5:\"andor\";s:0:\"\";}}');
INSERT INTO `layout_options` (`form_id`,`field_id`,`group_name`,`title`,`seq`,`data_type`,`uor`,`fld_length`,`max_length`,`list_id`,`titlecols`,`datacols`,`default_value`,`edit_options`,`description`,`fld_rows`,`list_backup_id`,`source`,`conditions`) VALUES ('DEM','passportYear','1Who','Year Issued',9,2,1,4,4,'',1,1,'','','Passport year Issued (YYYY)',0,'','F','a:1:{i:0;a:5:{s:2:\"id\";s:7:\"type_id\";s:6:\"itemid\";N;s:8:\"operator\";s:2:\"ne\";s:5:\"value\";s:8:\"Passport\";s:5:\"andor\";s:0:\"\";}}');
INSERT INTO `layout_options` (`form_id`,`field_id`,`group_name`,`title`,`seq`,`data_type`,`uor`,`fld_length`,`max_length`,`list_id`,`titlecols`,`datacols`,`default_value`,`edit_options`,`description`,`fld_rows`,`list_backup_id`,`source`,`conditions`) VALUES ('DEM','sex','1Who','Sex',10,1,2,0,0,'sex',1,1,'','N','Sex',0,'','F','');
INSERT INTO `layout_options` (`form_id`,`field_id`,`group_name`,`title`,`seq`,`data_type`,`uor`,`fld_length`,`max_length`,`list_id`,`titlecols`,`datacols`,`default_value`,`edit_options`,`description`,`fld_rows`,`list_backup_id`,`source`,`conditions`) VALUES ('DEM','status','1Who','Marital Status',11,1,1,0,0,'marital',1,1,'','','Marital Status',0,'','F','');
INSERT INTO `layout_options` (`form_id`,`field_id`,`group_name`,`title`,`seq`,`data_type`,`uor`,`fld_length`,`max_length`,`list_id`,`titlecols`,`datacols`,`default_value`,`edit_options`,`description`,`fld_rows`,`list_backup_id`,`source`,`conditions`) VALUES ('DEM','drivers_license','1Who','License/ID',12,1,1,0,0,'YNDN',1,1,'','','Drivers License',0,'','F','');
...
INSERT INTO `layout_options` (`form_id`,`field_id`,`group_name`,`title`,`seq`,`data_type`,`uor`,`fld_length`,`max_length`,`list_id`,`titlecols`,`datacols`,`default_value`,`edit_options`,`description`,`fld_rows`,`list_backup_id`,`source`,`conditions`) VALUES ('DEM','mothersname','1Who','Mother\'s Name',21,2,1,15,0,'',1,1,'','','Mother\'s Name',0,'','F','');
