 ...
 *  </code>
 */
class Google_Service_Recommender_Resource_OrganizationsLocationsInsightTypesInsights extends Google_Service_Resource
{
  /**
   ...
   */
  public function listOrganizationsLocationsInsightTypesInsights($parent, $optParams = array())
  {
