...
<!--
If you used AI tooling to create (fully or partially) your changes, use a commit trailier to indicate what tool was used.

`git commit --trailer "Assisted-by: Claude Code"` or similar.

If the AI made the commit(s), this was probably done automatically.
-->
