...
RUN apk add --no-cache \
    ...
    php7-mysqli php7-sockets php7-phar php7-openssl perl mysql-client tar curl imagemagick-dev nodejs \
...
COPY run_openemr.sh auto_configure.php /var/www/localhost/htdocs/
