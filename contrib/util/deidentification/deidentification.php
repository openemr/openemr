...
/**
 * De-identification script for OpenEMR database.
 *
 * This script de-identifies an OpenEMR database for the purpose of creating a live demo or for
 * development using real data while keeping patient identities secret. The script does the following:
 *  - Removes patient information from the patient_data table and replaces demographics with randomly generated names
 *  - Replaces data stored in the insurance_data table with the randomly generated name
 *  - Specifies insurance subscriber as self and populates subscriber info with auto-generated data
 *  - Clears provider and staff information in the user table, replacing with auto-generated unique names and IDNs
 *  - Truncates the log tables since personal information may be stored there
 *  - Removes data in forms - END USER MUST EDIT deIdForms function to ensure all form data is removed
 *
 * WARNING: There is no turning back. Your database will be permanently de-identified and can never be restored.
 *
 * NOTE: IT IS STILL THE RESPONSIBILITY OF THE USER TO ENSURE THAT ALL PERSONAL IDENTIFIABLE INFORMATION
 * HAS BEEN DELETED FROM THE DATABASE. THE END USER MUST MAKE SURE THAT ALL TEXT AREAS IN FORMS DO NOT
 * INCLUDE THE PATIENT'S REAL NAME.
 *
 * To use:
 *  1) Enter values for host, user, database, password
 *  2) Run: php deidentification.php
 *
 * @package   OpenEMR
 ...
 * @copyright Copyright (c) 2017 OEMR
