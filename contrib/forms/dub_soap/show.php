...
<tr><td valign='top'>&nbsp;</td><!-- called consumeRows 012--> <td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Previous Sonogram','e').':'; ?></td><td class='text data' colspan='1'><?php echo generate_display_field($manual_layouts['previous_sonogram'], $xyzzy['previous_sonogram']); ?></td></tr>
<tr><td valign='top'>&nbsp;</td><!-- called consumeRows 012--> <td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Previous Blood Work','e').':'; ?></td><td class='text data' colspan='1'><?php echo generate_display_field($manual_layouts['previous_blood_work'], $xyzzy['previous_blood_work']); ?></td></tr>
<tr><td valign='top'>&nbsp;</td><!-- called consumeRows 012--> <td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Previous Needs for Rx','e').':'; ?></td><td class='text data' colspan='1'><?php echo generate_display_field($manual_layouts['previous_needs_rx'], $xyzzy['previous_needs_rx']); ?></td></tr>
<tr><td valign='top'>&nbsp;</td><!-- called consumeRows 012--> <td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Other','e').':'; ?></td><td class='text data' colspan='1'><?php echo generate_display_field($manual_layouts['other'], $xyzzy['other']); ?></td><!-- called consumeRows 212--> <!-- Exiting not($fields)0--></tr>
