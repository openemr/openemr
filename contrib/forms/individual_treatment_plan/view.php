...
<input type="checkbox" name="individual_family_therapy" <?php if ($obj{"individual_family_therapy"} == "on") {echo "checked";
};?>>&nbsp;<b>Individual and / or Family Therapy</b></input>
<img src="../../../images/space.gif" width="6" height="1">
<input type="checkbox" name="substance_abuse" <?php if ($obj{"substance_abuse"} == "on") {echo "checked";
};?>>&nbsp;<b>Substance Abuse</b></input><br>

<input type="checkbox" name="group_therapy" <?php if ($obj{"group_therapy"} == "on") {echo "checked";
};?>>&nbsp;<b>Group Therapy - psychoeducational group</b></input>
<img src="../../../images/space.gif" width="6" height="1">
<input type="checkbox" name="parenting" <?php if ($obj{"parenting"} == "on") {echo "checked";
