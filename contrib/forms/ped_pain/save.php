...
if ($_GET["mode"] == "new") {
    ...
    sqlInsert("update form_ped_pain set pid = ?,
	groupname= ?,
	user= ?,
	authorized = ?,
	activity = 1, 
	...
	notes = ?,
	WHERE id= ?", array($_SESSION["pid"], $_SESSION["authProvider"], $_SESSION["authUser"], $userauthorized, $_POST["location"], $_POST["duration"],
	$_POST["severity"], $_POST["fever"], $_POST["lethargy"], $_POST["vomiting"], $_POST["oral_hydration_capable"], $_POST["urine_output_last_6_hours"], 
