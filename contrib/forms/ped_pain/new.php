...
<br>
<form method='post' action="<?echo $rootdir;?>/forms/ped_pain/save.php?mode=new" name='ped_pain' target='Main' >
...
<a href="javascript:document.ped_pain.submit();" class="link_submit">[Save]</a>
<br>
