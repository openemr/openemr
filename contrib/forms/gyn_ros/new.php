...
<!-- called consumeRows 015--> <!-- just calling --><!-- called consumeRows 225--> <!-- generating not($fields[$checked+1]) and calling last --><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Reviewed','e').':'; ?></td><td class='text data' colspan='1'><?php echo generate_form_field($manual_layouts['cardio_reviewed'], ''); ?></td><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Note','e').':'; ?></td><td class='text data' colspan='1'><?php echo generate_form_field($manual_layouts['cardio_note'], ''); ?></td><!-- called consumeRows 425--> <!-- Exiting not($fields) and generating 1 empty fields --><td class='emptycell' colspan='1'></td></tr>
</table></div>
...
<!-- called consumeRows 015--> <!-- just calling --><!-- called consumeRows 225--> <!-- generating not($fields[$checked+1]) and calling last --><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Reviewed','e').':'; ?></td><td class='text data' colspan='1'><?php echo generate_form_field($manual_layouts['gastro_reviewed'], ''); ?></td><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Note','e').':'; ?></td><td class='text data' colspan='1'><?php echo generate_form_field($manual_layouts['gastro_note'], ''); ?></td><!-- called consumeRows 425--> <!-- Exiting not($fields) and generating 1 empty fields --><td class='emptycell' colspan='1'></td></tr>
</table></div>
...
<!-- called consumeRows 015--> <!-- just calling --><!-- called consumeRows 225--> <!-- generating not($fields[$checked+1]) and calling last --><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Reviewed','e').':'; ?></td><td class='text data' colspan='1'><?php echo generate_form_field($manual_layouts['cns_reviewed'], ''); ?></td><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Note','e').':'; ?></td><td class='text data' colspan='1'><?php echo generate_form_field($manual_layouts['cns_note'], ''); ?></td><!-- called consumeRows 425--> <!-- Exiting not($fields) and generating 1 empty fields --><td class='emptycell' colspan='1'></td></tr>
</table></div>
...
<!-- called consumeRows 015--> <!-- just calling --><!-- called consumeRows 225--> <!-- generating not($fields[$checked+1]) and calling last --><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Reviewed','e').':'; ?></td><td class='text data' colspan='1'><?php echo generate_form_field($manual_layouts['other_reviewed'], ''); ?></td><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Note','e').':'; ?></td><td class='text data' colspan='1'><?php echo generate_form_field($manual_layouts['other_note'], ''); ?></td><!-- called consumeRows 425--> <!-- Exiting not($fields) and generating 1 empty fields --><td class='emptycell' colspan='1'></td></tr>
</table></div>
...
<!-- called consumeRows 015--> <!-- just calling --><!-- called consumeRows 225--> <!-- generating not($fields[$checked+1]) and calling last --><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Reviewed','e').':'; ?></td><td class='text data' colspan='1'><?php echo generate_form_field($manual_layouts['complications_reviewed'], ''); ?></td><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Note','e').':'; ?></td><td class='text data' colspan='1'><?php echo generate_form_field($manual_layouts['complications_note'], ''); ?></td><!-- called consumeRows 425--> <!-- Exiting not($fields) and generating 1 empty fields --><td class='emptycell' colspan='1'></td></tr>
</table></div>
...
<!-- called consumeRows 015--> <!-- just calling --><!-- called consumeRows 225--> <!--  generating 5 cells and calling --><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Discharge','e').':'; ?></td><td class='text data' colspan='1'><?php echo generate_form_field($manual_layouts['vag_discharge'], ''); ?></td><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Note','e').':'; ?></td><td class='text data' colspan='2'><?php echo generate_form_field($manual_layouts['vag_discharge_note'], ''); ?></td><!--  generating empties --><td class='emptycell' colspan='1'></td></tr>
<!-- called consumeRows 015--> <!-- just calling --><!-- called consumeRows 225--> <!--  generating 5 cells and calling --><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Itching','e').':'; ?></td><td class='text data' colspan='1'><?php echo generate_form_field($manual_layouts['vag_itching'], ''); ?></td><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Note','e').':'; ?></td><td class='text data' colspan='2'><?php echo generate_form_field($manual_layouts['vag_itching_note'], ''); ?></td><!--  generating empties --><td class='emptycell' colspan='1'></td></tr>
<!-- called consumeRows 015--> <!-- just calling --><!-- called consumeRows 225--> <!--  generating 5 cells and calling --><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Odor','e').':'; ?></td><td class='text data' colspan='1'><?php echo generate_form_field($manual_layouts['vag_odor'], ''); ?></td><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Note','e').':'; ?></td><td class='text data' colspan='2'><?php echo generate_form_field($manual_layouts['vag_odor_note'], ''); ?></td><!--  generating empties --><td class='emptycell' colspan='1'></td></tr>
<!-- called consumeRows 015--> <!-- just calling --><!-- called consumeRows 225--> <!--  generating 5 cells and calling --><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Irritation','e').':'; ?></td><td class='text data' colspan='1'><?php echo generate_form_field($manual_layouts['vag_irratation'], ''); ?></td><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Note','e').':'; ?></td><td class='text data' colspan='2'><?php echo generate_form_field($manual_layouts['vag_irratation_note'], ''); ?></td><!--  generating empties --><td class='emptycell' colspan='1'></td></tr>
<!-- called consumeRows 015--> <!-- just calling --><!-- called consumeRows 225--> <!--  generating 5 cells and calling --><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Spotting','e').':'; ?></td><td class='text data' colspan='1'><?php echo generate_form_field($manual_layouts['vag_spotting'], ''); ?></td><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Note','e').':'; ?></td><td class='text data' colspan='2'><?php echo generate_form_field($manual_layouts['vag_spotting_note'], ''); ?></td><!--  generating empties --><td class='emptycell' colspan='1'></td></tr>
<!-- called consumeRows 015--> <!-- just calling --><!-- called consumeRows 225--> <!-- generating not($fields[$checked+1]) and calling last --><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Prior Treatment','e').':'; ?></td><td class='text data' colspan='1'><?php echo generate_form_field($manual_layouts['priortreatment'], ''); ?></td><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Note','e').':'; ?></td><td class='text data' colspan='2'><?php echo generate_form_field($manual_layouts['priortreatment_note'], ''); ?></td><!-- called consumeRows 525--> <!-- Exiting not($fields) and generating 0 empty fields --></tr>
</table></div>
...
<!-- called consumeRows 015--> <!--  generating 5 cells and calling --><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Menses Pain','e').':'; ?></td><td class='text data' colspan='4'><?php echo generate_form_field($manual_layouts['pain_menses'], ''); ?></td><!--  generating empties --><td class='emptycell' colspan='1'></td></tr>
<!-- called consumeRows 015--> <!-- just calling --><!-- called consumeRows 325--> <!--  generating 5 cells and calling --><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Pain Level','e').':'; ?></td><td class='text data' colspan='2'><?php echo generate_form_field($manual_layouts['pain_level'], ''); ?></td><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Pain Location','e').':'; ?></td><td class='text data' colspan='1'><?php echo generate_form_field($manual_layouts['pain_location'], ''); ?></td><!--  generating empties --><td class='emptycell' colspan='1'></td></tr>
<!-- called consumeRows 015--> <!-- just calling --><!-- called consumeRows 325--> <!--  generating 7 cells and calling --><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Pain Length of Time','e').':'; ?></td><td class='text data' colspan='2'><?php echo generate_form_field($manual_layouts['pain_lenth'], ''); ?></td><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Pain OTC/NSAIDS Response','e').':'; ?></td><td class='text data' colspan='3'><?php echo generate_form_field($manual_layouts['pain_drug_resp'], ''); ?></td><!--  generating empties --><td class='emptycell' colspan='1'></td></tr>
<!-- called consumeRows 015--> <!-- just calling --><!-- called consumeRows 325--> <!-- generating not($fields[$checked+1]) and calling last --><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Pain with Intercourse','e').':'; ?></td><td class='text data' colspan='2'><?php echo generate_form_field($manual_layouts['pain_intercourse'], ''); ?></td><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('How Long','e').':'; ?></td><td class='text data' colspan='2'><?php echo generate_form_field($manual_layouts['pain_intercourse_time'], ''); ?></td><!-- called consumeRows 625--> <!-- Exiting not($fields) and generating -1 empty fields --></tr>
</table></div>
