...
<b>DCN:</b>&nbsp;<input type="entry" name="dcn" value="<?php echo attr($obj{"dcn"});?>"><img src="<?php echo $GLOBALS['images_static_relative'];?>/space.gif" width="125" height="1">
...
<label><b>Time In:</b>&nbsp;<input type="entry" name="time_in" value="<?php echo attr($obj{"time_in"});?>"></label><img src="<?php echo $GLOBALS['images_static_relative'];?>/space.gif" width="65" height="1">
<label><b>Time Out:</b>&nbsp;<input type="entry" name="time_out" value="<?php echo attr($obj{"time_out"});?>"></label><img src="<?php echo $GLOBALS['images_static_relative'];?>/space.gif" width="65" height="1">
...
<b>Purpose:</b>&nbsp; <input type=checkbox name='new_client_eval' <?php if ($obj{"new_client_eval"} == "on") {
    echo "checked";
                                                                  };?>  ><b>New client evaluation</b><img src="<?php echo $GLOBALS['images_static_relative'];?>/space.gif" width="10" height="1">
<input type=checkbox name='readmission' <?php if ($obj{"readmission"} == "on") {
    echo "checked";
                                        };?>  ><b>Readmission</b><img src="<?php echo $GLOBALS['images_static_relative'];?>/space.gif" width="35" height="1">
...
<b>Spiritual:</b>&nbsp;<input type="entry" name="spiritual" value="<?php echo attr($obj{"spiritual"});?>">&nbsp;<img src="<?php echo $GLOBALS['images_static_relative'];?>/space.gif" width="35" height="1">
...
<b>Number of admissions:</b>&nbsp;<input type="entry" name="number_admitt" value="<?php echo attr($obj{"number_admitt"});?>">&nbsp;<img src="<?php echo $GLOBALS['images_static_relative'];?>/space.gif" width="35" height="1">
