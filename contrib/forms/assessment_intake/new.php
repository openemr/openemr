...
<label><b>DCN:</b>&nbsp;<input type="text" name="dcn"></label><img src="../../../public/images/space.gif" width="125" height="1">
...
<label><b>Time In:</b>&nbsp;<input type="text" name="time_in"></label><img src="../../../public/images/space.gif" width="65" height="1">
<label><b>Time Out:</b>&nbsp;<input type="text" name="time_out"></label><img src="../../../public/images/space.gif" width="65" height="1">
<label><b>Referral Source:</b>&nbsp;<input type="text" name="referral_source"></label><br><br>
<b>Purpose:</b>&nbsp; <input type=checkbox name='new_client_eval'  ><b>New client evaluation</b><img src="../../../public/images/space.gif" width="10" height="1">
<input type=checkbox name='readmission'  ><b>Readmission</b><img src="../../../public/images/space.gif" width="35" height="1">
...
<b>Spiritual:</b>&nbsp;<input type="text" name="spiritual">&nbsp;<img src="../../../public/images/space.gif" width="35" height="1">
...
<b>Number of admissions:</b>&nbsp;<input type="text" name="number_admitt">&nbsp;<img src="../../../public/images/space.gif" width="35" height="1">
