...
<form method=post action="<?php echo $rootdir;?>/forms/Forms3_Cardiology/save.php?mode=new" name="my_form" onSubmit="return top.restoreSession()">
<h1> Forms3_Cardiology </h1>
<hr>
<input type="submit" name="submit form" value="submit form" /><table width="100%" cellpadding="0" cellspacing="0">
