...
<tr><td valign='top'>&nbsp;</td><!-- called consumeRows 012--> <td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Previous Cultures','e').':'; ?></td><td class='text data' colspan='1'><?php echo generate_display_field($manual_layouts['previous_cultures'], $xyzzy['previous_cultures']); ?></td></tr>
...
<tr><td class='sectionlabel'>Plan</td><!-- called consumeRows 012--> <!-- called consumeRows 212--> <!-- Exiting not($fields)0--></tr>
</table>
