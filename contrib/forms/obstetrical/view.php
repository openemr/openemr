...
<td><span class=text>Birthdate: </span></td><td><input type=entry size=10 name=birthdate value="<?php if ($obj{"birthdate"} != "0000-00-00 00:00:00") {echo date("Y-m-d",strtotime($obj{"birthdate"}));
} else {echo "YYYY-MM-DD";}?>"></td>
...
<td><input type=checkbox name="circumcised"  <?php if ($obj{"circumcised"} == "on") {echo "checked";
