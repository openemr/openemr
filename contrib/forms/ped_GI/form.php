...
<TR>
    ...
    <TD>
        ...
        <option <?php if ($obj["pain"]=='no pain') {
            print 'selected' ;}?> >no pain
        <option <?php if ($obj["pain"]=='moderate') {
            print 'selected';} ?>>moderate
        <option <?php if ($obj["pain"]=='intense') {
            print 'selected';} ?>>intense
