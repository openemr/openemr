...
<TR>
	...
	<TD>
		...
		<option <? if ($obj["diarrhea"]=='no') print 'selected'; ?>>no
		<option <? if ($obj["diarrhea"]=='yes') print 'selected'; ?>>yes
		</SELECT>
	</TD>
	<TD>Every bowel movement:</TD>
	<TD>
		<SELECT NAME="with_every_bowel_movement">
		<option <? if ($obj["with_every_bowel_movement"]=='n/a') print 'selected'; ?>>n/a
		<option <? if ($obj["with_every_bowel_movement"]=='no') print 'selected'; ?>>no
		<option <? if ($obj["with_every_bowel_movement"]=='yes') print 'selected'; ?>>yes
		</SELECT>
	</TD>
	<TD>After Every meal:</TD>
	<TD>
		<SELECT NAME="after_every_meal">
		<option <? if ($obj["after_every_meal"]=='n/a') print 'selected'; ?>>n/a
		<option <? if ($obj["after_every_meal"]=='no') print 'selected'; ?>>no
		<option <? if ($obj["after_every_meal"]=='yes') print 'selected'; ?>>yes
		</SELECT>
	</TD>
</TD>
<TR>
	...
	<TD>
		...
		<option <? if ($obj["blood_or_mucus_in_stool"]=='no') print 'selected'; ?>>no
		<option <? if ($obj["blood_or_mucus_in_stool"]=='blood') print 'selected'; ?>>blood
		<option <? if ($obj["blood_or_mucus_in_stool"]=='mucus') print 'selected'; ?>>mucus
		<option <? if ($obj["blood_or_mucus_in_stool"]=='both') print 'selected'; ?>>both
		</SELECT>
	</TD>
	<TD>Onset:</TD>
	<TD>
		<SELECT NAME="diarrhea_onset">
		<option <? if ($obj["diarrhea_onset"]=='one hour') print 'selected'; ?>>one hour
		<option <? if ($obj["diarrhea_onset"]=='twelve hours') print 'selected'; ?>>twelve hours
		<option <? if ($obj["diarrhea_onset"]=='one day') print 'selected'; ?>>one day
		<option <? if ($obj["diarrhea_onset"]=='two days') print 'selected'; ?>>two days
		<option <? if ($obj["diarrhea_onset"]=='three days') print 'selected'; ?>>three days
		<option <? if ($obj["diarrhea_onset"]=='more than 3 days') print 'selected'; ?>>more than 3 days
		</SELECT>
	</TD>
	<TD>Worms:</TD>
	<TD>
		<SELECT NAME="worms">
		<option <? if ($obj["worms"]=='no') print 'selected'; ?>>no
		<option <? if ($obj["worms"]=='yes') print 'selected'; ?>>yes
		</SELECT>
	</TD>
</TR>
...
<TR>
	...
	<TD>
		<SELECT NAME="vomits">
		<option <? if ($obj["vomits"]=='no') print 'selected'; ?>>no
		<option <? if ($obj["vomits"]=='yes') print 'selected'; ?>>yes
		</SELECT>
	</TD>
	<TD>Duration:</TD>
	<TD>
	...
	<TD>
		...
		<option <? if ($obj["projectile"]=='n/a') print 'selected'; ?>>n/a
		<option <? if ($obj["projectile"]=='no') print 'selected'; ?>>no
		<option <? if ($obj["projectile"]=='yes') print 'selected'; ?>>yes
		</SELECT>
	</TD>
</TR>
<TR>
	...
	<TD>
		...
		<option <? if ($obj["more_often_than_2_hours"]=='n/a') print 'selected' ;?> >n/a
		<option <? if ($obj["more_often_than_2_hours"]=='no') print 'selected' ;?> >no
		<option <? if ($obj["more_often_than_2_hours"]=='yes') print 'selected'; ?>>yes
		</SELECT>
	</TD>
	<TD >After every meal:</TD>
	<TD>
		<SELECT NAME="vomit_after_every_meal">
		<option <? if ($obj["vomit_after_every_meal"]=='n/a') print 'selected' ;?> >n/a
		<option <? if ($obj["vomit_after_every_meal"]=='no') print 'selected' ;?> >no
		<option <? if ($obj["vomit_after_every_meal"]=='yes') print 'selected'; ?>>yes
		</SELECT>
	</TD>
	<TD >Blood in vomitus:</TD>
	<TD>
		<SELECT NAME="blood_in_vomitus">
		<option <? if ($obj["blood_in_vomitus"]=='n/a') print 'selected' ;?> >n/a
		<option <? if ($obj["blood_in_vomitus"]=='no') print 'selected' ;?> >no
		<option <? if ($obj["blood_in_vomitus"]=='yes') print 'selected'; ?>>yes
		</SELECT>
	</TD>
</TR>
...
<TR>
	...
	<TD>
		...
		<option <? if ($obj["taking_medication"]=='no') print 'selected'; ?>>no
		<option <? if ($obj["taking_medication"]=='yes') print 'selected'; ?>>yes
	</TD>
	<TD>Oral Rehidration solution:</TD>
	<TD>
		<SELECT NAME="oral_rehydration">
		<option <? if ($obj["taking_oral_rehydration_solution"]=='yes') print 'selected'; ?>>yes
		<option <? if ($obj["taking_oral_rehydration_solution"]=='no') print 'selected'; ?>>no
	</TD>
	<TD>Eating Solid Food</TD>
	<TD>
		<SELECT NAME="eating_solid_food">
		<option <? if ($obj["eating_solid_food"]=='yes') print 'selected'; ?>>yes
		<option <? if ($obj["eating_solid_food"]=='no') print 'selected'; ?>>no
	</TD>
</TR>
<TR>
	<TD>Fever: </TD>
	...
	<TD>
		<SELECT NAME="pain">
		<option <? if ($obj["pain"]=='no pain') print 'selected' ;?> >no pain
		<option <? if ($obj["pain"]=='moderate') print 'selected'; ?>>moderate
		<option <? if ($obj["pain"]=='intense') print 'selected'; ?>>intense
		<option <? if ($obj["pain"]=='severe') print 'selected'; ?>>severe
		</SELECT>
	</TD>
	<TD >Lethargy:</TD>
	<TD>
...
<TR>
	...
	<TEXTAREA NAME="notes" ROWS="3" COLS="40"><? if ($obj["notes"]!='') print $obj["notes"]; ?></TEXTAREA></TD>
</TR>
</TABLE>
