<!-- view.php --> 
 ...
 $obj = formFetch("form_chiro_history", $_GET["id"]);  //#Use the formFetch function from api.inc to get values for existing form. 
 ...
 function chkdata_CB(&$obj, $nam, $var) {  
  ...
  { 
   if (preg_match("/Positive.*$var/",$obj{$nam})) 
   { 
     return "checked"; 
   } 
   else 
...
<form method=post action="<?php echo $rootdir;?>/forms/chiro_history/save.php?mode=update&id=<?php echo $_GET["id"];?>" name="my_form" onsubmit="return top.restoreSession()">
<hr>
