    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <form class="prefs p-4 row" name="addRecall" id="addRecall">
                ...
                <input type="hidden" name="csrf_token_form" value="<?php echo attr((string) \OpenEMR\Common\Csrf\CsrfUtils::collectCsrfToken(session: SessionWrapperFactory::getInstance()->getActiveSession())); ?>" />
