...
class ServiceLocatorEvent extends Event
{
    ...
    /**
     * @var string The service name/interface being requested
     */
    private $serviceName;
    ...
    /**
     * @var array Additional context for the service lookup
     */
    private $context;
     ...
     */
    public function __construct(string $serviceName, array $context = [])
    {
