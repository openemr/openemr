    ...
    protected function configureValidator()
    {
        ...
        $this->validator->context(
            ...
            function (Validator $context): void {
                ...
                ->required(fn($values): bool => array_key_exists('email_direct', $values) && $values['email_direct'] !== '' && $values['email_direct'] !== null) // @phpstan-ignore argument.type
                ->callback(function ($value) {
                    if (!ValidationUtils::isValidEmail($value)) {
                        throw new InvalidValueException("Trusted Email " . $value . " is not a valid email", "email_direct"); // @phpstan-ignore binaryOp.invalid
                    }
                    return true;
                });
            }
