    ...
    protected function configureValidator()
    {
        $this->validator->context(
            ...
            function (Validator $context) {
                ...
                $context->optional("route_id", "Drug Route")->string()->string()->string()->callback(function($value) {
                    return $this->validateCode($value, 'list_options', 'drug_route');
                });

                $context->optional("interval_id", "Drug Interval")->string()->string()->callback(function($value) {
...
patient_id: 3
drug: band
quantity: https://docs.google.com/spreads
size:
unit: 0
dosage: 1
form: 0
...
interval: 0
refills: 0
per_refill: https://docs.google.com/spreads
note:
substitute: 0
id: 0
process: true
rxnorm_drugcode: band
 */
