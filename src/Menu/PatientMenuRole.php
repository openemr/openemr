    ...
    public function displayHorizNavBarMenu()
    {
        ...
        foreach ($menu_restrictions as $key => $value) {
            if (!empty($value->children)) {
                ...
                $list = '<li class="dropdown"><a href="#"  id="' . attr($value->menu_id) . '" class="nav-link dropdown-toggle text-body ' . attr($class) . '" data-bs-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">' . text($value->label) . ' <span class="caret"></span></a>';
