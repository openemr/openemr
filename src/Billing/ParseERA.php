        ...
        while (true) {
            ...
            //    $out['payer_id'] = trim($seg[4]); no payer id in TRN04 for 5010
                ...
                $out['warnings'] .= 'Claim contact information: ' .
                    $seg[4] . "\n";
            } else if ($segid == 'AMT' && $out['loopid'] == '2100') { // For AMT01 see the Amount Qualifier Codes on pages 135-135 of the
            ...
            } else if ($segid == 'QTY' && $out['loopid'] == '2100') { // For QTY01 see the Quantity Qualifier Codes on pages 137-138 of the
