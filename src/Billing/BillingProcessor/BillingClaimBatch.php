...
class BillingClaimBatch
{
    ...
    public function __construct(
        ...
        $this->bat_filedir = \OpenEMR\Core\OEGlobalsBag::getInstance()->get('OE_SITE_DIR') . DIRECTORY_SEPARATOR . "documents" . DIRECTORY_SEPARATOR . "edi";
    ...
    public function write_batch_file()
    {
        ...
        if (
            true === $success &&
            \OpenEMR\Core\OEGlobalsBag::getInstance()->get('auto_sftp_claims_to_x12_partner')
        ) {
