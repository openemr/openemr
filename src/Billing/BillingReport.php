    ...
    public static function generateTheQueryPart($daysheet = false)
    {
        ...
        if (isset($_REQUEST['final_this_page_criteria'])) {
            foreach ($_REQUEST['final_this_page_criteria'] as $criteria_value) {
                //---------------------------------------------------------
                if (strpos((string) $criteria_value, "billing.billed|=|1") !== false) {
                    $billstring .= ' AND ' . "billing.billed = '1'";
                } elseif (strpos((string) $criteria_value, "billing.billed|=|0") !== false) {
                ...
                } elseif (strpos((string) $criteria_value, "billing.billed|=|7") !== false) {
                    $billstring .= ' AND ' . "billing.bill_process = '7'";
                } elseif (strpos((string) $criteria_value, "billing.id|=|null") !== false) {
                    $billstring .= ' AND ' . "billing.id is null";
                } elseif (strpos((string) $criteria_value, "billing.id|=|not null") !== false) {
                    $billstring .= ' AND ' . "billing.id is not null";
                } elseif (strpos((string) $criteria_value, "patient_data.fname|like|") !== false) {
                ...
                } elseif (strpos((string) $criteria_value, "form_encounter.pid|=|") !== false) {//comes like '781,780'
                    $elements = explode('|', (string) $criteria_value);
                ...
                } elseif (strpos((string) $criteria_value, "form_encounter.encounter|=|") !== false) {//comes like '781,780'
                    $elements = explode('|', (string) $criteria_value);
                ...
                } elseif (strpos((string) $criteria_value, "insurance_data.provider|=|1") !== false) {
                    $query_part .= ' AND ' . "insurance_data.provider > '0' and (insurance_data.date <= form_encounter.date OR insurance_data.date IS NULL)";
                } elseif (strpos((string) $criteria_value, "insurance_data.provider|=|0") !== false) {
                    $query_part .= ' AND ' . "(insurance_data.provider = '0' or insurance_data.date > form_encounter.date)";
                } elseif (strpos((string) $criteria_value, "form_encounter.date|between|") !== false) {
                    $elements = explode('|', (string) $criteria_value);
                ...
                } elseif (strpos((string) $criteria_value, "billing.date|between|") !== false) {
                    $elements = explode('|', (string) $criteria_value);
                ...
                } elseif (strpos((string) $criteria_value, "claims.process_time|between|") !== false) {
                    $elements = explode('|', (string) $criteria_value);
                    ...
                    if (substr((string) $criteria_value, 0, 12) === 'billing.user' && ($daysheet)) {
