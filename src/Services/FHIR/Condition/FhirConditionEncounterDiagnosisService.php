...
//            'verification-status' => new FhirSearchParameterDefinition('verification-status', SearchFieldType::TOKEN, ['verification_status'])
    ...
    protected function searchForOpenEMRRecords($openEMRSearchParameters): ProcessingResult
    {
        ...
        try {
            // TODO: @adunsulag this was generated by AI but we may want to shove it down to ConditionService or into an EncounterIssuesService
            $sql = "
            SELECT
                l.id,
                ie.uuid,
    ...
    private function populateRecordedDate($dataRecord, FHIRCondition $conditionResource): void
    {
        ...
        $recordedDate = $dataRecord['encounter_date'] ?? $dataRecord['begdate'];
        if ($recordedDate) {
