...
class UserService
{
    private AclGroupService $aclService;
    ...
    {
        $this->aclService = new AclGroupService();
        ...
        try {
            ...
            if ($aclGroupIds) {
                foreach ($aclGroupIds as $aclGroupId) {
                    $this->aclService->addUserToGroup(
                        sprintf('%s %s', $data['fname'], $data['lname']),
                        $data['username'],
                        $aclGroupId
                    );
                }
    ...
    public function deleteByUuid(string $uuid): void
    {
        ...
        $this->aclService->removeUserFromAllGroups($user['username']);
