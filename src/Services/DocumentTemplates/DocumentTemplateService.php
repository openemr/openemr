...
class DocumentTemplateService extends QuestionnaireService
{
    ...
    public function insertTemplate($pid, $category, $template, $content, $mimetype = null, $profile = null): int
    {
        ...
        return sqlInsert($sql, array($pid, ($_SESSION['authUserID'] ?? null), ($profile ?: ''), $category ?: '', $template, $name, 'New', $content, strlen((string) $content), $mimetype, $pid, ($_SESSION['authUserID'] ?? null), $content, strlen((string) $content), $mimetype));
    }
