...
class PractitionerService extends BaseService
{
    ...
    public function selectHelper($sqlUpToFromStatement, $map)
    {
        ...
        return parent::selectHelper($sqlUpToFromStatement, $map); // TODO: Change the autogenerated stub
    }

    public function search($search, $isAndCondition = true)
    {
        // we make sure we only get NPI values
        // TODO: stephen when we can get the Missing modifier working we can do that here...
...
//        $search['npi']->setModifier(SearchModifier::MISSING);
    ...
    public function getOne($uuid)
    {
        ...
        // TODO: adunsulag we probably want to refactor this to use the search mechanism... the challenge is we want it
        // to be a search that is limited to just a single value...
