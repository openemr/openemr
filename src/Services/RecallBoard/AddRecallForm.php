    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <form class="prefs p-4 row" name="addRecall" id="addRecall">
                ...
                <input type="hidden" name="csrf_token_form" value="<?php echo attr(\OpenEMR\Common\Csrf\CsrfUtils::collectCsrfToken()); ?>" />
                    ...
                    <div class="row divTableBody prefs">
                            ...
                            <div class="divTableCell indent20 form-group col-8 col-md-8">
                                <input type="text" name="new_recall_name" id="new_recall_name" class="form-control"
                                        ...
                                        value="<?php echo attr((string) ($result_pat['fname'] ?? '') . " " . (string) ($result_pat['lname'] ?? '')); ?>" />
        ...
        <script>
            ...
            $(function () {
                ...
                if (!empty($pid) && $pid !== 'new') {
                    ?>
                setpatient(<?php echo js_escape((string) $pid); ?>);
                    <?php
                }
                ?>
            var xljs_NOTE = <?php echo xlj("NOTE"); ?>;
            var xljs_PthsApSched = <?php echo xlj("This patient already has an appointment scheduled for"); ?>;
            var xljs_PlsDecRecDate = <?php echo xlj("Please select a recall date"); ?>;
