...
/**
 * @extends MultiSettingManager<array<string>>
 */
class MultiLanguageSettingManager extends MultiSettingManager
{
    ...
    {
        return $dataType === GlobalSetting::DATA_TYPE_MULTI_LANGUAGE_SELECT;
    }
    ...
    public function validateSettingValue(string $settingKey, $settingValue): void
    {
        ...
        foreach ($settingValue as $settingValueItem) {
            Assert::oneOf(
                $settingValueItem,
                array_map(
