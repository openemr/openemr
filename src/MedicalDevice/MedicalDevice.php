...
class MedicalDevice
{
    ...
    public static function fullOutputJavascript($jsVar, $jsVal, $showUdi = true)
    {
        ...
        $js .= 'if (' . $jsVal . '.standard_elements.deviceDescription) {' . $jsVar . ' += \'<span class="font-weight-bold">\' + jsXlt("Description") + \': </span>\' + jsText(' . $jsVal . '.standard_elements.deviceDescription) + \'<br>\';}';
        $js .= 'if (' . $jsVal . '.standard_elements.brandName) {' . $jsVar . ' += \'<span class="font-weight-bold">\' + jsXlt("Brand Name") + \': </span>\' + jsText(' . $jsVal . '.standard_elements.brandName) + \'<br>\';}';
        $js .= 'if (' . $jsVal . '.standard_elements.companyName) {' . $jsVar . ' += \'<span class="font-weight-bold">\' + jsXlt("Company Name") + \': </span>\' + jsText(' . $jsVal . '.standard_elements.companyName) + \'<br>\';}';
        $js .= 'if (' . $jsVal . '.standard_elements.versionModelNumber) {' . $jsVar . ' += \'<span class="font-weight-bold">\' + jsXlt("Version/Model Number") + \': </span>\' + jsText(' . $jsVal . '.standard_elements.versionModelNumber) + \'<br>\';}';
        $js .= 'if (' . $jsVal . '.standard_elements.di) {' . $jsVar . ' += \'<span class="font-weight-bold">\' + jsXlt("DI (Device Identifier)") + \': </span>\' + jsText(' . $jsVal . '.standard_elements.di) + \'<br>\';}';
        $js .= 'if (' . $jsVal . '.standard_elements.serialNumber) {' . $jsVar . ' += \'<span class="font-weight-bold">\' + jsXlt("Serial Number") + \': </span>\' + jsText(' . $jsVal . '.standard_elements.serialNumber) + \'<br>\';}';
        $js .= 'if (' . $jsVal . '.standard_elements.lotNumber) {' . $jsVar . ' += \'<span class="font-weight-bold">\' + jsXlt("Lot Number") + \': </span>\' + jsText(' . $jsVal . '.standard_elements.lotNumber) + \'<br>\';}';
        $js .= 'if (' . $jsVal . '.standard_elements.donationId) {' . $jsVar . ' += \'<span class="font-weight-bold">\' + jsXlt("Donation ID") + \': </span>\' + jsText(' . $jsVal . '.standard_elements.donationId) + \'<br>\';}';
        $js .= 'if (' . $jsVal . '.standard_elements.expirationDate) {' . $jsVar . ' += \'<span class="font-weight-bold">\' + jsXlt("Expiration Date") + \': </span>\' + jsText(' . $jsVal . '.standard_elements.expirationDate) + \'<br>\';}';
        $js .= 'if (' . $jsVal . '.standard_elements.manufacturingDate) {' . $jsVar . ' += \'<span class="font-weight-bold">\' + jsXlt("Manufacturing Date") + \': </span>\' + jsText(' . $jsVal . '.standard_elements.manufacturingDate) + \'<br>\';}';
        $js .= 'if (' . $jsVal . '.standard_elements.MRISafetyStatus) {' . $jsVar . ' += \'<span class="font-weight-bold">\' + jsXlt("MRI Safety Status") + \': </span>\' + jsText(' . $jsVal . '.standard_elements.MRISafetyStatus) + \'<br>\';}';
        $js .= 'if (' . $jsVal . '.standard_elements.labeledContainsNRL) {' . $jsVar . ' += \'<span class="font-weight-bold">\' + jsXlt("This device is required to be labeled as containing natural rubber latex or dry natural rubber.") + \'</span><br>\';}';
        $js .= 'if (' . $jsVal . '.standard_elements.deviceHCTP) {' . $jsVar . ' += \'<span class="font-weight-bold">\' + jsXlt("This device is labeled as a Human Cell, Tissue or Cellular or Tissue-Based Product (HCT/P).") + \'</span><br>\';}';
        $js .= 'if (' . $jsVal . '.standard_elements.issuingAgency) {' . $jsVar . ' += \'<span class="font-weight-bold">\' + jsXlt("Issuing Agency") + \': </span>\' + jsText(' . $jsVal . '.standard_elements.issuingAgency) + \'<br>\';}';
        $js .= 'if (' . $jsVal . '.standard_elements.issuingAuthority) {' . $jsVar . ' += \'<span class="font-weight-bold">\' + jsXlt("Assigning Authority") + \': </span>\' + jsText(' . $jsVal . '.standard_elements.issuingAuthority) + \'<br>\';}';
        if ($showUdi) {
            $js .= 'if (' . $jsVal . '.standard_elements.udi) {' . $jsVar . ' += \'<span class="font-weight-bold">\' + jsXlt("UDI (Unique Device Identifier)") + \': </span>\' + jsText(' . $jsVal . '.standard_elements.udi) + \'<br>\';}';
        }
        return $js;
    }
