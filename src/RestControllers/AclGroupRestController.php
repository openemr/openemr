...
/**
 * GroupRestController - REST API for group related operations
 *
 * @package   OpenEMR
 *
...
use OpenEMR\Validators\AclGroupValidator;
...
//    ];
    ...
    private AclGroupValidator $groupValidator;
