 ...
 *
 * All OIDC cache backends serialize and deserialize only this class.
 * By restricting unserialize() to CacheEntry, we prevent PHP object
 * injection attacks — no arbitrary classes can be instantiated from
 * cached data.
 *
