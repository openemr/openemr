...
class ORDataObject
{
    ...
    {
        if (
            !empty(\OpenEMR\Core\OEGlobalsBag::getInstance()->get('static')['enums'][$this->_table][$field_name])
            && is_array(\OpenEMR\Core\OEGlobalsBag::getInstance()->get('static')['enums'][$this->_table][$field_name])
            && !empty($this->_table)
        ) {
            return \OpenEMR\Core\OEGlobalsBag::getInstance()->get('static')['enums'][$this->_table][$field_name];
        } else {
            ...
            if ((is_array($cols) && !empty($cols)) || ($cols && !$cols->EOF)) {
                ...
                \OpenEMR\Core\OEGlobalsBag::getInstance()->get('static')['enums'][$this->_table][$field_name] = $enum;
            }
