...
class CryptoGen implements CryptoInterface
{
     ...
     */
    private function coreEncrypt(?string $sValue, ?string $customPassword = null, KeySource $keySource = KeySource::DRIVE, KeyVersion $keyVersion = self::CURRENT_KEY_VERSION): string
    {
     ...
     * @return false|string The decrypted data, or false if decryption fails
     */
    private function coreDecrypt(string $sValue, ?string $customPassword = null, KeySource $keySource = KeySource::DRIVE, KeyVersion $keyVersion = self::CURRENT_KEY_VERSION): false|string
    {
        if (!$this->isOpenSSLExtensionLoaded()) {
     ...
     */
    private function collectCryptoKey(KeyVersion $keyVersion, string $sub = "", KeySource $keySource = KeySource::DRIVE): string
    {
