...
class CryptoGen
{
     ...
     * @return false|string           the decrypted data or false if failed.
     */
     ...
     *                           sites/<site-dir>/documents/logs_and_misc/methods The 'database' keys are
     *                           stored in the 'keys' sql table
