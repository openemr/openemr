...
/**
 * Treatment Intervention Preference Dashboard Card
 *
 * @package   OpenEMR
...
class TreatmentPreferenceViewCard extends CardModel
{
    ...
    private const CARD_ID_EXPAND = 'treatmentpref_ps_expand';
    private const CARD_ID = 'card_treatment_preferences';

    /** @var TreatmentInterventionPreferenceService */
    private $service;
    ...
    public function __construct(private $pid, array $opts = [])
    {
        ...
        $this->service = new TreatmentInterventionPreferenceService();
    }
    ...
    {
        return xl('Treatment Intervention Preferences'); }
    public function getIdentifier(): string
    {
        return 'card_treatment_preferences'; }
    public function isInitiallyCollapsed(): bool
    {
        return (getUserSetting('card_treatment_preferences') == 0); }
