    ...
    <body>
        <div class="container oe-help-container">
            ...
            <div class= "row" id="medex_communication_service">
                ...
                <button type="button" class="btn btn-default btn-sm btn-add oe-no-float"><?php echo xlt("Sign-Up"); ?></button>
                ...
                <button type="button" class="btn btn-default btn-sm btn-add oe-no-float"><?php echo xlt("Register"); ?></button>
                ...
                <button type="button" class="btn btn-default btn-sm btn-add oe-no-float"><?php echo xlt("Proceed"); ?></button>
            ...
            <div class= "row" id="medex_enabled_recall_board">
                ...
                <p><i class="fa fa-exclamation-circle oe-text-orange" aria-hidden="true"></i> <strong><?php echo xlt("This is available only after registering and purchasing a MedEx subscription "); ?>.</strong>
            ...
            <div class= "row" id="sms_zone">
                ...
                <p><i class="fa fa-exclamation-circle oe-text-orange" aria-hidden="true"></i> <strong><?php echo xlt("This is available only after registering and purchasing a MedEx subscription and logging in"); ?>.</strong>
