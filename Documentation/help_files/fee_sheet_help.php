...
<html>
    ...
    <title><?php echo xlt("Fee Sheet Help");?></title>
    <style>
    .oe-help-container a {
    ...
    <body>
        <div class="container oe-help-container">
            ...
            <div class= "row">
                ...
                <p><i class="fa fa-exclamation-circleoe-text-orange" aria-hidden="true"></i> <strong><?php echo xlt("Before beginning to use the Fee Sheet read through this help page and do some preliminary setup.");?></strong>
                
                <p><?php echo xlt("The default fee sheet can be modified and customized to make it more useful.");?>
                
                <p><?php echo xlt("A follow-up appointment can also be scheduled right from the fee sheet.");?>
            ...
            <div class= "row" id="price_level">
                ...
                <p><?php echo xlt("To add more options to the drop-down menu go to Administration > Lists > Manage Lists and select 'Price Level' in the drop-down box and enter the types e.g: Credit Card, Cash etc.."); ?>
            ...
            <div class= "row" id="select_code">
                ...
                <p><?php echo xlt("The default has two buttons that is set for 'New Patient' and 'Established' patient. Clicking the button will reveal a pop-up that will list the E/M codes, check the appropriate code and click 'OK'."); ?>
            ...
            <div class= "row" id="search_additional">
                ...
                <p><i class="fa fa-exclamation-circle oe-text-orange" aria-hidden="true"></i> <strong><?php echo xlt("For a search to show results the codes must exist in the database.");?></strong>  <strong><a href="#setup" class="oe-help-redirect"><?php echo xlt("See Setup the Fee Sheet"); ?></a></strong>
                
                <p><?php echo xlt("Select the appropriate radio button. Enter the search term in the search box and click 'Search'. A pop-up box will alert you about success or failure."); ?>
            ...
            <div class= "row" id="selected_codes">
                ...
                <ul>
                    ...
                    <li><?php echo xlt("Justify"); ?> - <?php echo xlt("Justify each CPT code with one or more justifications using the drop-down box.These will reflect the diagnosis codes that was previously selected in 'Select Codes'"); ?></li>
                    <li><?php echo xlt("Provider/Warehouse"); ?> - <?php echo xlt("A provider or warehouse can be selected in the drop-down box. For this option to be displayed 'Support provider in line item in fee sheet' box must be checked in Administration > Globals> Billing page"); ?></li>
                    <li><?php echo xlt("Note Codes"); ?> - <?php echo xlt("Add a note to the biller."); ?></li>
                </ul>
                
                <p><?php echo xlt("In addition there are 2 check-boxes."); ?>
                <ul>
                    <li><?php echo xlt("Auth"); ?> - <?php echo xlt("Authorize or not as needed."); ?></li>
                    <li><?php echo xlt("Delete"); ?> - <?php echo xlt("Lets you delete a line or row. Hit 'Refresh' and the line will have a strike-through across it. To fully delete hit 'Save'."); ?></li>
                </ul>
            ...
            <div class= "row" id="select_providers">
                ...
                <p><?php echo xlt("To allow for each procedure line to have a separate provider you have to check the 'Support provider in line item in fee sheet' check-box in Administration > Globals > Billing. If not checked the rendering provider in this section will be used for all claims"); ?>
            ...
            <div class= "row" id="setup">
                ...
                <p><?php echo xlt("The very first step would be install the ICD codes. Go to Administration > Other > External Data Loads. Select the Code sets you want to install and click Install."); ?>
                ...
                <p><?php echo xlt("If you are planning on entering different prices for different modalities of payment go to Administration > Lists."); ?>
                ...
                <p><?php echo xlt("To change and activate the default parameters in the Fee Sheet go to Administration > Globals > Billing."); ?>
                    ...
                    <li><?php echo xlt("Support provider in line item in fee sheet"); ?> - <?php echo xlt(" Will add another drop-down menu in the CPT line to let you select a provider for that line item."); ?></li>
            ...
            <div class= "row" id="customize">
                ...
                <p><?php echo xlt("The following steps will help customize the Fee Sheet to mimic the old paper super-bill with a list of CPT4 and ICD codes arranged in categories."); ?>
                
                <p><i class="fa fa-exclamation-triangle oe-text-red" aria-hidden="true"></i> <strong><?php echo xlt("Before you begin customization please ensure that all the ICD and CPT codes you will be needing have been entered into the database."); ?></strong> <strong><a href="#setup" class="oe-help-redirect"><?php echo xlt("See Setup the Fee Sheet"); ?></a></strong>
                
                <p><?php echo xlt("The first step is to plan what your Fee Sheet 'Select Codes' section should display."); ?>
                
                <p><?php echo xlt("If you have an old super-bill you can use its grouping of codes as a template to start the customization."); ?>
                ...
                <p><?php echo xlt("Alternatively download a sample spreadsheet."); ?> &nbsp <a href="../../interface/forms/fee_sheet/fee_sheet_customization.ods" class= "btn btn-default btn-download" download="Fee Sheet Customization" target="_blank"> <?php echo xlt("Download"); ?></a>
                ...
                <p><?php echo xlt("The first two numbers in the first and second column will be used to determine the sort order of the buttons and the lists that are present in the popup."); ?>
                
                <p><?php echo xlt("Go to Administration > Lists. Select  'Fee Sheet'  from the drop-down box."); ?>
                
                <p><?php echo xlt("Replace the existing group and option values with these ones taking care to match the E/M codes."); ?>
                
                <p><?php echo xlt("Add the remaining codes, in order to do so the CPT code must already exist in the database."); ?>
                
                <p><?php echo xlt("After you filled in the spreadsheet with the relevant ICD categories and ICD codes go to Administration > Lists. Select  'Service Category'  from the drop-down box."); ?>
                ...
                <p><i class="fa fa-exclamation-circle oe-text-orange" aria-hidden="true"></i> <strong><?php echo xlt("Go to Administration > Lists and select 'Code Types' from the drop-down box. Use either ICD 9 or ICD 10, inactivate ICD 9 and select 'No' in the last drop-down box under ICD 10."); ?></strong>
                
                <p><?php echo xlt("Go to Administration > Codes. Select ICD 10 under Type, enter ICD 10 Code, enter Description, under category select an appropriate category, this ICD 10 code will then appear when the button with that category is clicked."); ?>
                
                <p><?php echo xlt("Click 'Save'."); ?>
                
                <p><i class="fa fa-exclamation-circle oe-text-orange" aria-hidden="true"></i> <strong><?php echo xlt("After you have finished entering all the ICD 10 codes go to Administration > Lists and select 'Code Types' from the drop-down box. Select 'ICD10 Diagnosis' from the last drop-down box under ICD 10."); ?></strong>
                ...
                <p><?php echo xlt("The customized Fee Sheet can be used. If and when you come across a code that is not there in the custom 'Select Codes' section you can always use the 'Search for Additional Codes' section."); ?>
            </div>
