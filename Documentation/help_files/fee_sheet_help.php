    ...
    <body>
        <div class="container oe-help-container">
            ...
            <div class= "row" id="setup">
                ...
                <p><?php echo xlt("Read this wiki page for more details"); ?>. <a href="https://www.open-emr.org/wiki/index.php/Code_Types" target="_blank"><?php echo xlt("Installing codes in openEMR"); ?> </a>
            ...
            <div class= "row" id="customize">
                ...
                <p><?php echo xlt("Read these two wiki articles for customizing the Fee Sheet"); ?>. <strong><a href="https://www.open-emr.org/wiki/index.php/HOWTO:_Create_Multiple_Code_Fee_Sheet_List_Categories" target="_blank"><?php echo xlt("Article"); ?> 1 </a></strong> <strong><a href="https://openemr.sourceforge.net/wiki/index.php/Preparing_for_Billing_and_using_the_Fee_Sheet" target="_blank"><?php echo xlt("Article"); ?> 2</a></strong>
