...
<html>
    ...
    <body>
        <div class="container oe-help-container">
            ...
            <div class= "row">
                <div class="col-sm-12">
                    <p><?php echo xlt("The dashboard is the central location for convenient access the patient's medical record");?>.
            ...
            <div class= "row" id="section1">
                <div class="col-sm-12">
                    ...
                    <p><?php echo xlt("The header section will reveal patient specific information across most pages related to the patient's medical record");?>.
                    ...
                    <p><strong><?php echo xlt("PATIENT PORTAL"); ?> :</strong>
                    ...
                    <p><i class="fa fa-exclamation-triangle oe-text-red"  aria-hidden="true"></i> <strong><?php echo xlt("You will need Administrator privileges to enable the patient portal");?>.</strong>
                    ...
                    <p><?php echo xlt("These credentials will be used by the patient to login to the patient portal for the first time");?>.
                    ...
                    <p><?php echo xlt("If the patient is deceased then the deceased notification will appear in red in this section");?>.
            ...
            <div class= "row" id="section2">
                <div class="col-sm-12">
                    ...
                    <p><?php echo xlt("The Nav Bar allows one to quickly navigate to various parts of the patient's medical record");?>.
                    ...
                    <p><?php echo xlt("Documents - a repository of the patient's scanned/faxed paper documents. It also the place to download patient specific templates");?>.
            ...
            <div class= "row" id="section3">
                <div class="col-sm-12">
                    ...
                    <p><?php echo xlt("The data section of the dashboard page lists all pertinent items related to a patient");?>.
                    
                    <p><?php echo xlt("These items can be edited if the user has sufficient privilege");?>.
                    
                    <p><?php echo xlt("Billing - provides a summary of the balances - Patient Balance Due, Insurance Balance Due, Total Balance Due and lists the name of the Primary Insurance along with its effective date");?>.
                    ...
                    <p><i class="fa fa-exclamation-triangle oe-text-red"  aria-hidden="true"></i> <strong><?php echo xlt("Please ensure that there is only one image file - jpeg, png or bmp in the Patient Photograph folder");?>.</strong>
                    ...
                    <p><?php echo xlt("Medical Problems - will show the patient's medical issues, Issues > Medical Problems");?>.
