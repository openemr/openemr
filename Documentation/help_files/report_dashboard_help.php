...
<html>
    ...
    <body>
        <div class="container oe-help-container">
            <div>
                <center><h2><a name='entire_doc'><?php echo xlt("Patient Reports Help");?></a></h2></center>
            </div>
            <div class= "row">
                <div class="col-sm-12">
                    <p><?php echo xlt("Reports consisting of various portions of the patient's medical record can be created here");?>.
                    
                    <p><?php echo xlt("There are three main types of reports that can be created, two pertain to continuity of ongoing care - Continuity of Care Record (CCR) and Continuity of Care Document (CCD) and the third - Patient Report that creates a document containing various sections of the patient's medical record including demographics, medical issues, procedures and encounters. It also has the ability to include all or any of the scanned documents in the patient's chart");?>.
                    
                    <p><?php echo xlt("This help file is divided into four sections");?>:
            ...
            <div class= "row" id="section1">
                <div class="col-sm-12">
                    ...
                    <p><?php echo xlt("The Continuity of Care Record (CCR) is the clinical record of the patient’s current and historical health care status");?>.
                    
                    <p><?php echo xlt("Basic patient information is included, such as patient and provider information, insurance, patient health status, recent care provided, care plan information, and reason for referral or transfer");?>.
                    
                    <p><?php echo xlt("It is intended to include only the information that is critical to effectively continue care");?>.
                    
                    <p><?php echo xlt("For those interested in details of what constitutes a Continuity of Care Record (CCR) click on the eye icon");?> &nbsp;<i class="show_hide fa fa-eye fa-lg small" title="<?php echo xla('Click to Show'); ?>"></i>
                    
                    <div id="ccr_details" class='hideaway oe-help-heading oe-help-add-info' style='display: none;'>
                        <p><?php echo xlt("The Continuity of Care Record (CCR) has been developed jointly by ASTM International - an organization that is involved in the development and delivery of voluntary consensus, the Massachusetts Medical Society (MMS), the Health Information Management and Systems Society (HIMSS), the American Academy of Family Physicians (AAFP), and the American Academy of Pediatrics");?>.
                    
                        <p><?php echo xlt("The basis for CCR is a Patient Care Referral Form developed by the Massachusetts Department of Public Health");?>.
                        
                        <p><?php echo xlt("In total, there are seventeen sections that can be included within a Continuity of Care Record (CCR)");?>.
                        
                        <p id = "my_hide"><?php echo xlt("All sections are not required, rather, they are available based on the information a practitioner believes is critical data for the patient at any given moment in time");?> &nbsp <i class="show_hide fa fa-eye fa-lg small" title="<?php echo xla('Click to Show'); ?>"></i>
                        ...
                        <div>
                        <p><?php echo xlt("The core dataset consists of");?>: &nbsp;<i class="show_hide fa fa-eye fa-lg small" title="<?php echo xla('Click to Show'); ?>"></i>
                    ...
                    <p><?php echo xlt("In openEMR the Continuity of Care Record (CCR) reports to be generated can be limited to a specific date range by checking the Use Date Range check-box and entering the desired date range");?>.
                    ...
                    <p><i class="fa fa-exclamation-circle oe-text-orange"  aria-hidden="true"></i> <strong><?php echo xlt("Note: this is not an email address");?>.</strong>
                    
                    <p><?php echo xlt("More information about what phiMail is and how to set it up is available here");?>. <a href="#section4"><?php echo xlt("Enabling EMR Direct phiMail");?></a>
                </div>
            </div>
            <div class= "row" id="section2">
                <div class="col-sm-12">
                    ...
                    <p><?php echo xlt("Continuity of Care Document (CCD) is an electronic document containing patient specific information that aids in continuity of care");?>.
                    
                    <p><?php echo xlt("It contains structured data that is included in the Continuity of Care Record (CCR) set to the the Clinical Document Architecture standard");?>.
                    
                    <p><?php echo xlt("Click to learn more about the Clinical Document Architecture (CDA) and Consolidated CDA (C-CDA)");?>  &nbsp;<i class="show_hide fa fa-eye fa-lg small" title="<?php echo xla('Click to Show'); ?>"></i>
                    
                    <div id="ccd_details" class='hideaway oe-help-heading oe-help-add-info' style='display: none;'>
                    
                        <p><?php echo xlt("CDA or Clinical Document Architecture is a document standard developed by the HL7 organization");?>.
                        
                        <p><?php echo xlt("CDA defines building blocks which can be used to contain healthcare data elements that can be captured, stored, accessed, displayed and transmitted electronically for use and reuse in many formats");?>.
                        
                        <p><?php echo xlt("Clinical documents are produced by arranging or limiting CDA elements in defined ways using templates and Implementation Guides (IG)");?>.
                        
                        <p><?php echo xlt("The CDA is a plain text document that is coded using the Extensible Markup Language (XML) and contains a Header and Body");?>.
                        
                        <p><?php echo xlt("The Header defines the context for the clinical document as a whole");?>.
                        
                        <p><?php echo xlt("The Body contains the clinical data that may be structured and organized as one or more sections or may be an unstructured blob of data");?>.
                        
                        <p><?php echo xlt("Each Section has one Narrative Block and zero to many coded Entries");?>.
                        
                        <p><?php echo xlt("The Narrative Block contains information that is rendered as readable text");?>.
                        
                        <p><?php echo xlt("The Entries contain data used for further computer processing");?>.
                        
                        <p><?php echo xlt("Examples of Sections are - Medications, Allergies, Vital Signs");?>.
                        
                        <p><?php echo xlt("The initial efforts led to the creation of duplicative and conflicting Implementation Guides (IGs) published by different standards organizations");?>.
                        
                        <p><?php echo xlt("The end result was a confusing collection of documents containing ambiguous and/or conflicting information");?>.
                        
                        <p><?php echo xlt("To help simplify implementations, commonly used templates were harmonized from existing CDA implementation guides and consolidated into a single implementation guide – the C-CDA Implementation Guide (IG) (07/2012)");?>.
                        
                        <p><?php echo xlt("There are nine C-CDA templates that are currently defined");?>:  &nbsp;<i class="show_hide fa fa-eye fa-lg small" title="<?php echo xla('Click to Show'); ?>"></i>
                        ...
                        <p><?php echo xlt("The Continuity of Care Document (CCD) and Continuity of Care Record (CCR) were both selected as acceptable formats to extract information for clinical care summaries as a part of Meaningful Use Stage 1");?>.
                        
                        <p><?php echo xlt("In the second stage of Meaningful Use, the CCD, but not the CCR, was included as part of the standard for clinical document exchange");?>.
                    </div>
                    
                    <p><?php echo xlt("Continuity of Care Document (CCD) is meant to be created at the conclusion of an encounter prior to transfer of care to enable the next provider to easily access such information");?>.
                    
                    <p><?php echo xlt("It serves as a necessary bridge to a different environment, often with new clinicians who know nothing about the patient, enabling next provider to easily");?>
            ...
            <div class= "row" id="section3">
                <div class="col-sm-12">
                    ...
                    <p><?php echo xlt("Creates a report that contains various sections of the patient's medical record");?>.
                    
                    <p><?php echo xlt("The created report can contain as much or as little information based on the need");?>.
                    ...
                    <p><?php echo xlt("To include the scanned documents that are a part of the patient's record select the desired records by check the relevant check-boxes");?>.
                    ...
                    <p><?php echo xlt("If the report is sent electronically all steps needed for safe and secure transmission of Protected Health Information (PHI) must be followed");?>.
            ...
            <div class= "row" id="section4">
                <div class="col-sm-12">
                    ...
                    <p><?php echo xlt("EMR Direct phiMail is a secure, scalable, standards-based way for participants to send authenticated, encrypted health information directly to known, trusted recipients over the Internet");?>.
                    ...
                    <p><?php echo xlt("Go to Administration > Globals > Connectors");?>.
                    
                    <p><?php echo xlt("Check the Enable phiMail Direct Messaging Service check-box");?>.
                    
                    <p><?php echo xlt("Enter the Server Address, Username, and Password provided to you");?>.
                    
                    <p><?php echo xlt("The server address will be of the form ");?> <b>ssl://servername.example.com:32541</b>
                    
                    <p><?php echo xlt("Replace the hostname and port with the values provided to you by EMR Direct");?>.
                    
                    <p><?php echo xlt("The Username is your Direct Address");?>.
                    
                    <p><?php echo xlt("Do not enter the server URL into your browser address bar, as this will not work");?>.
                    
                    <p><?php echo xlt("Specify the OpenEMR user who will receive notification of new incoming Direct messages");?>.
                    
                    <p><?php echo xlt("Enter their OpenEMR username in the notification user field");?>.
                    
                    <p><?php echo xlt("Specify the interval for automatic message checking, 5 or 10 minutes as a starting point");?>.
                    
                    <p><?php echo xlt("Installations processing a large number of Direct messages may want a shorter interval");?>.
                    
                    <p><?php echo xlt("To disable automatic message checking go to Administration > Globals > Connectors  and set phiMail Message Check Interval to 0 (zero) ");?>.
                    
                    <p><?php echo xlt("Disabling automatic checking would be appropriate if message checking is managed through another mechanism, such as a system cron job");?>.
                    
                    <p><?php echo xlt("In order to send Continuity of Care Record (CCR) and /or Continuity of Care Document (CCD )Optionally check phiMail Allow CCD Send and/or phiMail Allow CCR Send to enable the Transmit feature for these data types");?>.
                    ...
                    <p><?php echo xlt("To receive error notifications from the Direct Messaging service a valid Notification Email Address needs to be entered for the user named in  in Administration > Globals > Connectors > phiMail notification user");?>.
                    
                    <p><?php echo xlt("Install the EMR Direct trust anchor certificate");?>.
                        
                    <p><strong><?php echo xlt("SENDING A MESSAGE"); ?>:</strong>
                    ...
                    <p><?php echo xlt("Received messages are processed and a new Patient Note is delivered to a specified user and appears in that user's Message Center");?>.
                    
                    <p><?php echo xlt("These Patient notes are sent without an assigned patient");?>.
                    
                    <p><?php echo xlt("Open and review the message content and any attachments");?>.
