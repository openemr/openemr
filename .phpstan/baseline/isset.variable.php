...
$ignoreErrors[] = [
    'message' => '#^Variable \\$optionsLabel in isset\\(\\) always exists and is not nullable\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/clickmap/C_AbstractClickmap.php',
];
$ignoreErrors[] = [
    'message' => '#^Variable \\$tmp in isset\\(\\) always exists and is not nullable\\.$#',
    'count' => 1,
...
$ignoreErrors[] = [
    'message' => '#^Variable \\$template_view in isset\\(\\) always exists and is not nullable\\.$#',
    'count' => 1,
...
$ignoreErrors[] = [
    'message' => '#^Variable \\$m in isset\\(\\) is never defined\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/main/calendar/modules/PostCalendar/plugins/function.pc_date_select.php',
];
$ignoreErrors[] = [
...
$ignoreErrors[] = [
    'message' => '#^Variable \\$ProviderID in isset\\(\\) always exists and is not nullable\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/main/calendar/modules/PostCalendar/pnuser.php',
];
$ignoreErrors[] = [
    'message' => '#^Variable \\$end in isset\\(\\) always exists and is not nullable\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/main/calendar/modules/PostCalendar/pnuser.php',
];
$ignoreErrors[] = [
    'message' => '#^Variable \\$pc_facility in isset\\(\\) always exists and is not nullable\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/main/calendar/modules/PostCalendar/pnuser.php',
];
$ignoreErrors[] = [
    'message' => '#^Variable \\$start in isset\\(\\) always exists and is not nullable\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/main/calendar/modules/PostCalendar/pnuser.php',
];
$ignoreErrors[] = [
    'message' => '#^Variable \\$tmpDate in isset\\(\\) always exists and is not nullable\\.$#',
    'count' => 2,
    'path' => __DIR__ . '/../../interface/main/calendar/modules/PostCalendar/pnuser.php',
];
$ignoreErrors[] = [
...
$ignoreErrors[] = [
    'message' => '#^Variable \\$patientID in isset\\(\\) always exists and is not nullable\\.$#',
    'count' => 1,
...
$ignoreErrors[] = [
    'message' => '#^Variable \\$prescription_drug in isset\\(\\) always exists and is not nullable\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/reports/patient_list_creation.php',
];
$ignoreErrors[] = [
    'message' => '#^Variable \\$procedure_diagnosis in isset\\(\\) always exists and is not nullable\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/reports/patient_list_creation.php',
];
$ignoreErrors[] = [
...
$ignoreErrors[] = [
    'message' => '#^Variable \\$options in isset\\(\\) always exists and is always null\\.$#',
    'count' => 1,
...
$ignoreErrors[] = [
    'message' => '#^Variable \\$day_empty in isset\\(\\) always exists and is always null\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../library/smarty_legacy/smarty/plugins/function.html_select_date.php',
];
$ignoreErrors[] = [
    'message' => '#^Variable \\$month_empty in isset\\(\\) always exists and is always null\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../library/smarty_legacy/smarty/plugins/function.html_select_date.php',
];
$ignoreErrors[] = [
    'message' => '#^Variable \\$year_empty in isset\\(\\) always exists and is always null\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../library/smarty_legacy/smarty/plugins/function.html_select_date.php',
];
$ignoreErrors[] = [
    'message' => '#^Variable \\$inarray in isset\\(\\) is never defined\\.$#',
    'count' => 1,
...
$ignoreErrors[] = [
    'message' => '#^Variable \\$redirectUrl in isset\\(\\) always exists and is not nullable\\.$#',
    'count' => 3,
...
$ignoreErrors[] = [
    'message' => '#^Variable \\$test in isset\\(\\) always exists and is not nullable\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../src/Common/Layouts/LayoutsUtils.php',
];
$ignoreErrors[] = [
    'message' => '#^Variable \\$acl_ids in isset\\(\\) always exists and is not nullable\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../src/Gacl/GaclApi.php',
];
$ignoreErrors[] = [
    'message' => '#^Variable \\$groups_ids in isset\\(\\) always exists and is not nullable\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../src/Gacl/GaclApi.php',
];
$ignoreErrors[] = [
