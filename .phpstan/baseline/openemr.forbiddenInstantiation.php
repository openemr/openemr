...
$ignoreErrors = [];
$ignoreErrors[] = [
    'message' => '#^Direct instantiation of OpenEMR\\\\Common\\\\Logging\\\\SystemLogger is discouraged\\. Use ServiceContainer\\:\\:getLogger\\(\\) instead\\.$#',
    'count' => 1,
...
$ignoreErrors[] = [
    'message' => '#^Direct instantiation of OpenEMR\\\\Common\\\\Crypto\\\\CryptoGen is discouraged\\. Use ServiceContainer\\:\\:getCrypto\\(\\) instead\\.$#',
    'count' => 2,
...
$ignoreErrors[] = [
    'message' => '#^Direct instantiation of OpenEMR\\\\Common\\\\Http\\\\Psr17Factory is discouraged\\. Use ServiceContainer\\:\\:get\\*Factory\\(\\) instead\\.$#',
    'count' => 1,
