...
$ignoreErrors = [];
$ignoreErrors[] = [
    'message' => '#^Calling sqlFetchArray\\(\\) is forbidden, Use QueryUtils\\:\\:fetchRecords\\(\\) or QueryUtils\\:\\:fetchArrayFromResultSet\\(\\) instead of sqlFetchArray\\(\\)\\.$#',
    'count' => 1,
...
$ignoreErrors[] = [
    'message' => '#^Calling sqlStatementNoLog\\(\\) is forbidden, Use QueryUtils\\:\\:fetchRecordsNoLog\\(\\) instead of sqlStatementNoLog\\(\\)\\.$#',
    'count' => 3,
    'path' => __DIR__ . '/../../ccr/transmitCCD.php',
];
$ignoreErrors[] = [
    'message' => '#^Calling sqlQuery\\(\\) is forbidden, Use QueryUtils\\:\\:querySingleRow\\(\\) or QueryUtils\\:\\:fetchRecords\\(\\) instead of sqlQuery\\(\\)\\.$#',
    'count' => 2,
    'path' => __DIR__ . '/../../contrib/util/billing/load_fee_schedule.php',
];
$ignoreErrors[] = [
    'message' => '#^Calling sqlQueryNoLog\\(\\) is forbidden, Use QueryUtils\\:\\:querySingleRow\\(\\) instead of sqlQueryNoLog\\(\\)\\.$#',
    'count' => 5,
...
$ignoreErrors[] = [
    'message' => '#^Calling sqlStatement\\(\\) is forbidden, Use QueryUtils\\:\\:sqlStatementThrowException\\(\\) or QueryUtils\\:\\:fetchRecords\\(\\) instead of sqlStatement\\(\\)\\.$#',
    'count' => 3,
    'path' => __DIR__ . '/../../contrib/util/de_identification_upgrade.php',
];
$ignoreErrors[] = [
...
$ignoreErrors[] = [
    'message' => '#^Calling sqlInsert\\(\\) is forbidden, Use QueryUtils\\:\\:sqlInsert\\(\\) instead of sqlInsert\\(\\)\\.$#',
    'count' => 2,
    'path' => __DIR__ . '/../../controllers/C_Document.class.php',
];
$ignoreErrors[] = [
...
$ignoreErrors[] = [
    'message' => '#^Calling sqlBeginTrans\\(\\) is forbidden, Use QueryUtils\\:\\:startTransaction\\(\\) instead of sqlBeginTrans\\(\\)\\.$#',
    'count' => 5,
    'path' => __DIR__ . '/../../interface/billing/edit_payment.php',
];
$ignoreErrors[] = [
    'message' => '#^Calling sqlCommitTrans\\(\\) is forbidden, Use QueryUtils\\:\\:commitTransaction\\(\\) instead of sqlCommitTrans\\(\\)\\.$#',
    'count' => 5,
    'path' => __DIR__ . '/../../interface/billing/edit_payment.php',
];
$ignoreErrors[] = [
...
$ignoreErrors[] = [
    'message' => '#^Calling sqlquery\\(\\) is forbidden, Use QueryUtils\\:\\:querySingleRow\\(\\) or QueryUtils\\:\\:fetchRecords\\(\\) instead of sqlQuery\\(\\)\\. \\[sqlquery\\(\\) matches sqlQuery\\(\\)\\]$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/eRxStore.php',
];
$ignoreErrors[] = [
...
$ignoreErrors[] = [
    'message' => '#^Calling sqlRollbackTrans\\(\\) is forbidden, Use QueryUtils\\:\\:rollbackTransaction\\(\\) instead of sqlRollbackTrans\\(\\)\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/forms/procedure_order/handle_deletions.php',
];
$ignoreErrors[] = [
...
$ignoreErrors[] = [
    'message' => '#^Calling sqlstatement\\(\\) is forbidden, Use QueryUtils\\:\\:sqlStatementThrowException\\(\\) or QueryUtils\\:\\:fetchRecords\\(\\) instead of sqlStatement\\(\\)\\. \\[sqlstatement\\(\\) matches sqlStatement\\(\\)\\]$#',
    'count' => 1,
    'path' => __DIR__ . '/../../library/ajax/imm_autocomplete/search.php',
];
$ignoreErrors[] = [
...
$ignoreErrors[] = [
    'message' => '#^Calling sqlStatementThrowException\\(\\) is forbidden, Use QueryUtils\\:\\:sqlStatementThrowException\\(\\) instead of global sqlStatementThrowException\\(\\)\\.$#',
    'count' => 2,
    'path' => __DIR__ . '/../../src/Common/Database/QueryUtils.php',
];
$ignoreErrors[] = [
