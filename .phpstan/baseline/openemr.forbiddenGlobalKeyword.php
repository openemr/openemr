...
$ignoreErrors[] = [
    'message' => '#^Use of the "global" keyword is forbidden \\(\\$cell_count, \\$CPR, \\$historical_ids, \\$USING_BOOTSTRAP\\)\\. Use dependency injection instead\\.$#',
    'count' => 1,
...
$ignoreErrors[] = [
    'message' => '#^Use of the "global" keyword is forbidden \\(\\$disable_utf8_flag, \\$sqlconf\\)\\. Use dependency injection instead\\.$#',
    'count' => 1,
...
$ignoreErrors[] = [
    'message' => '#^Use of the "global" keyword is forbidden \\(\\$host, \\$port, \\$login, \\$pass, \\$dbase, \\$db_encoding, \\$disable_utf8_flag\\)\\. Use dependency injection instead\\.$#',
    'count' => 1,
...
$ignoreErrors[] = [
    'message' => '#^Use of the "global" keyword is forbidden \\(\\$SHORT_FORM\\)\\. Use dependency injection instead\\.$#',
    'count' => 1,
...
$ignoreErrors[] = [
    'message' => '#^Use of the "global" keyword is forbidden \\(\\$var_index\\)\\. Use dependency injection instead\\.$#',
    'count' => 1,
...
$ignoreErrors[] = [
    'message' => '#^Use of the "global" keyword is forbidden \\(\\$irow\\)\\. Use dependency injection instead\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/patient_file/summary/add_edit_issue.php',
];
$ignoreErrors[] = [
...
$ignoreErrors[] = [
    'message' => '#^Use of the "global" keyword is forbidden \\(\\$mysms\\)\\. Use dependency injection instead\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../modules/sms_email_reminder/cron_functions.php',
];
$ignoreErrors[] = [
...
$ignoreErrors[] = [
    'message' => '#^Use of the "global" keyword is forbidden \\(\\$sum_charges, \\$sum_ptpaid, \\$sum_inspaid, \\$sum_duept, \\$sum_copay, \\$sum_patcopay, \\$sum_balance\\)\\. Use dependency injection instead\\.$#',
    'count' => 1,
...
$ignoreErrors[] = [
    'message' => '#^Use of the "global" keyword is forbidden \\(\\$sqlconf, \\$disable_utf8_flag\\)\\. Use dependency injection instead\\.$#',
    'count' => 1,
