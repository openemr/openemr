...
$ignoreErrors[] = [
    'message' => '#^Variable \\$PLAN_results in empty\\(\\) always exists and is not falsy\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/forms/eye_mag/report.php',
];
$ignoreErrors[] = [
    'message' => '#^Variable \\$fee in empty\\(\\) is never defined\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/forms/fee_sheet/new.php',
];
$ignoreErrors[] = [
    'message' => '#^Variable \\$override in empty\\(\\) always exists and is not falsy\\.$#',
    'count' => 1,
...
$ignoreErrors[] = [
    'message' => '#^Variable \\$pcTemplate in empty\\(\\) always exists and is not falsy\\.$#',
    'count' => 1,
...
$ignoreErrors[] = [
    'message' => '#^Variable \\$newnam in empty\\(\\) is never defined\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/main/calendar/modules/PostCalendar/pnadmin.php',
];
$ignoreErrors[] = [
    'message' => '#^Variable \\$pc_category in empty\\(\\) always exists and is not falsy\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/main/calendar/modules/PostCalendar/pnuser.php',
];
$ignoreErrors[] = [
    'message' => '#^Variable \\$pc_topic in empty\\(\\) always exists and is not falsy\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/main/calendar/modules/PostCalendar/pnuser.php',
];
$ignoreErrors[] = [
    'message' => '#^Variable \\$s_category in empty\\(\\) always exists and is not falsy\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/main/calendar/modules/PostCalendar/pnuser.php',
];
$ignoreErrors[] = [
    'message' => '#^Variable \\$s_topic in empty\\(\\) always exists and is not falsy\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/main/calendar/modules/PostCalendar/pnuser.php',
];
$ignoreErrors[] = [
    'message' => '#^Variable \\$sqlKeywords in empty\\(\\) always exists and is not falsy\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/main/calendar/modules/PostCalendar/pnuser.php',
];
$ignoreErrors[] = [
    'message' => '#^Variable \\$submit in empty\\(\\) always exists and is not falsy\\.$#',
    'count' => 3,
    'path' => __DIR__ . '/../../interface/main/calendar/modules/PostCalendar/pnuser.php',
];
$ignoreErrors[] = [
...
$ignoreErrors[] = [
    'message' => '#^Variable \\$topic in empty\\(\\) always exists and is not falsy\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/main/calendar/modules/PostCalendar/pnuserapi.php',
];
$ignoreErrors[] = [
    'message' => '#^Variable \\$patientArray in empty\\(\\) always exists and is not falsy\\.$#',
    'count' => 1,
...
$ignoreErrors[] = [
    'message' => '#^Variable \\$relatedPatient in empty\\(\\) always exists and is not falsy\\.$#',
    'count' => 1,
...
$ignoreErrors[] = [
    'message' => '#^Variable \\$setup in empty\\(\\) always exists and is not falsy\\.$#',
    'count' => 1,
...
$ignoreErrors[] = [
    'message' => '#^Variable \\$newKey in empty\\(\\) always exists and is always falsy\\.$#',
    'count' => 1,
...
$ignoreErrors[] = [
    'message' => '#^Variable \\$details in empty\\(\\) always exists and is always falsy\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/modules/zend_modules/module/Carecoordination/src/Carecoordination/Model/EncounterccdadispatchTable.php',
];
$ignoreErrors[] = [
    'message' => '#^Variable \\$encounter in empty\\(\\) always exists and is always falsy\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/modules/zend_modules/module/Carecoordination/src/Carecoordination/Model/EncounterccdadispatchTable.php',
];
$ignoreErrors[] = [
    'message' => '#^Variable \\$getprovider in empty\\(\\) always exists and is always falsy\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/modules/zend_modules/module/Carecoordination/src/Carecoordination/Model/EncounterccdadispatchTable.php',
];
$ignoreErrors[] = [
...
$ignoreErrors[] = [
    'message' => '#^Variable \\$searchClause in empty\\(\\) always exists and is not falsy\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/modules/zend_modules/module/Carecoordination/src/Carecoordination/Model/EncounterccdadispatchTable.php',
];
$ignoreErrors[] = [
    'message' => '#^Variable \\$time in empty\\(\\) always exists and is always falsy\\.$#',
    'count' => 2,
    'path' => __DIR__ . '/../../interface/modules/zend_modules/module/Carecoordination/src/Carecoordination/Model/EncounterccdadispatchTable.php',
];
$ignoreErrors[] = [
    'message' => '#^Variable \\$insco in empty\\(\\) always exists and is not falsy\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/orders/order_manifest.php',
];
$ignoreErrors[] = [
    'message' => '#^Variable \\$aNotes in empty\\(\\) always exists and is always falsy\\.$#',
    'count' => 1,
...
$ignoreErrors[] = [
    'message' => '#^Variable \\$b in empty\\(\\) always exists and is always falsy\\.$#',
    'count' => 2,
    'path' => __DIR__ . '/../../interface/reports/receipts_by_method_report.php',
];
$ignoreErrors[] = [
    'message' => '#^Variable \\$key in empty\\(\\) is never defined\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/reports/receipts_by_method_report.php',
];
$ignoreErrors[] = [
...
$ignoreErrors[] = [
    'message' => '#^Variable \\$contraception_billing_code in empty\\(\\) always exists and is always falsy\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../library/contraception_billing_scan.inc.php',
];
$ignoreErrors[] = [
    'message' => '#^Variable \\$contraception_billing_prov in empty\\(\\) always exists and is always falsy\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../library/contraception_billing_scan.inc.php',
];
$ignoreErrors[] = [
...
$ignoreErrors[] = [
    'message' => '#^Variable \\$randomsecret in empty\\(\\) always exists and is not falsy\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../setup.php',
];
$ignoreErrors[] = [
...
$ignoreErrors[] = [
    'message' => '#^Variable \\$responses in empty\\(\\) always exists and is not falsy\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../src/Billing/EDI270.php',
];
$ignoreErrors[] = [
...
$ignoreErrors[] = [
    'message' => '#^Variable \\$encounter_for_forms in empty\\(\\) always exists and is always falsy\\.$#',
    'count' => 2,
    'path' => __DIR__ . '/../../src/Services/Cda/CdaTemplateImportDispose.php',
];
$ignoreErrors[] = [
    'message' => '#^Variable \\$static_encounter in empty\\(\\) is never defined\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../src/Services/Cda/CdaTemplateImportDispose.php',
];
$ignoreErrors[] = [
