...
$ignoreErrors = [];
$ignoreErrors[] = [
    'message' => '#^Call to deprecated function sqlFetchArray\\(\\)\\:
Use QueryUtils\\:\\:fetchRecords\\(\\) or QueryUtils\\:\\:fetchArrayFromResultSet\\(\\) instead$#',
    'count' => 1,
...
$ignoreErrors[] = [
    'message' => '#^Call to deprecated function sqlStatementNoLog\\(\\)\\:
Use QueryUtils\\:\\:fetchRecordsNoLog\\(\\) instead$#',
    'count' => 3,
    'path' => __DIR__ . '/../../ccr/transmitCCD.php',
];
$ignoreErrors[] = [
    'message' => '#^Call to deprecated function sqlQuery\\(\\)\\:
Use QueryUtils\\:\\:querySingleRow\\(\\) or QueryUtils\\:\\:fetchRecords\\(\\) instead$#',
    'count' => 2,
    'path' => __DIR__ . '/../../contrib/util/billing/load_fee_schedule.php',
];
$ignoreErrors[] = [
    'message' => '#^Call to deprecated function sqlQueryNoLog\\(\\)\\:
Use QueryUtils\\:\\:querySingleRow\\(\\) instead$#',
    'count' => 5,
...
$ignoreErrors[] = [
    'message' => '#^Call to deprecated function sqlStatement\\(\\)\\:
Use QueryUtils\\:\\:sqlStatementThrowException\\(\\) or QueryUtils\\:\\:fetchRecords\\(\\) instead$#',
    'count' => 3,
    'path' => __DIR__ . '/../../contrib/util/de_identification_upgrade.php',
];
$ignoreErrors[] = [
...
$ignoreErrors[] = [
    'message' => '#^Call to deprecated function sqlInsert\\(\\)\\:
Use QueryUtils\\:\\:sqlInsert\\(\\) instead$#',
    'count' => 2,
    'path' => __DIR__ . '/../../controllers/C_Document.class.php',
];
$ignoreErrors[] = [
...
Use QueryUtils\\:\\:inTransaction\\(\\) instead$#',
    'count' => 5,
    'path' => __DIR__ . '/../../interface/billing/edit_payment.php',
];
$ignoreErrors[] = [
    'message' => '#^Call to deprecated function sqlCommitTrans\\(\\)\\:
Use QueryUtils\\:\\:inTransaction\\(\\) instead$#',
    'count' => 5,
    'path' => __DIR__ . '/../../interface/billing/edit_payment.php',
];
...
$ignoreErrors[] = [
    'message' => '#^Call to deprecated function sqlRollbackTrans\\(\\)\\:
Use QueryUtils\\:\\:inTransaction\\(\\) instead$#',
    'count' => 1,
    'path' => __DIR__ . '/../../interface/forms/procedure_order/handle_deletions.php',
];
...
$ignoreErrors[] = [
    'message' => '#^Call to deprecated function sqlStatementThrowException\\(\\)\\:
Use QueryUtils\\:\\:sqlStatementThrowException\\(\\) instead$#',
    'count' => 2,
    'path' => __DIR__ . '/../../src/Common/Database/QueryUtils.php',
];
$ignoreErrors[] = [
