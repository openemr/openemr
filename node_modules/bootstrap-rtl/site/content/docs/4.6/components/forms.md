...
<form>
  ...
  <fieldset class="form-group row">
    <legend class="col-form-label col-sm-2 float-sm-right pt-0">Radios</legend>
    <div class="col-sm-10">
      <div class="form-check">
...
<form>
  <div class="form-row align-items-center">
    <div class="col-auto my-1">
      <label class="ml-sm-2 sr-only" for="inlineFormCustomSelect">Preference</label>
...
<form class="form-inline">
  ...
  <input type="text" class="form-control mb-2 ml-sm-2" id="inlineFormInputName2" placeholder="Jane Doe">
...
{{< example >}}
<form class="form-inline">
  <label class="my-1 ml-2" for="inlineFormCustomSelectPref">Preference</label>
  <select class="custom-select my-1 ml-sm-2" id="inlineFormCustomSelectPref">
    <option selected>Choose...</option>
    <option value="1">One</option>
    <option value="2">Two</option>
    <option value="3">Three</option>
  ...
  <div class="custom-control custom-checkbox my-1 ml-sm-2">
