...
<head>
    ...
    <?php
    $csrf_php = js_escape((string) CsrfUtils::collectCsrfToken(session: $session));
...
<body class="p-0 m-0 mt-1">
    <script>
        ...
        function fetchPdf(divName, docid, printContents = null) {
            let csrf_token_js = <?php echo js_escape((string) CsrfUtils::collectCsrfToken(session: $session)); ?>;
            top.restoreSession();
