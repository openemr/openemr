...
<?php echo xlt('Change any item available and when ready click Send for review. The changes will be flagged and staff notified to review changes before commiting them to chart. During the time period before changes are reviewed the Revised button will show Pending and profile data is still available for changes. When accessing profile in pending state all previous edits will appear in Blue and current chart values in Red. You may revert any edit to chart value by clicking that red item (or vica versa) but remember that when you click Send for Review then items that populate the field items are the ones that are sent. Revert Edits button changes everything back to chart values and you may make changes from there. So to recap: Items in BLUE are patient edits with items in RED being original values before any edits.'); ?>
        ...
        <form class="form-inline" onsubmit="return false;">
            <fieldset class="row">
                <!-- <div class="form-group" id="idInputContainer">
            ...
            <div class="form-group" id="provideridInputContainer">
                <label for="providerid"><?php echo xlt('Select Primary Physician')?></label>
                <div class="controls">
            ...
            <!-- <div class="form-group" id="financialInputContainer">
                    <label for="financial"><?php echo xlt('Financial')?></label>
                    <div class="controls">
                        <input type="text" class="form-control" id="financial" placeholder="Financial" value="<%= _.escape(item.get('financial') || '') %>">
                        <span class="help-inline"></span>
                    </div>
                </div> -->
                <div class="form-group" id="fnameInputContainer">
                ...
                <div class="form-group" id="mnameInputContainer">
                ...
                <div class="form-group" id="lnameInputContainer">
                ...
                <div class="form-group  dynhide hide" id="pidInputContainer">
                    <label for="pid"><?php echo xlt('Pid')?></label>
                    <div class="controls">
                        <input type="text" class="form-control" id="pid" placeholder="<?php echo xla('Pid')?>" value="<%= _.escape(item.get('pid') || '') %>">
                        <span class="help-inline"></span>
                    </div>
                </div>
                <div class="form-group" id="pubpidInputContainer">
                    <label for="pubpid"><?php echo xlt('Public Patient Id')?></label>
                    <div class="controls">
                        <input type="text" class="form-control" id="pubpid" disabled value="<%= _.escape(item.get('pubpid') || '') %>">
                        <span class="help-inline"></span>
                    </div>
                </div>
                <div class="form-group" id="dobInputContainer">
                ...
                <div class="form-group" id="ssInputContainer">
                    <label for="ss"><?php echo xlt('SSN')?></label>
                    <div class="controls">
                ...
                <!--<div class="form-group" id="pharmacyIdInputContainer">
                    <label for="pharmacyId"><?php echo xlt('Pharmacy Id')?></label>
                    <div class="controls">
                ...
                <div class="form-group" id="streetInputContainer">
                    <label for="street"><?php echo xlt('Street')?></label>
                    <div class="controls">
                        <input type="text" class="form-control" id="street" required placeholder="<?php echo xla('Street'); ?>" value="<%= _.escape(item.get('street') || '') %>"/>
                        <span class="help-inline"></span>
                    </div>
                </div>
            <div class="form-group" id="cityInputContainer">
            ...
            <div class="form-group" id="stateInputContainer">
                ...
                <div class="form-group" id="postalCodeInputContainer">
                    <label for="postalCode"><?php echo xlt('Postal Code')?></label>
                    <div class="controls">
                        <input type="text" class="form-control" id="postalCode" placeholder="<?php echo xla('Postal Code'); ?>" value="<%= _.escape(item.get('postalCode') || '') %>">
                        <span class="help-inline"></span>
                    </div>
                </div>
                <div class="form-group" id="countyInputContainer">
                    <label for="county"><?php echo xlt('County')?></label>
                    <div class="controls">
                        <input type="text" class="form-control" id="county" placeholder="<?php echo xla('County'); ?>" value="<%= _.escape(item.get('county') || '') %>">
                        <span class="help-inline"></span>
                    </div>
                </div>
                <div class="form-group" id="countryCodeInputContainer">
                    <label for="countryCode"><?php echo xlt('Country Code')?></label>
                    <div class="controls">
                ...
                <div class="form-group" id="phoneHomeInputContainer">
                    <label for="phoneHome"><?php echo xlt('Home Phone')?></label>
                    <div class="controls">
                        <input type="text" class="form-control" id="phoneHome" placeholder="<?php echo xla('Phone Home'); ?>" value="<%= _.escape(item.get('phoneHome') || '') %>">
                        <span class="help-inline"></span>
                    </div>
                </div>
                <div class="form-group" id="phoneBizInputContainer">
                    <label for="phoneBiz"><?php echo xlt('Business Phone')?></label>
                    <div class="controls">
                        <input type="text" class="form-control" id="phoneBiz" placeholder="<?php echo xla('Phone Biz'); ?>" value="<%= _.escape(item.get('phoneBiz') || '') %>">
                        <span class="help-inline"></span>
                    </div>
                </div>
                <div class="form-group" id="phoneCellInputContainer">
                    <label for="phoneCell"><?php echo xlt('Cell Phone')?></label>
                    <div class="controls">
                        <input type="text" class="form-control" id="phoneCell" placeholder="<?php echo xla('Phone Cell'); ?>" value="<%= _.escape(item.get('phoneCell') || '') %>">
                        <span class="help-inline"></span>
                    </div>
                </div>
                <div class="form-group" id="phoneContactInputContainer">
                    <label for="phoneContact"><?php echo xlt('Contact or Notify Phone')?></label>
                    <div class="controls">
                ...
                <div class="form-group" id="contactRelationshipInputContainer">
                    <label for="contactRelationship"><?php echo xlt('Contact Relationship')?></label>
                    <div class="controls">
                ...
                <div class="form-group dynhide" id="refProvideridInputContainer">
                    <label for="refProviderid"><?php echo xlt('Referral Provider')?></label>
                    <div class="controls">
                ...
                <div class="form-group dynhide" id="emailDirectInputContainer">
                    <label for="emailDirect"><?php echo xlt('Email Direct')?></label>
                    <div class="controls">
                ...
                <div class="form-group" id="languageInputContainer">
                    <label for="language"><?php echo xlt('Preferred Language')?></label>
                    <div class="controls">
           ...
           <div class="form-group" id="ethnicityInputContainer">
            ...
            <div class="form-group dynhide" id="familySizeInputContainer">
                    <label for="familySize"><?php echo xlt('Family Size')?></label>
                    <div class="controls">
                ...
                <div class="form-group dynhide" id="regdateInputContainer">
                ...
                <div class="form-group" id="mothersnameInputContainer">
                    <label for="mothersname"><?php echo xlt('Mothers Name')?></label>
                    <div class="controls">
                ...
                <div class="form-group dynhide" id="guardiansnameInputContainer">
                    <label for="guardiansname"><?php echo xlt('Guardians Name')?></label>
                    <div class="controls">
                ...
                <div class="form-group" id="hipaaMailInputContainer">
                    <label for="hipaaMail"><?php echo xlt('Allow Postal Mail')?></label>
                ...
                <div class="form-group" id="hipaaVoiceInputContainer">
                    <label for="hipaaVoice"><?php echo xlt('Allow Voice Call')?></label>
                    <div class="form-check-inline">
                ...
                <div class="form-group" id="hipaaNoticeInputContainer">
                    <label for="hipaaNotice"><?php echo xlt('Allow Notice')?></label>
                    <div class="form-check-inline">
                ...
                <div class="form-group dynhide" id="hipaaMessageInputContainer">
                    <label for="hipaaMessage"><?php echo xlt('Hipaa Message')?></label>
                    <div class="controls">
                ...
                <div class="form-group" id="hipaaAllowsmsInputContainer">
                    <label for="hipaaAllowsms"><?php echo xlt('Allow SMS')?></label>
                    <div class="form-check-inline">
                ...
                <div class="form-group" id="hipaaAllowemailInputContainer">
                    <label for="hipaaAllowemail"><?php echo xlt('Allow Email')?></label>
                    <div class="form-check-inline">
                ...
                <div class="form-group" id="allowImmRegUseInputContainer">
                    <label for="allowImmRegUse"><?php echo xlt('Allow Immunization Registry Use')?></label>
                    <div class="form-check-inline">
                ...
                <div class="form-group" id="allowImmInfoShareInputContainer">
                    <label for="allowImmInfoShare"><?php echo xlt('Allow Immunization Info Share')?></label>
                    <div class="form-check-inline">
                ...
                <div class="form-group" id="allowHealthInfoExInputContainer">
                    <label for="allowHealthInfoEx"><?php echo xlt('Allow Health Info Exchange')?></label>
                    <div class="form-check-inline">
                ...
                <div class="form-group" id="allowPatientPortalInputContainer">
                    <label for="allowPatientPortal"><?php echo xlt('Allow Patient Portal')?></label>
                    <div class="form-check-inline">
                ...
                <div class="form-group dynhide" id="careTeamInputContainer">
                    <label for="careTeam"><?php echo xlt('Care Team')?></label>
                    <div class="controls">
                        <select class="form-control" id="careTeam" placeholder="<?php echo xla('Care Team'); ?>" value="<%= _.escape(item.get('careTeam') || '') %>"></select>
                        <span class="help-inline"></span>
                    </div>
                </div>
                <div class="form-group dynhide" id="noteInputContainer">
                    <label style="color:green" for="note"><?php echo xlt('Message to Reviewer')?></label>
                    <div class="controls">
...
<?php //$this->display('_Footer.tpl.php');?>
                ...
                <!-- <div class="form-group" id="interpretterInputContainer">
                    <label for="interpretter"><?php //echo xlt('Interpreter')?></label>
                    <div class="controls">
                ...
                <div class="form-group" id="migrantseasonalInputContainer">
                    <label for="migrantseasonal"><?php //echo xlt('Migrant Seasonal')?></label>
                    <div class="controls">
                ...
                <!-- <div class="form-group" id="industryInputContainer">
                    <label for="industry"><?php //echo xlt('Industry')?></label>
                    <div class="controls">
                        <input type="text" class="form-control" id="industry" placeholder="<?php //echo xla('Industry')?>" value="<%= _.escape(item.get('industry') || '') %>">
                        <span class="help-inline"></span>
                    </div>
                </div>
                <div class="form-group" id="occupationInputContainer">
                    <label for="occupation"><?php //echo xlt('Occupation')?></label>
                    <div class="controls">
                        <textarea class="form-control" id="occupation" rows="1" style='min-width:90px'><%= _.escape(item.get('occupation') || '') %></textarea>
                        <span class="help-inline"></span>
                    </div>
                </div> -->
            <!--<div class="form-group" id="referrerInputContainer">
                    <label for="referrer"><?php //echo xlt('Referrer')?></label>
                    <div class="controls">
                        <input type="text" class="form-control" id="referrer" placeholder="<?php //echo xla('Referrer')?>" value="<%= _.escape(item.get('referrer') || '') %>">
                        <span class="help-inline"></span>
                    </div>
                </div>
                <div class="form-group" id="referreridInputContainer">
                    <label for="referrerid"><?php //echo xlt('Referrerid')?></label>
                    <div class="controls">
                        <input type="text" class="form-control" id="referrerid" placeholder="<?php //echo xla('Referrerid')?>" value="<%= _.escape(item.get('referrerid') || '') %>">
                        <span class="help-inline"></span>
                    </div>
                </div>-->
                                <!-- <div class="form-group" id="monthlyIncomeInputContainer">
                    <label for="monthlyIncome"><?php //echo xlt('Monthly Income')?></label>
                    <div class="controls">
                ...
                <div class="form-group" id="billingNoteInputContainer">
                    <label for="billingNote"><?php //echo xlt('Billing Note')?></label>
                    <div class="controls">
                ...
                <div class="form-group" id="homelessInputContainer">
                    <label for="homeless"><?php //echo xlt('Homeless')?></label>
                    <div class="controls">
                        <input type="text" class="form-control" id="homeless" placeholder="<?php //echo xla('Homeless')?>" value="<%= _.escape(item.get('homeless') || '') %>">
                        <span class="help-inline"></span>
                    </div>
                </div>
                <div class="form-group" id="financialReviewInputContainer">
                    <label for="financialReview"><?php //echo xlt('Financial Review')?></label>
                    <div class="controls">
                        <div class="input-group">
                ...
                <div class="form-group" id="pubpidInputContainer">
                    <label for="pubpid"><?php //echo xlt('Pubpid')?></label>
                    <div class="controls">
                ...
                <div class="form-group" id="genericname1InputContainer">
                    <label for="genericname1"><?php //echo xlt('Genericname1')?></label>
                    <div class="controls">
                ...
                <div class="form-group" id="genericval1InputContainer">
                    <label for="genericval1"><?php //echo xlt('Genericval1')?></label>
                    <div class="controls">
                ...
                <div class="form-group" id="genericname2InputContainer">
                    <label for="genericname2"><?php //echo xlt('Genericname2')?></label>
                    <div class="controls">
                ...
                <div class="form-group" id="genericval2InputContainer">
                    <label for="genericval2"><?php //echo xlt('Genericval2')?></label>
                    <div class="controls">
                ...
                <!-- <div class="form-group" id="squadInputContainer">
                    <label for="squad"><?php //echo xlt('Squad')?></label>
                    <div class="controls">
                        <input type="text" class="form-control" id="squad" placeholder="<?php //echo xla('Squad')?>" value="<%= _.escape(item.get('squad') || '') %>">
                        <span class="help-inline"></span>
                    </div>
                </div>
                <div class="form-group" id="fitnessInputContainer">
                    <label for="fitness"><?php //echo xlt('Fitness')?></label>
                    <div class="controls">
               ...
               <!-- <div class="form-group" id="allowPatientPortalInputContainer">
                ...
                <div class="form-group" id="deceasedDateInputContainer">
                    <label for="deceasedDate"><?php //echo xlt('Deceased Date')?></label>
                    <div class="controls">
                        <div class="input-group">
                ...
                <div class="form-group" id="deceasedReasonInputContainer">
                    <label for="deceasedReason"><?php //echo xlt('Deceased Reason')?></label>
                    <div class="controls">
                ...
                <div class="form-group" id="soapImportStatusInputContainer">
                    <label for="soapImportStatus"><?php //echo xlt('Soap Import Status')?></label>
                    <div class="controls">
                ...
                <div class="form-group" id="cmsportalLoginInputContainer">
                    <label for="cmsportalLogin"><?php //echo xlt('Cmsportal Login')?></label>
                    <div class="controls">
                        ...
                        <!--        <div class="form-group" id="contrastartInputContainer">
                    <label for="contrastart"><?php //echo xlt('Contrastart')?></label>
                    <div class="controls">
                        <div class="input-group">
                ...
                <div class="form-group" id="completedAdInputContainer">
                    <label for="completedAd"><?php //echo xlt('Completed Ad')?></label>
                    <div class="controls">
                ...
                <div class="form-group" id="adReviewedInputContainer">
                    <label for="adReviewed"><?php //echo xlt('Ad Reviewed')?></label>
                    <div class="controls">
                        <div class="input-group">
