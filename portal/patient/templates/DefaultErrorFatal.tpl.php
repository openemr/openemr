...
<div class="container">
    ...
    <h3 onclick="$('#stacktrace').show('slow');" class="p-0 mb-4 bg-body-tertiary" style="cursor: pointer;"><?php $this->eprint($this->message); ?></h3>
    ...
    <div id="stacktrace" class="p-0 mb-4 bg-body-tertiary hide">
        <p class="fw-bold"><?php echo xlt('Stack Trace'); ?>:</p>
