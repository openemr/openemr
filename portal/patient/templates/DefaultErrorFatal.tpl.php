...
<div class="container">
    ...
    <h3 onclick="$('#stacktrace').show('slow');" class="jumbletron jumbletron-sm" style="cursor: pointer;"><?php $this->eprint($this->message); ?></h3>
    ...
    <div id="stacktrace" class="jumbletron jumbletron-sm hide">
