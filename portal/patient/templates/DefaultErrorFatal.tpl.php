...
<div class="container">
    ...
    <h3 onclick="$('#stacktrace').show('slow');" class="bg-body-tertiary p-4" style="cursor: pointer;"><?php $this->eprint($this->message); ?></h3>
    ...
    <div id="stacktrace" class="bg-body-tertiary p-4 hide">
