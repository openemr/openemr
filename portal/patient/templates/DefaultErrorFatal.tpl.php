...
<div class="container">
    ...
    <h3 onclick="$('#stacktrace').show('slow');" class="p-0 mb-4 bg-light" style="cursor: pointer;"><?php $this->eprint($this->message); ?></h3>
    ...
    <div id="stacktrace" class="p-0 mb-4 bg-light hide">
