...
var pageAudit = {
    ...
    init: function () {
        ...
        if (pageAudit.isInitialized || pageAudit.isInitializing) {
            return;
        }
        pageAudit.isInitializing = true;

        if (!$.isReady && console) {
            console.warn('pageAudit was initialized before dom is ready.  views may not render properly.');
        }
    ...
    updateModel: function () {
        ...
        pageAudit.onsitePortalActivity.save({
            ...
            success: function () {
                ...
                if (isNew) {
                    pageAudit.onsitePortalActivities.add(pageAudit.onsitePortalActivity) }
