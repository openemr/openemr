...
/**
 * OnsiteActivityViewCriteria.php
 *
 * @package   OpenEMR
...
require_once("DAO/OnsiteActivityViewCriteriaDAO.php");

/**
 * The OnsiteActivityViewCriteria class extends OnsiteActivityViewDAOCriteria and is used
