...
class OnsiteActivityViewMap implements IDaoMap, IDaoMap2
{
    ...
    public static function GetFieldMaps()
    {
        if (self::$FM == null) {
            self::$FM =  [];
            // Fields from onsite_portal_activity
            ...
            self::$FM["Ufname"] = new FieldMap("Ufname", "users", "fname", false, FM_TYPE_VARCHAR, 255, null, false);
            self::$FM["Umname"] = new FieldMap("Umname", "users", "mname", false, FM_TYPE_VARCHAR, 255, null, false);
            self::$FM["Ulname"] = new FieldMap("Ulname", "users", "lname", false, FM_TYPE_VARCHAR, 255, null, false);
            ...
            self::$FM["Utitle"] = new FieldMap("Utitle", "users", "title", false, FM_TYPE_VARCHAR, 30, null, false);
