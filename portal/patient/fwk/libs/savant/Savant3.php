...
class Savant3
{
     ...
     *
     * @param array $config
     *          An associative array of configuration keys for
     ...
     *
     * @param string $name
     *          The plugin name. If this plugin has not
     ...
     *
     * @param string $key
     *          The specific configuration key to return. If null,
     ...
     *
     * @param bool $flag
     *          True to use __autoload(), false to not use it.
     *
     * @return void
     *
     */
     ...
     *          A compiler callback value suitable for the
     ...
     *
     * @param string $text
     *          The error text when a template is echoed.
     *
     * @return void
     *
     */
     ...
     *
     * @param bool $flag
     *          True to turn on exception throwing, false
     *          to turn it off.
     *
     * @return void
     *
     ...
     *
     * @param bool $flag
     *          True to turn on variable extraction, false
     *          to turn it off.
     *
     * @return void
     *
     ...
     *
     * @param mixed $value
     *          The value to be escaped and printed.
     *
     * @return void
     *
     */
     ...
     *          The new set of search paths. If null or
     ...
     *
     * @param string|array $path
     *          The directory or stream to search.
     *
     * @return void
     *
     */
     ...
     *
     * @param array $type
     *          The type of path to search (template or resource).
     *
     * @param string $file
     ...
     *
     * @param string $tpl
     *          The template source to compile and display.
     *
     * @return void
     *
     */
     ...
     *
     * @param $tpl The
     *          template to process; if null, uses the
     ...
     *
     * @param string $tpl
     *          The template to process; if null, uses the
     *          default template set with setTemplate().
     *
     ...
     *
     * @param string $tpl
     *          The template source name to look for.
     *
     ...
     *
     * @param string $code
     *          A Savant3 'ERR_*' string.
     *
     * @param array $info
     *          An array of error-specific information.
     *
     * @param int $level
     *          The error severity level, default is
