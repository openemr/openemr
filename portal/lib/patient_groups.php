            ...
            <div class='col-6 col-height p-0 pb-1'>
                ...
                <div id="edit-groups" class='control-group mx-1 border-start border-end'>
                    ...
                    foreach ($group_list as $groups) {
                        ...
                        echo "<h5 class='bg-dark text-light text-center' data-bs-toggle='collapse' data-bs-target='#$group_esc' role='button'><i class='fa fa-eye me-1'></i>" . text($groups['title']) . "</h5>\n";
        ...
        <div class='col-6 col-height p-0 pb-1'>
            ...
            <div id="edit-groups" class='control-group mx-1  border-start border-end'>
                ...
                foreach ($group_list as $group => $groups) {
                    $group_esc = attr($groups['option_id']);
                    $groups_esc = attr($groups['option_id']);
                    echo "<li class='list-group-item move-handle text-center bg-light text-dark fw-bolder p-1 mt-1 mb-0' data-group='$group_esc'>" . text($groups['title']) . "<i class='fa fa-eye float-end my-1 me-2' data-bs-toggle='collapse' data-bs-target='#$group_esc' role='button'></i></li>\n";
        ...
        <div class='col-6 col-height p-0 pb-1'>
            ...
            <div id='edit-profiles' class='control-group mx-1 border-start border-end'>
                ...
                foreach ($profile_list as $profile => $profiles) {
                    ...
                    $active_text = !empty($active) ? '<span class="small float-start">' . xlt('Active') . '</span>' : '';
                    $profile_esc = attr($profile);
                    echo "<h5 class='text-center bg-dark text-light p-1 mt-1 mb-0'>" . $active_text . text($profiles['title']) .
                        "<i class='fa fa-eye float-end my-1 me-2' data-bs-toggle='collapse' data-bs-target='#$profile_esc' role='button'></i></h5>\n";
