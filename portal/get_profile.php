...
<div class='demographics table-responsive' id='DEM'>
    ...
    <div class="card">
            ...
            <?php if ($pending) {
                echo '<button type="button" id="editDems" class="btn btn-danger btn-sm float-end text-white">' . xlt('Pending Review') . '</button>';
            } else {
                echo '<button type="button" id="editDems" class="btn btn-success btn-sm float-end text-white">' . xlt('Revise') . '</button>';
            }
            ?>
            </header>
