...
<head>
    <title>
        <?php echo xlt('OpenEMR Portal'); ?> | <?php echo xlt('Home'); ?>
    </title>
    ...
    <script>
        $(function() {
            ...
            function showProfileModal() {
                ...
                var params = {
                    buttons: [{
                            text: <?php echo xlj('Help'); ?>,
                            close: false,
                            style: 'info',
                            id: 'formHelp'
                        },
                        {
                            text: <?php echo xlj('Cancel'); ?>,
                            close: true,
                            style: 'default'
                        },
                        {
                            text: <?php echo xlj('Revert Edits'); ?>,
                            close: false,
                            style: 'danger',
                            id: 'replaceAllButton'
                        },
                        {
                            text: <?php echo xlj('Send for Review'); ?>,
                            close: false,
                            style: 'success',
            ...
            <ul class="nav navbar-nav">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-md-right" aria-labelledby="profiletab">
                        <a class="dropdown-item" href="<?php echo $GLOBALS['web_root']; ?>/portal/messaging/messages.php" target="_blank" rel="nofollow noreferrer"> <i class="fa fa-envelope"></i> <?php echo xlt('Messages'); ?>
                            <span class="badge badge-pill badge-danger"><?php echo text($msgcnt); ?></span></a>
                        <div class="dropdown-divider"></div>
                        <?php if ($GLOBALS['allow_portal_chat']) { ?>
                            <a class="dropdown-item" href="#messagescard" data-toggle="collapse" data-parent="#cardgroup"><i class="fa fa-user fa-fw"></i> <?php echo xlt("Chat"); ?></a>
                        <?php } ?>
                ...
                <!-- Mobile nav items | TODO: Need to figure out a way to do this without having 2 nav tags -->

                <li class="nav-item d-lg-none d-md-block" data-toggle="pill"><a class="nav-link" href="#profilecard" data-toggle="collapse" data-parent="#cardgroup"><i class="fas fa-id-card"></i> <?php echo xlt('Profile'); ?></a></li>
                <li class="nav-item d-lg-none d-md-block" data-toggle="pill"><a class="nav-link" href="#lists" data-toggle="collapse" data-parent="#cardgroup"><i class="fas fa-list"></i> <?php echo xlt('Lists'); ?></a></li>
                <li class="nav-item d-lg-none d-md-block"><a class="nav-link" href="<?php echo $GLOBALS['web_root']; ?>/portal/patient/onsitedocuments?pid=<?php echo attr_url($pid); ?>" target="_blank" rel="nofollow noreferrer"><i class="fas fa-file-medical"></i> <?php echo xlt('Patient Documents'); ?></a></li>
                <?php if ($GLOBALS['allow_portal_appointments']) { ?>
                    <li class="nav-item d-lg-none d-md-block" data-toggle="pill"><a class="nav-link" href="#appointmentcard" data-toggle="collapse" data-parent="#cardgroup"><i class="fas fa-calendar-check"></i> <?php echo xlt("Appointment"); ?></a></li>
                <?php } ?>
                <?php if ($GLOBALS['portal_two_ledger'] || $GLOBALS['portal_two_payments']) { ?>
                    <li class="nav-item dropdown accounting-menu d-lg-none d-md-block"><a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown"><i class="fas fa-file-invoice-dollar"></i> <?php echo xlt('Accountings'); ?></a>
                ...
                <?php } ?>
                <li class="nav-item dropdown reporting-menu d-lg-none d-md-block"><a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown"><i class="fas fa-book-medical"></i> <?php echo xlt('Reports'); ?></a>
                    <div class="dropdown-menu">
                        ...
                        <?php if (!empty($GLOBALS['portal_onsite_document_download'])) { ?>
                            <span data-toggle="pill"><a class="dropdown-item" href="#reportcard" data-toggle="collapse" data-parent="#cardgroup"><i class="fa fa-folder-open"></i> <?php echo xlt('Report Content'); ?></a></span>

                            <span data-toggle="pill"><a class="dropdown-item" href="#downloadcard" data-toggle="collapse" data-parent="#cardgroup"><i class="fa fa-download"></i> <?php echo xlt('Download Lab Documents'); ?></a></span>
                        <?php } ?>
                    </div>
                </li>
                <li class="nav-item d-lg-none d-md-block"><a class="nav-link" href="<?php echo $GLOBALS['web_root']; ?>/portal/messaging/messages.php"><i class="fas fa-envelope"></i> <?php echo xlt('Secure Messaging'); ?></a></li>
                <?php if ($GLOBALS['easipro_enable'] && !empty($GLOBALS['easipro_server']) && !empty($GLOBALS['easipro_name'])) { ?>
                    <li class="nav-item d-lg-none d-md-block" data-toggle="pill"><a class="nav-link" href="#procard" data-toggle="collapse" data-parent="#cardgroup"><i class="fa fa-edit"></i> <?php echo xlt("Patient Reported Outcomes"); ?></a></li>
                <?php } ?>
                <li class="nav-item d-lg-none d-md-block" data-toggle="pill"><a class="nav-link" href="#openSignModal" data-toggle="modal" data-type="patient-signature"><i class="fas fa-file-signature"></i> <?php echo xlt('Signature on File'); ?></a></li>
                <li class="nav-item d-lg-none d-md-block"><a class="nav-link" href="logout.php"><i class="fa fa-ban"></i> <?php echo xlt('Logout'); ?></a></li>
            </ul>
        </div>
    </nav>


    <div class="container-fluid portal-content h-100">
        <div class="row h-100">
                    ...
                    <ul class="nav nav-pills flex-column text-dark">
                        ...
                        <li class="nav-item">
                            <div class="container-fluid">
                                <span class="navbar-text"><i class="fa fa-user"></i> <?php echo xlt('Welcome') . ' ' . text($result['fname']); ?></span>
                            </div>
                        </li>
                        ...
                        <li class="nav-item"><a class="nav-link" href="<?php echo $GLOBALS['web_root']; ?>/portal/patient/onsitedocuments?pid=<?php echo attr_url($pid); ?>" target="_blank" rel="nofollow noreferrer"><i class="fas fa-file-medical"></i> <?php echo xlt('Patient Documents'); ?></a></li>
                        <?php if ($GLOBALS['allow_portal_appointments']) { ?>
                    ...
                    <?php if ($GLOBALS['allow_portal_appointments']) { ?>
                        ...
                        ?>
                            <div class="card collapse" id="procard">
                                ...
                                <div id="pro" class="card-body"></div>
                            </div>
                        <?php } ?>
